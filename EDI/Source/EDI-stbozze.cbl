      *{TOTEM}PRG-COMMENT
      * EDI-stbozze.Cbl
      * EDI-stbozze.Cbl is generated by TOTEM
      * This is a generated file. DO NOT modify this file directly.
      *{TOTEM}END
       IDENTIFICATION       DIVISION.
      *{TOTEM}PRGID
       PROGRAM-ID.          EDI-stbozze.
       AUTHOR.              andre.
       DATE-WRITTEN.        martedì 25 giugno 2019 16:01:51.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:EDI-stbozze, INIT:EDI-stbozze, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       78 titolo VALUE IS "Geslux - Stampa Master bozze EDI". 
       77 anno-to          PIC  9(4).
       77 num-from         PIC  9(8).
       77 num-to           PIC  9(8).
       77 screen-2-handle
      ...
      *{TOTEM}COPY-PROCEDURE
       EXIT-STOP-ROUTINE.
      * <TOTEM:EPT. INIT:EDI-stbozze, INIT:EDI-stbozze, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. STAMPA-EFFETTIVA>
           initialize EDI-stb-limiti
           move anno-to   to EDI-stb-da-anno
           move anno-to   to EDI-stb-a-anno
           move num-from  to EDI-stb-da-num
           move num-to    to EDI-stb-a-num

           move data-from(1:2)     to data-from-AAAAMMGG(7:2)
           move data-from(3:2)     to data-from-AAAAMMGG(5:2)
           move data-from(5:4)     to data-from-AAAAMMGG(1:4)
           move data-from-AAAAMMGG to EDI-stb-da-data
           move data-to(1:2)       to data-to-AAAAMMGG(7:2)
           move data-to(3:2)       to data-to-AAAAMMGG(5:2)
           move data-to(5:4)       to data-to-AAAAMMGG(1:4)
           move data-to-AAAAMMGG   to EDI-stb-a-data
