       ...
       MAIN-PRG.
           ...
           if tutto-ok
              ...
              if FileCreato
                 ...
                 accept  path-backup 
                         from environment "FATT_EDI_PATH_BACKUP"
                 inspect path-backup 
                         replacing trailing spaces by low-value

                 string  path-backup    delimited low-value
                         tipo-nome-file delimited size
      ...
      ***---
       INIT.
           ...
           accept como-ora  from time.
           initialize wstampa.
           accept  wstampa from environment "FATT_EDI_PATH".
      ...
      ***---
       OPEN-LOGFILE.
           ...
           string path-log           delimited low-value
                  "LOG_EDI_EXPORT_"  delimited size
                  como-data          delimited size
                  "_"                delimited size
                  como-ora           delimited size
                  ".log"             delimited size
       ...
       ELABORAZIONE-FATTURE.
           ...
           start tordini key  is >= k-fattura
                 ...
                 if not RichiamoSchedulato
                    ...
                    move "Nessun documento da inviare" to como-riga
                    perform SCRIVI-RIGA-LOG
                 end-if
                 set errori to true
           end-start.
...
OMAGGI     end-if.
      ...
      ***--
       CLOSE-FILES.
           ...
           close tivaese tparamge clienti
