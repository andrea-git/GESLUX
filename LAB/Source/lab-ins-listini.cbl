      *{TOTEM}PRG-COMMENT
      * lab-ins-listini.Cbl
      * lab-ins-listini.Cbl is generated by TOTEM
      * This is a generated file. DO NOT modify this file directly.
      *{TOTEM}END
       IDENTIFICATION       DIVISION.
      *{TOTEM}PRGID
       PROGRAM-ID.          lab-ins-listini.
       AUTHOR.              andre.
       DATE-WRITTEN.        giovedì 9 novembre 2023 15:00:39.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:lab-ins-listini, INIT:lab-ins-listini, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       78 titolo VALUE IS "Geslux LAB - Inserimento manuale righe listin
      -    "i". 
       77 form1-Handle
       ...
       77 ef-art-cli-buf   PIC  x(15).
       77 ef-prezzo-buf    PIC  9(12)v99.
      ...
      ***** Elenco ID Logici *****
       ...
       78  78-ID-ef-art-cli VALUE 5004.
       78  78-ID-ef-prezzo VALUE 5005.
      ***** Fine ID Logici *****
      *{TOTEM}END
      ...
      * ENTRY FIELD
       05
           ...
           BOXED,
           COLOR IS 513,
           ID IS 78-ID-ef-art-cli,                
           HEIGHT-IN-CELLS,
           WIDTH-IN-CELLS,
           LEFT,
           VALUE ef-art-cli-buf,
           AFTER PROCEDURE ef-art-cli-AfterProcedure, 
           BEFORE PROCEDURE ef-art-cli-BeforeProcedure, 
           .
      ...
      * ENTRY FIELD
       05
           ...
           NUMERIC,
           VALUE ef-prezzo-buf,
           AFTER PROCEDURE ef-prezzo-AfterProcedure, 
           BEFORE PROCEDURE ef-prezzo-BeforeProcedure, 
           .
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:lab-ins-listini, INIT:lab-ins-listini, BeforeDeclarative>
      * <TOTEM:END>
       INPUT-ERROR SECTION.
      ...
      * <TOTEM:EPT. INIT:lab-ins-listini, INIT:lab-ins-listini, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-listini.
      * <TOTEM:EPT. INIT:lab-ins-listini, FD:listini, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O listini
           ...
           END-IF
      * <TOTEM:EPT. INIT:lab-ins-listini, FD:listini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-blister.
      * <TOTEM:EPT. INIT:lab-ins-listini, FD:blister, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT blister
           IF NOT Valid-STATUS-blister
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:lab-ins-listini, FD:blister, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tgrupgdo.
      * <TOTEM:EPT. INIT:lab-ins-listini, FD:tgrupgdo, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tgrupgdo
           IF NOT Valid-STATUS-tgrupgdo
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:lab-ins-listini, FD:tgrupgdo, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-articoli.
      * <TOTEM:EPT. INIT:lab-ins-listini, FD:articoli, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT articoli
           IF NOT Valid-STATUS-articoli
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:lab-ins-listini, FD:articoli, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-listini.
      * <TOTEM:EPT. INIT:lab-ins-listini, FD:listini, BeforeClose>
      * <TOTEM:END>
           CLOSE listini
           .

       CLOSE-blister.
      * <TOTEM:EPT. INIT:lab-ins-listini, FD:blister, BeforeClose>
      * <TOTEM:END>
           CLOSE blister
           .

       CLOSE-tgrupgdo.
      * <TOTEM:EPT. INIT:lab-ins-listini, FD:tgrupgdo, BeforeClose>
      * <TOTEM:END>
           CLOSE tgrupgdo
           .

       CLOSE-articoli.
      * <TOTEM:EPT. INIT:lab-ins-listini, FD:articoli, BeforeClose>
      * <TOTEM:END>
           CLOSE articoli
           .
...
LUBEXX     if ef-art-cli-buf = spaces
              ...
              start listini key not > lst-k-gdo-articolo
                 ...
                 not invalid
                    perform until 1 = 2
                       ...
                       if lst-gdo      not = ef-gdo-buf   or
                          lst-articolo not = ef-art-buf
                          exit perform
                       end-if
                       if lst-cod-art-cli not = spaces
                          move lst-cod-art-cli to ef-art-cli-buf
                          exit perform
                       end-if
                    end-perform
              end-start
           ...
           move ef-gdo-buf      to lst-gdo
           move ef-data-buf     to como-data
           move como-data(1:2)  to lst-data(7:2)
           move como-data(3:2)  to lst-data(5:2)
           move como-data(5:4)  to lst-data(1:4)
           move ef-art-buf      to lst-articolo

           read listini no lock
              invalid
                 perform SCRIVI-LISTINO
              not invalid
                 display message box "Riga Listino già inserita."
                                     x"0D0A"
                                     "Sovrascirvere i dati?"
                          type mb-yes-no
                          giving scelta
                          title titolo
                 if scelta = mb-yes
                    perform RISCRIVI-LISTINO
      ...
      ***---
       SCRIVI-LISTINO.
           move ef-art-cli-buf  to lst-cod-art-cli 
           move ef-prezzo-buf   to lst-prezzo
           accept lst-data-modifica   from century-date
           accept lst-ora-modifica    from time
           move user-codi          to lst-utente-modifica
                                      lst-utente-creazione
           move lst-data-modifica  to lst-data-creazione
           move lst-ora-modifica   to lst-ora-creazione
      ...
      * <TOTEM:PARA. INIT-SCREEN>
           ...
           modify ef-data    value ef-gdo-buf.
           modify ef-art     value ef-art-buf.
           modify lab-art    title lab-art-buf.
           modify ef-art-cli value ef-art-cli-buf.
           modify ef-prezzo  value ef-prezzo-buf 
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. pb-ok-LinkTo>
           ...
           perform  varying CONTROL-ID from 78-ID-ef-gdo by 1
                      until CONTROL-ID > 78-ID-ef-prezzo
              perform CONTROLLO
              if errori 
                 exit perform 
              end-if
      ...
      * <TOTEM:PARA. Screen4-Ef-2-AfterProcedure>
           ...
           .
      * <TOTEM:END>
       ef-art-cli-BeforeProcedure.
      * <TOTEM:PARA. ef-art-cli-BeforeProcedure>
           MODIFY CONTROL-HANDLE COLOR = COLORE-NU
           .
      * <TOTEM:END>
       ef-art-cli-AfterProcedure.
      * <TOTEM:PARA. ef-art-cli-AfterProcedure>
           MODIFY CONTROL-HANDLE COLOR = COLORE-OR
           perform CONTROLLO 
           .
      * <TOTEM:END>
       ef-prezzo-AfterProcedure.
      * <TOTEM:PARA. ef-prezzo-AfterProcedure>
           MODIFY CONTROL-HANDLE COLOR = COLORE-OR
           perform CONTROLLO 
           .
      * <TOTEM:END>
       ef-prezzo-BeforeProcedure.
      * <TOTEM:PARA. ef-prezzo-BeforeProcedure>
           MODIFY CONTROL-HANDLE COLOR = COLORE-NU
           .
      * <TOTEM:END>
