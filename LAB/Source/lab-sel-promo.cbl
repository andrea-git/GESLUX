      *{TOTEM}PRG-COMMENT
      * lab-sel-promo.Cbl
      * lab-sel-promo.Cbl is generated by TOTEM
      * This is a generated file. DO NOT modify this file directly.
      *{TOTEM}END
       IDENTIFICATION       DIVISION.
      *{TOTEM}PRGID
       PROGRAM-ID.          lab-sel-promo.
       AUTHOR.              ANDREA EVENTI.
       DATE-WRITTEN.        martedì 12 aprile 2016 15:00:40.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:lab-sel-promo, INIT:lab-sel-promo, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       78 titolo VALUE IS "Geslux LAB - Ricerca Volanitni". 
       77 Small-Font
       ...
       01 rec-grid.
           ...
           05 col-ini-dpo      PIC  99/99/9999.
           05 col-fine-dpo     PIC  99/99/9999.
           05 col-ini-vol      PIC  99/99/9999.
           05 col-fine-vol     PIC  99/99/9999.
      ...
      * GRID
       05
           ...
           ADJUSTABLE-COLUMNS,
           BOXED,
           DATA-COLUMNS (1, 2, 52, 62, 72, 82, 92, 132),
           ALIGNMENT ("C", "U", "C", "C", "C", "C", "U", "U"),
           SEPARATION (5, 5, 5, 5, 5, 5, 5, 5),
           DATA-TYPES ("U(1)", "X", "X", "X", "X", "X", "X", "X"),
           NUM-COL-HEADINGS 1,
           COLUMN-HEADINGS,
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:lab-sel-promo, INIT:lab-sel-promo, BeforeDeclarative>
      * <TOTEM:END>
       INPUT-ERROR SECTION.
      ...
      * <TOTEM:EPT. INIT:lab-sel-promo, INIT:lab-sel-promo, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-tgrupgdo.
      * <TOTEM:EPT. INIT:lab-sel-promo, FD:tgrupgdo, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tgrupgdo
           ...
           END-IF
      * <TOTEM:EPT. INIT:lab-sel-promo, FD:tgrupgdo, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tpromo.
      * <TOTEM:EPT. INIT:lab-sel-promo, FD:tpromo, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tpromo
           IF NOT Valid-STATUS-tpromo
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:lab-sel-promo, FD:tpromo, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-rpromo.
      * <TOTEM:EPT. INIT:lab-sel-promo, FD:rpromo, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT rpromo
           IF NOT Valid-STATUS-rpromo
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:lab-sel-promo, FD:rpromo, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-destini.
      * <TOTEM:EPT. INIT:lab-sel-promo, FD:destini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT destini
           IF NOT Valid-STATUS-destini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:lab-sel-promo, FD:destini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-clienti.
      * <TOTEM:EPT. INIT:lab-sel-promo, FD:clienti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT clienti
           IF NOT Valid-STATUS-clienti
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:lab-sel-promo, FD:clienti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-articoli.
      * <TOTEM:EPT. INIT:lab-sel-promo, FD:articoli, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT articoli
           IF NOT Valid-STATUS-articoli
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:lab-sel-promo, FD:articoli, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmp-destini.
      * <TOTEM:EPT. INIT:lab-sel-promo, FD:tmp-destini, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-tmp-destini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:lab-sel-promo, FD:tmp-destini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-locali.
      * <TOTEM:EPT. INIT:lab-sel-promo, FD:locali, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT locali
           IF NOT Valid-STATUS-locali
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:lab-sel-promo, FD:locali, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-blister.
      * <TOTEM:EPT. INIT:lab-sel-promo, FD:blister, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT blister
           IF NOT Valid-STATUS-blister
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:lab-sel-promo, FD:blister, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-tgrupgdo.
      * <TOTEM:EPT. INIT:lab-sel-promo, FD:tgrupgdo, BeforeClose>
      * <TOTEM:END>
           CLOSE tgrupgdo
           .

       CLOSE-tpromo.
      * <TOTEM:EPT. INIT:lab-sel-promo, FD:tpromo, BeforeClose>
      * <TOTEM:END>
           CLOSE tpromo
           .

       CLOSE-rpromo.
      * <TOTEM:EPT. INIT:lab-sel-promo, FD:rpromo, BeforeClose>
      * <TOTEM:END>
           CLOSE rpromo
           .

       CLOSE-destini.
      * <TOTEM:EPT. INIT:lab-sel-promo, FD:destini, BeforeClose>
      * <TOTEM:END>
           CLOSE destini
           .

       CLOSE-clienti.
      * <TOTEM:EPT. INIT:lab-sel-promo, FD:clienti, BeforeClose>
      * <TOTEM:END>
           CLOSE clienti
           .

       CLOSE-articoli.
      * <TOTEM:EPT. INIT:lab-sel-promo, FD:articoli, BeforeClose>
      * <TOTEM:END>
           CLOSE articoli
           .

       CLOSE-tmp-destini.
      * <TOTEM:EPT. INIT:lab-sel-promo, FD:tmp-destini, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-locali.
      * <TOTEM:EPT. INIT:lab-sel-promo, FD:locali, BeforeClose>
      * <TOTEM:END>
           CLOSE locali
           .

       CLOSE-blister.
      * <TOTEM:EPT. INIT:lab-sel-promo, FD:blister, BeforeClose>
      * <TOTEM:END>
           CLOSE blister
           .
      ...
      * DISPLAY-COLUMNS settings
              MODIFY gd1, DISPLAY-COLUMNS (1, 4, 34, 45, 56, 67, 78, 
           108)
           .
      ...
      * <TOTEM:EPT. FORM:Form1, FORM:Form1, BeforeExit>
           if not scelto-promo move 0 to link-codice end-if.
           ...
           if save-cliente not = 0 or
              ...
              if tutto-ok
                 perform until 1 = 2
                    ...
                    if loc-gdo not = save-gdo     exit perform end-if
                    if loc-ini-dpo > como-data-to exit perform end-if
