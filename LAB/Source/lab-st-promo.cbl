      *{TOTEM}PRG-COMMENT
      * lab-st-promo.Cbl
      * lab-st-promo.Cbl is generated by TOTEM
      * This is a generated file. DO NOT modify this file directly.
      *{TOTEM}END
       IDENTIFICATION       DIVISION.
      *{TOTEM}PRGID
       PROGRAM-ID.          lab-st-promo.
       AUTHOR.              andre.
       DATE-WRITTEN.        giovedì 9 novembre 2023 11:23:53.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:lab-st-promo, INIT:lab-st-promo, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       78 titolo VALUE IS "Geslux LAB - Stampa Promozioni". 
       ...
       77 lab-gdo-buf      PIC  X(50)
                  VALUE IS "<<HELP>> SPACES = Tutti i supermercati".
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:lab-st-promo, INIT:lab-st-promo, BeforeDeclarative>
      * <TOTEM:END>
       INPUT-ERROR SECTION.
      ...
      * <TOTEM:EPT. INIT:lab-st-promo, INIT:lab-st-promo, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-tgrupgdo.
      * <TOTEM:EPT. INIT:lab-st-promo, FD:tgrupgdo, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tgrupgdo
           ...
           END-IF
      * <TOTEM:EPT. INIT:lab-st-promo, FD:tgrupgdo, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-tgrupgdo.
      * <TOTEM:EPT. INIT:lab-st-promo, FD:tgrupgdo, BeforeClose>
      * <TOTEM:END>
           CLOSE tgrupgdo
           .
           ...
           when 78-ID-ef-data-to                              
                ...
                if como-data-to <  como-data-from
                   ...
                   if como-data-to(1:4) not = como-data-from(1:4)
                      set errori to true
                      display message box "Le date devono fare riferimen
      -    "to allo stesso anno"
                              title = tit-err
                              icon 2
                      move 78-ID-ef-data-from to control-id
      ...
      *
           when 78-ID-ef-gdo
                ...
                if gdo-codice = spaces
                   move "Tutti i supermercati" to gdo-intestazione
                else
           ...
           if tutto-ok
              ...
              initialize st-promo-linkage
                         replacing numeric data by zeroes
                              alphanumeric data by spaces
              move como-data-from to link-data-from
              move como-data-to   to link-data-to
              move gdo-codice     to link-gdo
              move form1-handle   to link-handle
              call   "lab-st-promo-all-p" using st-promo-linkage
              cancel "lab-st-promo-all-p"
              move 78-ID-ef-data-from to control-id
              move 4                  to accept-control
