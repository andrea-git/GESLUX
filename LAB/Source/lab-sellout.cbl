      *{TOTEM}PRG-COMMENT
      * lab-sellout.Cbl
      * lab-sellout.Cbl is generated by TOTEM
      * This is a generated file. DO NOT modify this file directly.
      *{TOTEM}END
       IDENTIFICATION       DIVISION.
      *{TOTEM}PRGID
       PROGRAM-ID.          lab-sellout.
       AUTHOR.              ANDREA EVENTI.
       DATE-WRITTEN.        giovedì 21 settembre 2017 19:05:54.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:lab-sellout, INIT:lab-sellout, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       78 titolo VALUE IS "Geslux LAB - Sell Out Sicuro". 
       77 Small-Font
      ...
      *{TOTEM}COPY-PROCEDURE
       EXIT-STOP-ROUTINE.
      * <TOTEM:EPT. INIT:lab-sellout, INIT:lab-sellout, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      * <TOTEM:EPT. FORM:Form1, FORM:Form1, BeforeAccept>
           ...
           display ef-data.
      *****     move como-data(5:2) to mese-attuale.
      *****     move como-data(1:4) to anno-attuale.
      *****
      *****     evaluate mese-attuale
      *****     when 01 move "Gennaio"   to cbo-mese-buf
      *****     when 02 move "Febbraio"  to cbo-mese-buf
      *****     when 03 move "Marzo"     to cbo-mese-buf
      *****     when 04 move "Aprile"    to cbo-mese-buf
      *****     when 05 move "Maggio"    to cbo-mese-buf
      *****     when 06 move "Giugno"    to cbo-mese-buf
      *****     when 07 move "Luglio"    to cbo-mese-buf
      *****     when 08 move "Agosto"    to cbo-mese-buf
      *****     when 09 move "Settembre" to cbo-mese-buf
      *****     when 10 move "Ottobre"   to cbo-mese-buf
      *****     when 11 move "Novembre"  to cbo-mese-buf
      *****     when 12 move "Dicembre"  to cbo-mese-buf
      *****     end-evaluate.
      *****     modify cbo-mese, value cbo-mese-buf.
      ...
      * <TOTEM:PARA. pb-ok-LinkTo>
           ...
           if tutto-ok
              ...
              call   "lab-sellout-p" using como-data,
                                           form1-handle
              cancel "lab-sellout-p"
      ...
      *****     inquire cbo-mese, value in cbo-mese-buf.
      *****     evaluate cbo-mese-buf
      *****     when "Gennaio"    move 01 to como-mese
      *****     when "Febbraio"   move 02 to como-mese
      *****     when "Marzo"      move 03 to como-mese
      *****     when "Aprile"     move 04 to como-mese
      *****     when "Maggio"     move 05 to como-mese
      *****     when "Giugno"     move 06 to como-mese
      *****     when "Luglio"     move 07 to como-mese
      *****     when "Agosto"     move 08 to como-mese
      *****     when "Settembre"  move 09 to como-mese
      *****     when "Ottobre"    move 10 to como-mese
      *****     when "Novembre"   move 11 to como-mese
      *****     when "Dicembre"   move 12 to como-mese
      *****     end-evaluate.
      *****
      *****     move anno-attuale to como-anno.
      *****     if como-mese < mese-attuale
      *****        add 1 to como-anno
      *****     end-if.
      ...
      *****                                  form1-handle.
      *****     cancel "lab-sellout-p".
      *****     move 78-ID-cbo-mese to control-id.
      *****     move 4              to accept-control .
      *****     perform CANCELLA-COLORE.
      *****     modify pb-ok,       bitmap-number = 1.
      *****     modify pb-annulla,  bitmap-number = 1.
