      *{TOTEM}PRG-COMMENT
      * SHI-tart-exp.Cbl
      * SHI-tart-exp.Cbl is generated by TOTEM
      * This is a generated file. DO NOT modify this file directly.
      *{TOTEM}END
       IDENTIFICATION       DIVISION.
      *{TOTEM}PRGID
       PROGRAM-ID.          SHI-tart-exp.
       AUTHOR.              ANDREA EVENTI.
       DATE-WRITTEN.        martedì 1 aprile 2014 17:51:35.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:SHI-tart-exp, INIT:SHI-tart-exp, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       77 STATUS-art-exp-shi           PIC  X(2).
           88 Valid-STATUS-art-exp-shi VALUE IS "00" THRU "09". 
      ...
      * Data.Entry-Field
       ...
       77 TMP-Form1-art-exp-shi-RESTOREBUF  PIC X(615).
       ...
       77 TMP-DataSet1-art-exp-shi-BUF     PIC X(615).
      ...
      * FILE'S LOCK MODE FLAG
       77 DataSet1-art-exp-shi-LOCK-FLAG   PIC X VALUE SPACE.
           88 DataSet1-art-exp-shi-LOCK  VALUE "Y".
       77 DataSet1-KEYIS   PIC 9(3) VALUE 1.
       77 DataSet1-art-exp-shi-KEY1-ORDER  PIC X VALUE "A".
          88 DataSet1-art-exp-shi-KEY1-Asc  VALUE "A".
          88 DataSet1-art-exp-shi-KEY1-Desc VALUE "D".
       ...
       01 old-aes-rec.
           05 old-aes-chiave.
               10 old-aes-articolo     PIC  9(6).
               10 old-aes-imballo      PIC  x(3).
           05 old-aes-dati.
               10 old-aes-dati-comuni.
                   15 old-aes-data-creazione           PIC  9(8).
                   15 old-aes-ora-creazione            PIC  9(8).
                   15 old-aes-utente-creazione         PIC  X(10).
                   15 old-aes-data-ultima-modifica     PIC  9(8).
                   15 old-aes-ora-ultima-modifica      PIC  9(8).
                   15 old-aes-utente-ultima-modifica   PIC  X(10).
               10 old-aes-vuoti.
                   15 old-aes-num-vuoto-1  PIC  9(18).
                   15 old-aes-num-vuoto-2  PIC  9(18).
                   15 old-aes-num-vuoto-3  PIC  9(18).
                   15 old-aes-alfa-vuoto   PIC  x(500).
      *{TOTEM}END
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:SHI-tart-exp, INIT:SHI-tart-exp, BeforeDeclarative>
       FILE-ERROR SECTION.
      ...
      * <TOTEM:EPT. INIT:SHI-tart-exp, INIT:SHI-tart-exp, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-art-exp-shi.
      * <TOTEM:EPT. INIT:SHI-tart-exp, FD:art-exp-shi, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O art-exp-shi
           IF STATUS-art-exp-shi = "35"
              OPEN OUTPUT art-exp-shi
                IF Valid-STATUS-art-exp-shi
                   CLOSE art-exp-shi
                   OPEN I-O art-exp-shi
                END-IF
           END-IF
           IF NOT Valid-STATUS-art-exp-shi
              PERFORM  Form1-EXTENDED-FILE-STATUS
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:SHI-tart-exp, FD:art-exp-shi, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-articoli.
      * <TOTEM:EPT. INIT:SHI-tart-exp, FD:articoli, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT articoli
           IF NOT Valid-STATUS-articoli
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:SHI-tart-exp, FD:articoli, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-timbalqta.
      * <TOTEM:EPT. INIT:SHI-tart-exp, FD:timbalqta, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-timbalqta
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:SHI-tart-exp, FD:timbalqta, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-timballi.
      * <TOTEM:EPT. INIT:SHI-tart-exp, FD:timballi, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT timballi
           IF NOT Valid-STATUS-timballi
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:SHI-tart-exp, FD:timballi, AfterOpen>
      * <TOTEM:END>
           .

       CLOSE-FILE-RTN.
      *    Before Close
           PERFORM CLOSE-art-exp-shi
      ...
      *    After Close
       ...
       CLOSE-art-exp-shi.
      * <TOTEM:EPT. INIT:SHI-tart-exp, FD:art-exp-shi, BeforeClose>
      * <TOTEM:END>
           CLOSE art-exp-shi
           .

       CLOSE-articoli.
      * <TOTEM:EPT. INIT:SHI-tart-exp, FD:articoli, BeforeClose>
      * <TOTEM:END>
           CLOSE articoli
           .

       CLOSE-timbalqta.
      * <TOTEM:EPT. INIT:SHI-tart-exp, FD:timbalqta, BeforeClose>
      * <TOTEM:END>
           CLOSE timbalqta
           .

       CLOSE-timballi.
      * <TOTEM:EPT. INIT:SHI-tart-exp, FD:timballi, BeforeClose>
      * <TOTEM:END>
           CLOSE timballi
           .

       DataSet1-art-exp-shi-INITSTART.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              IF DataSet1-art-exp-shi-KEY1-Asc
                 MOVE Low-Value TO aes-chiave
              ELSE
                 MOVE High-Value TO aes-chiave
              END-IF
           END-EVALUATE
           .

       DataSet1-art-exp-shi-INITEND.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              IF DataSet1-art-exp-shi-KEY1-Asc
                 MOVE High-Value TO aes-chiave
       ...
       DataSet1-Change-CurrentKey-Asc.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              MOVE "A" TO DataSet1-art-exp-shi-KEY1-ORDER
           END-EVALUATE
           .
       ...
       DataSet1-Change-CurrentKey-Desc.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              MOVE "D" TO DataSet1-art-exp-shi-KEY1-ORDER
           END-EVALUATE
           .

      * art-exp-shi
       DataSet1-art-exp-shi-START.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              IF DataSet1-art-exp-shi-KEY1-Asc
                 START art-exp-shi KEY >= aes-chiave
              ELSE
                 START art-exp-shi KEY <= aes-chiave
              END-IF
           END-EVALUATE
       ...
       DataSet1-art-exp-shi-START-NOTGREATER.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              IF DataSet1-art-exp-shi-KEY1-Asc
                 START art-exp-shi KEY <= aes-chiave
       ...
       DataSet1-art-exp-shi-START-GREATER.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              IF DataSet1-art-exp-shi-KEY1-Asc
                 START art-exp-shi KEY > aes-chiave
       ...
       DataSet1-art-exp-shi-START-LESS.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              IF DataSet1-art-exp-shi-KEY1-Asc
                 START art-exp-shi KEY < aes-chiave
       ...
       DataSet1-art-exp-shi-Read.
      * <TOTEM:EPT. FD:DataSet1, FD:art-exp-shi, BeforeRead>
      * <TOTEM:END>
      * <TOTEM:EPT. FD:DataSet1, FD:art-exp-shi, BeforeReadRecord>
      * <TOTEM:END>
           EVALUATE DataSet1-KEYIS
           WHEN 1
              IF DataSet1-art-exp-shi-LOCK
                 READ art-exp-shi WITH LOCK 
                 KEY aes-chiave
              ELSE
                 READ art-exp-shi WITH NO LOCK 
                 KEY aes-chiave
              END-IF
           END-EVALUATE
           MOVE STATUS-art-exp-shi TO TOTEM-ERR-STAT 
           MOVE "art-exp-shi" TO TOTEM-ERR-FILE
           MOVE "READ" TO TOTEM-ERR-MODE
      * <TOTEM:EPT. FD:DataSet1, FD:art-exp-shi, AfterRead>
      * <TOTEM:END>
      * <TOTEM:EPT. FD:DataSet1, FD:art-exp-shi, AfterReadRecord>
      * <TOTEM:END>
           .

       DataSet1-art-exp-shi-Read-Next.
      * <TOTEM:EPT. FD:DataSet1, FD:art-exp-shi, BeforeRead>
      * <TOTEM:END>
      * <TOTEM:EPT. FD:DataSet1, FD:art-exp-shi, BeforeReadNext>
      * <TOTEM:END>
           EVALUATE DataSet1-KEYIS
           WHEN 1
              IF DataSet1-art-exp-shi-KEY1-Asc
                 IF DataSet1-art-exp-shi-LOCK
                    READ art-exp-shi NEXT WITH LOCK
                 ELSE
                    READ art-exp-shi NEXT WITH NO LOCK
                 END-IF
              ELSE
                 IF DataSet1-art-exp-shi-LOCK
                    READ art-exp-shi PREVIOUS WITH LOCK
                 ELSE
                    READ art-exp-shi PREVIOUS WITH NO LOCK
                 END-IF
              END-IF
           END-EVALUATE
           MOVE STATUS-art-exp-shi TO TOTEM-ERR-STAT
      ...
      * <TOTEM:EPT. FD:DataSet1, FD:art-exp-shi, AfterRead>
      * <TOTEM:END>
      * <TOTEM:EPT. FD:DataSet1, FD:art-exp-shi, AfterReadNext>
      * <TOTEM:END>
           .

       DataSet1-art-exp-shi-Read-Prev.
      * <TOTEM:EPT. FD:DataSet1, FD:art-exp-shi, BeforeRead>
      * <TOTEM:END>
      * <TOTEM:EPT. FD:DataSet1, FD:art-exp-shi, BeforeReadPrev>
      * <TOTEM:END>
           EVALUATE DataSet1-KEYIS
           WHEN 1
              IF DataSet1-art-exp-shi-KEY1-Asc
      ...
      * <TOTEM:EPT. FD:DataSet1, FD:art-exp-shi, AfterRead>
      * <TOTEM:END>
      * <TOTEM:EPT. FD:DataSet1, FD:art-exp-shi, AfterReadPrev>
      * <TOTEM:END>
           .

       DataSet1-art-exp-shi-Rec-Write.
      * <TOTEM:EPT. FD:DataSet1, FD:art-exp-shi, BeforeWrite>
      * <TOTEM:END>
           WRITE aes-rec OF art-exp-shi.
           MOVE STATUS-art-exp-shi TO TOTEM-ERR-STAT
           MOVE "art-exp-shi" TO TOTEM-ERR-FILE
           MOVE "WRITE" TO TOTEM-ERR-MODE
      * <TOTEM:EPT. FD:DataSet1, FD:art-exp-shi, AfterWrite>
      * <TOTEM:END>
           .

       DataSet1-art-exp-shi-Rec-Rewrite.
      * <TOTEM:EPT. FD:DataSet1, FD:art-exp-shi, BeforeRewrite>
      * <TOTEM:END>
           REWRITE aes-rec OF art-exp-shi.
           MOVE STATUS-art-exp-shi TO TOTEM-ERR-STAT
           MOVE "art-exp-shi" TO TOTEM-ERR-FILE
           MOVE "REWRITE" TO TOTEM-ERR-MODE
      * <TOTEM:EPT. FD:DataSet1, FD:art-exp-shi, AfterRewrite>
      * <TOTEM:END>
           .

       DataSet1-art-exp-shi-Rec-Delete.
      * <TOTEM:EPT. FD:DataSet1, FD:art-exp-shi, BeforeDelete>
      * <TOTEM:END>
           DELETE art-exp-shi.
           MOVE STATUS-art-exp-shi TO TOTEM-ERR-STAT
           MOVE "art-exp-shi" TO TOTEM-ERR-FILE
           MOVE "DELETE" TO TOTEM-ERR-MODE
      * <TOTEM:EPT. FD:DataSet1, FD:art-exp-shi, AfterDelete>
      * <TOTEM:END>
           .
      ...
      * <TOTEM:END>
       ...
       DataSet1-INIT-RECORD.
           INITIALIZE aes-rec OF art-exp-shi
      ...
      * GRID
       ...
       Form1-DataSet1-Update-Key.
           MOVE aes-rec OF art-exp-shi TO
                     Form1-MULKEY-TMPBUF
           PERFORM Form1-CLEAR
           PERFORM Form1-INIT-DATA
           MOVE Form1-MULKEY-TMPBUF TO
                     aes-rec OF art-exp-shi
           PERFORM DataSet1-art-exp-shi-Read
       ...
       Form1-First.
           ...
           PERFORM DataSet1-art-exp-shi-INITSTART
           PERFORM DataSet1-art-exp-shi-START
           IF NOT Valid-STATUS-art-exp-shi
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
           PERFORM DataSet1-art-exp-shi-Read-Next
           IF NOT Valid-STATUS-art-exp-shi
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Previous.
              PERFORM Form1-Buf-To-Fld
              PERFORM DataSet1-art-exp-shi-START-LESS
           IF NOT Valid-STATUS-art-exp-shi
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
           PERFORM DataSet1-art-exp-shi-Read-Prev
           IF NOT Valid-STATUS-art-exp-shi
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Next.
              PERFORM Form1-Buf-To-Fld
              PERFORM DataSet1-art-exp-shi-START-GREATER
           IF NOT Valid-STATUS-art-exp-shi
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Last.
           ...
           PERFORM DataSet1-art-exp-shi-INITEND
           PERFORM DataSet1-art-exp-shi-START-NOTGREATER
           IF NOT Valid-STATUS-art-exp-shi
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
      * write
           PERFORM DataSet1-art-exp-shi-Rec-Rewrite
           IF Valid-STATUS-art-exp-shi
      ...
      * delete
           PERFORM Form1-Buf-To-Fld
           PERFORM DataSet1-art-exp-shi-Rec-Delete
           IF Valid-STATUS-art-exp-shi
              PERFORM Form1-CLEAR
              PERFORM Form1-DUMMY-DELETE-INIT
              MOVE "303" TO TOTEM-MSG-ID
              MOVE "00" to STATUS-art-exp-shi
           END-IF
      ...
      * DB_Entry-Field : ef-art
           MOVE ef-art-BUF TO aes-articolo
      ...
      * <TOTEM:END>
      * DB_Entry-Field : ef-art
           MOVE aes-articolo TO ef-art-BUF
      ...
      * <TOTEM:END>
       ...
       Form1-Save-Status.
           MOVE DataSet1-art-exp-shi-KEY1-ORDER TO TMP-Form1-KEY1-ORDER
           MOVE DataSet1-KEYIS TO TMP-Form1-KEYIS
           MOVE aes-rec OF art-exp-shi TO 
              TMP-Form1-art-exp-shi-RESTOREBUF
           .             

       Form1-Restore-Status.
           MOVE TMP-Form1-KEY1-ORDER TO DataSet1-art-exp-shi-KEY1-ORDER
           MOVE TMP-Form1-KEYIS TO DataSet1-KEYIS
           MOVE TMP-Form1-art-exp-shi-RESTOREBUF TO
              aes-rec OF art-exp-shi
           PERFORM DataSet1-art-exp-shi-START
           IF Valid-STATUS-art-exp-shi
              PERFORM DataSet1-art-exp-shi-Read-Next
           ELSE
              PERFORM DataSet1-art-exp-shi-INITREC
           END-IF
           PERFORM UNTIL NOT Valid-STATUS-art-exp-shi OR
              (Valid-STATUS-art-exp-shi AND
                 aes-rec OF art-exp-shi = 
                   TMP-Form1-art-exp-shi-RESTOREBUF)
              PERFORM DataSet1-art-exp-shi-Read-Next
           END-PERFORM
      ...
      *
           if scelta = mb-yes      
              ...
              move aes-articolo    to memo-art
              perform X-Y
              perform VALORE-RIGA
              ||move col-id-num   to aes-articolo
              delete art-exp-shi record 
                 invalid 
                    continue 
              end-delete
              ...
              if totale-righe = 1 
                 ...
                 if riga = 2
                    unlock art-exp-shi all records   
                    perform VALORE-RIGA
                    perform RIEMPI-CHIAVE   
                    perform LOCK-RECORD
                 end-if
      ...
      * <TOTEM:PARA. CERCA>
           ...
           when 78-id-gd-cve
                if colonna = 1| and nuovo
                   perform VALORE-RIGA
                   move aes-imballo to imq-codice
                   ...
                   if stato-zoom = 0  
                      ...
                      if aes-imballo not = old-aes-imballo
      ...
      * Adriano - Gestione lock sul file inizio
                 close art-exp-shi
                 open i-o art-exp-shi allowing readers
      * Adriano fine
      ...
      * <TOTEM:PARA. VALORE-RIGA>
           ...
           move col-imballo    to aes-imballo
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. VALORE-OLD-RIGA>
           if vecchio
              inquire gd-cve(riga, 1) cell-data old-aes-imballo
              move old-aes-imballo  to aes-imballo
              read art-exp-shi no lock
              move aes-rec         to old-aes-rec
           else
              initialize old-aes-rec replacing numeric data by zeroes
                                     alphanumeric data by spaces
           end-if 
           .
      * <TOTEM:END>
      ...
      *    se non ho valorizzato i campi di creazione li valorizzo
           if aes-data-creazione = zero
              accept aes-data-creazione from century-date
           end-if.
           if aes-ora-creazione = zero
              accept aes-ora-creazione from time
           end-if.
           if aes-utente-creazione = space
              move user-codi to aes-utente-creazione
           end-if.

           accept aes-data-ultima-modifica from century-date.
           accept aes-ora-ultima-modifica from time.
           move user-codi to aes-utente-ultima-modifica 
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. PRIMO>
           ...
           if tutto-ok
              ...
              if errori
                 display message box "File [art-exp-shi]"
      ...
      * <TOTEM:PARA. PRECEDENTE>
           ...
           if tutto-ok     
              ...
              modify control-handle, color = colore-or 
              perform RIEMPI-CHIAVE
              move low-value to aes-imballo

              start art-exp-shi key is < aes-chiave
                 invalid 
                    set errori to true
                 not invalid 
                    read art-exp-shi previous no lock
                       at end 
                          set errori to true 
                    end-read
              end-start
      ...
      * <TOTEM:PARA. SUCCESSIVO>
           ...
           if tutto-ok            
              ...
              modify control-handle, color = colore-or 
              perform RIEMPI-CHIAVE
              move high-value to aes-imballo
      ...
      * <TOTEM:PARA. RIEMPI-CHIAVE>
           inquire ef-art, value in aes-articolo 
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. CLEAR-SCREEN>
           move aes-articolo to old-aes-articolo.

           initialize aes-rec replacing numeric data by zeroes
                              alphabetic data by spaces.
                        
           move old-aes-articolo to aes-articolo.
      ...
      * <TOTEM:PARA. CURRENT-RECORD>
           ...
           start art-exp-shi key not less aes-chiave
              invalid 
                 set errori to true 
           end-start.
           ...
           if tutto-ok
              ...
              perform until 1 = 2
                 ...
                 if aes-articolo    not = Memo-art
                    move Memo-art to aes-articolo
                    exit perform
                 end-if
      ...
      ***---
       METTI-IN-GRIGLIA.
           move aes-imballo  to col-imballo
                                imq-codice
      ...
      *        perform VALORE-OLD-RIGA
      *        if col-imballo not = old-aes-imballo
      *           move riga to store-riga
      *           set NoSalvato        to true
      ...
      * <TOTEM:PARA. PAS004P-Ev-Before-Program>
           ...
           move "GESLUX - Tabella Articoli inviati a SHI" to titolo
           .
      * <TOTEM:END>
