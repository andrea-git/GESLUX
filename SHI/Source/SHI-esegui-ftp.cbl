      ...
      ***---
       EXPORT.
           ...
           move shi-path-remota-exp   to como-path
           perform SCRIVI-CD

           move shi-path-exp   to como-path
           perform SCRIVI-LCD
           ...
           evaluate true
           when ftp-export-art
                move shi-file-articoli  to como-file
                perform SCRIVI-PUT
                move shi-file-ean  to como-file
                perform SCRIVI-PUT
                move shi-file-prodener  to como-file
                perform SCRIVI-PUT

           when ftp-export-ord
                move shi-file-tordini       to como-file
                perform SCRIVI-PUT
                move shi-file-rordini       to como-file
                perform SCRIVI-PUT
                move shi-file-note-ordini   to como-file
                perform SCRIVI-PUT
                move shi-file-articoli      to como-file
                perform SCRIVI-PUT
                move shi-file-ean           to como-file
                ...
                perform SCRIVI-PUT
           when ftp-export-ana
                move shi-file-vettori  to como-file
                perform SCRIVI-PUT
                move shi-file-fornitori  to como-file
                perform SCRIVI-PUT
                move shi-file-classi  to como-file
                perform SCRIVI-PUT
           end-evaluate.
      ...
      ***---
       IMPORTORD.
           ...
           move shi-path-remota-imp   to como-path.
           perform SCRIVI-CD.

           move shi-path-imp   to como-path.
           perform SCRIVI-LCD.

           perform SCRIVI-BINARY.

           move shi-file-tordini-imp  to como-file.
           perform SCRIVI-GET.

           move shi-file-rordini-imp  to como-file.
           perform SCRIVI-GET.
      ...
      ***---
       IMPORTART.
           ...
           move shi-file-articoli-imp  to como-file.
           perform SCRIVI-GET.
      ...
      ***---
       IMPORTCAR.
           ...
           move shi-path-remota-impcar   to como-path
           perform SCRIVI-CD

           move shi-path-impcar   to como-path
           perform SCRIVI-LCD

           perform SCRIVI-BINARY

           move shi-file-carichi-impcar  to como-file
           perform SCRIVI-GET
      ...
      *     move shi-path-exp   to como-path
           ...
           move shi-nome-semaforo  to como-file
           perform SCRIVI-PUT.
      ...
      ***---
       SCRIVI-USER-PWD-EXP.
           ...
           string "user "        delimited by size
                  shi-user-exp   delimited by size
                  into line-riga
           write line-riga
           move shi-pwd-exp      to line-riga
           write line-riga.
      ...
      ***---
       SCRIVI-USER-PWD-IMP.
           initialize line-riga
           string "user "        delimited by size
                  shi-user-imp   delimited by size
                  into line-riga
           write line-riga
           move shi-pwd-imp      to line-riga
           write line-riga.
      ...
      ***---
       SCRIVI-USER-PWD-IMPCAR.
           initialize line-riga
           string "user "          delimited by size
                  shi-user-impcar  delimited by size
                  into line-riga
           write line-riga
           move shi-pwd-impcar     to line-riga
           write line-riga.
      ...
      ***---
       FAI-FTP.
           ...
           when ftp-togli-sem-exp 
           when ftp-contr-sem-exp 
                move shi-sito-exp     to como-sito
           when ftp-metti-sem-imp 
           when ftp-togli-sem-imp 
           when ftp-contr-sem-imp 
           when ftp-import        
                move shi-sito-imp     to como-sito
           when ftp-metti-sem-impcar
           when ftp-togli-sem-impcar
           when ftp-contr-sem-impcar
           when ftp-importcar
                move shi-sito-impcar  to como-sito
           end-evaluate
      ...
      *    CSYS-HIDDEN          32
           ...
           call "C$SYSTEM" using wstampa, 114|80
                          giving Status-ftp.
      ...
      ***---
       CREA-SEM.
           ...
           string path-temp           delimited by low-value
                  shi-nome-semaforo   delimited by size
                  into wstampa.
      ...
      *     move file-crt  to wstampa
           ...
           perform until 1 = 2
              ...
              inspect line-riga tallying cont 
                                   for all shi-nome-semaforo(1:cont-sem)
              if cont not = zero
                 initialize cont
