      ...
      ***---
       OPEN-PARAMSHI.
           ...
           if shi-path-impcar   = space or
              shi-file-carichi-impcar = space
              set errori to true
              set errore-bloccante to true
      ...
      ***---
       PREPARA-PERCORSI.
           ...
           string shi-path-imp              delimited by low-value
                  ...
                  shi-file-carichi-impcar   delimited by size
                  into wstampa.
      ...
      *     end-if.
           ...
           move shi-mag-SHI-1   to reva-codmag
      ...
      ***---
       AGGIORNA-PROGMAG.
           if no-ordine
              move shi-causale-impcar to link-causale
           else           
              move tof-causale        to link-causale
           end-if
           set link-update            to true.
      ...
      *    nell'ordine passato da SHI, intanto cerco anche se nello
      ...
      ***---
       VAL-TEVA.
           ...
           move shi-mag-SHI-1 to teva-mag
      ...
      ***---
       INVIA-DATI.
           if shi-mail-impcar = space and
              shi-mail-cc-impcar = space
      ...
      -            "esenti indirizzi a cui spedirla"
           ...
           move "Bozze d'evasione SHI"  to LinkSubject
      ...
      ***---
       CREA-PDF.
           ...
           string "Bozze_evasione_SHI"   delimited size  
                  "_("                   delimited size
      ...
      ***---
       PREPARA-INDIRIZZO-cc.
           move shi-mail-cc-impcar to mail
