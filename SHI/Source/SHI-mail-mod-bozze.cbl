      ...
      ***---
       INIT.
           move  "GESLUX - Mail modifica bozze ordini clienti SHI" 
                                            to titolo.
      ...
      ***---
       PREPARA-SUBJECT-CANCELLA.
           move mmb-tor-numero           to num-edit
           move shi-oggetto-canc-bozze   to linkBody
      ...
      ***---
       PREPARA-SUBJECT-MODIFICA.
           move mmb-tor-numero           to num-edit
           move shi-oggetto-mod-bozze    to linkBody
      ...
      ***---
       PREPARA-CORPO-CANCELLA.
           move mmb-tor-numero  to num-edit
           move shi-corpo-canc-bozze  to linkBody
      ...
      ***---
       PREPARA-CORPO-MODIFICA.
           move mmb-tor-numero  to num-edit
           move shi-corpo-mod-bozze  to linkBody
      ...
      ***---
       PREPARA-INDIRIZZO.
           move shi-mail-mod-bozze to mail
