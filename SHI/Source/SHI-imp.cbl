      *{TOTEM}PRG-COMMENT
      * SHI-imp.Cbl
      * SHI-imp.Cbl is generated by TOTEM
      ...
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:SHI-imp, INIT:SHI-imp, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:SHI-imp, INIT:SHI-imp, BeforeDeclarative>
      ...
      * <TOTEM:EPT. INIT:SHI-imp, INIT:SHI-imp, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-paramSHI.
      * <TOTEM:EPT. INIT:SHI-imp, FD:paramSHI, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT paramSHI
           ...
           END-IF
      * <TOTEM:EPT. INIT:SHI-imp, FD:paramSHI, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-lineseq.
      * <TOTEM:EPT. INIT:SHI-imp, FD:lineseq, BeforeOpen>
      * <TOTEM:END>
           OPEN  OUTPUT lineseq
           IF NOT Valid-STATUS-lineseq
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:SHI-imp, FD:lineseq, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-paramSHI.
      * <TOTEM:EPT. INIT:SHI-imp, FD:paramSHI, BeforeClose>
      * <TOTEM:END>
           CLOSE paramSHI
           .

       CLOSE-lineseq.
      * <TOTEM:EPT. INIT:SHI-imp, FD:lineseq, BeforeClose>
      * <TOTEM:END>
           .
      ...
      * <TOTEM:PARA. IMP-CARICHI>
           if shi-file-carichi-impcar = space 
      ...
      -              "valorizzato"  to como-messaggio
              ...
              move user-codi to imp-user
              call   "SHI-impcarichi" using imp-linkage
              cancel "SHI-impcarichi" 
           end-if 
           .
      * <TOTEM:END>
