      *{TOTEM}PRG-COMMENT
      * sbloc.Cbl
      * sbloc.Cbl is generated by TOTEM
      ...
      *{TOTEM}PRGID
       ...
       DATE-WRITTEN.        venerdì 12 dicembre 2014 09:56:23.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:sbloc, INIT:sbloc, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Data.Label
       ...
       77 TMP-screen2-tordini-RESTOREBUF  PIC X(907).
       77 TMP-screen2-KEYIS  PIC 9(3) VALUE 1.
       77 screen2-MULKEY-TMPBUF   PIC X(907).
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:sbloc, INIT:sbloc, BeforeDeclarative>
      ***---
       TORDINI-ERR SECTION.
      ...
      * <TOTEM:EPT. INIT:sbloc, INIT:sbloc, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-tordini.
      * <TOTEM:EPT. INIT:sbloc, FD:tordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O tordini
           ...
           END-IF
      * <TOTEM:EPT. INIT:sbloc, FD:tordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-clienti.
      * <TOTEM:EPT. INIT:sbloc, FD:clienti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT clienti
           IF NOT Valid-STATUS-clienti
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:sbloc, FD:clienti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-destini.
      * <TOTEM:EPT. INIT:sbloc, FD:destini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT destini
           IF NOT Valid-STATUS-destini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:sbloc, FD:destini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tparamge.
      * <TOTEM:EPT. INIT:sbloc, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           IF NOT Valid-STATUS-tparamge
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:sbloc, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tcaumag.
      * <TOTEM:EPT. INIT:sbloc, FD:tcaumag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcaumag
           IF NOT Valid-STATUS-tcaumag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:sbloc, FD:tcaumag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-rordini.
      * <TOTEM:EPT. INIT:sbloc, FD:rordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O rordini
           ...
           IF NOT Valid-STATUS-rordini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:sbloc, FD:rordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-articoli.
      * <TOTEM:EPT. INIT:sbloc, FD:articoli, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT articoli
           IF NOT Valid-STATUS-articoli
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:sbloc, FD:articoli, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmarche.
      * <TOTEM:EPT. INIT:sbloc, FD:tmarche, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tmarche
           IF NOT Valid-STATUS-tmarche
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:sbloc, FD:tmarche, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-progmag.
      * <TOTEM:EPT. INIT:sbloc, FD:progmag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT progmag
           IF NOT Valid-STATUS-progmag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:sbloc, FD:progmag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-ttipocli.
      * <TOTEM:EPT. INIT:sbloc, FD:ttipocli, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT ttipocli
           IF NOT Valid-STATUS-ttipocli
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:sbloc, FD:ttipocli, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tpiombo.
      * <TOTEM:EPT. INIT:sbloc, FD:tpiombo, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tpiombo
           IF NOT Valid-STATUS-tpiombo
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:sbloc, FD:tpiombo, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-mtordini.
      * <TOTEM:EPT. INIT:sbloc, FD:mtordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT mtordini
           IF NOT Valid-STATUS-mtordini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:sbloc, FD:mtordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-param.
      * <TOTEM:EPT. INIT:sbloc, FD:param, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT param
           IF NOT Valid-STATUS-param
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:sbloc, FD:param, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-tordini.
      * <TOTEM:EPT. INIT:sbloc, FD:tordini, BeforeClose>
      * <TOTEM:END>
           CLOSE tordini
           .

       CLOSE-clienti.
      * <TOTEM:EPT. INIT:sbloc, FD:clienti, BeforeClose>
      * <TOTEM:END>
           CLOSE clienti
           .

       CLOSE-destini.
      * <TOTEM:EPT. INIT:sbloc, FD:destini, BeforeClose>
      * <TOTEM:END>
           CLOSE destini
           .

       CLOSE-tparamge.
      * <TOTEM:EPT. INIT:sbloc, FD:tparamge, BeforeClose>
      * <TOTEM:END>
           CLOSE tparamge
           .

       CLOSE-tcaumag.
      * <TOTEM:EPT. INIT:sbloc, FD:tcaumag, BeforeClose>
      * <TOTEM:END>
           CLOSE tcaumag
           .

       CLOSE-rordini.
      * <TOTEM:EPT. INIT:sbloc, FD:rordini, BeforeClose>
      * <TOTEM:END>
           CLOSE rordini
           .

       CLOSE-articoli.
      * <TOTEM:EPT. INIT:sbloc, FD:articoli, BeforeClose>
      * <TOTEM:END>
           CLOSE articoli
           .

       CLOSE-tmarche.
      * <TOTEM:EPT. INIT:sbloc, FD:tmarche, BeforeClose>
      * <TOTEM:END>
           CLOSE tmarche
           .

       CLOSE-progmag.
      * <TOTEM:EPT. INIT:sbloc, FD:progmag, BeforeClose>
      * <TOTEM:END>
           CLOSE progmag
           .

       CLOSE-ttipocli.
      * <TOTEM:EPT. INIT:sbloc, FD:ttipocli, BeforeClose>
      * <TOTEM:END>
           CLOSE ttipocli
           .

       CLOSE-tpiombo.
      * <TOTEM:EPT. INIT:sbloc, FD:tpiombo, BeforeClose>
      * <TOTEM:END>
           CLOSE tpiombo
           .

       CLOSE-mtordini.
      * <TOTEM:EPT. INIT:sbloc, FD:mtordini, BeforeClose>
      * <TOTEM:END>
           CLOSE mtordini
           .

       CLOSE-param.
      * <TOTEM:EPT. INIT:sbloc, FD:param, BeforeClose>
      * <TOTEM:END>
           CLOSE param
           .
      ...
      * DB_LABEL : lab-cliente
              MOVE tor-cod-cli  TO lab-cliente-BUF
      * DB_LABEL : lab-destino
              MOVE tor-prg-destino  TO lab-destino-BUF
      * DB_LABEL : lab-causale
              MOVE tor-causale  TO lab-causale-BUF
      * DB_LABEL : lab-annoa
              MOVE tor-numero  TO lab-annoa-BUF
...
BLISTR           end-string
              ...
              move ror-prz-unitario to hid-prezzo

              move ror-chiave to HiddenKey
...
OMAGGI*****                SavePrezzo * ( ror-qta - ror-qta-omaggi )
      ...
      * <TOTEM:PARA. CARICA-ORDINI>
           ...
           move data-from-AAAAMMGG to tor-data-ordine.
           move ordine-from        to tor-numero.
           move cliente-from       to tor-cod-cli.
           move low-value          to tor-prg-destino.

           start tordini key is >= k-promo
                 invalid continue
                      ...
                      read tordini
                       ...
                       not invalid
                           if tor-fattura-manuale
                              ...
                              if tor-attivo or tor-disattivo
                                 set errori to true
                                 move 78-ID-ef-ordine-from to CONTROL-ID
      ...
      * <TOTEM:PARA. METTI-IN-GRIGLIA>
           ...
           move tor-data-creazione(1:4)  to col-data(7:4)
           move tor-data-creazione(5:2)  to col-data(4:2)
           move tor-data-creazione(7:2)  to col-data(1:2)
           ...
           perform varying riga from 2 by 1 
              ...
              if ror-prz-unitario = 0
                 ...
                 move 0 to ror-imp-consumo   ror-imp-cou-cobat 
                           ror-imponib-merce ror-add-piombo
                 move iva-omaggio   to ror-cod-iva
              else
                 set ror-no-omaggio to true
              end-if
              if ror-prz-unitario > 99999
                 set errori to true
              else
      ...
      * <TOTEM:PARA. SCORRI-ORDINI>
           ...
           perform until 1 = 2
              ...
              if tor-disattivo or tor-attivo
                 exit perform
              end-if

              if tor-data-ordine > data-to-AAAAMMGG
                 exit perform
              end-if
      ...
      * <TOTEM:PARA. VALIDA-ORDINE>
           ...
           if tor-numero < ordine-from or 
              tor-numero > ordine-to
              set record-ok to false
           end-if.

           if tor-cod-cli not = cliente-from and cliente-from not = 0
              set record-ok to false
           end-if.
      ...
      * <TOTEM:PARA. Form1-Gd-1-Ev-Msg-Begin-Entry>
           ...
           inquire form1-gd-1(riga, 1), hidden-data in hidden-dati.
           inquire form1-gd-1(riga, 5), cell-data   in como-prezzo.
           if hid-si-bloccato or como-prezzo > 99999
