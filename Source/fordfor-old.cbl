      *{TOTEM}PRG-COMMENT
      * fordfor-old.Cbl
      * fordfor-old.Cbl is generated by TOTEM
      * This is a generated file. DO NOT modify this file directly.
      *{TOTEM}END
       IDENTIFICATION       DIVISION.
      *{TOTEM}PRGID
       PROGRAM-ID.          fordfor-old.
       AUTHOR.              ANDREA EVENTI.
       DATE-WRITTEN.        martedì 1 aprile 2014 19:14:37.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:fordfor-old, INIT:fordfor-old, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:fordfor-old, INIT:fordfor-old, BeforeDeclarative>
      ***---
      ...
      * <TOTEM:EPT. INIT:fordfor-old, INIT:fordfor-old, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-tparamge.
      * <TOTEM:EPT. INIT:fordfor-old, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           ...
           END-IF
      * <TOTEM:EPT. INIT:fordfor-old, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmagaz.
      * <TOTEM:EPT. INIT:fordfor-old, FD:tmagaz, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tmagaz
           IF NOT Valid-STATUS-tmagaz
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:fordfor-old, FD:tmagaz, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-tparamge.
      * <TOTEM:EPT. INIT:fordfor-old, FD:tparamge, BeforeClose>
      * <TOTEM:END>
           CLOSE tparamge
           .

       CLOSE-tmagaz.
      * <TOTEM:EPT. INIT:fordfor-old, FD:tmagaz, BeforeClose>
      * <TOTEM:END>
           CLOSE tmagaz
           .
      ...
      * <TOTEM:EPT. FORM:Screen1, FORM:Screen1, BeforeAccept>
           ...
           call   "fordfor-old-p" using user-codi,
                                        como-data-1, |INIZIO
                                        como-data-2, |FINE
                                        mag-codice,
                                        link-result,
                                        screen1-handle.
           cancel "fordfor-old-p".
