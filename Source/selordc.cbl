      *{TOTEM}PRG-COMMENT
      * selordc.Cbl
      * selordc.Cbl is generated by TOTEM
      ...
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:selordc, INIT:selordc, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:selordc, INIT:selordc, BeforeDeclarative>
      ***---
       TORDINI-ERR SECTION.
      ...
      * <TOTEM:EPT. INIT:selordc, INIT:selordc, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-tordini.
      * <TOTEM:EPT. INIT:selordc, FD:tordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tordini
           ...
           END-IF
      * <TOTEM:EPT. INIT:selordc, FD:tordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-clienti.
      * <TOTEM:EPT. INIT:selordc, FD:clienti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT clienti
           IF NOT Valid-STATUS-clienti
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selordc, FD:clienti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-destini.
      * <TOTEM:EPT. INIT:selordc, FD:destini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT destini
           IF NOT Valid-STATUS-destini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selordc, FD:destini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tparamge.
      * <TOTEM:EPT. INIT:selordc, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           IF NOT Valid-STATUS-tparamge
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selordc, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tescons.
      * <TOTEM:EPT. INIT:selordc, FD:tescons, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tescons
           IF NOT Valid-STATUS-tescons
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selordc, FD:tescons, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-tordini.
      * <TOTEM:EPT. INIT:selordc, FD:tordini, BeforeClose>
      * <TOTEM:END>
           CLOSE tordini
           .

       CLOSE-clienti.
      * <TOTEM:EPT. INIT:selordc, FD:clienti, BeforeClose>
      * <TOTEM:END>
           CLOSE clienti
           .

       CLOSE-destini.
      * <TOTEM:EPT. INIT:selordc, FD:destini, BeforeClose>
      * <TOTEM:END>
           CLOSE destini
           .

       CLOSE-tparamge.
      * <TOTEM:EPT. INIT:selordc, FD:tparamge, BeforeClose>
      * <TOTEM:END>
           CLOSE tparamge
           .
      ...
      * DISPLAY-COLUMNS settings
              MODIFY gd-ordini, DISPLAY-COLUMNS (1, 4, 12, 24, 37, 52, 
           61, 86, 111, 136)
           .
...
LUBEXX     when tutti
LUBEXX          move anno-to     to tor-anno
LUBEXX          move ordine-from to tor-numero
LUBEXX          move data-from-AAAAMMGG   to tor-data-creazione
...
LUBEXX          move anno-to     to tor-anno-bolla
LUBEXX          move ordine-from to tor-num-bolla
LUBEXX          move data-from-AAAAMMGG     to tor-data-bolla
LUBEXX          set  tor-bolla-si-prenotata to true
LUBEXX          start tordini key is >= k3
LUBEXX                invalid continue
LUBEXX            not invalid perform SCORRI-ORDINI
LUBEXX          end-start
LUBEXX     when fatturati 
LUBEXX          move anno-to     to tor-anno-fattura
LUBEXX          move ordine-from to tor-num-fattura
LUBEXX          move data-from-AAAAMMGG    to tor-data-fattura
...
LUBEXX*****              move tge-causale-corrisp to tor-causale
LUBEXX*****              start tordini key not < k-causale
LUBEXX*****                    invalid continue
LUBEXX*****                not invalid perform SCORRI-ORDINI
LUBEXX*****              end-start
LUBEXX*****           else
LUBEXX*****              set tor-ordine to true
...
LUBEXX*****           end-if 
      ...
      * <TOTEM:PARA. CHIAMA-MANUTENZIONE>
           ...
           move como-anno          to tor-anno.
           move como-numero-ordine to tor-numero.
      ...
      * <TOTEM:PARA. CONTROLLO>
      ...
      -    "rio!"
                      ...
                      read tordini
                       ...
                       not invalid
                           if tor-fattura-manuale
                              set errori to true
                              move 78-ID-ef-ordine-from to CONTROL-ID
                              display message "Fattura manuale!"
                                      title tit-err
                                      icon  MB-WARNING-ICON
                           end-if 
                      end-read
           ...
           when 78-ID-ef-data-to
                ...
                if data-to-AAAAMMGG = 99999999
                   move anno-to to data-to-AAAAMMGG(1:4)
                   move "12"    to data-to-AAAAMMGG(5:2)
                   move "31"    to data-to-AAAAMMGG(7:2)
                end-if
...
LUBEXX     when corrispettivi
LUBEXX     when inevasi
LUBEXX          move tor-data-creazione(1:4)  to col-data(7:4)
LUBEXX          move tor-data-creazione(5:2)  to col-data(4:2)
LUBEXX          move tor-data-creazione(7:2)  to col-data(1:2)
LUBEXX     when emessa-bolla
LUBEXX          move tor-data-bolla(1:4)   to col-data(7:4)
LUBEXX          move tor-data-bolla(5:2)   to col-data(4:2)
LUBEXX          move tor-data-bolla(7:2)   to col-data(1:2)
LUBEXX     when fatturati
LUBEXX          move tor-data-fattura(1:4) to col-data(7:4)
LUBEXX          move tor-data-fattura(5:2) to col-data(4:2)
LUBEXX          move tor-data-fattura(7:2) to col-data(1:2)
LUBEXX     end-evaluate.

           move "/"                   to col-data(3:1)
                                         col-data(6:1).

           move tor-cod-cli           to Col-cliente
                                         cli-codice.
           ...
           if tor-esito-consegna = space
              ...
              read tescons
                 invalid
                    move "Esito non codificato"   to tec-descrizione
              end-read
           end-if
           move tec-descrizione to col-esito
      ...
      * <TOTEM:PARA. RIEMPI-COMBO-STATO-CONS>
           move 78-TUTTI to cbo-stato-cons-buf
           Modify cbo-stato-cons   value cbo-stato-cons-buf.
...
LUBEXX*****         if tor-anno > anno-to    exit perform end-if

LUBEXX*****         if corrispettivi and tor-causale not = tge-causale-corrisp
LUBEXX*****            exit perform
LUBEXX*****         end-if
...
LUBEXX        when corrispettivi
LUBEXX        when tutti
LUBEXX             if tor-data-creazione > data-to-AAAAMMGG or
LUBEXX                tor-anno           > anno-to
LUBEXX                exit perform
LUBEXX             end-if
LUBEXX        when emessa-bolla
LUBEXX             if tor-anno-bolla not = anno-to          or
LUBEXX                tor-data-bolla >     data-to-AAAAMMGG
LUBEXX                exit perform
LUBEXX             end-if
LUBEXX        when fatturati
LUBEXX             if tor-anno-fattura not = anno-to or
LUBEXX                tor-data-fattura > data-to-AAAAMMGG
LUBEXX                exit perform
LUBEXX             end-if
LUBEXX        end-evaluate
...
LUBEXX     when corrispettivi
LUBEXX     when tutti
LUBEXX          if tor-numero < ordine-from or 
LUBEXX             tor-numero > ordine-to
LUBEXX             set record-ok to false
LUBEXX          end-if
LUBEXX     when emessa-bolla
LUBEXX          if tor-num-bolla < ordine-from or
LUBEXX             tor-num-bolla > ordine-to
LUBEXX             set record-ok to false
LUBEXX          end-if
LUBEXX     when fatturati
LUBEXX          if tor-num-fattura < ordine-from or
LUBEXX             tor-num-fattura > ordine-to
LUBEXX             set record-ok to false
LUBEXX          end-if
LUBEXX     end-evaluate.

LUBEXX*****     if tor-data-creazione < data-from-AAAAMMGG or 
LUBEXX*****        tor-data-creazione > data-to-AAAAMMGG
LUBEXX*****        set record-ok to false
LUBEXX*****     end-if.

LUBEXX*****     if tor-data-ordine < data-from-AAAAMMGG or tor-data-ordine > data-to-AAAAMMGG
LUBEXX*****        set record-ok to false
LUBEXX*****     end-if.

           if tor-cod-cli < cliente-from or 
              tor-cod-cli > cliente-to
           ...
           evaluate true
           when inevasi     
                if not r-inevaso or tor-fattura-manuale
                   set record-ok   to false
                end-if
           when emessa-bolla
                if not r-emessa-bolla or tor-fattura-manuale
                   set record-ok   to false
                end-if
           when fatturati   
                if not r-fatturato or tor-fattura-manuale
                   set record-ok   to false
                end-if
           when corrispettivi or tor-fattura-manuale
