      *{TOTEM}PRG-COMMENT
      * note-pie.Cbl
      * note-pie.Cbl is generated by TOTEM
      ...
      *{TOTEM}PRGID
       ...
       DATE-WRITTEN.        lunedì 2 dicembre 2013 21:27:53.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:note-pie, INIT:note-pie, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       77 E-SELEZIONA      PIC  9
                  VALUE IS 0.
       78 TITOLO VALUE IS "Geslux - Gestione Note a pié bolla Clienti". 
      ...
      * Data.Entry-Field
       ...
       77 TMP-Form1-note-RESTOREBUF  PIC X(284).
      ...
      * FILE'S LOCK MODE FLAG
       ...
       77 DataSet1-note-KEY1-ORDER  PIC X VALUE "A".
          88 DataSet1-note-KEY1-Asc  VALUE "A".
          88 DataSet1-note-KEY1-Desc VALUE "D".
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:note-pie, INIT:note-pie, BeforeDeclarative>
       NOTE-ERR SECTION.
      ...
      * <TOTEM:EPT. INIT:note-pie, INIT:note-pie, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-note.
      * <TOTEM:EPT. INIT:note-pie, FD:note, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O note
           IF STATUS-note = "35"
              OPEN OUTPUT note
           ...
           END-IF
      * <TOTEM:EPT. INIT:note-pie, FD:note, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-note.
      * <TOTEM:EPT. INIT:note-pie, FD:note, BeforeClose>
      * <TOTEM:END>
           CLOSE note
           .
       ...
       DataSet1-Change-CurrentKey-Asc.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              MOVE "A" TO DataSet1-note-KEY1-ORDER
           END-EVALUATE
           .
       ...
       DataSet1-Change-CurrentKey-Desc.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              MOVE "D" TO DataSet1-note-KEY1-ORDER
           END-EVALUATE
           .
      ...
      * <TOTEM:END>
       ...
       Form1-DataSet1-Update-Key.
           MOVE not-rec OF note TO
                     Form1-MULKEY-TMPBUF
           PERFORM Form1-CLEAR
           PERFORM Form1-INIT-DATA
           MOVE Form1-MULKEY-TMPBUF TO
                     not-rec OF note
           PERFORM DataSet1-note-Read
       ...
       Form1-First.
           ...
           PERFORM DataSet1-note-INITSTART
           PERFORM DataSet1-note-START
           IF NOT Valid-STATUS-note
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
           PERFORM DataSet1-note-Read-Next
           IF NOT Valid-STATUS-note
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Previous.
              PERFORM Form1-Buf-To-Fld
              PERFORM DataSet1-note-START-LESS
           IF NOT Valid-STATUS-note
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
           PERFORM DataSet1-note-Read-Prev
           IF NOT Valid-STATUS-note
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Next.
              PERFORM Form1-Buf-To-Fld
              PERFORM DataSet1-note-START-GREATER
           IF NOT Valid-STATUS-note
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Last.
           ...
           PERFORM DataSet1-note-INITEND
           PERFORM DataSet1-note-START-NOTGREATER
           IF NOT Valid-STATUS-note
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
      * write
           PERFORM DataSet1-note-Rec-Rewrite
           IF Valid-STATUS-note
      ...
      * <TOTEM:END>
       ...
       Form1-Save-Status.
           MOVE DataSet1-note-KEY1-ORDER TO TMP-Form1-KEY1-ORDER
           MOVE DataSet1-KEYIS TO TMP-Form1-KEYIS
           MOVE not-rec OF note TO 
              TMP-Form1-note-RESTOREBUF
           .             

       Form1-Restore-Status.
           MOVE TMP-Form1-KEY1-ORDER TO DataSet1-note-KEY1-ORDER
           MOVE TMP-Form1-KEYIS TO DataSet1-KEYIS
           MOVE TMP-Form1-note-RESTOREBUF TO
              not-rec OF note
           PERFORM DataSet1-note-START
           IF Valid-STATUS-note
              PERFORM DataSet1-note-Read-Next
           ELSE
              PERFORM DataSet1-note-INITREC
           END-IF
           PERFORM UNTIL NOT Valid-STATUS-note OR
              (Valid-STATUS-note AND
                 not-rec OF note = 
                   TMP-Form1-note-RESTOREBUF)
              PERFORM DataSet1-note-Read-Next
           END-PERFORM
