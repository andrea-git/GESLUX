      *{TOTEM}PRG-COMMENT
      * tudm.Cbl
      * tudm.Cbl is generated by TOTEM
      ...
      *{TOTEM}PRGID
       ...
       DATE-WRITTEN.        martedì 1 aprile 2014 19:20:28.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:tudm, INIT:tudm, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       77 Form1-Tb-1-Handle
                  USAGE IS HANDLE OF WINDOW.
       78 titolo VALUE IS "Geslux - Tabella Unità di Misura". 
       77 E-ESCI           PIC  9
                  VALUE IS 1.
       77 E-NUOVO          PIC  9
                  VALUE IS 1.
       ...
       01 old-udm-rec.
           05 old-udm-chiave.
               10 old-udm-codice   PIC  X(2).
           05 old-udm-dati.
               10 old-udm-descrizione          PIC  X(30).
               10 old-udm-dati-comuni.
                   15 old-udm-data-creazione       PIC  9(8).
                   15 old-udm-ora-creazione        PIC  9(8).
                   15 old-udm-utente-creazione     PIC  X(10).
                   15 old-udm-data-ultima-modifica PIC  9(8).
               10 old-udm-vuoti.
                   15 old-udm-num-vuoto-1          PIC  9(15).
               10 old-udm-num-vuoto-2          PIC  9(15).
               10 old-udm-num-vuoto-3          PIC  9(15).
               10 old-udm-alfa-vuoto-1         PIC  X(20).
               10 old-udm-alfa-vuoto-2         PIC  X(20).
               10 old-udm-alfa-vuoto-3         PIC  X(20).
      ...
      ***********************************************************
       ...
       77 TMP-Form1-tudm-RESTOREBUF  PIC X(189).
       77 TMP-Form1-KEYIS  PIC 9(3) VALUE 1.
       77 Form1-MULKEY-TMPBUF   PIC X(189).
      ...
      * FILE'S LOCK MODE FLAG
       ...
       77 DataSet1-tudm-KEY1-ORDER  PIC X VALUE "A".
          88 DataSet1-tudm-KEY1-Asc  VALUE "A".
          88 DataSet1-tudm-KEY1-Desc VALUE "D".
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:tudm, INIT:tudm, BeforeDeclarative>
       TUDM-ERR SECTION.
      ...
      * <TOTEM:EPT. INIT:tudm, INIT:tudm, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-tudm.
      * <TOTEM:EPT. INIT:tudm, FD:tudm, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O tudm
           IF STATUS-tudm = "35"
              OPEN OUTPUT tudm
                IF Valid-STATUS-tudm
                   CLOSE tudm
                   OPEN I-O tudm
                END-IF
           END-IF
           ...
           END-IF
      * <TOTEM:EPT. INIT:tudm, FD:tudm, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-tudm.
      * <TOTEM:EPT. INIT:tudm, FD:tudm, BeforeClose>
      * <TOTEM:END>
           CLOSE tudm
           .
       ...
       DataSet1-Change-CurrentKey-Asc.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              MOVE "A" TO DataSet1-tudm-KEY1-ORDER
           END-EVALUATE
           .
       ...
       DataSet1-Change-CurrentKey-Desc.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              MOVE "D" TO DataSet1-tudm-KEY1-ORDER
           END-EVALUATE
           .
      ...
      * GRID
       ...
       Form1-DataSet1-Update-Key.
           MOVE udm-rec OF tudm TO
                     Form1-MULKEY-TMPBUF
           PERFORM Form1-CLEAR
           PERFORM Form1-INIT-DATA
           MOVE Form1-MULKEY-TMPBUF TO
                     udm-rec OF tudm
           PERFORM DataSet1-tudm-Read
       ...
       Form1-First.
           ...
           PERFORM DataSet1-tudm-INITSTART
           PERFORM DataSet1-tudm-START
           IF NOT Valid-STATUS-tudm
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
           PERFORM DataSet1-tudm-Read-Next
           IF NOT Valid-STATUS-tudm
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Previous.
              PERFORM Form1-Buf-To-Fld
              PERFORM DataSet1-tudm-START-LESS
           IF NOT Valid-STATUS-tudm
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
           PERFORM DataSet1-tudm-Read-Prev
           IF NOT Valid-STATUS-tudm
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Next.
              PERFORM Form1-Buf-To-Fld
              PERFORM DataSet1-tudm-START-GREATER
           IF NOT Valid-STATUS-tudm
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Last.
           ...
           PERFORM DataSet1-tudm-INITEND
           PERFORM DataSet1-tudm-START-NOTGREATER
           IF NOT Valid-STATUS-tudm
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
      * write
           PERFORM DataSet1-tudm-Rec-Rewrite
           IF Valid-STATUS-tudm
      ...
      * <TOTEM:END>
       ...
       Form1-Save-Status.
           MOVE DataSet1-tudm-KEY1-ORDER TO TMP-Form1-KEY1-ORDER
           MOVE DataSet1-KEYIS TO TMP-Form1-KEYIS
           MOVE udm-rec OF tudm TO 
              TMP-Form1-tudm-RESTOREBUF
           .             

       Form1-Restore-Status.
           MOVE TMP-Form1-KEY1-ORDER TO DataSet1-tudm-KEY1-ORDER
           MOVE TMP-Form1-KEYIS TO DataSet1-KEYIS
           MOVE TMP-Form1-tudm-RESTOREBUF TO
              udm-rec OF tudm
           PERFORM DataSet1-tudm-START
           IF Valid-STATUS-tudm
              PERFORM DataSet1-tudm-Read-Next
           ELSE
              PERFORM DataSet1-tudm-INITREC
           END-IF
           PERFORM UNTIL NOT Valid-STATUS-tudm OR
              (Valid-STATUS-tudm AND
                 udm-rec OF tudm = 
                   TMP-Form1-tudm-RESTOREBUF)
              PERFORM DataSet1-tudm-Read-Next
           END-PERFORM
      ...
      * <TOTEM:PARA. LOAD-RECORD>
           ...
           move low-value to udm-codice.
           start tudm key is >= udm-chiave
                  invalid continue
              not invalid
                  perform varying riga from 2 by 1
                     ...
                     read tudm next
                          at end exit perform
                      not at end
                          move udm-codice          to col-id
                          move udm-descrizione     to col-des
      ...
      *--->MODIFICA (ISACCO)
           if nuovo 
              ...
              if mod = 1
                 close    tudm
                 open i-o tudm allowing readers
              else
                 set tutto-ok to true
                 if NoSalvato
                    move 1 to mod
      ...
      * <TOTEM:PARA. NUOVO>
           ...
           if tutto-ok
              ...
              initialize old-udm-rec replacing numeric data by zeroes
                                          alphanumeric data by spaces
      ...
      * <TOTEM:PARA. VALORE-RIGA>
           inquire form1-gd-1(riga, 1), cell-data udm-codice.
           inquire form1-gd-1(riga, 2), cell-data udm-descrizione 
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. VALORE-OLD-RIGA>
           if vecchio
              inquire form1-gd-1(riga, 1) cell-data old-udm-codice
              move old-udm-codice         to udm-codice
              read tudm                   no lock
              move udm-rec                to old-udm-rec
           else
              initialize old-udm-rec replacing numeric data by zeroes
                                          alphanumeric data by spaces
           end-if 
      ...
      * SE NON HO VALORIZZATO I CAMPI DI CREAZIONE LI VALORIZZO
           if udm-data-creazione   = zero
              accept udm-data-creazione from century-date
           end-if.
           if udm-ora-creazione    = zero
              accept udm-ora-creazione  from time
           end-if.
           if udm-utente-creazione = space
              move user-codi to udm-utente-creazione
           end-if.

           accept udm-data-ultima-modifica from century-date.
           accept udm-ora-ultima-modifica  from time.
           move user-codi    to udm-utente-ultima-modifica 
           .
      * <TOTEM:END>
