      ...
      *****************************************************************
       ...
       01  st-intesta4.
           ...
           05 filler        pic x(13) value "Foglio n. ".
           05 st-pag        pic z(04).

       01  st-line-riga     pic x(86) value all "-".

       77  i                pic 9(5) value 0.      
       78  max-righe        value 44.                    
       78  78-ini           value 5.
      ...
      ***---
       ELABORAZIONE.      
           ...
           read anautf  no lock
            ...
            not invalid perform STAMPA-DATI
           end-read
      ...
      ***---
       PRIMA-PAG.
           ...
           move "REGISTRO" to line-riga(60 - 78-ini:)
           write line-riga

           write line-riga from spaces

           initialize line-riga
           move utf-desc1 to line-riga(45 - 78-ini:)
           write line-riga

           write line-riga from spaces

           initialize line-riga
           move utf-desc2 to line-riga(45 - 78-ini:)
           write line-riga

           write line-riga from spaces

           initialize line-riga
           move utf-modello to line-riga(60 - 78-ini:)
           write line-riga
      ...
      -    "nti"
           ...
           initialize line-riga
           move "Il presente registro nr. ________" 
             to line-riga(40 - 78-ini:)
           write line-riga
           ...
           initialize line-riga
           move "si compone di nr. _________ fogli" 
             to line-riga(40 - 78-ini:)
           write line-riga
           ...
           initialize line-riga
           move "numerati da _________ a _________" 
             to line-riga(40 - 78-ini:)
           write line-riga
           ...
           initialize line-riga
           move "Esercizio finanziario ___________" 
             to line-riga(40 - 78-ini:)
           write line-riga
           ...
           initialize line-riga
           move "Milano, li ______________________" 
             to line-riga(40 - 78-ini:)
           write line-riga.

           move 41 to num-righe.
