      ...
      ***---
       SETTA-COLONNE-FATTURA.
           ...
           when 3,1
                ...
                move 4,0             to    winprint-col-start
                call "WIN$PRINTER"   using winprint-set-page-column, 
                                           winprint-column
                                    giving return-code
                                   
                move 6,6             to    winprint-col-start
                call "WIN$PRINTER"   using winprint-set-page-column, 
                                           winprint-column
                                    giving return-code
      ...
      ***---
       SETTA-COLONNE-BOLLE.
           ...
           when 5
                ...
                move 6,55              to winprint-col-start
                call "WIN$PRINTER"  using winprint-set-page-column, 
                                          winprint-column             
                                   giving return-code
                ...
                move 13,00               to winprint-col-start
                call "WIN$PRINTER"  using winprint-set-page-column, 
                                          winprint-column             
                                   giving return-code
                ...
                call "WIN$PRINTER"  using winprint-set-page-column, 
                                          winprint-column             
                                   giving return-code
                move 14,35               to winprint-col-start
                call "WIN$PRINTER"  using winprint-set-page-column, 
                                          winprint-column             
                                   giving return-code
                ...
                move 17,95              to winprint-col-start
                call "WIN$PRINTER"  using winprint-set-page-column, 
                                          winprint-column
                                   giving return-code
