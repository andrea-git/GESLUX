      ...
      ***---
       DESTINIF-ERR SECTION.
           ...
           when "35"
                display message "Impossibile procedere."
                  x"0d0a""File destini [DESTINIF] inesistente"
                          title titolo
                           icon 2
                set errori to true
           when "39"
      ...
      ***---
       OPEN-FILES.
           open output lineseq.
           if tutto-ok
              open input destinif clienti
           end-if.

      ***---
       ELABORAZIONE.
           move stampa-codice-da  to desf-codice.
           move stampa-destino-da to desf-prog.
           ...
           if tutto-ok
              ...
              perform until 1 = 2
                 ...
                 if desf-codice > stampa-codice-a  exit perform end-if  
                 if desf-prog   >= stampa-destino-da and
                    desf-prog   <= stampa-destino-a
      ...
      ***---
       VALUTA-RECORD.
           if desf-codice not = cli-codice
              move desf-codice to cli-codice
      ...
      ***---
       GENERA-FILE-EXCEL.
           ...
           if desf-codice not = save-codice
              move desf-codice to save-codice
              move desf-codice to r-codice
              initialize line-riga
           ...
           string " "           delimited size
                  ...
                  desf-localita  delimited size
                  separatore    delimited size
                  "C.A.P.: "    delimited size
                  desf-cap       delimited size
                  into line-riga
           end-string.
           write line-riga.
           initialize line-riga.
           string " "           delimited size
                  ...
                  desf-telef-1   delimited size
                  separatore    delimited size
                  "Tel. 2: "    delimited size
                  desf-telef-2   delimited size
                  into line-riga
           end-string.
           write line-riga.
           initialize line-riga.
           string " "           delimited size
                  ...
                  separatore    delimited size
                  "Fax: "       delimited size
                  desf-fax       delimited size
                  separatore    delimited size
                  "E-mail: "    delimited size
                  desf-mail      delimited size
                  into line-riga
           end-string.
           write line-riga.
           write line-riga from spaces.
      ...
      ***---
       GENERA-FILE-TXT.
           ...
           move desf-prog        to r-prog.
           move desf-ragsoc-1    to r-ragsoc-1.
           move desf-ragsoc-2    to r-ragsoc-2. 
           write line-riga    from riga-2.
           add 1 to WrittenRows.

           move desf-indirizzo   to r-indirizzo.
           ...
           move desf-telef-1     to r-tel-1.
           move desf-telef-2     to r-tel-2.
           write line-riga    from riga-5. 
           add 1 to WrittenRows.

           move desf-mail        to r-email.
           move desf-fax         to r-fax.
      ...
      ***---
       CLOSE-FILES.
           close destinif lineseq clienti.
