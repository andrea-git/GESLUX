      *{TOTEM}PRG-COMMENT
      * bprenf-nc.Cbl
      * bprenf-nc.Cbl is generated by TOTEM
      * This is a generated file. DO NOT modify this file directly.
      *{TOTEM}END
       IDENTIFICATION       DIVISION.
      *{TOTEM}PRGID
       PROGRAM-ID.          bprenf-nc.
       AUTHOR.              ANDREA EVENTI.
       DATE-WRITTEN.        martedì 1 aprile 2014 19:13:39.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:bprenf-nc, INIT:bprenf-nc, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:bprenf-nc, INIT:bprenf-nc, BeforeDeclarative>
       TNOTACR-ERR SECTION.
      ...
      * <TOTEM:EPT. INIT:bprenf-nc, INIT:bprenf-nc, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-destini.
      * <TOTEM:EPT. INIT:bprenf-nc, FD:destini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT destini
           ...
           END-IF
      * <TOTEM:EPT. INIT:bprenf-nc, FD:destini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-clienti.
      * <TOTEM:EPT. INIT:bprenf-nc, FD:clienti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT clienti
           IF NOT Valid-STATUS-clienti
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bprenf-nc, FD:clienti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tnotacr.
      * <TOTEM:EPT. INIT:bprenf-nc, FD:tnotacr, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O tnotacr
           ...
           IF NOT Valid-STATUS-tnotacr
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bprenf-nc, FD:tnotacr, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-rnotacr.
      * <TOTEM:EPT. INIT:bprenf-nc, FD:rnotacr, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT rnotacr
           IF NOT Valid-STATUS-rnotacr
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bprenf-nc, FD:rnotacr, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tivaese.
      * <TOTEM:EPT. INIT:bprenf-nc, FD:tivaese, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tivaese
           IF NOT Valid-STATUS-tivaese
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bprenf-nc, FD:tivaese, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tcaumag.
      * <TOTEM:EPT. INIT:bprenf-nc, FD:tcaumag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcaumag
           IF NOT Valid-STATUS-tcaumag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bprenf-nc, FD:tcaumag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-zoom-tordini.
      * <TOTEM:EPT. INIT:bprenf-nc, FD:zoom-tordini, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-zoom-tordini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bprenf-nc, FD:zoom-tordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-articoli.
      * <TOTEM:EPT. INIT:bprenf-nc, FD:articoli, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT articoli
           IF NOT Valid-STATUS-articoli
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bprenf-nc, FD:articoli, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-destini.
      * <TOTEM:EPT. INIT:bprenf-nc, FD:destini, BeforeClose>
      * <TOTEM:END>
           CLOSE destini
           .

       CLOSE-clienti.
      * <TOTEM:EPT. INIT:bprenf-nc, FD:clienti, BeforeClose>
      * <TOTEM:END>
           CLOSE clienti
           .

       CLOSE-tnotacr.
      * <TOTEM:EPT. INIT:bprenf-nc, FD:tnotacr, BeforeClose>
      * <TOTEM:END>
           CLOSE tnotacr
           .

       CLOSE-rnotacr.
      * <TOTEM:EPT. INIT:bprenf-nc, FD:rnotacr, BeforeClose>
      * <TOTEM:END>
           CLOSE rnotacr
           .

       CLOSE-tivaese.
      * <TOTEM:EPT. INIT:bprenf-nc, FD:tivaese, BeforeClose>
      * <TOTEM:END>
           CLOSE tivaese
           .

       CLOSE-tcaumag.
      * <TOTEM:EPT. INIT:bprenf-nc, FD:tcaumag, BeforeClose>
      * <TOTEM:END>
           CLOSE tcaumag
           .

       CLOSE-zoom-tordini.
      * <TOTEM:EPT. INIT:bprenf-nc, FD:zoom-tordini, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-articoli.
      * <TOTEM:EPT. INIT:bprenf-nc, FD:articoli, BeforeClose>
      * <TOTEM:END>
           CLOSE articoli
           .
...
LUBEXX           if rno-prz-unitario > 99999
...
LUBEXX        end-if
      ...
      * <TOTEM:PARA. RIEMPI-TMP>
           ...
           string path-zoom-tordini       delimited by low-value
                  "zoom-tnotacr"          delimited by size
                  "_"                     delimited by size
      ...
      * <TOTEM:PARA. PB-ESEGUIa-LinkTo>
           display message "S'intende procedere alla prenotazione fattur
      -                    "a del documento selezionato?"
                   title = titolo
                   type mb-yes-no
                   default mb-no
                   giving scelta
...
LUBEXX        else
                 evaluate true
                 when errore-prezzo
LUBEXX                modify screen2-gd-1(store-riga),  row-color = 176
LUBEXX                display message "Prenotazione impossibile!!!"
LUBEXX                         x"0d0a""Prezzo incoerente a riga " 
           store-riga
LUBEXX                          title tit-err
LUBEXX                           icon 2
LUBEXX                modify screen2-gd-1(store-riga), row-color = 516
                 end-evaluate
LUBEXX        end-if
           end-if 
           .
...
030205* così come da richiesta avanzata da Sig.Trivella
           ...
           read tnotacr no lock
                invalid 
                set errori to true
                display message box "Documento non caricato"
                        title = tit-err
                        icon MB-WARNING-ICON
            not invalid
                if tno-fatt-si-prenotata
                   set errori to true
                   display message box "Nota Credito già precedentemente
      -    " prenotata"
                           title = tit-err   
                           icon MB-WARNING-ICON
                end-if
