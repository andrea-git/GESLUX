      *{TOTEM}PRG-COMMENT
      * vmovmag.Cbl
      * vmovmag.Cbl is generated by TOTEM
      ...
      *{TOTEM}PRGID
       PROGRAM-ID.          vmovmag.
       AUTHOR.              andre.
       DATE-WRITTEN.        venerdì 6 novembre 2020 13:17:51.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:vmovmag, INIT:vmovmag, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       77 tot-kg           PIC  s9(9)v999.
       77 tot-imp          PIC  s9(9)v99.
       77 tot-colimp       PIC  s9(9)v99.
       77 tot-cons         PIC  s9(9)v99.
       77 tot-coubat       PIC  s9(9)v99.
       ...
       01 r-riga.
           ...
           05 r-data-ordine    PIC  99/99/9999.
           05 r-numdoc         PIC  z(8).
           05 r-datadoc        PIC  99/99/9999.
           05 r-cod-pag        PIC  xxx.
           05 r-des-pag        PIC  x(50).
           05 r-marca          PIC  z(4).
           05 r-mag            PIC  x(3).
           ...
           05 r-cli-tipo       PIC  x(2).
           05 r-tcl-descrizione            PIC  x(50).
      ...
      * Data.Label
       ...
       77 TMP-form4-tmovmag-RESTOREBUF  PIC X(256).
       77 TMP-form4-KEYIS  PIC 9(3) VALUE 1.
       77 form4-MULKEY-TMPBUF   PIC X(256).
      ...
      * GRID
       05
           ...
           BOXED,
           CENTERED-HEADINGS,
           DATA-COLUMNS (1, 2, 6, 56, 64, 74, 85, 100, 109),
           ALIGNMENT ("C", "L", "L", "R", "C", "R", "R", "R", "R"),
           SEPARATION (5, 5, 5, 5, 5, 5, 5, 5, 5),
           DATA-TYPES ("X", "X", "X", "X", "X", "9(11)", "9(15)", "9(9)"
           , "9(9)"),
           NUM-COL-HEADINGS 1,
           COLUMN-HEADINGS,
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:vmovmag, INIT:vmovmag, BeforeDeclarative>
       LINESEQ-ERR SECTION.
      ...
      * <TOTEM:EPT. INIT:vmovmag, INIT:vmovmag, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-tmovmag.
      * <TOTEM:EPT. INIT:vmovmag, FD:tmovmag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tmovmag
           ...
           END-IF
      * <TOTEM:EPT. INIT:vmovmag, FD:tmovmag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-rmovmag.
      * <TOTEM:EPT. INIT:vmovmag, FD:rmovmag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT rmovmag
           IF NOT Valid-STATUS-rmovmag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vmovmag, FD:rmovmag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-articoli.
      * <TOTEM:EPT. INIT:vmovmag, FD:articoli, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT articoli
           IF NOT Valid-STATUS-articoli
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vmovmag, FD:articoli, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmarche.
      * <TOTEM:EPT. INIT:vmovmag, FD:tmarche, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tmarche
           IF NOT Valid-STATUS-tmarche
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vmovmag, FD:tmarche, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-clienti.
      * <TOTEM:EPT. INIT:vmovmag, FD:clienti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT clienti
           IF NOT Valid-STATUS-clienti
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vmovmag, FD:clienti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-destini.
      * <TOTEM:EPT. INIT:vmovmag, FD:destini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT destini
           IF NOT Valid-STATUS-destini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vmovmag, FD:destini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmp-movmag.
      * <TOTEM:EPT. INIT:vmovmag, FD:tmp-movmag, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-tmp-movmag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vmovmag, FD:tmp-movmag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tcodpag.
      * <TOTEM:EPT. INIT:vmovmag, FD:tcodpag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcodpag
           IF NOT Valid-STATUS-tcodpag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vmovmag, FD:tcodpag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmagaz.
      * <TOTEM:EPT. INIT:vmovmag, FD:tmagaz, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tmagaz
           IF NOT Valid-STATUS-tmagaz
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vmovmag, FD:tmagaz, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tparamge.
      * <TOTEM:EPT. INIT:vmovmag, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           IF NOT Valid-STATUS-tparamge
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vmovmag, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tcaumag.
      * <TOTEM:EPT. INIT:vmovmag, FD:tcaumag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcaumag
           IF NOT Valid-STATUS-tcaumag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vmovmag, FD:tcaumag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-destinif.
      * <TOTEM:EPT. INIT:vmovmag, FD:destinif, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT destinif
           IF NOT Valid-STATUS-destinif
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vmovmag, FD:destinif, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-lineseq.
      * <TOTEM:EPT. INIT:vmovmag, FD:lineseq, BeforeOpen>
      * <TOTEM:END>
           OPEN  OUTPUT lineseq
           IF NOT Valid-STATUS-lineseq
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vmovmag, FD:lineseq, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-ttipocli.
      * <TOTEM:EPT. INIT:vmovmag, FD:ttipocli, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT ttipocli
           IF NOT Valid-STATUS-ttipocli
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vmovmag, FD:ttipocli, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-progmag.
      * <TOTEM:EPT. INIT:vmovmag, FD:progmag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT progmag
           IF NOT Valid-STATUS-progmag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vmovmag, FD:progmag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-progmagric.
      * <TOTEM:EPT. INIT:vmovmag, FD:progmagric, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-progmagric
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vmovmag, FD:progmagric, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-timposte.
      * <TOTEM:EPT. INIT:vmovmag, FD:timposte, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT timposte
           IF NOT Valid-STATUS-timposte
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vmovmag, FD:timposte, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tordini.
      * <TOTEM:EPT. INIT:vmovmag, FD:tordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tordini
           IF NOT Valid-STATUS-tordini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vmovmag, FD:tordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tgrupgdo.
      * <TOTEM:EPT. INIT:vmovmag, FD:tgrupgdo, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tgrupgdo
           IF NOT Valid-STATUS-tgrupgdo
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vmovmag, FD:tgrupgdo, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-rordini.
      * <TOTEM:EPT. INIT:vmovmag, FD:rordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT rordini
           IF NOT Valid-STATUS-rordini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vmovmag, FD:rordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-agenti.
      * <TOTEM:EPT. INIT:vmovmag, FD:agenti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT agenti
           IF NOT Valid-STATUS-agenti
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vmovmag, FD:agenti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tnotacr.
      * <TOTEM:EPT. INIT:vmovmag, FD:tnotacr, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tnotacr
           IF NOT Valid-STATUS-tnotacr
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vmovmag, FD:tnotacr, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-timbalqta.
      * <TOTEM:EPT. INIT:vmovmag, FD:timbalqta, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-timbalqta
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vmovmag, FD:timbalqta, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tprov.
      * <TOTEM:EPT. INIT:vmovmag, FD:tprov, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tprov
           IF NOT Valid-STATUS-tprov
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vmovmag, FD:tprov, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tregioni.
      * <TOTEM:EPT. INIT:vmovmag, FD:tregioni, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tregioni
           IF NOT Valid-STATUS-tregioni
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vmovmag, FD:tregioni, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-tmovmag.
      * <TOTEM:EPT. INIT:vmovmag, FD:tmovmag, BeforeClose>
      * <TOTEM:END>
           CLOSE tmovmag
           .

       CLOSE-rmovmag.
      * <TOTEM:EPT. INIT:vmovmag, FD:rmovmag, BeforeClose>
      * <TOTEM:END>
           CLOSE rmovmag
           .

       CLOSE-articoli.
      * <TOTEM:EPT. INIT:vmovmag, FD:articoli, BeforeClose>
      * <TOTEM:END>
           CLOSE articoli
           .

       CLOSE-tmarche.
      * <TOTEM:EPT. INIT:vmovmag, FD:tmarche, BeforeClose>
      * <TOTEM:END>
           CLOSE tmarche
           .

       CLOSE-clienti.
      * <TOTEM:EPT. INIT:vmovmag, FD:clienti, BeforeClose>
      * <TOTEM:END>
           CLOSE clienti
           .

       CLOSE-destini.
      * <TOTEM:EPT. INIT:vmovmag, FD:destini, BeforeClose>
      * <TOTEM:END>
           CLOSE destini
           .

       CLOSE-tmp-movmag.
      * <TOTEM:EPT. INIT:vmovmag, FD:tmp-movmag, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-tcodpag.
      * <TOTEM:EPT. INIT:vmovmag, FD:tcodpag, BeforeClose>
      * <TOTEM:END>
           CLOSE tcodpag
           .

       CLOSE-tmagaz.
      * <TOTEM:EPT. INIT:vmovmag, FD:tmagaz, BeforeClose>
      * <TOTEM:END>
           CLOSE tmagaz
           .

       CLOSE-tparamge.
      * <TOTEM:EPT. INIT:vmovmag, FD:tparamge, BeforeClose>
      * <TOTEM:END>
           CLOSE tparamge
           .

       CLOSE-tcaumag.
      * <TOTEM:EPT. INIT:vmovmag, FD:tcaumag, BeforeClose>
      * <TOTEM:END>
           CLOSE tcaumag
           .

       CLOSE-destinif.
      * <TOTEM:EPT. INIT:vmovmag, FD:destinif, BeforeClose>
      * <TOTEM:END>
           CLOSE destinif
           .

       CLOSE-lineseq.
      * <TOTEM:EPT. INIT:vmovmag, FD:lineseq, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-ttipocli.
      * <TOTEM:EPT. INIT:vmovmag, FD:ttipocli, BeforeClose>
      * <TOTEM:END>
           CLOSE ttipocli
           .

       CLOSE-progmag.
      * <TOTEM:EPT. INIT:vmovmag, FD:progmag, BeforeClose>
      * <TOTEM:END>
           CLOSE progmag
           .

       CLOSE-progmagric.
      * <TOTEM:EPT. INIT:vmovmag, FD:progmagric, BeforeClose>
      * <TOTEM:END>
           CLOSE progmagric
           .

       CLOSE-timposte.
      * <TOTEM:EPT. INIT:vmovmag, FD:timposte, BeforeClose>
      * <TOTEM:END>
           CLOSE timposte
           .

       CLOSE-tordini.
      * <TOTEM:EPT. INIT:vmovmag, FD:tordini, BeforeClose>
      * <TOTEM:END>
           CLOSE tordini
           .

       CLOSE-tgrupgdo.
      * <TOTEM:EPT. INIT:vmovmag, FD:tgrupgdo, BeforeClose>
      * <TOTEM:END>
           CLOSE tgrupgdo
           .

       CLOSE-rordini.
      * <TOTEM:EPT. INIT:vmovmag, FD:rordini, BeforeClose>
      * <TOTEM:END>
           CLOSE rordini
           .

       CLOSE-agenti.
      * <TOTEM:EPT. INIT:vmovmag, FD:agenti, BeforeClose>
      * <TOTEM:END>
           CLOSE agenti
           .

       CLOSE-tnotacr.
      * <TOTEM:EPT. INIT:vmovmag, FD:tnotacr, BeforeClose>
      * <TOTEM:END>
           CLOSE tnotacr
           .

       CLOSE-timbalqta.
      * <TOTEM:EPT. INIT:vmovmag, FD:timbalqta, BeforeClose>
      * <TOTEM:END>
           CLOSE timbalqta
           .

       CLOSE-tprov.
      * <TOTEM:EPT. INIT:vmovmag, FD:tprov, BeforeClose>
      * <TOTEM:END>
           CLOSE tprov
           .

       CLOSE-tregioni.
      * <TOTEM:EPT. INIT:vmovmag, FD:tregioni, BeforeClose>
      * <TOTEM:END>
           CLOSE tregioni
           .
      ...
      * DISPLAY-COLUMNS settings
              MODIFY gd-mov, DISPLAY-COLUMNS (1, 4, 15, 62, 77, 94, 
           107, 126, 145)
           .
      ...
      * <TOTEM:EPT. FORM:form3, FORM:form3, BeforeAccept>
           ...
           if tipo-rec = 1 set save-C to true
           else            set save-F to true
           end-if.
      ...
      * <TOTEM:EPT. FORM:form4, FORM:form4, BeforeAccept>
           ...
           move hid-anno  to tmo-anno.
           move hid-movim to tmo-numero.

           read tmovmag no lock invalid set errori to true end-read.

           if tutto-ok
              move tmo-tipo to Save-CF
              ...
              move tca-cod-magaz   to tmo-codmag mag-codice
      ...
      * DB_Entry-Field : ef-num-fatt
           MOVE ef-num-fatt-BUF TO tmo-num-fattura
      * DB_Entry-Field : ef-data-fatt
           MOVE ef-data-fatt-BUF TO tmo-data-fattura
      ...
      * DB_Entry-Field : ef-num-fatt
           MOVE tmo-num-fattura TO ef-num-fatt-BUF
      * DB_Entry-Field : ef-data-fatt
           MOVE tmo-data-fattura TO ef-data-fatt-BUF
      * DB_Entry-Field : ef-pag
      ...
      * <TOTEM:EPT. FORM:form4, FORM:form4, AfterFldToBuf>
           ...
           move tmo-data-fattura to como-data.
           perform DATE-TO-SCREEN.
           move como-data to ef-data-fatt-buf.

           move tmo-numero to numero-edit.
      ...
      * <TOTEM:END>
       ...
       form4-Save-Status.
           MOVE DataSet1-tmovmag-KEY1-ORDER TO TMP-form4-KEY1-ORDER
           MOVE DataSet1-KEYIS TO TMP-form4-KEYIS
           MOVE tmo-rec OF tmovmag TO 
              TMP-form4-tmovmag-RESTOREBUF
           .             

       form4-Restore-Status.
           MOVE TMP-form4-KEY1-ORDER TO DataSet1-tmovmag-KEY1-ORDER
           MOVE TMP-form4-KEYIS TO DataSet1-KEYIS
           MOVE TMP-form4-tmovmag-RESTOREBUF TO
              tmo-rec OF tmovmag
           PERFORM DataSet1-tmovmag-START
           IF Valid-STATUS-tmovmag
              PERFORM DataSet1-tmovmag-Read-Next
      ...
      *
           when 78-ID-ef-des
                if tipo-rec = 1
                   ...
                   move "forn-des"   to Como-File
                   call   "zoom-gt" using como-file, desf-rec
                                   giving stato-zoom
                   cancel "zoom-gt"
                   if stato-zoom = 0
                      modify ef-des,   value desf-prog
                      modify lab-des,  value desf-ragsoc-1
                   end-if
                end-if
      *
           when 78-ID-ef-marca
                ...
                if tipo-rec = 1
                   ...
                   if tcl-codice not = spaces
                      read ttipocli no lock
                           ...
                           set errori to true
                           display message "Inserimento tipologia NON va
      -    "lida"
                                     title tit-err
                                      icon 2
      ...
      * <TOTEM:PARA. RIEMPI-GRIGLIA-RIGHE-ORDINE>
           ...
           if tutto-ok
              ...
              perform until 1 = 2
                 ...
                 move rmo-riga     to col-num-righe
                 move rmo-articolo to col-art-righe art-codice
                 read articoli no lock invalid continue end-read
                 move art-descrizione to col-des-righe
                 move rmo-qta      to col-qta-righe
                 move rmo-peso-udm to col-udm-righe
                 compute numero = art-peso-standard * rmo-qta
                 move numero       to col-kg-righe
                 move rmo-listino  to col-listino-righe
                 move rmo-sconto   to col-sconto-righe
                 move rmo-imp-cons to col-cons-righe
                 move rmo-coubat   to col-coubat-righe
                 move rmo-netto    to col-netto-righe
                 compute numero = 
      ...
      * <TOTEM:PARA. VALORIZZA-LABELS>
           ...
           move hid-indirizzo-des   to lab-indirizzo-buf.
      ...
      * <TOTEM:PARA. ef-num-AfterProcedure>
              ...
              IF NOT TOTEM-CHECK-OK
                 MOVE 1 TO ACCEPT-CONTROL
              END-IF
              INQUIRE ef-num-fatt, VALUE IN tmo-num-fattura
              SET TOTEM-CHECK-OK TO FALSE
              PERFORM ef-num-fatt-VALIDATION
              IF NOT TOTEM-CHECK-OK
                 MOVE 1 TO ACCEPT-CONTROL
      ...
      * <TOTEM:PARA. ef-data-doc-AfterProcedure>
              ...
              IF NOT TOTEM-CHECK-OK
                 MOVE 1 TO ACCEPT-CONTROL
              END-IF
              INQUIRE ef-data-fatt, VALUE IN tmo-data-fattura
              SET TOTEM-CHECK-OK TO FALSE
              PERFORM ef-data-fatt-VALIDATION
              IF NOT TOTEM-CHECK-OK
                 MOVE 1 TO ACCEPT-CONTROL
