      *{TOTEM}PRG-COMMENT
      * int-selordc.Cbl
      * int-selordc.Cbl is generated by TOTEM
      * This is a generated file. DO NOT modify this file directly.
      *{TOTEM}END
       IDENTIFICATION       DIVISION.
      *{TOTEM}PRGID
       PROGRAM-ID.          int-selordc.
       AUTHOR.              Andrea.
       DATE-WRITTEN.        martedì 10 aprile 2007 17.11.21.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:int-selordc, INIT:int-selordc, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      ***********************************************************
       ...
       77 TMP-Form2-int-tordini-RESTOREBUF  PIC X(907).
       ...
       77 TMP-DataSet1-clienti-BUF     PIC X(933).
       77 TMP-DataSet1-destini-BUF     PIC X(445).
       77 TMP-DataSet1-tparamge-BUF     PIC X(236).
      ...
      * FILE'S LOCK MODE FLAG
       ...
       77 DataSet1-int-tordini-KEY1-ORDER  PIC X VALUE "A".
          88 DataSet1-int-tordini-KEY1-Asc  VALUE "A".
          88 DataSet1-int-tordini-KEY1-Desc VALUE "D".
      ...
      ***** Elenco ID Logici *****
       ...
       78  78-ID-CBO-STATO-ORD VALUE 5007.
      ***** Fine ID Logici *****
      *{TOTEM}END
      ...
      * COMBO-BOX
       05
           ...
           COLOR IS 513,
           ENABLED MOD-LIMITI,
           ID IS 78-ID-CBO-STATO-ORD,                
           HEIGHT-IN-CELLS,
           WIDTH-IN-CELLS,
           MASS-UPDATE 0,
           DROP-LIST,
           UNSORTED,
           VALUE CBO-stato-ord-BUF,
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:int-selordc, INIT:int-selordc, BeforeDeclarative>
      ***---
       INT-TORDINI-ERR SECTION.
           ...
           when "35"
                display message "File [INT-TORDINI] not found!"
                           title titolo
                            icon 3
                set errori to true
           when "39"
      ...
      * <TOTEM:EPT. INIT:int-selordc, INIT:int-selordc, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-clienti.
      * <TOTEM:EPT. INIT:int-selordc, FD:clienti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT clienti
           ...
           END-IF
      * <TOTEM:EPT. INIT:int-selordc, FD:clienti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-destini.
      * <TOTEM:EPT. INIT:int-selordc, FD:destini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT destini
           IF NOT Valid-STATUS-destini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:int-selordc, FD:destini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tparamge.
      * <TOTEM:EPT. INIT:int-selordc, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           IF NOT Valid-STATUS-tparamge
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:int-selordc, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-int-tordini.
      * <TOTEM:EPT. INIT:int-selordc, FD:int-tordini, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-int-tordini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:int-selordc, FD:int-tordini, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-clienti.
      * <TOTEM:EPT. INIT:int-selordc, FD:clienti, BeforeClose>
      * <TOTEM:END>
           CLOSE clienti
           .

       CLOSE-destini.
      * <TOTEM:EPT. INIT:int-selordc, FD:destini, BeforeClose>
      * <TOTEM:END>
           CLOSE destini
           .

       CLOSE-tparamge.
      * <TOTEM:EPT. INIT:int-selordc, FD:tparamge, BeforeClose>
      * <TOTEM:END>
           CLOSE tparamge
           .

       CLOSE-int-tordini.
      * <TOTEM:EPT. INIT:int-selordc, FD:int-tordini, BeforeClose>
      * <TOTEM:END>
           CLOSE int-tordini
           .
       ...
       clienti-cli-K1-MERGE-SPLITBUF.
           ...
           MOVE cli-tipo-CF(1:1) TO clienti-cli-K1-SPLITBUF(1:1)
           MOVE cli-ragsoc-1(1:40) TO clienti-cli-K1-SPLITBUF(2:40)
           MOVE cli-codice(1:5) TO clienti-cli-K1-SPLITBUF(42:5)
           .

       clienti-cli-K3-MERGE-SPLITBUF.
           INITIALIZE clienti-cli-K3-SPLITBUF
           MOVE cli-gdo(1:5) TO clienti-cli-K3-SPLITBUF(1:5)
           MOVE cli-chiave(1:6) TO clienti-cli-K3-SPLITBUF(6:6)
           .

       clienti-cli-K4-MERGE-SPLITBUF.
           INITIALIZE clienti-cli-K4-SPLITBUF
           MOVE cli-utf(1:1) TO clienti-cli-K4-SPLITBUF(1:1)
           MOVE cli-chiave(1:6) TO clienti-cli-K4-SPLITBUF(2:6)
           .
      ...
      * <TOTEM:END>
       ...
       DataSet1-int-tordini-INITSTART.
           ...
           WHEN 1
              IF DataSet1-int-tordini-KEY1-Asc
       ...
       DataSet1-Change-CurrentKey-Asc.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              MOVE "A" TO DataSet1-int-tordini-KEY1-ORDER
           END-EVALUATE
           .
       ...
       DataSet1-Change-CurrentKey-Desc.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              MOVE "D" TO DataSet1-int-tordini-KEY1-ORDER
           END-EVALUATE
           .
      ...
      * GRID
       ...
       Form2-DataSet1-Update-Key.
           MOVE int-tor-rec OF int-tordini TO
                     Form2-MULKEY-TMPBUF
           PERFORM Form2-CLEAR
           PERFORM Form2-INIT-DATA
           MOVE Form2-MULKEY-TMPBUF TO
                     int-tor-rec OF int-tordini
           PERFORM DataSet1-int-tordini-Read
       ...
       Form2-First.
           ...
           PERFORM DataSet1-int-tordini-INITSTART
           PERFORM DataSet1-int-tordini-START
           IF NOT Valid-STATUS-int-tordini
      ...
      * <TOTEM:END>
           PERFORM DataSet1-int-tordini-Read-Next
           IF NOT Valid-STATUS-int-tordini
              PERFORM Form2-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form2-Previous.
              PERFORM Form2-Buf-To-Fld
              PERFORM DataSet1-int-tordini-START-LESS
           IF NOT Valid-STATUS-int-tordini
              PERFORM Form2-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
           PERFORM DataSet1-int-tordini-Read-Prev
           IF NOT Valid-STATUS-int-tordini
              PERFORM Form2-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form2-Next.
              PERFORM Form2-Buf-To-Fld
              PERFORM DataSet1-int-tordini-START-GREATER
           IF NOT Valid-STATUS-int-tordini
              PERFORM Form2-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form2-Last.
           ...
           PERFORM DataSet1-int-tordini-INITEND
           PERFORM DataSet1-int-tordini-START-NOTGREATER
           IF NOT Valid-STATUS-int-tordini
              PERFORM Form2-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
      * write
           PERFORM DataSet1-int-tordini-Rec-Rewrite
           IF Valid-STATUS-int-tordini
      ...
      * delete
           PERFORM Form2-Buf-To-Fld
           PERFORM DataSet1-int-tordini-Rec-Delete
           IF Valid-STATUS-int-tordini
              PERFORM Form2-CLEAR
              PERFORM Form2-DUMMY-DELETE-INIT
              MOVE "303" TO TOTEM-MSG-ID
              MOVE "00" to STATUS-int-tordini
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form2-Save-Status.
           MOVE DataSet1-int-tordini-KEY1-ORDER TO TMP-Form2-KEY1-ORDER
           MOVE DataSet1-KEYIS TO TMP-Form2-KEYIS
           MOVE int-tor-rec OF int-tordini TO 
              TMP-Form2-int-tordini-RESTOREBUF
           .             

       Form2-Restore-Status.
           MOVE TMP-Form2-KEY1-ORDER TO DataSet1-int-tordini-KEY1-ORDER
           MOVE TMP-Form2-KEYIS TO DataSet1-KEYIS
           MOVE TMP-Form2-int-tordini-RESTOREBUF TO
              int-tor-rec OF int-tordini
           PERFORM DataSet1-int-tordini-START
           IF Valid-STATUS-int-tordini
              PERFORM DataSet1-int-tordini-Read-Next
           ELSE
              PERFORM DataSet1-int-tordini-INITREC
           END-IF
           PERFORM UNTIL NOT Valid-STATUS-int-tordini OR
              (Valid-STATUS-int-tordini AND
                 int-tor-rec OF int-tordini = 
                   TMP-Form2-int-tordini-RESTOREBUF)
              PERFORM DataSet1-int-tordini-Read-Next
           END-PERFORM
      ...
      * SPECIFICO PER PROGRAMMI CON SCREEN DI ACCETTAZIONE LIMITI
           ...
           Perform RIEMPI-COMBO-STATO-ORD.

          
           move 78-inevasi to cbo-stato-ord-buf
      ...
      * <TOTEM:PARA. CARICA-ORDINI>
           move anno-to      to int-tor-anno.
           move ordine-from  to int-tor-numero.

LUBEXX     evaluate true
LUBEXX     when inevasi
LUBEXX     when corrispettivi
LUBEXX     when tutti
LUBEXX          move anno-to     to int-tor-anno
LUBEXX          move ordine-from to int-tor-numero
LUBEXX          move data-from-AAAAMMGG   to int-tor-data-creazione
LUBEXX          start int-tordini key is >= int-k-data
LUBEXX                invalid continue
LUBEXX            not invalid perform SCORRI-ORDINI
LUBEXX          end-start
LUBEXX     when emessa-bolla
LUBEXX          move anno-to     to int-tor-anno-bolla
LUBEXX          move ordine-from to int-tor-num-bolla
LUBEXX          move data-from-AAAAMMGG     to int-tor-data-bolla
LUBEXX          set  int-tor-bolla-si-prenotata to true
LUBEXX          start int-tordini key is >= int-k3
LUBEXX                invalid continue
LUBEXX            not invalid perform SCORRI-ORDINI
LUBEXX          end-start
LUBEXX     when fatturati 
LUBEXX          move anno-to     to int-tor-anno-fattura
LUBEXX          move ordine-from to int-tor-num-fattura
LUBEXX          move data-from-AAAAMMGG    to int-tor-data-fattura
LUBEXX          set  int-tor-fatt-si-prenotata to true
LUBEXX          start int-tordini key is >= int-k4
LUBEXX                invalid continue
LUBEXX            not invalid perform SCORRI-ORDINI
LUBEXX          end-start
LUBEXX     end-evaluate.
...
LUBEXX*****              move spaces to tge-anno
LUBEXX*****              move spaces to tge-codice
LUBEXX*****              read tparamge no lock invalid continue end-read
LUBEXX*****              move tge-causale-corrisp to int-tor-causale
LUBEXX*****              start tordini key not < k-causale
LUBEXX*****                    invalid continue
LUBEXX*****                not invalid perform SCORRI-ORDINI
LUBEXX*****              end-start
LUBEXX*****           else
LUBEXX*****              set int-tor-ordine to true
LUBEXX*****              start tordini key >= k-tipo
LUBEXX*****                    invalid continue
LUBEXX*****                not invalid perform SCORRI-ORDINI
LUBEXX*****              end-start
LUBEXX*****           end-if 
      ...
      * <TOTEM:PARA. CHIAMA-MANUTENZIONE>
           ...
           move como-anno          to int-tor-anno.
           move como-numero-ordine to int-tor-numero.
           move int-tor-chiave         to LinkChiave.
           move "selordc"          to LinkPgm.

           modify form2-Handle, visible = zero.
           call   "int-gordcvar" using gordcvar-linkage.
           cancel "int-gordcvar".
           modify form2-Handle, visible = 1 
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. METTI-IN-GRIGLIA>
           move int-tor-anno     to col-anno.
           move int-tor-numero   to col-numero.

LUBEXX     evaluate true
LUBEXX     when tutti
LUBEXX     when corrispettivi
LUBEXX     when inevasi
LUBEXX          move int-tor-data-creazione(1:4)  to col-data(7:4)
LUBEXX          move int-tor-data-creazione(5:2)  to col-data(4:2)
LUBEXX          move int-tor-data-creazione(7:2)  to col-data(1:2)
LUBEXX     when emessa-bolla
LUBEXX          move int-tor-data-bolla(1:4)   to col-data(7:4)
LUBEXX          move int-tor-data-bolla(5:2)   to col-data(4:2)
LUBEXX          move int-tor-data-bolla(7:2)   to col-data(1:2)
LUBEXX     when fatturati
LUBEXX          move int-tor-data-fattura(1:4) to col-data(7:4)
LUBEXX          move int-tor-data-fattura(5:2) to col-data(4:2)
LUBEXX          move int-tor-data-fattura(7:2) to col-data(1:2)
LUBEXX     end-evaluate.

           move "/"                   to col-data(3:1)
                                         col-data(6:1).

           move int-tor-cod-cli           to Col-cliente
                                         cli-codice.
      ...
      * <TOTEM:PARA. PARAGRAFO-COPY>
           ...
           copy "riempi-combo-stato-ord.cpy" 
           .
      * <TOTEM:END>
...
LUBEXX     when corrispettivi
LUBEXX     when tutti
LUBEXX          modify gd-ordini(1, 4), cell-data "Creazione"
LUBEXX     when emessa-bolla
LUBEXX          modify gd-ordini(1, 4), cell-data "Dt. Bolla"
LUBEXX     when fatturati
LUBEXX          modify gd-ordini(1, 4), cell-data "Dt. Fatt."
lubexx     end-evaluate.
...
LUBEXX*****         if int-tor-anno > anno-to    exit perform end-if

LUBEXX*****         if corrispettivi and int-tor-causale not = tge-causale-corrisp
LUBEXX*****            exit perform
LUBEXX*****         end-if
...
LUBEXX        when corrispettivi
LUBEXX        when tutti
LUBEXX             if int-tor-data-creazione > data-to-AAAAMMGG or
LUBEXX                int-tor-anno           > anno-to
LUBEXX                exit perform
LUBEXX             end-if
LUBEXX        when emessa-bolla
LUBEXX             if int-tor-anno-bolla not = anno-to          or
LUBEXX                int-tor-data-bolla >     data-to-AAAAMMGG
LUBEXX                exit perform
LUBEXX             end-if
LUBEXX        when fatturati
LUBEXX             if int-tor-anno-fattura not = anno-to or
LUBEXX                int-tor-data-fattura > data-to-AAAAMMGG
LUBEXX                exit perform
LUBEXX             end-if
LUBEXX        end-evaluate
...
LUBEXX     when corrispettivi
LUBEXX     when tutti
LUBEXX          if int-tor-numero < ordine-from or 
LUBEXX             int-tor-numero > ordine-to
LUBEXX             set record-ok to false
LUBEXX          end-if
LUBEXX     when emessa-bolla
LUBEXX          if int-tor-num-bolla < ordine-from or
LUBEXX             int-tor-num-bolla > ordine-to
LUBEXX             set record-ok to false
LUBEXX          end-if
LUBEXX     when fatturati
LUBEXX          if int-tor-num-fattura < ordine-from or
LUBEXX             int-tor-num-fattura > ordine-to
LUBEXX             set record-ok to false
LUBEXX          end-if
LUBEXX     end-evaluate.

LUBEXX*****     if int-tor-data-creazione < data-from-AAAAMMGG or 
LUBEXX*****        int-tor-data-creazione > data-to-AAAAMMGG
LUBEXX*****        set record-ok to false
LUBEXX*****     end-if.

LUBEXX*****     if int-tor-data-ordine < data-from-AAAAMMGG or int-tor-data-ordine > data-to-AAAAMMGG
LUBEXX*****        set record-ok to false
LUBEXX*****     end-if.

           if int-tor-cod-cli < cliente-from or 
              int-tor-cod-cli > cliente-to
              set record-ok to false
           end-if.

           if int-tor-num-bolla = 0
              set r-inevaso           to true
           else           
              if int-tor-data-fattura = 0
           ...
           evaluate true
           when inevasi     
                if not r-inevaso or int-tor-fattura-manuale
                   set record-ok   to false
                end-if
           when emessa-bolla
                if not r-emessa-bolla or int-tor-fattura-manuale
                   set record-ok   to false
                end-if
           when fatturati   
                if not r-fatturato or int-tor-fattura-manuale
                   set record-ok   to false
                end-if
           when corrispettivi or int-tor-fattura-manuale
                if int-tor-causale not = tge-causale-corrisp
                   set record-ok   to false
                end-if
           when tutti
                if int-tor-fattura-manuale
