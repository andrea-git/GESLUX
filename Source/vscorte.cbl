      *{TOTEM}PRG-COMMENT
      * vscorte.Cbl
      * vscorte.Cbl is generated by TOTEM
      ...
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:vscorte, INIT:vscorte, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       78 titolo VALUE IS "Geslux - Merce da evadere o fatturare". 
       78 78-item1 VALUE IS "Non fatturati e non emessa bolla". 
       78 78-item2 VALUE IS "Non fatturati, ma con bolla emessa". 
       ...
       77 lab-tot-kg-buf   PIC  zzz.zzz.zz9,99.
       77 lab-tot-imp-buf  PIC  zzz.zzz.zz9,99.
       77 tot-kg           PIC  9(9)v99.
       77 tot-imp          PIC  9(9)v99.
       77 tot-colimp       PIC  9(9)v99.
       77 tot-cons         PIC  9(9)v99.
       77 tot-coubat       PIC  9(9)v99.
       ...
       77 lab-tot-buf      PIC  zzz.zzz.zzz.zz9,999.
       ...
       01 rec-grid.
           ...
           05 col-qta-righe    PIC  z(7)9.
           05 col-udm-righe    PIC  zz9,999.
           05 col-kg-righe     PIC  z.zzz9,999.
           05 col-listino-righe            PIC  zzz.zzz.zz9,99.
           05 col-sconto-righe PIC  z9,99.
           05 col-cons-righe   PIC  z.zz9,99.
           05 col-coubat-righe PIC  z.zz9,99.
           05 col-add-righe    PIC  z.zz9,99.
           05 col-netto-righe  PIC  zzz.zzz.zz9,99.
           05 col-tot-righe    PIC  zzz.zzz.zzz.zz9,99.
       ...
       01 r-riga.
           ...
           05 r-qta            PIC  zz.zzz.zz9.
           05 r-prezzo         PIC  ----.---.---.--9,99.
           05 r-tot            PIC  ----.---.---.--9,99.
           05 r-peso           PIC  zzz.zz9,999.
       77 lab-tot-coubat-buf           PIC  zzz.zzz.zz9,99.
       77 lab-tot-cons-buf PIC  zzz.zzz.zz9,99.
       77 lab-tot-colimp-buf           PIC  zzz.zzz.zz9,99.
       ...
       77 path-tmp-ordini  PIC  X(256).
       77 STATUS-tmp-ordini            PIC  X(2).
           88 Valid-STATUS-tmp-ordini VALUE IS "00" THRU "09". 
      ...
      * FILE'S LOCK MODE FLAG
       ...
       77 DataSet1-tmp-ordini-LOCK-FLAG   PIC X VALUE SPACE.
           88 DataSet1-tmp-ordini-LOCK  VALUE "Y".
       77 DataSet1-tmp-ordini-KEY-ORDER  PIC X VALUE "A".
          88 DataSet1-tmp-ordini-KEY-Asc  VALUE "A".
          88 DataSet1-tmp-ordini-KEY-Desc VALUE "D".
      ...
      * GRID
       05
           ...
           BOXED,
           CENTERED-HEADINGS,
           DATA-COLUMNS (1, 2, 6, 56, 64, 74, 81, 95, 103, 112),
      ...
      * LABEL
       05
           ...
           CENTER,
           TRANSPARENT,
           TITLE "Tipologia di ordini da visualizzare",
           .
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:vscorte, INIT:vscorte, BeforeDeclarative>
       LINESEQ-ERR SECTION.
      ...
      ***---
       TMP-ORDINI-ERR SECTION.
           use after error procedure on tmp-ordini.
           set tutto-ok  to true.
           evaluate status-tmp-ordini
           when "35"
                display message "File [TMP-ORDINI] not found!"
                           title titolo
                            icon 3
                set errori to true
           when "39"
                display message "File [TMP-ORDINI] Mismatch size!"
                           title titolo
                            icon 3
                set errori to true
           when "98"
                display message "[TMP-ORDINI] Indexed file corrupt!"
                           title titolo
                            icon 3
                set errori to true
           end-evaluate.
      ...
      * <TOTEM:EPT. INIT:vscorte, INIT:vscorte, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-articoli.
      * <TOTEM:EPT. INIT:vscorte, FD:articoli, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT articoli
           ...
           END-IF
      * <TOTEM:EPT. INIT:vscorte, FD:articoli, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmarche.
      * <TOTEM:EPT. INIT:vscorte, FD:tmarche, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tmarche
           IF NOT Valid-STATUS-tmarche
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vscorte, FD:tmarche, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-clienti.
      * <TOTEM:EPT. INIT:vscorte, FD:clienti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT clienti
           IF NOT Valid-STATUS-clienti
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vscorte, FD:clienti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-destini.
      * <TOTEM:EPT. INIT:vscorte, FD:destini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT destini
           IF NOT Valid-STATUS-destini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vscorte, FD:destini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tparamge.
      * <TOTEM:EPT. INIT:vscorte, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           IF NOT Valid-STATUS-tparamge
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vscorte, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tcaumag.
      * <TOTEM:EPT. INIT:vscorte, FD:tcaumag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcaumag
           IF NOT Valid-STATUS-tcaumag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vscorte, FD:tcaumag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-lineseq.
      * <TOTEM:EPT. INIT:vscorte, FD:lineseq, BeforeOpen>
      * <TOTEM:END>
           OPEN  OUTPUT lineseq
           IF NOT Valid-STATUS-lineseq
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vscorte, FD:lineseq, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tordini.
      * <TOTEM:EPT. INIT:vscorte, FD:tordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tordini
           IF NOT Valid-STATUS-tordini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vscorte, FD:tordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-rordini.
      * <TOTEM:EPT. INIT:vscorte, FD:rordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT rordini
           IF NOT Valid-STATUS-rordini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vscorte, FD:rordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmp-ordini.
      * <TOTEM:EPT. INIT:vscorte, FD:tmp-ordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  OUTPUT tmp-ordini
           IF NOT Valid-STATUS-tmp-ordini
              PERFORM  Form1-EXTENDED-FILE-STATUS
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vscorte, FD:tmp-ordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tcodpag.
      * <TOTEM:EPT. INIT:vscorte, FD:tcodpag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcodpag
           IF NOT Valid-STATUS-tcodpag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vscorte, FD:tcodpag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-ttipocli.
      * <TOTEM:EPT. INIT:vscorte, FD:ttipocli, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT ttipocli
           IF NOT Valid-STATUS-ttipocli
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vscorte, FD:ttipocli, AfterOpen>
      * <TOTEM:END>
           .
      ...
      * <TOTEM:END>
       ...
       OPEN-timbalqta.
      * <TOTEM:EPT. INIT:vscorte, FD:timbalqta, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-timbalqta
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vscorte, FD:timbalqta, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-timballi.
      * <TOTEM:EPT. INIT:vscorte, FD:timballi, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT timballi
           IF NOT Valid-STATUS-timballi
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vscorte, FD:timballi, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-articoli.
      * <TOTEM:EPT. INIT:vscorte, FD:articoli, BeforeClose>
      * <TOTEM:END>
           CLOSE articoli
           .

       CLOSE-tmarche.
      * <TOTEM:EPT. INIT:vscorte, FD:tmarche, BeforeClose>
      * <TOTEM:END>
           CLOSE tmarche
           .

       CLOSE-clienti.
      * <TOTEM:EPT. INIT:vscorte, FD:clienti, BeforeClose>
      * <TOTEM:END>
           CLOSE clienti
           .

       CLOSE-destini.
      * <TOTEM:EPT. INIT:vscorte, FD:destini, BeforeClose>
      * <TOTEM:END>
           CLOSE destini
           .

       CLOSE-tparamge.
      * <TOTEM:EPT. INIT:vscorte, FD:tparamge, BeforeClose>
      * <TOTEM:END>
           CLOSE tparamge
           .

       CLOSE-tcaumag.
      * <TOTEM:EPT. INIT:vscorte, FD:tcaumag, BeforeClose>
      * <TOTEM:END>
           CLOSE tcaumag
           .

       CLOSE-lineseq.
      * <TOTEM:EPT. INIT:vscorte, FD:lineseq, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-tordini.
      * <TOTEM:EPT. INIT:vscorte, FD:tordini, BeforeClose>
      * <TOTEM:END>
           CLOSE tordini
           .

       CLOSE-rordini.
      * <TOTEM:EPT. INIT:vscorte, FD:rordini, BeforeClose>
      * <TOTEM:END>
           CLOSE rordini
           .

       CLOSE-tmp-ordini.
      * <TOTEM:EPT. INIT:vscorte, FD:tmp-ordini, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-tcodpag.
      * <TOTEM:EPT. INIT:vscorte, FD:tcodpag, BeforeClose>
      * <TOTEM:END>
           CLOSE tcodpag
           .
      ...
      * <TOTEM:END>
       ...
       CLOSE-timbalqta.
      * <TOTEM:EPT. INIT:vscorte, FD:timbalqta, BeforeClose>
      * <TOTEM:END>
           CLOSE timbalqta
           .

       CLOSE-timballi.
      * <TOTEM:EPT. INIT:vscorte, FD:timballi, BeforeClose>
      * <TOTEM:END>
           CLOSE timballi
           .
      ...
      * <TOTEM:END>
       ...
       DataSet1-tmp-ordini-INITSTART.
           IF DataSet1-tmp-ordini-KEY-Asc
      ...
      * tmp-ordini
       DataSet1-tmp-ordini-START.
           IF DataSet1-tmp-ordini-KEY-Asc
              START tmp-ordini KEY >= tmp-ord-chiave
           ELSE
              START tmp-ordini KEY <= tmp-ord-chiave
           END-IF
           .

       DataSet1-tmp-ordini-START-NOTGREATER.
           IF DataSet1-tmp-ordini-KEY-Asc
              START tmp-ordini KEY <= tmp-ord-chiave
           ELSE
              START tmp-ordini KEY >= tmp-ord-chiave
       ...
       DataSet1-tmp-ordini-START-GREATER.
           IF DataSet1-tmp-ordini-KEY-Asc
              START tmp-ordini KEY > tmp-ord-chiave
           ELSE
              START tmp-ordini KEY < tmp-ord-chiave
       ...
       DataSet1-tmp-ordini-START-LESS.
           IF DataSet1-tmp-ordini-KEY-Asc
              START tmp-ordini KEY < tmp-ord-chiave
           ELSE
              START tmp-ordini KEY > tmp-ord-chiave
       ...
       DataSet1-tmp-ordini-Read.
      * <TOTEM:EPT. FD:DataSet1, FD:tmp-ordini, BeforeRead>
      * <TOTEM:END>
      * <TOTEM:EPT. FD:DataSet1, FD:tmp-ordini, BeforeReadRecord>
      * <TOTEM:END>
      * <TOTEM:EPT. FD:DataSet1, FD:tmp-ordini, AfterRead>
      * <TOTEM:END>
      * <TOTEM:EPT. FD:DataSet1, FD:tmp-ordini, AfterReadRecord>
      * <TOTEM:END>
           .

       DataSet1-tmp-ordini-Read-Next.
      * <TOTEM:EPT. FD:DataSet1, FD:tmp-ordini, BeforeRead>
      * <TOTEM:END>
      * <TOTEM:EPT. FD:DataSet1, FD:tmp-ordini, BeforeReadNext>
      * <TOTEM:END>
      * <TOTEM:EPT. FD:DataSet1, FD:tmp-ordini, AfterRead>
      * <TOTEM:END>
      * <TOTEM:EPT. FD:DataSet1, FD:tmp-ordini, AfterReadNext>
      * <TOTEM:END>
           .

       DataSet1-tmp-ordini-Read-Prev.
      * <TOTEM:EPT. FD:DataSet1, FD:tmp-ordini, BeforeRead>
      * <TOTEM:END>
      * <TOTEM:EPT. FD:DataSet1, FD:tmp-ordini, BeforeReadPrev>
      * <TOTEM:END>
      * <TOTEM:EPT. FD:DataSet1, FD:tmp-ordini, AfterRead>
      * <TOTEM:END>
      * <TOTEM:EPT. FD:DataSet1, FD:tmp-ordini, AfterReadPrev>
      * <TOTEM:END>
           .

       DataSet1-tmp-ordini-Rec-Write.
      * <TOTEM:EPT. FD:DataSet1, FD:tmp-ordini, BeforeWrite>
      * <TOTEM:END>
           WRITE tmp-ord-rec OF tmp-ordini.
           MOVE STATUS-tmp-ordini TO TOTEM-ERR-STAT
           MOVE "tmp-ordini" TO TOTEM-ERR-FILE
           MOVE "WRITE" TO TOTEM-ERR-MODE
      * <TOTEM:EPT. FD:DataSet1, FD:tmp-ordini, AfterWrite>
      * <TOTEM:END>
           .

       DataSet1-tmp-ordini-Rec-Rewrite.
      * <TOTEM:EPT. FD:DataSet1, FD:tmp-ordini, BeforeRewrite>
      * <TOTEM:END>
           MOVE STATUS-tmp-ordini TO TOTEM-ERR-STAT
           MOVE "tmp-ordini" TO TOTEM-ERR-FILE
           MOVE "REWRITE" TO TOTEM-ERR-MODE
      * <TOTEM:EPT. FD:DataSet1, FD:tmp-ordini, AfterRewrite>
      * <TOTEM:END>
           .

       DataSet1-tmp-ordini-Rec-Delete.
      * <TOTEM:EPT. FD:DataSet1, FD:tmp-ordini, BeforeDelete>
      * <TOTEM:END>
           MOVE STATUS-tmp-ordini TO TOTEM-ERR-STAT
           MOVE "tmp-ordini" TO TOTEM-ERR-FILE
           MOVE "DELETE" TO TOTEM-ERR-MODE
      * <TOTEM:EPT. FD:DataSet1, FD:tmp-ordini, AfterDelete>
      * <TOTEM:END>
           .
      ...
      * DISPLAY-COLUMNS settings
              MODIFY gd-mov, DISPLAY-COLUMNS (1, 4, 15, 57, 71, 86, 
           101, 115, 129, 145)
           .
      ...
      * SPECIFICO PER PROGRAMMI CON SCREEN DI ACCETTAZIONE LIMITI
           ...
           modify cbo-tipo-ord,  reset-list = 1.
           move 78-item1                 to cbo-tipo-ord-buf.
           modify cbo-tipo-ord, item-to-add cbo-tipo-ord-buf.
           move 78-item2                 to cbo-tipo-ord-buf.
           modify cbo-tipo-ord, item-to-add cbo-tipo-ord-buf.

           modify cbo-tipo-ord,  value 78-item1.
      ...
      * DISPLAY-COLUMNS settings
              MODIFY Form1-Gd-1, DISPLAY-COLUMNS (1, 8, 15, 45, 52, 64, 
           73, 83, 89, 100, 111, 122, 134)
           .
      ...
      * Generazione stringa perform CONTROLLO
       ...
       form4-AfterProcedure.
           ...
           When 8 PERFORM ef-pag-AfterProcedure
           END-EVALUATE
           ...
           when 78-ID-ef-art
                ...
                if art-codice not = 0   
                   read articoli no lock
                        invalid
                        set errori to true
                        display message box "Inserimento articolo NON va
      -    "lido"
                                title = tit-err
                                icon 2
      ...
      *               
           when 78-ID-cbo-tipo-ord
                ...
                evaluate cbo-tipo-ord-buf
                when 78-item1 move 1 to tipo-ord
                when 78-item2 move 2 to tipo-ord
                end-evaluate
           end-evaluate.
...
OMAGGI              perform AGGIUNGI-RIGA
      ...
      ***---
       AGGIUNGI-RIGA.
           ...
           giving ror-peso-udm.
           move ror-peso-udm     to col-udm-righe.
           compute numero = art-peso-standard * ror-qta.
           move numero           to col-kg-righe.
      *****     move ror-listino  to col-listino-righe
      ...
      * <TOTEM:PARA. SECCA-TMP>
           if FileOpen
              close tmp-ordini
              call "C$DELETE" using path-tmp-ordini, "I"
      ...
      * <TOTEM:PARA. VALORIZZA-LABELS>
           ...
           move hid-ragsoc-des      to lab-des-2-buf.
