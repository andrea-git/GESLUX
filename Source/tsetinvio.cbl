      *{TOTEM}PRG-COMMENT
      * tsetinvio.Cbl
      * tsetinvio.Cbl is generated by TOTEM
      * This is a generated file. DO NOT modify this file directly.
      *{TOTEM}END
       IDENTIFICATION       DIVISION.
      *{TOTEM}PRGID
       PROGRAM-ID.          tsetinvio.
       AUTHOR.              ANDREA EVENTI.
       DATE-WRITTEN.        martedì 1 aprile 2014 19:20:22.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:tsetinvio, INIT:tsetinvio, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       77 Form1-Tb-1-Handle
                  USAGE IS HANDLE OF WINDOW.
       78 titolo VALUE IS "Geslux - Tabella Settaggi Invio". 
       77 E-ESCI           PIC  9
                  VALUE IS 1.
       77 E-NUOVO          PIC  9
                  VALUE IS 1.
       ...
       77 toolbar-bmp      PIC  S9(9)
                  ...
                  VALUE IS 0.
       01 rec-grid.
           05 col-programma    PIC  x(20).
           05 col-smtp         PIC  x(100).
           05 col-porta        PIC  zzzz9.
           05 col-SSL          PIC  x.
           05 col-user         PIC  x(100).
           05 col-pass         PIC  x(100).
           05 col-user-from    PIC  x(100).
       77 Screen1-Handle
                  USAGE IS HANDLE OF WINDOW.
      ...
      ***********************************************************
       ...
       77 TMP-Form1-tsetinvio-RESTOREBUF  PIC X(1023).
       77 TMP-Form1-KEYIS  PIC 9(3) VALUE 1.
       77 Form1-MULKEY-TMPBUF   PIC X(1023).
      ...
      * FILE'S LOCK MODE FLAG
       ...
       77 DataSet1-tsetinvio-KEY1-ORDER  PIC X VALUE "A".
          88 DataSet1-tsetinvio-KEY1-Asc  VALUE "A".
          88 DataSet1-tsetinvio-KEY1-Desc VALUE "D".


       01 old-tsi-rec.
           05 old-tsi-chiave.
               10 old-tsi-codice      PIC  x(20).
           05 old-tsi-dati.                      
               10 old-tsi-smtp         PIC  x(100).
               10 old-tsi-porta        PIC  9(5).
               10 old-tsi-SSL          PIC  x.
                   88 old-tsi-SSL-si VALUE IS "S". 
                   88 old-tsi-SSL-no VALUE IS "N". 
               10 old-tsi-user         PIC  x(100).
               10 old-tsi-pass         PIC  x(100).
               10 old-tsi-user-from    PIC  x(100).
               10 old-tsi-dati-comuni.
                   15 old-tsi-data-creazione          PIC  9(8).
                   15 old-tsi-ora-creazione            PIC  9(8).
                   15 old-tsi-utente-creazione         PIC  X(10).
                   15 old-tsi-data-modifica            PIC  9(8).
                   15 old-tsi-ora-modifica PIC  9(8).
                   15 old-tsi-utente-modifica          PIC  X(10).
               10 old-tsi-vuoti.
                   15 old-tsi-num-vuoto-1  PIC  9(15).
                   15 old-tsi-num-vuoto-2  PIC  9(15).
                   15 old-tsi-num-vuoto-3  PIC  9(15).
                   15 old-tsi-filler       PIC  x(500).
      *{TOTEM}END
      ...
      * GRID
       05
           ...
           ADJUSTABLE-COLUMNS,
           BOXED,
           DATA-COLUMNS (1, 21, 121, 126, 127, 227, 327),
           ALIGNMENT ("L", "U", "R", "C", "U", "U", "U"),
           SEPARATION (5, 5, 5, 5, 5, 5, 5),
           DATA-TYPES ("X", "X", "zzzz9", "U(1)", "X", "X", "X"),
           NUM-COL-HEADINGS 1,
           COLUMN-HEADINGS,
      ...
      * LABEL
       05
           ...
           WIDTH-IN-CELLS,
           TRANSPARENT,
           TITLE "PROGRAMMA = SPACES per default",
           .
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:tsetinvio, INIT:tsetinvio, BeforeDeclarative>
       tsetinvio-ERR SECTION.
           use after error procedure on tsetinvio.
           evaluate status-tsetinvio
           when "35"
                display message "File [tsetinvio] not found!"
                           title titolo
                            icon 3
                set errori to true
           when "39"
      ...
      * <TOTEM:EPT. INIT:tsetinvio, INIT:tsetinvio, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-tsetinvio.
      * <TOTEM:EPT. INIT:tsetinvio, FD:tsetinvio, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O tsetinvio
           ...
           END-IF
      * <TOTEM:EPT. INIT:tsetinvio, FD:tsetinvio, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-tsetinvio.
      * <TOTEM:EPT. INIT:tsetinvio, FD:tsetinvio, BeforeClose>
      * <TOTEM:END>
           CLOSE tsetinvio
           .
       ...
       DataSet1-tsetinvio-INITSTART.
           ...
           WHEN 1
              IF DataSet1-tsetinvio-KEY1-Asc
       ...
       DataSet1-Change-CurrentKey-Asc.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              MOVE "A" TO DataSet1-tsetinvio-KEY1-ORDER
           END-EVALUATE
           .
       ...
       DataSet1-Change-CurrentKey-Desc.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              MOVE "D" TO DataSet1-tsetinvio-KEY1-ORDER
           END-EVALUATE
           .
      ...
      * DISPLAY-COLUMNS settings
              MODIFY form1-gd-1, DISPLAY-COLUMNS (1, 21, 51, 58, 63, 
           103, 123)
           .
      ...
      * GRID
       ...
       Form1-DataSet1-Update-Key.
           MOVE tsi-rec OF tsetinvio TO
                     Form1-MULKEY-TMPBUF
           PERFORM Form1-CLEAR
           PERFORM Form1-INIT-DATA
           MOVE Form1-MULKEY-TMPBUF TO
                     tsi-rec OF tsetinvio
           PERFORM DataSet1-tsetinvio-Read
       ...
       Form1-First.
           ...
           PERFORM DataSet1-tsetinvio-INITSTART
           PERFORM DataSet1-tsetinvio-START
           IF NOT Valid-STATUS-tsetinvio
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
           PERFORM DataSet1-tsetinvio-Read-Next
           IF NOT Valid-STATUS-tsetinvio
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Previous.
              PERFORM Form1-Buf-To-Fld
              PERFORM DataSet1-tsetinvio-START-LESS
           IF NOT Valid-STATUS-tsetinvio
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
           PERFORM DataSet1-tsetinvio-Read-Prev
           IF NOT Valid-STATUS-tsetinvio
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Next.
              PERFORM Form1-Buf-To-Fld
              PERFORM DataSet1-tsetinvio-START-GREATER
           IF NOT Valid-STATUS-tsetinvio
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Last.
           ...
           PERFORM DataSet1-tsetinvio-INITEND
           PERFORM DataSet1-tsetinvio-START-NOTGREATER
           IF NOT Valid-STATUS-tsetinvio
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
      * write
           PERFORM DataSet1-tsetinvio-Rec-Rewrite
           IF Valid-STATUS-tsetinvio
      ...
      * delete
           PERFORM Form1-Buf-To-Fld
           PERFORM DataSet1-tsetinvio-Rec-Delete
           IF Valid-STATUS-tsetinvio
              PERFORM Form1-CLEAR
              PERFORM Form1-DUMMY-DELETE-INIT
              MOVE "303" TO TOTEM-MSG-ID
              MOVE "00" to STATUS-tsetinvio
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Save-Status.
           MOVE DataSet1-tsetinvio-KEY1-ORDER TO TMP-Form1-KEY1-ORDER
           MOVE DataSet1-KEYIS TO TMP-Form1-KEYIS
           MOVE tsi-rec OF tsetinvio TO 
              TMP-Form1-tsetinvio-RESTOREBUF
           .             

       Form1-Restore-Status.
           MOVE TMP-Form1-KEY1-ORDER TO DataSet1-tsetinvio-KEY1-ORDER
           MOVE TMP-Form1-KEYIS TO DataSet1-KEYIS
           MOVE TMP-Form1-tsetinvio-RESTOREBUF TO
              tsi-rec OF tsetinvio
           PERFORM DataSet1-tsetinvio-START
           IF Valid-STATUS-tsetinvio
              PERFORM DataSet1-tsetinvio-Read-Next
           ELSE
              PERFORM DataSet1-tsetinvio-INITREC
           END-IF
           PERFORM UNTIL NOT Valid-STATUS-tsetinvio OR
              (Valid-STATUS-tsetinvio AND
                 tsi-rec OF tsetinvio = 
                   TMP-Form1-tsetinvio-RESTOREBUF)
              PERFORM DataSet1-tsetinvio-Read-Next
           END-PERFORM
      ...
      *--->fine.                 
           ...
           if scelta = mb-yes
              ...
              delete tsetinvio record invalid continue end-delete
      ...
      * <TOTEM:PARA. CONTROLLO>
           ...
           when 2
                if tsi-smtp = spaces
                   set errori to true
                   move 2 to colonna
                   display message box "Server SMTP obbligatorio"
                           title = tit-err
                           icon mb-warning-icon
                end-if
           when 4
                if tsi-SSL not = "S" and not = "N"
                   set errori to true
                   move 4 to colonna
                   display message box "Valori possibili S(i)/N(o)"
                           title = tit-err
                           icon mb-warning-icon
                end-if
      ...
      * <TOTEM:PARA. LOAD-RECORD>
           ...
           move low-value to tsi-codice.
           start tsetinvio key is >= tsi-chiave
                  invalid continue
              not invalid
                  perform varying riga from 2 by 1
                     ...
                     read tsetinvio next
                          at end exit perform
                      not at end
                          move tsi-codice    to col-programma
                          move tsi-smtp      to col-smtp
                          move tsi-porta     to col-porta
                          move tsi-SSL       to col-SSL
                          move tsi-user      to col-user
                          move tsi-pass      to col-pass
                          move tsi-user-from to col-user-from
      ...
      *--->modifica (isacco)
           if nuovo 
              ...
              if mod = 1
                 close tsetinvio
                 open i-o tsetinvio allowing readers
              else
                 set tutto-ok to true
                 if NoSalvato
                    move 1 to mod
      ...
      * <TOTEM:PARA. NUOVO>
           ...
           if tutto-ok
              ...
              initialize old-tsi-rec replacing numeric data by zeroes
                                          alphanumeric data by spaces
      ...
      * <TOTEM:PARA. VALORE-RIGA>
           inquire form1-gd-1(riga, 1), cell-data tsi-codice.
           inquire form1-gd-1(riga, 2), cell-data tsi-smtp.
           inquire form1-gd-1(riga, 3), cell-data tsi-porta. 
           inquire form1-gd-1(riga, 4), cell-data tsi-SSL. 
           inquire form1-gd-1(riga, 5), cell-data tsi-user.
           inquire form1-gd-1(riga, 6), cell-data tsi-pass.
           inquire form1-gd-1(riga, 7), cell-data tsi-user-from   
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. VALORE-OLD-RIGA>
           if vecchio
              inquire form1-gd-1(riga, 1) cell-data old-tsi-codice
              move old-tsi-codice         to tsi-codice
              read tsetinvio              no lock
              move tsi-rec                to old-tsi-rec
           else
              initialize old-tsi-rec replacing numeric data by zeroes
                                          alphanumeric data by spaces
           end-if 
      ...
      *    se non ho valorizzato i campi di creazione li valorizzo
           if tsi-data-creazione = zero
              accept tsi-data-creazione from century-date
           end-if.
           if tsi-ora-creazione = zero
              accept tsi-ora-creazione from time
           end-if.
           if tsi-utente-creazione = space
              move user-codi to tsi-utente-creazione
           end-if.

           accept tsi-data-modifica from century-date.
           accept tsi-ora-modifica  from time.
           move user-codi to tsi-utente-modifica 
           .
      * <TOTEM:END>
