      *{TOTEM}PRG-COMMENT
      * selmovc.Cbl
      * selmovc.Cbl is generated by TOTEM
      ...
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:selmovc, INIT:selmovc, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       78 titolo VALUE IS "Geslux - Ricerca e variazione movimenti". 
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:selmovc, INIT:selmovc, BeforeDeclarative>
      ***---
       TMOVMAG-ERR SECTION.
      ...
      * <TOTEM:EPT. INIT:selmovc, INIT:selmovc, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-tmovmag.
      * <TOTEM:EPT. INIT:selmovc, FD:tmovmag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tmovmag
           ...
           END-IF
      * <TOTEM:EPT. INIT:selmovc, FD:tmovmag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-clienti.
      * <TOTEM:EPT. INIT:selmovc, FD:clienti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT clienti
           IF NOT Valid-STATUS-clienti
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selmovc, FD:clienti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-rmovmag.
      * <TOTEM:EPT. INIT:selmovc, FD:rmovmag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT rmovmag
           IF NOT Valid-STATUS-rmovmag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selmovc, FD:rmovmag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tcaumag.
      * <TOTEM:EPT. INIT:selmovc, FD:tcaumag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcaumag
           IF NOT Valid-STATUS-tcaumag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selmovc, FD:tcaumag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tparamge.
      * <TOTEM:EPT. INIT:selmovc, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           IF NOT Valid-STATUS-tparamge
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selmovc, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-tmovmag.
      * <TOTEM:EPT. INIT:selmovc, FD:tmovmag, BeforeClose>
      * <TOTEM:END>
           CLOSE tmovmag
           .

       CLOSE-clienti.
      * <TOTEM:EPT. INIT:selmovc, FD:clienti, BeforeClose>
      * <TOTEM:END>
           CLOSE clienti
           .

       CLOSE-rmovmag.
      * <TOTEM:EPT. INIT:selmovc, FD:rmovmag, BeforeClose>
      * <TOTEM:END>
           CLOSE rmovmag
           .

       CLOSE-tcaumag.
      * <TOTEM:EPT. INIT:selmovc, FD:tcaumag, BeforeClose>
      * <TOTEM:END>
           CLOSE tcaumag
           .
      ...
      * <TOTEM:EPT. FORM:Form2, FORM:Form2, BeforeAccept>
           ...
           if not trovato
              display message box "Nessun movimento presente per i limit
      -    "i richiesti"
                      title = tit-err
                      icon mb-error-icon
              perform FORM2-EXIT
      ...
      * <TOTEM:PARA. SCORRI-ORDINI>
           ...
           perform until 1 = 2
              ...
              if tmo-anno > anno-to    exit perform end-if
