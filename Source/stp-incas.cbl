      *{TOTEM}PRG-COMMENT
      * stp-incas.Cbl
      * stp-incas.Cbl is generated by TOTEM
      * This is a generated file. DO NOT modify this file directly.
      *{TOTEM}END
       IDENTIFICATION       DIVISION.
      *{TOTEM}PRGID
       PROGRAM-ID.          stp-incas.
       AUTHOR.              ANDREA EVENTI.
       DATE-WRITTEN.        martedì 1 aprile 2014 19:19:24.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:stp-incas, INIT:stp-incas, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       78 titolo VALUE IS "Liquidazione provvigioni: stampa incassato". 
       01 file-info.
       ...
       77 lab-da-age-buf   PIC  X(40).
       77 ef-da-age-buf    PIC  z(5).
       77 ef-a-age-buf     PIC  z(5).
       77 lab-a-age-buf    PIC  X(40).
       77 ef-data-liq-buf  PIC  99/99/9999.
      ...
      *{TOTEM}ID-LOGICI
      ***** Elenco ID Logici *****
       78  78-ID-ef-data-liq VALUE 5001.
       78  78-ID-ef-da-age VALUE 5002.
       78  78-ID-ef-a-age VALUE 5003.
      ***** Fine ID Logici *****
      *{TOTEM}END
      ...
      * ENTRY FIELD
       05
           ...
           COLOR IS 513,
           ENABLED e-data,
           ID IS 78-ID-ef-data-liq,                
           HEIGHT-IN-CELLS,
           WIDTH-IN-CELLS,
           CENTER,
           NUMERIC,
           VALUE ef-data-liq-buf,
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:stp-incas, INIT:stp-incas, BeforeDeclarative>
      ***---
       AGENTI-ERR SECTION.
      ...
      * <TOTEM:EPT. INIT:stp-incas, INIT:stp-incas, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-agenti.
      * <TOTEM:EPT. INIT:stp-incas, FD:agenti, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O agenti
           IF STATUS-agenti = "35"
              OPEN OUTPUT agenti
           ...
           END-IF
      * <TOTEM:EPT. INIT:stp-incas, FD:agenti, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-agenti.
      * <TOTEM:EPT. INIT:stp-incas, FD:agenti, BeforeClose>
      * <TOTEM:END>
           CLOSE agenti
           .
      ...
      * <TOTEM:EPT. FORM:Form1, FORM:Form1, BeforeAccept>
           ...
           move como-data to ef-data-liq-buf.             

           move 99999 to ef-a-age-buf.

           display ef-data-liq ef-a-age.
      ...
      * Generazione stringa perform CONTROLLO
           evaluate control-id
           |78-ID-ef-data-liq è l'ID del campo ef-data-liq
           when 78-ID-ef-data-liq
                perform CONTROLLO
      ...
      * <TOTEM:PARA. CONTROLLO>
           ...
           evaluate CONTROL-ID
           when 78-ID-ef-data-liq                          
                inquire ef-data-liq, value in ef-data-liq-buf
                move ef-data-liq-buf to como-data
                if como-data not = 0
                   perform DATE-FORMAT
                   move como-data to ef-data-liq-buf
                else
      ...
      * <TOTEM:PARA. pb-ok-LinkTo>
           ...
           perform  varying CONTROL-ID from 78-ID-ef-data-liq by 1
           ...
           if tutto-ok
              ...
              move como-data        to sta-data-liq
              move ef-da-age-buf    to sta-da-age
              move ef-a-age-buf     to sta-a-age
              set sta-incassato     to true
              call   "stp-incsos-p" using stp-incsos-linkage
              cancel "stp-incsos-p"
              
              modify form1-Handle, visible = 1
              modify pb-ok,        bitmap-number = 1
              modify pb-annulla,   bitmap-number = 1
              move 78-ID-ef-data-liq   to CONTROL-ID     
              move 4                   to ACCEPT-CONTROL 
           end-if 
           .
      * <TOTEM:END>
