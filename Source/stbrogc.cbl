      *{TOTEM}PRG-COMMENT
      * stbrogc.Cbl
      * stbrogc.Cbl is generated by TOTEM
      ...
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:stbrogc, INIT:stbrogc, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       78 titolo VALUE IS "Stampa Brogliaccio". 
       77 anno-to          PIC  9(4).
       77 num-from         PIC  9(8).
       77 num-to           PIC  9(8).
       77 screen-2-handle
      ...
      ***** Elenco ID Logici *****
       ...
       78  78-ID-rb-tutte VALUE 5004.
       78  78-ID-rb-merce VALUE 5005.
       78  78-ID-rb-manuali VALUE 5006.
      ***** Fine ID Logici *****
      *{TOTEM}END
      ...
      * RADIO BUTTON
       05
           ...
           TITLE "&L",
           VALUE tipo-elab,
           AFTER PROCEDURE rb-fatt-AfterProcedure, 
           BEFORE PROCEDURE rb-fatt-BeforeProcedure, 
           .
      * LABEL
       05
           Screen3-La-1a, 
      ...
      * LABEL
       05
           ...
           WIDTH-IN-CELLS,
           TRANSPARENT,
           TITLE "Includi ordini &fatturati",
           .
      ...
      *{TOTEM}COPY-PROCEDURE
       EXIT-STOP-ROUTINE.
      * <TOTEM:EPT. INIT:stbrogc, INIT:stbrogc, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. PB-ESEGUI-LinkTo>
           ...
           if tutto-ok
              ...
              if tipo-elab = 1
                 ...
                 move tipo-cli     to stbrogc-tipo-cli
                 evaluate tipo-doc
                 when 1   set stbrogc-tutte   to true
                 when 2   set stbrogc-no-fm   to true
                 when 3   set stbrogc-solo-fm to true
                 end-evaluate
                 move chk-fattu-buf to stbrogc-fattu
              else
                 move 0            to stbrogc-da-num
                 move 99999999     to stbrogc-a-num
                 move 9999         to stbrogc-da-anno
                 move 9999         to stbrogc-a-anno
                 set stbrogc-no-fm to true

              end-if

              move form1-handle to stbrogc-handle

              call "W$MOUSE" using set-mouse-shape, wait-pointer

              call   "stbrogcp" using stbrogcp-limiti
              cancel "stbrogcp"
      ...
      * <TOTEM:PARA. Form1-Pb-2-LinkTo>
           .
      * <TOTEM:END>
       rb-fatt-AfterProcedure.
      * <TOTEM:PARA. rb-fatt-AfterProcedure>
           modify control-handle, color = colore-or
           .
      * <TOTEM:END>
       rb-fatt-BeforeProcedure.
      * <TOTEM:PARA. rb-fatt-BeforeProcedure>
           modify control-handle, color = colore-nu
           .
      * <TOTEM:END>
       rb-fatt-LinkTo.
