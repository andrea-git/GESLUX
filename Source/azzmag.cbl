      *{TOTEM}PRG-COMMENT
      * azzmag.Cbl
      * azzmag.Cbl is generated by TOTEM
      ...
      *{TOTEM}PRGID
       ...
       DATE-WRITTEN.        martedì 1 aprile 2014 19:13:15.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:azzmag, INIT:azzmag, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * LABEL
       05
           ...
           WIDTH-IN-CELLS,
           TRANSPARENT,
           TITLE "Ricalcolo dati CONSOLIDATI SU PROGRESSIVI DI MAGAZZINO
      -    " DEFINITIVO e IRREVERSIBILE!            Fare il salvataggio 
      -    "degli archivi.",
           .
      ...
      * LABEL
       05
           ...
           WIDTH-IN-CELLS,
           TRANSPARENT,
           TITLE "Riaggiornamento progressivi di magazzino in corso...",
           .
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:azzmag, INIT:azzmag, BeforeDeclarative>
      ***---
      ...
      * <TOTEM:EPT. INIT:azzmag, INIT:azzmag, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-tparamge.
      * <TOTEM:EPT. INIT:azzmag, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           ...
           END-IF
      * <TOTEM:EPT. INIT:azzmag, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-multigest.
      * <TOTEM:EPT. INIT:azzmag, FD:multigest, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O multigest
           ...
           IF NOT Valid-STATUS-multigest
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:azzmag, FD:multigest, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-tparamge.
      * <TOTEM:EPT. INIT:azzmag, FD:tparamge, BeforeClose>
      * <TOTEM:END>
           CLOSE tparamge
           .

       CLOSE-multigest.
      * <TOTEM:EPT. INIT:azzmag, FD:multigest, BeforeClose>
      * <TOTEM:END>
           .
      ...
      * <TOTEM:EPT. FORM:Screen1, FORM:Screen1, BeforeAccept>
           ...
           call  "azzmag-p" using agmag-linkage.
           cancel"azzmag-p".
