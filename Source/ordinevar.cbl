      *{TOTEM}PRG-COMMENT
      * ordinevar.Cbl
      * ordinevar.Cbl is generated by TOTEM
      ...
      *{TOTEM}PRGID
       ...
       AUTHOR.              andre.
       DATE-WRITTEN.        martedì 7 settembre 2021 12:34:01.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:ordinevar, INIT:ordinevar, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       77 como-x8          PIC  x(8).
       77 colore           PIC  9(5).
       77 como-x10         PIC  x(10).
       77 BitmapNumEvasioni            PIC  9.
       77 como-x           PIC  x.
       77 save-tor-numero  PIC  9(8).
       01 FILLER           PIC  9
                  VALUE IS 0.
       ...
       01 FILLER           PIC  9.
           88 GeneraSaldo VALUE IS 1    WHEN SET TO FALSE  0. 
       01 FILLER           PIC  9.
       ...
       78 TITOLO VALUE IS "Geslux - Variazione Ordini MASTER". 
       01 gruppo-hidden.
           05 HiddenKey.
           ...
           05 hid-prz-promo    PIC  9.
               88 hid-si-prz-promo VALUE IS 1. 
               88 hid-no-prz-promo VALUE IS 0. 
       ...
       77 AUTO-ID          PIC  9(6)
                  VALUE IS 0,00.
       77 SaveTaglio       PIC  9(6).
       01 FILLER           PIC  9.
           88 PrimoTaglio VALUE IS 1    WHEN SET TO FALSE  0. 
       01 tab-iva.
       ...
       77 path-check-mrordini          PIC  X(256)
                  VALUE IS spaces.
       77 STATUS-check-mrordini        PIC  X(2).
           88 Valid-STATUS-check-mrordini VALUE IS "00" THRU "09". 
       ...
       77 path-tmp-mrordini-ini        PIC  X(256).
       77 path-tmp-mrordini-end        PIC  X(256).
       77 STATUS-tmp-mrordini2         PIC  X(2).
           88 VALID-STATUS-tmp-mrordini2 VALUE IS "00" THRU "09". 
       77 STATUS-tmp-mrordini1         PIC  X(2).
           88 VALID-STATUS-tmp-mrordini1 VALUE IS "00" THRU "09". 
       77 STATUS-reltor    PIC  X(2).
           88 Valid-STATUS-reltor VALUE IS "00" THRU "09". 
       77 doc-coll-bmp     PIC  S9(9)
                  USAGE IS COMP-4
                  VALUE IS 0.
       77 path-tmp-mtordini-zoom       PIC  X(256).
       77 STATUS-tmp-mtordini-zoom     PIC  X(2).
           88 Valid-STATUS-tmp-mtordini-zoom VALUE IS "00" THRU "09". 
       77 evasioni-bmp     PIC  S9(9)
                  USAGE IS COMP-4
                  VALUE IS 0.
       77 mod-evasioni     PIC  9
                  VALUE IS 0.
       77 lab-stato-ordine-buf         PIC  X(50).
       ...
       01 .
           03 mto-stato-Item.
               05      PIC  X(10).
           78 mto-stato-Num VALUE IS 1. 
           03 mto-stato REDEFINES mto-stato-Item  PIC  X(10)
                      OCCURS 1 TIMES
                      INDEXED  mto-stato-Idx.
       ...
       77 lab-chiusura-buf PIC  X(50).
       77 mto-tenere-saldi PIC  9
                  VALUE IS 0.
      ...
      * CHECK BOX
       10
           ...
           BEFORE PROCEDURE chk-evas-tot-BeforeProcedure, 
            .
      ...
      * LABEL
       10
           ...
           SIZE 60,00 ,
           COLOR IS 5,
           FONT IS Impact16B-Occidentale,
           ID IS 41,
           HEIGHT-IN-CELLS,
           WIDTH-IN-CELLS,
           CENTER,
           TRANSPARENT,
           TITLE lab-stato-ordine-buf,
           .
      ...
      * PUSH BUTTON
       10
           ...
           ID IS 3000,
           SELF-ACT,
           TITLE "Visualizza evasioni/bolle collegate",
           VISIBLE v-evasioni,
           BITMAP-NUMBER=NumBitmapDocColl
           AFTER PROCEDURE pb-colleg-AfterProcedure, 
           BEFORE PROCEDURE pb-colleg-BeforeProcedure, 
           .
      ...
      * PUSH BUTTON
       10
           ...
           SELF-ACT,
           VISIBLE 0,
           AFTER PROCEDURE pb-recupero-AfterProcedure, 
           BEFORE PROCEDURE pb-recupero-BeforeProcedure, 
           .
      ...
      * LABEL
       10
           ...
           LINES 1,31 ,
           SIZE 8,00 ,
           COLOR IS 78-colore-in-lavorazione,
           FONT IS Verdana10B-Occidentale,
           ID IS 82,
           HEIGHT-IN-CELLS,
           WIDTH-IN-CELLS,
      ...
      * PUSH BUTTON
       05
           ...
           LINES 29,00 ,
           SIZE 73,00 ,
           BITMAP-HANDLE EVASIONI-BMP,
           UNFRAMED,
           SQUARE,
           ENABLED mod-evasioni,
           EXCEPTION-VALUE 1000,
           FLAT,
           FONT IS Small-Font,
           ID IS 121,
           SELF-ACT,
           BITMAP-NUMBER=BitmapNumEvasioni
           AFTER PROCEDURE pb-evasioni-AfterProcedure, 
           BEFORE PROCEDURE pb-evasioni-BeforeProcedure, 
           .
      ...
      * LABEL
       05
           ...
           WIDTH-IN-CELLS,
           TRANSPARENT,
           TITLE "CONSIGLIATO RECUPERO PREZZI",
           VISIBLE v-recupero,
           .
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:ordinevar, INIT:ordinevar, BeforeDeclarative>
      ...
      * <TOTEM:EPT. INIT:ordinevar, INIT:ordinevar, BeforeDestroyResource>
      * <TOTEM:END>
           DESTROY Impact16B-Occidentale
           DESTROY Verdana10B-Occidentale
           CALL "w$bitmap" USING WBITMAP-DESTROY, DOC-COLL-BMP
           CALL "w$bitmap" USING WBITMAP-DESTROY, RECUPERO-BMP
           CALL "w$bitmap" USING WBITMAP-DESTROY, 
           STRIP_GRID_GCLIENTI-BMP
           CALL "w$bitmap" USING WBITMAP-DESTROY, EVASIONI-BMP
      ...
      * Verdana10B-Occidentale
       ...
       INIT-BMP.
      * pb-colleg
           COPY RESOURCE "DOC-COLL.BMP".
           CALL "w$bitmap" USING WBITMAP-LOAD "DOC-COLL.BMP", 
                   GIVING DOC-COLL-BMP.
      * pb-recupero-EX
           COPY RESOURCE "RECUPERO.BMP".
           CALL "w$bitmap" USING WBITMAP-LOAD "RECUPERO.BMP", 
                   GIVING RECUPERO-BMP.
      * pb-grid-elimina
      ...
      * pb-evasioni
           COPY RESOURCE "EVASIONI.BMP".
           CALL "w$bitmap" USING WBITMAP-LOAD "EVASIONI.BMP", 
                   GIVING EVASIONI-BMP.
      * TOOL-ESCI
      ...
      *    After Open
       ...
       OPEN-mtordini.
      * <TOTEM:EPT. INIT:ordinevar, FD:mtordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O mtordini
           ...
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:mtordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-agenti.
      * <TOTEM:EPT. INIT:ordinevar, FD:agenti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT agenti
           IF NOT Valid-STATUS-agenti
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:agenti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tvettori.
      * <TOTEM:EPT. INIT:ordinevar, FD:tvettori, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tvettori
           IF NOT Valid-STATUS-tvettori
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:tvettori, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tivaese.
      * <TOTEM:EPT. INIT:ordinevar, FD:tivaese, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tivaese
           IF NOT Valid-STATUS-tivaese
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:tivaese, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-clienti.
      * <TOTEM:EPT. INIT:ordinevar, FD:clienti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT clienti
           IF NOT Valid-STATUS-clienti
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:clienti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-destini.
      * <TOTEM:EPT. INIT:ordinevar, FD:destini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT destini
           IF NOT Valid-STATUS-destini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:destini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-articoli.
      * <TOTEM:EPT. INIT:ordinevar, FD:articoli, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT articoli
           IF NOT Valid-STATUS-articoli
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:articoli, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-note.
      * <TOTEM:EPT. INIT:ordinevar, FD:note, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT note
           IF NOT Valid-STATUS-note
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:note, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tcodpag.
      * <TOTEM:EPT. INIT:ordinevar, FD:tcodpag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcodpag
           IF NOT Valid-STATUS-tcodpag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:tcodpag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmagaz.
      * <TOTEM:EPT. INIT:ordinevar, FD:tmagaz, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tmagaz
           IF NOT Valid-STATUS-tmagaz
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:tmagaz, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-progmag.
      * <TOTEM:EPT. INIT:ordinevar, FD:progmag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT progmag
           IF NOT Valid-STATUS-progmag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:progmag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-timposte.
      * <TOTEM:EPT. INIT:ordinevar, FD:timposte, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT timposte
           IF NOT Valid-STATUS-timposte
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:timposte, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmarche.
      * <TOTEM:EPT. INIT:ordinevar, FD:tmarche, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tmarche
           IF NOT Valid-STATUS-tmarche
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:tmarche, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmp-assorcli.
      * <TOTEM:EPT. INIT:ordinevar, FD:tmp-assorcli, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-tmp-assorcli
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:tmp-assorcli, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tcaumag.
      * <TOTEM:EPT. INIT:ordinevar, FD:tcaumag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcaumag
           IF NOT Valid-STATUS-tcaumag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:tcaumag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-timbalqta.
      * <TOTEM:EPT. INIT:ordinevar, FD:timbalqta, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-timbalqta
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:timbalqta, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-timballi.
      * <TOTEM:EPT. INIT:ordinevar, FD:timballi, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT timballi
           IF NOT Valid-STATUS-timballi
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:timballi, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-recapiti.
      * <TOTEM:EPT. INIT:ordinevar, FD:recapiti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT recapiti
           IF NOT Valid-STATUS-recapiti
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:recapiti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tparamge.
      * <TOTEM:EPT. INIT:ordinevar, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           IF NOT Valid-STATUS-tparamge
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-ttipocli.
      * <TOTEM:EPT. INIT:ordinevar, FD:ttipocli, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT ttipocli
           IF NOT Valid-STATUS-ttipocli
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:ttipocli, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmp-progmag-zoom.
      * <TOTEM:EPT. INIT:ordinevar, FD:tmp-progmag-zoom, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-tmp-progmag-zoom
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:tmp-progmag-zoom, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tpromo.
      * <TOTEM:EPT. INIT:ordinevar, FD:tpromo, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O tpromo
           IF STATUS-tpromo = "35"
              OPEN OUTPUT tpromo
           ...
           IF NOT Valid-STATUS-tpromo
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:tpromo, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-lineseq.
      * <TOTEM:EPT. INIT:ordinevar, FD:lineseq, BeforeOpen>
      * <TOTEM:END>
           OPEN  OUTPUT lineseq
           IF NOT Valid-STATUS-lineseq
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:lineseq, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-lineseq1.
      * <TOTEM:EPT. INIT:ordinevar, FD:lineseq1, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT VALID-STATUS-lineseq1
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:lineseq1, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-logfile.
      * <TOTEM:EPT. INIT:ordinevar, FD:logfile, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O logfile
           ...
           IF NOT Valid-STATUS-logfile
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:logfile, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-lisagente.
      * <TOTEM:EPT. INIT:ordinevar, FD:lisagente, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-lisagente
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:lisagente, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-mrordini.
      * <TOTEM:EPT. INIT:ordinevar, FD:mrordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O mrordini
           ...
           IF NOT Valid-STATUS-mrordini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:mrordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-zoom-tcaumag.
      * <TOTEM:EPT. INIT:ordinevar, FD:zoom-tcaumag, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-zoom-tcaumag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:zoom-tcaumag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tpiombo.
      * <TOTEM:EPT. INIT:ordinevar, FD:tpiombo, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tpiombo
           IF NOT Valid-STATUS-tpiombo
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:tpiombo, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-blister.
      * <TOTEM:EPT. INIT:ordinevar, FD:blister, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT blister
           IF NOT Valid-STATUS-blister
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:blister, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-rordini.
      * <TOTEM:EPT. INIT:ordinevar, FD:rordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT rordini
           IF NOT Valid-STATUS-rordini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:rordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tordini.
      * <TOTEM:EPT. INIT:ordinevar, FD:tordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tordini
           IF NOT Valid-STATUS-tordini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:tordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-zoom-tor-master.
      * <TOTEM:EPT. INIT:ordinevar, FD:zoom-tor-master, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-zoom-tor-master
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:zoom-tor-master, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tescons.
      * <TOTEM:EPT. INIT:ordinevar, FD:tescons, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tescons
           IF NOT Valid-STATUS-tescons
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:tescons, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-rmovmag.
      * <TOTEM:EPT. INIT:ordinevar, FD:rmovmag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT rmovmag
           IF NOT Valid-STATUS-rmovmag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:rmovmag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-listini.
      * <TOTEM:EPT. INIT:ordinevar, FD:listini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT listini
           IF NOT Valid-STATUS-listini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:listini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-locali.
      * <TOTEM:EPT. INIT:ordinevar, FD:locali, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT locali
           IF NOT Valid-STATUS-locali
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:locali, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-rpromo.
      * <TOTEM:EPT. INIT:ordinevar, FD:rpromo, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O rpromo
           IF STATUS-rpromo = "35"
              OPEN OUTPUT rpromo
           ...
           IF NOT Valid-STATUS-rpromo
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:rpromo, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmp-promo-prz.
      * <TOTEM:EPT. INIT:ordinevar, FD:tmp-promo-prz, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-tmp-promo-prz
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:tmp-promo-prz, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-sitfin.
      * <TOTEM:EPT. INIT:ordinevar, FD:sitfin, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT sitfin
           IF NOT Valid-STATUS-sitfin
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:sitfin, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tagli.
      * <TOTEM:EPT. INIT:ordinevar, FD:tagli, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O tagli
           IF STATUS-tagli = "35"
              OPEN OUTPUT tagli
           ...
           IF NOT Valid-STATUS-tagli
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:tagli, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tscorte.
      * <TOTEM:EPT. INIT:ordinevar, FD:tscorte, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tscorte
           IF NOT Valid-STATUS-tscorte
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:tscorte, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-USER.
      * <TOTEM:EPT. INIT:ordinevar, FD:USER, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT USER
           IF NOT Valid-STATUS-USER
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:USER, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-param.
      * <TOTEM:EPT. INIT:ordinevar, FD:param, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT param
           IF NOT Valid-STATUS-param
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:param, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-cli-prg.
      * <TOTEM:EPT. INIT:ordinevar, FD:cli-prg, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT cli-prg
           IF NOT Valid-STATUS-cli-prg
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:cli-prg, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-pagbloc.
      * <TOTEM:EPT. INIT:ordinevar, FD:pagbloc, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT pagbloc
           IF NOT Valid-STATUS-pagbloc
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:pagbloc, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tsetinvio.
      * <TOTEM:EPT. INIT:ordinevar, FD:tsetinvio, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O tsetinvio
           ...
           IF NOT Valid-STATUS-tsetinvio
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:tsetinvio, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tordforn.
      * <TOTEM:EPT. INIT:ordinevar, FD:tordforn, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tordforn
           IF NOT Valid-STATUS-tordforn
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:tordforn, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-rordforn.
      * <TOTEM:EPT. INIT:ordinevar, FD:rordforn, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT rordforn
           IF NOT Valid-STATUS-rordforn
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:rordforn, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tcontat.
      * <TOTEM:EPT. INIT:ordinevar, FD:tcontat, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcontat
           IF NOT Valid-STATUS-tcontat
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:tcontat, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tnazioni.
      * <TOTEM:EPT. INIT:ordinevar, FD:tnazioni, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tnazioni
           IF NOT Valid-STATUS-tnazioni
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:tnazioni, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-grade.
      * <TOTEM:EPT. INIT:ordinevar, FD:grade, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT grade
           IF NOT Valid-STATUS-grade
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ordinevar, FD:grade, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-mtordini.
      * <TOTEM:EPT. INIT:ordinevar, FD:mtordini, BeforeClose>
      * <TOTEM:END>
           CLOSE mtordini
           .

       CLOSE-agenti.
      * <TOTEM:EPT. INIT:ordinevar, FD:agenti, BeforeClose>
      * <TOTEM:END>
           CLOSE agenti
           .

       CLOSE-tvettori.
      * <TOTEM:EPT. INIT:ordinevar, FD:tvettori, BeforeClose>
      * <TOTEM:END>
           CLOSE tvettori
           .

       CLOSE-tivaese.
      * <TOTEM:EPT. INIT:ordinevar, FD:tivaese, BeforeClose>
      * <TOTEM:END>
           CLOSE tivaese
           .

       CLOSE-clienti.
      * <TOTEM:EPT. INIT:ordinevar, FD:clienti, BeforeClose>
      * <TOTEM:END>
           CLOSE clienti
           .

       CLOSE-destini.
      * <TOTEM:EPT. INIT:ordinevar, FD:destini, BeforeClose>
      * <TOTEM:END>
           CLOSE destini
           .

       CLOSE-articoli.
      * <TOTEM:EPT. INIT:ordinevar, FD:articoli, BeforeClose>
      * <TOTEM:END>
           CLOSE articoli
           .

       CLOSE-note.
      * <TOTEM:EPT. INIT:ordinevar, FD:note, BeforeClose>
      * <TOTEM:END>
           CLOSE note
           .

       CLOSE-tcodpag.
      * <TOTEM:EPT. INIT:ordinevar, FD:tcodpag, BeforeClose>
      * <TOTEM:END>
           CLOSE tcodpag
           .

       CLOSE-tmagaz.
      * <TOTEM:EPT. INIT:ordinevar, FD:tmagaz, BeforeClose>
      * <TOTEM:END>
           CLOSE tmagaz
           .

       CLOSE-progmag.
      * <TOTEM:EPT. INIT:ordinevar, FD:progmag, BeforeClose>
      * <TOTEM:END>
           CLOSE progmag
           .

       CLOSE-timposte.
      * <TOTEM:EPT. INIT:ordinevar, FD:timposte, BeforeClose>
      * <TOTEM:END>
           CLOSE timposte
           .

       CLOSE-tmarche.
      * <TOTEM:EPT. INIT:ordinevar, FD:tmarche, BeforeClose>
      * <TOTEM:END>
           CLOSE tmarche
           .

       CLOSE-tmp-assorcli.
      * <TOTEM:EPT. INIT:ordinevar, FD:tmp-assorcli, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-tcaumag.
      * <TOTEM:EPT. INIT:ordinevar, FD:tcaumag, BeforeClose>
      * <TOTEM:END>
           CLOSE tcaumag
           .

       CLOSE-timbalqta.
      * <TOTEM:EPT. INIT:ordinevar, FD:timbalqta, BeforeClose>
      * <TOTEM:END>
           CLOSE timbalqta
           .

       CLOSE-timballi.
      * <TOTEM:EPT. INIT:ordinevar, FD:timballi, BeforeClose>
      * <TOTEM:END>
           CLOSE timballi
           .

       CLOSE-recapiti.
      * <TOTEM:EPT. INIT:ordinevar, FD:recapiti, BeforeClose>
      * <TOTEM:END>
           CLOSE recapiti
           .

       CLOSE-tparamge.
      * <TOTEM:EPT. INIT:ordinevar, FD:tparamge, BeforeClose>
      * <TOTEM:END>
           CLOSE tparamge
           .

       CLOSE-ttipocli.
      * <TOTEM:EPT. INIT:ordinevar, FD:ttipocli, BeforeClose>
      * <TOTEM:END>
           CLOSE ttipocli
           .

       CLOSE-tmp-progmag-zoom.
      * <TOTEM:EPT. INIT:ordinevar, FD:tmp-progmag-zoom, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-tpromo.
      * <TOTEM:EPT. INIT:ordinevar, FD:tpromo, BeforeClose>
      * <TOTEM:END>
           CLOSE tpromo
           .

       CLOSE-lineseq.
      * <TOTEM:EPT. INIT:ordinevar, FD:lineseq, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-lineseq1.
      * <TOTEM:EPT. INIT:ordinevar, FD:lineseq1, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-logfile.
      * <TOTEM:EPT. INIT:ordinevar, FD:logfile, BeforeClose>
      * <TOTEM:END>
           CLOSE logfile
           .

       CLOSE-lisagente.
      * <TOTEM:EPT. INIT:ordinevar, FD:lisagente, BeforeClose>
      * <TOTEM:END>
           CLOSE lisagente
           .

       CLOSE-mrordini.
      * <TOTEM:EPT. INIT:ordinevar, FD:mrordini, BeforeClose>
      * <TOTEM:END>
           CLOSE mrordini
           .

       CLOSE-zoom-tcaumag.
      * <TOTEM:EPT. INIT:ordinevar, FD:zoom-tcaumag, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-tpiombo.
      * <TOTEM:EPT. INIT:ordinevar, FD:tpiombo, BeforeClose>
      * <TOTEM:END>
           CLOSE tpiombo
           .

       CLOSE-blister.
      * <TOTEM:EPT. INIT:ordinevar, FD:blister, BeforeClose>
      * <TOTEM:END>
           CLOSE blister
           .

       CLOSE-rordini.
      * <TOTEM:EPT. INIT:ordinevar, FD:rordini, BeforeClose>
      * <TOTEM:END>
           CLOSE rordini
           .

       CLOSE-tordini.
      * <TOTEM:EPT. INIT:ordinevar, FD:tordini, BeforeClose>
      * <TOTEM:END>
           CLOSE tordini
           .

       CLOSE-zoom-tor-master.
      * <TOTEM:EPT. INIT:ordinevar, FD:zoom-tor-master, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-tescons.
      * <TOTEM:EPT. INIT:ordinevar, FD:tescons, BeforeClose>
      * <TOTEM:END>
           CLOSE tescons
           .

       CLOSE-rmovmag.
      * <TOTEM:EPT. INIT:ordinevar, FD:rmovmag, BeforeClose>
      * <TOTEM:END>
           CLOSE rmovmag
           .

       CLOSE-listini.
      * <TOTEM:EPT. INIT:ordinevar, FD:listini, BeforeClose>
      * <TOTEM:END>
           CLOSE listini
           .

       CLOSE-locali.
      * <TOTEM:EPT. INIT:ordinevar, FD:locali, BeforeClose>
      * <TOTEM:END>
           CLOSE locali
           .

       CLOSE-rpromo.
      * <TOTEM:EPT. INIT:ordinevar, FD:rpromo, BeforeClose>
      * <TOTEM:END>
           CLOSE rpromo
           .

       CLOSE-tmp-promo-prz.
      * <TOTEM:EPT. INIT:ordinevar, FD:tmp-promo-prz, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-sitfin.
      * <TOTEM:EPT. INIT:ordinevar, FD:sitfin, BeforeClose>
      * <TOTEM:END>
           CLOSE sitfin
           .

       CLOSE-tagli.
      * <TOTEM:EPT. INIT:ordinevar, FD:tagli, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-tscorte.
      * <TOTEM:EPT. INIT:ordinevar, FD:tscorte, BeforeClose>
      * <TOTEM:END>
           CLOSE tscorte
           .

       CLOSE-USER.
      * <TOTEM:EPT. INIT:ordinevar, FD:USER, BeforeClose>
      * <TOTEM:END>
           CLOSE USER
           .

       CLOSE-param.
      * <TOTEM:EPT. INIT:ordinevar, FD:param, BeforeClose>
      * <TOTEM:END>
           CLOSE param
           .

       CLOSE-cli-prg.
      * <TOTEM:EPT. INIT:ordinevar, FD:cli-prg, BeforeClose>
      * <TOTEM:END>
           CLOSE cli-prg
           .

       CLOSE-pagbloc.
      * <TOTEM:EPT. INIT:ordinevar, FD:pagbloc, BeforeClose>
      * <TOTEM:END>
           CLOSE pagbloc
           .

       CLOSE-tsetinvio.
      * <TOTEM:EPT. INIT:ordinevar, FD:tsetinvio, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-tordforn.
      * <TOTEM:EPT. INIT:ordinevar, FD:tordforn, BeforeClose>
      * <TOTEM:END>
           CLOSE tordforn
           .

       CLOSE-rordforn.
      * <TOTEM:EPT. INIT:ordinevar, FD:rordforn, BeforeClose>
      * <TOTEM:END>
           CLOSE rordforn
           .

       CLOSE-tcontat.
      * <TOTEM:EPT. INIT:ordinevar, FD:tcontat, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-tnazioni.
      * <TOTEM:EPT. INIT:ordinevar, FD:tnazioni, BeforeClose>
      * <TOTEM:END>
           CLOSE tnazioni
           .

       CLOSE-grade.
      * <TOTEM:EPT. INIT:ordinevar, FD:grade, BeforeClose>
      * <TOTEM:END>
           CLOSE grade
           .
...
PATCH**    file mrordini se non mi serve per scriverlo
...
PATCH           close      mrordini
PATCH           open input mrordini
PATCH      end-evaluate.
      ...
      *****        set ArticoloSetFocus to false
           ...
           call   "check-prog-master" using mto-chiave, "I".
           accept versione-evasione from environment "VERSIONE_EVASIONE"

           if PgmChiamante = "del-master"
              perform MODIFICA
              if tutto-ok
                 perform CANCELLA
              end-if
      ...
      * <TOTEM:EPT. FORM:Form1, FORM:Form1, AfterAccept>
           ...
           if CallDettaglio
              ...
              if LinkPgm not = "gordcvar"
                 ...
                 inspect path-zoom-tor-master 
                         replacing trailing spaces by low-value
                 accept como-data from century-date
                 accept como-ora  from time
                 inquire form1-gd-1(store-riga, 2),   cell-data in 
           art-codice
                 inquire form1-gd-1(store-riga, 2), hidden-data in 
           hid-progr
                 move art-codice to numero-x
                 ...
                 move mto-chiave to ror-chiave-ordine
           ...
           mro-chiave-testa or
                             ror-progr-master        not = hid-progr
                             exit perform
                          end-if
                          if ror-cod-articolo = art-codice
                             set trovato to true
                             move ror-anno       to tor-anno
                             move ror-num-ordine to tor-numero
                             read tordini no lock invalid continue 
           end-read
                             move tor-chiave to ztm-chiave

                             move tor-data-ordine(7:2) to ztm-data(1:2)
                             move "/"                  to ztm-data(3:1)
                             move tor-data-ordine(5:2) to ztm-data(4:2)
                             move "/"                  to ztm-data(6:1)
                             move tor-data-ordine(1:4) to ztm-data(7:4)

                             move tor-data-bolla(7:2) to ztm-data-b(1:2)
                             move "/"                 to ztm-data-b(3:1)
                             move tor-data-bolla(5:2) to ztm-data-b(4:2)
                             move "/"                 to ztm-data-b(6:1)
                             move tor-data-bolla(1:4) to ztm-data-b(7:4)
                       
                             move tor-num-bolla to ztm-num-b  

                             move tor-data-fattura(7:2) to 
           ztm-data-f(1:2)
                             move "/"                   to 
           ztm-data-f(3:1)
                             move tor-data-fattura(5:2) to 
           ztm-data-f(4:2)
                             move "/"                   to 
           ztm-data-f(6:1)
                             move tor-data-fattura(1:4) to 
           ztm-data-f(7:4)

                             move tor-num-fattura to ztm-num-f

                             move tor-vettore to vet-codice
                             read tvettori no lock 
                                  invalid move spaces to vet-descrizione
                             end-read
                             move vet-descrizione to ztm-vettore
                             
                             if tor-esito-consegna = space
                                move "Senza Esito"   to tec-descrizione
                             else
                                move tor-esito-consegna to tec-codice
                                read tescons
                                     invalid move "Esito non codificato"
                                               to tec-descrizione
                                end-read
                             end-if
                             move tec-descrizione to ztm-esito
                             move ror-qta         to ztm-qta-e
              ...
              if trovato
                 ...
                 move "zoom-tor-master-b"   to como-file
                 ...
                 if stato-zoom = 0
                    ...
                    if tutto-ok
                       ...
                       move ztm-anno         to LinkAnno  
                       move ztm-numero       to LinkNumero
                       move "ordinevar"      to LinkPgm
                       set RicaricaGrid      to false
                       move mto-chiave       to LinkOrdine
                       ...
                       perform AGGIORNA-GRID-EVASA
                       if path-zoom-tor-master not = spaces
                          delete file zoom-tor-master
                          move spaces to path-zoom-tor-master
                       end-if
      ...
      * <TOTEM:EPT. FORM:Form1, FORM:Form1, AfterBufToFld>
           ...
           move stato           to mto-stato-attivazione save-stato.
      *                                              
      ...
      *
           ...
           accept como-ora from time.
           move data-oggi  to mto-data-ultima-modifica.
           move como-ora   to mto-ora-ultima-modifica.
           move user-codi  to mto-utente-ultima-modifica.
      ...
      * <TOTEM:EPT. FORM:Form1, FORM:Form1, AfterFldToBuf>
           ...
           inspect hid-des-imballo replacing trailing low-value 
                                             by spaces.
           move mto-stato-attivazione to stato.
           ...
           if mto-chiuso or mto-chiuso-man
              move 0 to mod-evasioni
              move 3 to BitmapNumEvasioni
           else
              if mod = 0           and
                 livello-abil >= 2
                 move 1 to mod-evasioni
                 move 1 to BitmapNumEvasioni
              else
                 move 0 to mod-evasioni
                 move 3 to BitmapNumEvasioni
              end-if
      ...
      *
           ...
           move mto-data-passaggio-ordine to como-data.
           perform DATE-TO-SCREEN.
      ...
      ***     if mto-dt-consegna = zero

      ***        move space  to lbl-dt-cons-buf
      ***     else
      ***        move mto-dt-consegna(7:2)  to lbl-dt-cons-buf(1:2)
      ***        move "/"                   to lbl-dt-cons-buf(3:1)
      ***        move mto-dt-consegna(5:2)  to lbl-dt-cons-buf(4:2)
      ***        move "/"                   to lbl-dt-cons-buf(6:1)
      ***        move mto-dt-consegna(1:4)  to lbl-dt-cons-buf(7:4)
      ***     end-if
      ...
      * <TOTEM:END>
       ...
       Form1-CONTROLLO-OLD.
           ...
           perform Form1-BUF-TO-FLD.
           move 0 to scelta.
           if mto-causale not = old-mto-causale
              and SiSalvato
           ...
           if mto-prg-destino not = old-mto-prg-destino
              and SiSalvato
              set NoSalvato to true
           ...
           if mto-urgente not = old-mto-urgente
              and SiSalvato
              set NoSalvato to true
              |78-ID-chk-urgente è l'ID del campo chk-urgente
              move 78-ID-chk-urgente to store-id 
           end-if
      ...
      * <TOTEM:PARA. ABILITA-DISABILITA-CLIENTE-DESTINO>
           move 0 to mod-cliente-destino mod-destino.
           if mod = 0
      ...
      * <TOTEM:END>
       ...
       AGGIORNA-DATI-TESTATA.
      * <TOTEM:PARA. AGGIORNA-DATI-TESTATA>
           close    tordini.
           open i-o tordini.
           move low-value  to ror-rec.
           move mto-chiave to ror-chiave-ordine-testa.
           start rordini key >= ror-k-master
                 invalid continue
             not invalid
                 perform until 1 = 2
                    ...
                    if ror-chiave-ordine-testa not = mto-chiave
                       exit perform
                    end-if
                    ...
                    if tor-data-fattura = 0
                       perform AGGIORNA-TESTA
                    end-if

                    if tor-data-bolla = 0
                       perform AGGIORNA-STATO
                    end-if
      ...
      ***---
       AGGIORNA-TESTA.
           ...
           perform until 1 = 2
              set RecLocked to false
              read tordini lock key tor-chiave
                   invalid continue 
              end-read
              if not RecLocked
                 exit perform
      ...
      ***---
       AGGIORNA-STATO.
           ...
           if tutto-ok
              call   "trova-stato" using tor-chiave, tor-stato
              cancel "trova-stato"
              rewrite tor-rec
              rewrite tor-rec invalid continue end-rewrite
              unlock tordini all records
      ...
      * <TOTEM:END>
       ...
       AGGIORNA-GRID-EVASA.
      * <TOTEM:PARA. AGGIORNA-GRID-EVASA>
           ...
           perform varying store-riga from 2 by 1 
              ...
              inquire form1-gd-1(store-riga, 2), 
                      hidden-data in mro-progr
              read mrordini no lock key mro-k-progr
              move mro-qta-e to col-qta-e
              modify form1-gd-1(store-riga, 5), cell-data  col-qta-e
           end-perform 
           .
      * <TOTEM:END>

       AGGIORNA-PREZZI-EVASIONI.
      * <TOTEM:PARA. AGGIORNA-PREZZI-EVASIONI>
           close    rordini.
           open i-o rordini.
           move low-value        to ror-rec.
           ...
           start rordini key >= ror-k-master
                 invalid continue
             not invalid
                 move 0 to save-tor-numero
                 perform until 1 = 2
                    read rordini next no lock 
                         at end  exit perform
                    end-read
                    if ror-chiave-ordine-testa not = mro-chiave-testa
                       exit perform
                    end-if

                    if ror-progr-master = mro-progr
      *****                 if ror-prz-unitario not = mro-prz-unitario
                          move ror-anno         to tor-anno
                          move ror-num-ordine   to tor-numero
                          read tordini no lock key tor-chiave
                          if tor-data-fattura = 0 and
                             tor-num-fattura  = 0
                             perform AGGIORNA-PREZZO
                          end-if
      *****                 end-if
                    end-if
                 end-perform
      ...
      ***---
       AGGIORNA-PREZZO.
           ...
           if tutto-ok
              ...
              read    rordini no lock key ror-k-master
           end-if  
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. CANCELLA>
           if mto-registrato
              if PgmChiamante not = "del-master"
              ...
              display message box "Impossibile cancellare ordine già lav
      -    "orato"
                        title titolo
                      default mb-no
           ...
           if scelta = mb-yes     
              ...
              perform varying riga from 2 by 1 
                 ...
                 inquire form1-gd-1(riga, 2), cell-data 
           mro-prg-cod-articolo
                 inquire form1-gd-1(riga, 4), cell-data mro-qta
...
PATCH               commit transaction
                    delete mtordini  record Invalid continue end-delete
                    perform CANCELLA-PROMO-FITTIZIA
                    move 0 to mod
                    initialize mto-rec
                           old-mto-rec replacing numeric data by zeroes
                                            alphanumeric data by spaces
                    if PgmChiamante not = "del-master"
                       display message "Cancellazione avenuta con succes
      -    "so!"
                                 title titolo
                    end-if
                 ...
                 move mto-rec to old-mto-rec 
                 move 0 to mod
                 modify tool-modifica, value mod
                 perform MODIFICA
                 display message "Si sta cercando di eliminare merce già
      -    " ordinata al fornitore."
...
PATCH      move low-value  to mro-chiave
PATCH      move mto-anno   to mro-anno
PATCH      move mto-numero to mro-numero
PATCH      start mrordini key >= mro-chiave
PATCH            invalid continue
PATCH        not invalid
PATCH            perform until 1 = 2
PATCH               read mrordini next no lock 
PATCH                    at end exit perform 
PATCH               end-read
PATCH               if mro-chiave-testa not = mto-chiave
PATCH                  exit perform
PATCH               end-if
PATCH               if mro-cancellato
PATCH                  delete mrordini record
PATCH                         invalid continue
PATCH                  end-delete
PATCH               end-if
PATCH            end-perform
PATCH      end-start 
      ...
      * <TOTEM:END>
       ...
       CAUSALE-CHIUSURA.
      * <TOTEM:PARA. CAUSALE-CHIUSURA>
           evaluate true
           when mto-causale-blocco-manuale move "MANUALE" to 
           lab-chiusura-buf
           when mto-causale-blocco-prezzo  move "PREZZO"  to 
           lab-chiusura-buf
           when mto-causale-blocco-fido    move "FIDO"    to 
           lab-chiusura-buf
           when other                      move spaces    to 
           lab-chiusura-buf
           end-evaluate.
           display lab-chiusura 
           .
      * <TOTEM:END>
      ...
      * <TOTEM:END>
       ...
       CONTROLLA-ORDINATO-RIGHE.
      * <TOTEM:PARA. CONTROLLA-ORDINATO-RIGHE>
           set OkCancella to true.
           perform varying riga from 2 by 1 
                     until riga > tot-righe
      ...
      *     perform RIEMPI-CHIAVE.
           ...
           if mod = 1
              read mtordini lock invalid 
                   set errori to true 
              end-read
           else       
              unlock mtordini all records
              read mtordini no lock invalid 
                   set errori to true 
              end-read
           end-if.
...
LUBEXX        move mto-stato-attivazione to save-stato
                    
              if mto-causale = tge-causale-corrisp 
      ...
      *****        end-if
              ...
              move mto-cod-cli     to cli-codice ef-cli-buf 
           save-cli-codice
      ...
      *****           move 0 to v-trad
              ...
              if mto-prg-destino not = 0
                 ...
                 move mto-prg-destino to des-prog ef-des-buf
           ...
           move mto-cod-pagamento to SavePag.
           move mto-cod-ese-iva   to SaveIva.
           move mto-vettore       to SaveVet.

           perform CAUSALE-CHIUSURA.
      ...
      * <TOTEM:PARA. DELETE-RIGHE>
           move 0 to DeletedRows NonDeletedRows.
           ...
           start mrordini key is >= mro-chiave
             ...
             not invalid 
                 perform until 1 = 2
                    read mrordini next no lock at 
                         end exit perform 
                    end-read
                    if mro-chiave-testa not = mto-chiave
                       exit perform
                    end-if
PATCH               if status-mrordini not = "00"
...
PATCH                             exit perform
                       ...
                       if mro-chiuso
                          ...
                          if CancellazioneFisica
                             |Posso cancellare un ordine solamente se evaso = 0
                             move mro-qta to link-valore link-impegnato
                          else
                             perform QTA-IMPEGNATO
                          end-if
       ...
       CARICA-GRID-MANUALE.
           ...
           perform until 1 = 2
              ...
              if mro-chiave-testa not = mto-chiave
                 ...
                 move mro-cod-articolo to old-art-codice
                 exit perform
              end-if
...
BLISTR           end-string
      ...
      *              move mro-qta-imballi to num-blist
      *           end-if
      *           compute hid-bli-qta = mro-qta / num-blist
      *    Luciano fine
              else
                 string  art-descrizione delimited by low-value
                         " - "           delimited by size
              ...
              move mro-des-imballo   to hid-des-imballo
              move mro-qta-imballi   to hid-imballi
      *    Luciano       
              move mro-bli-qta  to hid-bli-qta
      *    Luciano fine
              ...
              move mro-cod-art-cli   to hid-cod-art-cli
              ...
              modify form1-gd-1(store-riga, 5),  cell-data = col-qta-e
              modify form1-gd-1(store-riga, 6),  cell-data = col-uni
              modify form1-gd-1(store-riga, 7),  cell-data = col-tot
              modify form1-gd-1(store-riga, 8),  cell-data = col-cons
      ...
      *****        if SaveGDO = spaces
              ...
              move mro-qta        to hid-old-qta

OMAGGI        move mro-qta-omaggi to hid-qta-omaggi
BLISTR        move mro-blister    to hid-blister
              move mro-evadi-dal  to hid-evadi-dal

BLISTR        move mro-bli-codice to hid-bli-codice
BLISTR        move mro-bli-perce  to hid-bli-perce

LABLAB        move mro-promo      to hid-promo
              if mro-promo not = 0
                 set si-promo to true
              end-if
      *****        move mro-giang      to hid-giang
              move mro-stato      to hid-stato-riga
LABLAB        move mro-prz-commle to hid-prz-commle

              move mro-prg-chiave to HiddenKey

              move "IV"        to tbliv-codice1
              move mro-cod-iva to tbliv-codice2 hid-cod-iva
              read tivaese invalid continue end-read
              move tbliv-percentuale to hid-perce-iva
              move mro-prz-promo     to hid-prz-promo
      ...
      *    Luciano
              move mro-prz-manuale to hid-prz-manuale
      *    Luciano fine
              modify form1-gd-1(store-riga, 1), 
                     hidden-data gruppo-hidden
              |Colonna a parte per evitare rischi che venga 
              |letto e riaggiornato da altre routines
              modify form1-gd-1(store-riga, 2), 
                     hidden-data hid-progr

              compute SavePrezzo = mro-imponib-merce +
                                   mro-imp-cou-cobat +
                                   mro-imp-consumo   +
                                   mro-add-piombo
OMAGGI        compute SavePrezzo = 
OMAGGI                SavePrezzo * ( mro-qta - mro-qta-omaggi )
      ...
      *****       move 78-colore-fatt-tot       to colore
           ...
           modify form1-gd-1(store-riga, 1), 
                  cell-color = colore,
                  cell-font  = Verdana10B-Occidentale 
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. ENTRY-TO-ROW>
           ...
           if NewRow
              ...
              modify form1-gd-1(riga, 1), 
                     cell-color = 78-colore-registrato,
                     cell-font  = Verdana10B-Occidentale
           else
...
BLISTR     move chk-blister-buf   to hid-blister.
      ...
      *    Luciano Fine
           ...
           modify form1-gd-1(riga, 5),  cell-data = col-qta-e.
...
LABLAB        if hid-prz-commle not = mro-prz-unitario
...
LUBEXX        end-if
      ...
      *****        if SaveGdo = spaces
              if tcl-gdo-no
                 move 1 to v-recupero
                 display lab-recupero
              end-if
           end-if.

           if hid-evadi-dal not = old-hid-evadi-dal
              set RigaCambiata to true
           end-if 
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. INVIO-MAIL>
           ...
           when 2
                ...
                string "CANCELLAZIONE PREVENTIVA" delimited size
                       ...
                       mto-chiave                 delimited size
                       " - RIGA: "                delimited size
                       mro-chiave                 delimited size
           ...
           when 5
                call "C$RERR" using extend-stat, 
                                    text-message
                string "CANCELLAZIONE DELETE-RIGHE"      delimited size
                       "(IF STATUS-mrordini NOT = 00...)" delimited size
                       " - TESTATA: "                    delimited size
                       mto-chiave                        delimited size
                       " - RIGA: "                       delimited size
                       mro-chiave                        delimited size
           ...
           move "ordinevar" to NomeProgramma.
           perform 10 times
              perform SEND-MAIL
              open input lineseq1
              read lineseq1 next
      ...
      * <TOTEM:END>
       ...
       LABEL-STATO-ORDINE.
      * <TOTEM:PARA. LABEL-STATO-ORDINE>
           evaluate true
           when mto-registrato     move "REGISTRATO"             to 
           lab-stato-ordine-buf
           when mto-in-lavorazione move "IN LAVORAZIONE"         to 
           lab-stato-ordine-buf
           when mto-sped-parz      move "SPEDITO PARZIALMENTE"   to 
           lab-stato-ordine-buf
           when mto-sped-tot       move "SPEDITO TOTALMENTE"     to 
           lab-stato-ordine-buf
      *****     when mto-fatt-parz      move "FATTURATO PARZIALMENTE" to lab-stato-ordine-buf
      *****     when mto-fatt-tot       move "FATTURATO TOTALMENTE"   to lab-stato-ordine-buf
           when mto-chiuso         move "CHIUSO"                 to 
           lab-stato-ordine-buf
           end-evaluate.
           display lab-stato-ordine 
           .
      * <TOTEM:END>
      ...
      * <TOTEM:END>
       ...
       MAIL-CHIUSURA-MANUALE.
      * <TOTEM:PARA. MAIL-CHIUSURA-MANUALE>
           accept LinkAddressCC 
                 from environment "CHIU_ORD_MASTER_ADDRESSES_CC"
           if LinkAddressCC = space and cli-email = space
              move mb-no  to scelta
           else
              display message 
              "Si desidera inviare la notifica di chiusura?"
                     title titolo
                      icon 2
                      type mb-yes-no
                    giving scelta
      ...
      *    quando rec-grd e rec-not sono valorizzati
           ...
           |inquire form1-gd-1(riga, 7),  cell-data in col-sconto.
           inquire form1-gd-1(riga, 8),  cell-data in col-cons.
...
LUBEXX     read timbalqta no lock invalid continue end-read.
           ...
           move col-qta    to old-col-qta    ef-qta-buf mro-qta.
OMAGGI     move hid-qta-omaggi to ef-qta-oma-buf mro-qta-omaggi.
BLISTR     move hid-blister to chk-blister-buf mro-blister 
           old-hid-blister.
           move hid-evadi-dal to mro-evadi-dal old-hid-evadi-dal 
           como-data.
           perform DATE-TO-SCREEN.
           move como-data to ef-evadi-dal-buf.


LABLAB     move hid-prz-commle to mro-prz-commle.
LABLAB     move hid-promo      to mro-promo.
      *****     move hid-giang      to mro-giang.
           move hid-stato-riga to mro-stato.
...
PATCH       bitmap-number = BitmapNumSave.
      ...
      *****           end-if
              ...
              if errori
                 ...
                 if errori
                    ...
                    move chk-ritira-buf to mto-ritira-in-lubex
      ...
      *****              if CondizioniRecupero or RigaCambiata
      *****                 move mto-data-ordine to tor-data-ordine
      *****                 display message "Sono state fatte modifiche che rendono"
      *****                          X"0d0a""consigliabile il recupero dei prezzi."
      *****                          x"0d0a""Effettuare?"
      *****                           title titolo
      *****                            type mb-yes-no
      *****                          giving scelta
                       ...
                       start mrordini key >= mro-chiave
                         ...
                         not invalid
                             perform until 1 = 2
                                ...
                                if mto-chiuso
                                  |Allineo comunque i prezzi sulle evasioni
                                   perform AGGIORNA-PREZZI-EVASIONI
                                end-if
                             end-perform
                       end-start

                       if mto-prenotazione-qta not = 
           old-mto-prenotazione-qta
                          if chk-prenot-buf = 0
                             perform CANCELLA-PROMO-FITTIZIA
                          else
...
LUBEXX                 move save-stato to mto-stato-attivazione
...
PATCH                  commit transaction
                       ...
                       if old-mto-stato-ordine not = 7 and
                          mto-chiuso-man
                          perform MAIL-CHIUSURA-MANUALE
                          display message "Riportare quantità inevase ne
      -    "i tagli giornalieri?"
                                    title titolo
                                     icon 2
                                     type mb-yes-no
                                  default mb-no
                                   giving scelta
                          if scelta = mb-no
                             set no-tagli to true
                          else
                             set ok-tutto to true
                          end-if
                          perform STORNA-IMPEGNATO-E-TAGLI
                       else
                          if old-mto-chiuso-man            and
                             mto-stato-ordine      not = 7 and
                             mto-stato-attivazione not = "C"
      ...
      *****                                             link-path, "M"
      *****                    cancel "st-ordine"
      *****                    call   "st-ordine-PDF" using mto-chiave, 
      *****                                                 link-path, "M"
...
PATCH *****     move low-value  to mro-chiave.
PATCH *****     move mto-anno   to mro-anno.
PATCH *****     move mto-numero to mro-num-ordine.
PATCH *****     start mrordini key >= mro-chiave
PATCH *****           invalid continue
PATCH *****       not invalid
PATCH *****           perform until 1 = 2
...
PATCH *****                   at end exit perform 
PATCH *****              end-read
PATCH *****              if mro-anno       not = mto-anno or
PATCH *****                 mro-num-ordine not = mto-numero
PATCH *****                 exit perform
PATCH *****              end-if
PATCH *****              delete mrordini record 
PATCH *****                     invalid
...
PATCH      move 0 to righe-finali progressivo write-effettuate.
           ...
           perform DELETE-RIGHE. 
           set HoSalvato to true.
           move mto-promo-fittizia to save-tpr-codice.
...
PATCH            move progressivo to mro-riga
PATCH            modify form1-gd-1(riga, 1), cell-data mro-riga   
      ...
      *****           inquire form1-gd-1(riga, 7), cell-data in col-sconto
      *****           move col-sconto to mro-perce-sconto
...
LUBEXX              end-if
           ...
           gruppo-hidden
                 inquire form1-gd-1(riga, 2), hidden-data in hid-progr

                 move hid-prz-promo to mro-prz-promo
...
LABLAB           if mro-prz-commle not = mro-prz-unitario and
LABLAB              mro-prz-commle not = 0
LABLAB              |Blocco di nuovo l'ordine
LABLAB              set hid-bloccato to true
LABLAB              move 0 to hid-prz-commle mro-prz-commle
...
LABLAB           end-if
                 ...
                 if mro-prz-unitario >= 999999 and tcl-gdo-si
                    set  ordine-bloccato       to true
                    set  mto-bloccato          to true
                    move mto-stato-attivazione to save-stato
                 end-if
LABLAB           move hid-promo      to mro-promo
      *****           move hid-giang      to mro-giang
                 move hid-stato-riga to mro-stato
...
PATCH            end-if
                 ...
                 accept como-ora from time
                 move data-oggi  to mro-data-ultima-modifica
                 move como-ora   to mro-ora-ultima-modifica
                 move user-codi  to mro-utente-ultima-modifica
              
                 set mro-cancellato to false
                 ...
                 if hid-progr = 0
                    ...
                    cancel "find-progr"
                    move fp-progr to hid-progr
                    modify form1-gd-1(riga, 2), hidden-data hid-progr
                 end-if

      *    Luciano
                 move hid-prz-manuale  to mro-prz-manuale
      *    Luciano fine                   
...
PATCH         move low-value  to mro-chiave
PATCH         move mto-chiave to mro-chiave-testa
PATCH         start mrordini key >= mro-chiave
PATCH               invalid continue
PATCH           not invalid
PATCH               perform until 1 = 2
...
PATCH      move 0 to tipo-messaggio save-tot-righe.
      ...
      * <TOTEM:PARA. anagr01-Ev-After-Program>
           ...
           if path-zoom-tor-master-T not = spaces
              move path-zoom-tor-master-T to path-zoom-tor-master
              delete file zoom-tor-master
           end-if 
           .
      * <TOTEM:END>
...
121004*    Recupero la descrizione e il codice
      ...
      * <TOTEM:PARA. ef-data-AfterProcedure>
              ...
              END-IF
           MODIFY CONTROL-HANDLE COLOR = COLORE-OR
           perform CONTROLLO. |LASCIARE QUA ALTRIMENTI SOTTO NON VA
           if CondizioniRecupero or RigaCambiata 
      *****        if SaveGDO = spaces
              if tcl-gdo-no
                 move 1 to v-recupero
      ...
      * <TOTEM:PARA. pb-grid-elimina-LinkTo>
           |21/11/2012: POTER CANCELLARE LE RIGHE CHIUSE 
           |SU MASTER CHIUSO CON QUANTITA' EVASA 0
           if mod-campi = 1           and
              mod-cliente-destino = 0 and
              mod-destino         = 0 and
              mto-chiuso                      
              inquire form1-gd-1, last-row in tot-righe, cursor-y in 
           riga
              if tot-righe > 1
           ...
           if tot-righe > 1
              if riga <= tot-righe or riga > 2
                 inquire Form1-Gd-1(riga, 1), hidden-data in 
           gruppo-hidden
                 inquire Form1-Gd-1(riga, 5), cell-data in mro-qta-e 
                 if mro-qta-e not = 0
                    display message "Impossibile cancellare articoli eva
      -    "si"
                              title titolo
                               icon 2
                 else
                    if hid-blister = 0
                       ...
                       display message "Cancellare il blister selezionat
      -    "o?"
                                 title titolo
                                  type mb-yes-no
                                giving scelta
                    ...
                    if scelta = mb-yes
                       ...
                       if scelta = mb-yes
                          inquire form1-gd-1(riga, 2), 
                                  cell-data in mro-prg-cod-articolo
                          inquire form1-gd-1(riga, 4), cell-data mro-qta
                          perform CONTROLLA-SCORTA
                       end-if

                       if not OkCancella
                          display message "Si sta cercando di eliminare 
      -    "merce già ordinata al fornitore."
                                   x"0d0a""Annullare prima l'ordine forn
      -    "itore."
                                    title titolo
                                     icon 2
                       else
                          if hid-blister = 0
                             ...
                             perform until 1 = 2
                                ...
                                if hid-imballi not = 0
                                   modify form1-gd-1, record-to-delete 
           = store-riga
                                   exit perform
                                end-if
                             ...
                             perform until 1 = 2
                                inquire form1-gd-1, last-row in 
           tot-righe
                                inquire form1-gd-1(store-riga, 1), 
           hidden-data in gruppo-hidden
...
LUBEXX                       move store-riga to riga
      ...
      *****        if SaveGDO = spaces
           ...
           .
      * <TOTEM:END>
       pb-evasioni-BeforeProcedure.
      * <TOTEM:PARA. pb-evasioni-BeforeProcedure>
           modify pb-evasioni, bitmap-number 2.
           move 2 to BitmapNumEvasioni 
           .
      * <TOTEM:END>
       pb-evasioni-AfterProcedure.
      * <TOTEM:PARA. pb-evasioni-AfterProcedure>
           modify pb-evasioni, bitmap-number 1.
           move 1 to BitmapNumEvasioni 
           .
      * <TOTEM:END>
       pb-evasioni-LinkTo.
      * <TOTEM:PARA. pb-evasioni-LinkTo>
           move LinkChiave to evaord-chiave.
           move user-codi  to evaord-user.
           move user-codi  to user-cod.
           read user no lock invalid continue end-read.
           if user-ev-man-si
              move 6 to Passwd-password
              call   "passwd" using Passwd-linkage
              cancel "passwd"

              if Passwd-StatusOk
                 move 0 to evaord-status
                 call   "evaord" using evaord-linkage
                 cancel "evaord"
                 if evaord-status = 0
                    close    rordini
                    open i-o rordini
                    ...
                    perform CURRENT-RECORD
                    if path-zoom-tor-master-T not = spaces
                       move path-zoom-tor-master-T to 
           path-zoom-tor-master
                       delete file zoom-tor-master
                       move spaces to path-zoom-tor-master-T
                    end-if
                 end-if
              end-if
           else
              display message "Utente non abilitato"
                        title tit-err
                         icon 2
           end-if    
           .
      * <TOTEM:END>
       pb-colleg-BeforeProcedure.
      * <TOTEM:PARA. pb-colleg-BeforeProcedure>
           move 2 to NumBitmapDocColl.
           display pb-colleg 
           .
      * <TOTEM:END>
       pb-colleg-AfterProcedure.
      * <TOTEM:PARA. pb-colleg-AfterProcedure>
           move 1 to NumBitmapDocColl.
           display pb-colleg 
           .
      * <TOTEM:END>
       pb-colleg-LinkTo.
      * <TOTEM:PARA. pb-colleg-LinkTo>
           if LinkPgm = "gordcvar" exit paragraph end-if.

           set trovato to false.
           move path-zoom-tor-master-T to path-zoom-tor-master
           if path-zoom-tor-master = spaces
              accept path-zoom-tor-master from environment "PATH_ST" 
              inspect path-zoom-tor-master 
                      replacing trailing spaces by low-value
              accept como-data from century-date
              accept como-ora  from time
              move mto-numero to numero-x
              inspect numero-x replacing leading x"30" by x"20"
              call "C$JUSTIFY" using numero-x, "L"
              inspect numero-x replacing trailing spaces by low-value
              inspect path-zoom-tor-master replacing trailing 
                                            spaces by low-value
              string  path-zoom-tor-master delimited low-value
                      "____MASTER_ANNO_"   delimited size
              ...
              start rordini key >= ror-k-master
                ...
                not invalid
                    perform until 1 = 2
                       ...
                       move tor-data-fattura(7:2) to ztm-data-f(1:2)
                       move "/"                   to ztm-data-f(3:1)
                       move tor-data-fattura(5:2) to ztm-data-f(4:2)
                       move "/"                   to ztm-data-f(6:1)
                       move tor-data-fattura(1:4) to ztm-data-f(7:4)
              ...
              set trovato to true
              open input zoom-tor-master
           end-if.
           if trovato
              move path-zoom-tor-master  to ext-file 
           path-zoom-tor-master-T
              move "zoom-tor-master"     to como-file
              call "zoom-gt"          using como-file, 
                                            ztm-rec
                                     giving stato-zoom
              end-call
              ...
              if stato-zoom = 0
                 ...
                 if tutto-ok
                    ...
                    unlock mtordini all record
                    |Viene già fatto dal programma di evasione
      *****              close    rordini
      *****              open i-o rordini
      *****              set no-tagli to true
      *****              perform AGGIORNA-STATO-MASTER
      ...
      *****              end-if
           ...
           .
      * <TOTEM:END>
       pb-recupero-BeforeProcedure.
      * <TOTEM:PARA. pb-recupero-BeforeProcedure>
      *****     modify pb-recupero, bitmap-number = 2 
           .
      * <TOTEM:END>
       pb-recupero-AfterProcedure.
      * <TOTEM:PARA. pb-recupero-AfterProcedure>
      *****     modify pb-recupero, bitmap-number = 1 
           .
      * <TOTEM:END>
       pb-recupero-LinkTo.
      * <TOTEM:PARA. pb-recupero-LinkTo>
      * IN CASO DI RIPRISTINO METTERE LA VARIABILE V-TRAD2 IN VISIBLE VARIABLE

      *****     if mod-campi           = 0 or
      *****        mod-cliente-destino = 1 or
      *****        mod-destino         = 1 or
      *****        cbo-stato-buf not = "Attivo"
      *****        exit paragraph 
      *****     end-if.
      *****     
      ...
      *****              
      *****     move mto-data-ordine to tor-data-ordine.
      *****     display message "Recupero prezzi?"
      *****               title titolo
      *****                type mb-yes-no
      *****              giving scelta
      *****     if scelta = mb-yes
      *****        move ef-art-buf to SaveArticolo
      *****        perform RECUPERO-PREZZI-TRADIZIONALE
      *****        set PrezzoCambiato to true
      ...
      * <TOTEM:PARA. chk-prenot-LinkTo>
           if mto-registrato
              if chk-prenot-buf = 1
                 if chk-saldi-banco-buf = 1 or
                    chk-saldi-promo-buf = 1
                    perform CONTROLLA-ORDINATO-RIGHE
                 end-if
                 if OkCancella
                    move 0 to chk-saldi-banco-buf chk-saldi-promo-buf
                    display chk-saldi-banco chk-saldi-promo
                 end-if
              end-if
           else     
             |251007: non posso cambiare il flag se non sono in registrato
              if chk-prenot-buf = 1
                 move 0 to chk-prenot-buf
              else
                 move 1 to chk-prenot-buf
      ...
      * <TOTEM:PARA. pb-conf-LinkTo>
           move mto-chiave to conf-chiave-ordine.
