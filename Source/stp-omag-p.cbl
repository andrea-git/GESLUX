      ...
      *****************************************************************
       ...
       78  titolo        value "Liq. provvigione: stampa lista omaggi".
      ...
      * RIGHE PER LA STAMPA
       ...
       01  riga-intestazione.
           ...
           05 filler                pic x(5)  value "Fatt.".     | 5
           05 filler                pic x(2)  value "rg".        |10
           05 filler                pic x(7)  value "Cliente".   |12
           05 filler                pic x(6)  value "Codice".    |19
           05 filler                pic x(8)  value "Prodotto".  |25
           05 filler                pic x(2)  value "UM".        |33
           05 filler                pic x(4)  value "Q.tà".      |35
           05 filler                pic x(6)  value "Prezzo".    |39
           05 filler                pic x(8)  value "Addebito".  |45
       ...
       01  r-riga.
           ...
           05 r-cod-art             pic z(6).            |47
           05 r-des-art             pic x(25).           |53
           05 r-um                  pic x(2).            |78
           05 r-qta-vend            pic ---.--9.         |80
           05 r-prezzo-unit-vend    pic ---.--9,99.      |87
           05 r-val-provvig         pic ---.--9,99.      |97
       ...
       LINKAGE SECTION.
       copy "link-stp-omag.def".

      ******************************************************************
       PROCEDURE DIVISION using stp-omag-linkage.
           ...
           if tutto-ok
              perform until 1 = 2
                 ...
                 if pvv-data-fat >= sta-data-from and
                    pvv-data-fat <= sta-data-to   and
                    pvv-agente   >= sta-da-age    and
                    pvv-agente   <= sta-a-age     and
                    pvv-omaggio
                    perform STAMPA-OMAGGI
                 end-if
       ...
       STAMPA-OMAGGI.
           ...
           if prima-volta
              ...
              if selprint-stampante not = space
                 ...
                 move "GESLUX - Provv. lista omaggi" to spl-nome-job
      ...
      ***---
       SCRIVI-INTESTAZIONE.
           ...
           string st-agente                      delimited by size
                  ...
                  "  DETTAGLIO OMAGGI periodo: " delimited by size
           ...
           move 0                 to save-riga.
           move 37                to spl-tipo-colonna.
           call "C$JUSTIFY" using riga-titolo(1:85), "C".
      ...
      ***---
       STAMPA-FRAME.
           ...
           move 3                    to spl-colonna.
           move 27                   to spl-colonna-fine.
