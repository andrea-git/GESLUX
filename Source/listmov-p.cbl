      ...
      *****************************************************************
       ...
       77  tot-uscita-s1           pic s9(12)v999 value 0.
       77  tot-uscita-s2           pic s9(12)v999 value 0.
       77  tot-uscita-s3           pic s9(12)v999 value 0.
       77  totale-entrata          pic s9(12)v999 value 0.
       77  totale-uscita-s1        pic s9(12)v999 value 0.
       77  totale-uscita-s2        pic s9(12)v999 value 0.
       77  totale-uscita-s3        pic s9(12)v999 value 0.
      ...
      * RIGHE PER LA STAMPA
       ...
       01  r-titolo.
         ...
         03 filler                 pic x(10).
         03 filler                 pic x(12) value "Uscite Kg. 1". 
         03 filler                 pic x(11).
         03 filler                 pic x(12) value "Uscite Kg. 2". 
         03 filler                 pic x(15).
       ...
       01  r-riga.
         ...
         03 filler                 pic x(3).
         03 r-uscita-s1            pic zzz.zzz.zzz.zz9,999- blank zero.
         03 filler                 pic x(3).
         03 r-uscita-s2            pic zzz.zzz.zzz.zz9,999- blank zero.
         03 filler                 pic x(3).
         03 r-uscita-s3            pic zzz.zzz.zzz.zz9,999- blank zero.
         03 filler                 pic x(3).
       ...
       01  r-totali.
         ...
         03 filler                 pic x(3).
         03 r-tot-uscita-s1        pic zzz.zzz.zzz.zz9,999-.
         03 filler                 pic x(3).
         03 r-tot-uscita-s2        pic zzz.zzz.zzz.zz9,999-.
         03 filler                 pic x(3).
         03 r-tot-uscita-s3        pic zzz.zzz.zzz.zz9,999-.
         03 filler                 pic x(3).
      ...
      *****        move utf-reg-serie-1 to listmov-num-reg
      *****        perform ELABORAZIONE
      *****        move utf-reg-serie-2 to listmov-num-reg
      *****        perform ELABORAZIONE
              if totale-entrata   +
                 totale-uscita-s1 + 
                 totale-uscita-s2 +
                 totale-uscita-s3 not = 0
      ...
      ***---
       ELABORAZIONE.
           move 0 to save-data.
           move 0 to tot-entrata 
                     tot-uscita-s1 tot-uscita-s2 tot-uscita-s3.
           move low-value to mov-rec.
           ...
           if tutto-ok
              perform until 1 = 2
                 ...
                 |Si usa solo un registro ed in ogni caso avrò
                 |o il cumulativo o uno dei due dettagli
      ...
      *****           end-if
                 ...
                 if mov-kg not = 0
                    ...
                    if mov-entrata
                       ...
                       if mov-num-reg = utf-reg-serie-1
                          add mov-kg to tot-uscita-s1  totale-uscita-s1
                       end-if
                       if mov-num-reg = utf-reg-serie-2
                          add mov-kg to tot-uscita-s2  totale-uscita-s2
                       end-if
                       if mov-num-reg = utf-reg-serie-3
                          add mov-kg to tot-uscita-s3  totale-uscita-s3
                       end-if
                    end-if
                 end-if
              end-perform
      ...
      ***---
       SCRIVI-TITOLO.
           if listmov-data-from-anautf
              move all "-" to line-riga(1:99)
              write line-riga
              add 1 to RowCounter
              move "Giacenza" to tit-giacenza
           else
              move all "-" to line-riga(1:76)
              write line-riga
              add 1 to RowCounter
      ...
      ***---
       SCRIVI-RIGA-GIACENZA-INIZIALE.
           ...
           move spaces   to r-uscita-s1. 
           move spaces   to r-uscita-s2. 
           move spaces   to r-uscita-s3. 
      ...
      ***---
       VALORIZZA-RIGA. 
           ...
           move tot-uscita-s1  to r-uscita-s1. 
           move tot-uscita-s2  to r-uscita-s2. 
           move tot-uscita-s3  to r-uscita-s3. 
           move r-riga         to line-riga.
           write line-riga.
           add 1 to RowCounter.
      ...
      ***---
       SCRIVI-TOTALI.
           ...
           move totale-uscita-s1  to r-tot-uscita-s1.
           move totale-uscita-s2  to r-tot-uscita-s2.
           move totale-uscita-s3  to r-tot-uscita-s3.
           if listmov-data-from-anautf
