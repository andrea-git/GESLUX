      *{TOTEM}PRG-COMMENT
      * estfel-r.Cbl
      * estfel-r.Cbl is generated by TOTEM
      ...
      *{TOTEM}PRGID
       ...
       DATE-WRITTEN.        lunedì 17 dicembre 2018 20:18:45.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:estfel-r, INIT:estfel-r, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       78 titolo VALUE IS "Generazione manuale XML FE". 
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:estfel-r, INIT:estfel-r, BeforeDeclarative>
      ***---
      ...
      * <TOTEM:EPT. INIT:estfel-r, INIT:estfel-r, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-tparamge.
      * <TOTEM:EPT. INIT:estfel-r, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           ...
           END-IF
      * <TOTEM:EPT. INIT:estfel-r, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-tparamge.
      * <TOTEM:EPT. INIT:estfel-r, FD:tparamge, BeforeClose>
      * <TOTEM:END>
           .
      ...
      * <TOTEM:END>
           EVALUATE TRUE
              ...
              WHEN Key-Status = 1000
                 PERFORM Screen4-Rb-1-LinkTo
              WHEN Key-Status = 1002
                 PERFORM Screen4-Rb-1a-LinkTo
      ...
      * <TOTEM:PARA. PB-ESEGUI-LinkTo>
           ...
           if tutto-ok
              display message box "Confermi la rigenerazione?"
                      title = titolo
                      type MB-YES-NO
                      giving scelta

              if scelta = MB-YES       
                 move anno-from    to lfel-anno
                 move num-from     to lfel-da
                 move num-to       to lfel-a
                 move form1-handle to lfel-handle
                 move 0 to lfel-status               
                 if tipo-doc = 1
                    set lfel-f to true               
                 else
                    set lfel-nc to true
      ...
      * <TOTEM:END>
       Screen4-Rb-1-LinkTo.
      * <TOTEM:PARA. Screen4-Rb-1-LinkTo>
           move 1 to tipo-doc 
           .
      * <TOTEM:END>
       Screen4-Rb-1a-LinkTo.
      * <TOTEM:PARA. Screen4-Rb-1a-LinkTo>
           move 2 to tipo-doc 
           .
      * <TOTEM:END>
