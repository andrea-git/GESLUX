       ...
       PROGRAM-ID.                      check-mag-p.
       AUTHOR.                          Andrea.
       REMARKS.
           Congruenza tra peso magazzino trattato e 
           quello indicato nella causale.
      ...
      *    COSTANTI
       78  titolo               value "Verifica congruenza magazzino".
           ...
           start tordini key >= tor-chiave
             ...
             not invalid
                 perform until 1 = 2
                    ...
                    if tor-causale not = "FTMA"|Abbuono generico
           ...
           start tnotacr key >= tno-chiave
             ...
             not invalid
                 perform until 1 = 2
                    ...
                    when "NCNC" |Abbuono generico
                    when "NNEX" |Abbuono generico
           ...
           start rnotacr key >= rno-chiave
             ...
             not invalid
                 perform until 1 = 2
                    ...
                    move rno-prg-cod-magazzino to ror-prg-cod-magazzino
      ...
      ***---
       CONTROLLO-MAGAZZINO.
           if ror-prg-cod-magazzino not = tca-cod-magaz
              perform ERRORE
           end-if.
       ...
       ERRORE.
           if link-result = 0
              ...
              string "Anno"          delimited size
                     ...
                     separatore      delimited size
                     "Mag. trattato" delimited size
                     separatore      delimited size
                     "Mag. causale"  delimited size
                     into line-riga
              end-string
              write line-riga
           end-if.
           ...
           move ror-prg-cod-magazzino to r-mag-t.
           move tca-cod-magaz         to r-mag-c.
           ...
           string r-anno        delimited size
                  ...
                  separatore    delimited size
                  r-mag-t       delimited size
                  separatore    delimited size
                  r-mag-c       delimited size
                  into line-riga
           end-string.
           write line-riga.
