      *{TOTEM}PRG-COMMENT
      * statgio.Cbl
      * statgio.Cbl is generated by TOTEM
      ...
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:statgio, INIT:statgio, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       77 lab-oper-buf     PIC  X(50)
                  VALUE IS "Stampa Statistica giornaliera per mese in co
      -    "rso...".
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:statgio, INIT:statgio, BeforeDeclarative>
      ***---
      ...
      * <TOTEM:EPT. INIT:statgio, INIT:statgio, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-tparamge.
      * <TOTEM:EPT. INIT:statgio, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           ...
           END-IF
      * <TOTEM:EPT. INIT:statgio, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-tparamge.
      * <TOTEM:EPT. INIT:statgio, FD:tparamge, BeforeClose>
      * <TOTEM:END>
           CLOSE tparamge
           .
      ...
      * <TOTEM:EPT. FORM:Form2, FORM:Form2, BeforeAccept>
           ...
           move "Stampa Statistica giornaliera per mese in corso..." 
             to lab-oper-buf.
           display lab-oper.
           ...
           move "Stampa Statistica delta in corso..." to lab-oper-buf.
           display lab-oper.
