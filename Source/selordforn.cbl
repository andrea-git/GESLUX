      *{TOTEM}PRG-COMMENT
      * selordforn.Cbl
      * selordforn.Cbl is generated by TOTEM
      * This is a generated file. DO NOT modify this file directly.
      *{TOTEM}END
       IDENTIFICATION       DIVISION.
      *{TOTEM}PRGID
       PROGRAM-ID.          selordforn.
       AUTHOR.              ANDREA EVENTI.
       DATE-WRITTEN.        martedì 1 aprile 2014 19:18:53.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:selordforn, INIT:selordforn, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       78 titolo VALUE IS "Geslux - Ricerca e variazione ordini fornitor
      -    "i". 
       ...
       01 Gd-ordini-Record.
           ...
           05 Col-fornitore    PIC  z(4)9.
           05 Col-rag-soc-forn PIC  X(40).
           05 col-dest         PIC  z(4)9.
           05 col-rag-soc-dest PIC  X(40).
       01 FILLER           PIC  x.
      ...
      * FILE'S LOCK MODE FLAG
       ...
       77 destini-k-localita-SPLITBUF  PIC X(36).
           ...
           copy "combo-stato-ordforn.def".
           copy "link-gordfornvar.def".


       01 tipo-record           PIC  x.
           88 r-inseriti        value "I". 
           88 r-accettati       value "A". 
           88 r-inviati         value "S". 
           88 r-in-lavorazioni  value "L". 
           88 r-chiusi          value "C". 

       78 78-colore-inseriti       value 513. 
       78 78-colore-accettati      value 481. 
       78 78-colore-inviati        value 400. 
       78 78-colore-in-lavorazioni value 224. 
       78 78-colore-chiusi         value 112. 

       78 78-tit-inseriti          value "Inserito". 
       78 78-tit-accettati         value "Accettato". 
       78 78-tit-inviati           value "Inviato". 
       78 78-tit-in-lavorazioni    value "In Lavorazione". 
       78 78-tit-chiusi            value "Chiuso". 
      ...
      ***** Elenco ID Logici *****
       ...
       78  78-ID-EF-FORN-FROM VALUE 5006.
       78  78-ID-EF-DEST-FORN-FROM VALUE 5007.
       78  78-ID-EF-CLIENTE-FROM VALUE 5008.
       78  78-ID-EF-DEST-CLI-FROM VALUE 5009.
       78  78-ID-CBO-STATO-ORD VALUE 5010.
      ***** Fine ID Logici *****
      *{TOTEM}END
      ...
      * GRID
       05
           ...
           SIZE 161,67 ,
           BOXED,
           DATA-COLUMNS (1, 2, 6, 14, 24, 29, 69, 74),
           ALIGNMENT ("C", "C", "R", "C", "R", "U", "R", "U"),
           SEPARATION (5, 5, 5, 5, 5, 5, 5, 5),
           DATA-TYPES ("X", "9(4)", "9(8)", "99/99/9999", "9(5)", "x(40)
      -    "", "9(5)", "x(40)"),
           NUM-COL-HEADINGS 1,
           COLUMN-HEADINGS,
      ...
      * ENTRY FIELD
       05
           ...
           VALUE FORN-FROM,
           PIC Z(4)9
           AFTER PROCEDURE EF-FORN-FROM-AfterProcedure, 
           BEFORE PROCEDURE EF-FORN-FROM-BeforeProcedure, 
           .
      ...
      * ENTRY FIELD
       05
           ...
           BOXED,
           COLOR IS 513,
           ENABLED MOD-DEST-FORN,
           ID IS 78-ID-EF-DEST-FORN-FROM,                
           HEIGHT-IN-CELLS,
           WIDTH-IN-CELLS,
           RIGHT,
           MAX-TEXT 5,
           NUMERIC,
           VALUE DEST-FORN-FROM,
           PIC Z(4)9
           AFTER PROCEDURE EF-DEST-FORN-FROM-AfterProcedure, 
           BEFORE PROCEDURE EF-DEST-FORN-FROM-BeforeProcedure, 
           .
      ...
      * ENTRY FIELD
       05
           ...
           BOXED,
           COLOR IS 513,
           ENABLED MOD-DEST-CLI,
           ID IS 78-ID-EF-DEST-CLI-FROM,                
           HEIGHT-IN-CELLS,
           WIDTH-IN-CELLS,
           RIGHT,
           MAX-TEXT 5,
           ...
           VALUE DEST-CLI-FROM,
           PIC Z(4)9
           AFTER PROCEDURE EF-DEST-CLI-FROM-AfterProcedure, 
           BEFORE PROCEDURE EF-DEST-CLI-FROM-BeforeProcedure, 
           .
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:selordforn, INIT:selordforn, BeforeDeclarative>
      ***---
      ...
      * <TOTEM:EPT. INIT:selordforn, INIT:selordforn, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-tordforn.
      * <TOTEM:EPT. INIT:selordforn, FD:tordforn, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tordforn
           ...
           END-IF
      * <TOTEM:EPT. INIT:selordforn, FD:tordforn, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-clienti.
      * <TOTEM:EPT. INIT:selordforn, FD:clienti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT clienti
           IF NOT Valid-STATUS-clienti
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selordforn, FD:clienti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tparamge.
      * <TOTEM:EPT. INIT:selordforn, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           IF NOT Valid-STATUS-tparamge
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selordforn, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tescons.
      * <TOTEM:EPT. INIT:selordforn, FD:tescons, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tescons
           IF NOT Valid-STATUS-tescons
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selordforn, FD:tescons, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-destinif.
      * <TOTEM:EPT. INIT:selordforn, FD:destinif, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT destinif
           IF NOT Valid-STATUS-destinif
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selordforn, FD:destinif, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-destini.
      * <TOTEM:EPT. INIT:selordforn, FD:destini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT destini
           IF NOT Valid-STATUS-destini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selordforn, FD:destini, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-tordforn.
      * <TOTEM:EPT. INIT:selordforn, FD:tordforn, BeforeClose>
      * <TOTEM:END>
           CLOSE tordforn
           .

       CLOSE-clienti.
      * <TOTEM:EPT. INIT:selordforn, FD:clienti, BeforeClose>
      * <TOTEM:END>
           CLOSE clienti
           .

       CLOSE-tparamge.
      * <TOTEM:EPT. INIT:selordforn, FD:tparamge, BeforeClose>
      * <TOTEM:END>
           CLOSE tparamge
           .

       CLOSE-tescons.
      * <TOTEM:EPT. INIT:selordforn, FD:tescons, BeforeClose>
      * <TOTEM:END>
           CLOSE tescons
           .

       CLOSE-destinif.
      * <TOTEM:EPT. INIT:selordforn, FD:destinif, BeforeClose>
      * <TOTEM:END>
           CLOSE destinif
           .

       CLOSE-destini.
      * <TOTEM:EPT. INIT:selordforn, FD:destini, BeforeClose>
      * <TOTEM:END>
           CLOSE destini
           .
      ...
      * DISPLAY-COLUMNS settings
              MODIFY gd-ordini, DISPLAY-COLUMNS (1, 4, 12, 24, 37, 49, 
           89, 101)
           .
      ...
      * Generazione stringa perform CONTROLLO
           ...
           when 78-ID-EF-DATA-TO
                perform CONTROLLO
           |78-ID-EF-FORN-FROM è l'ID del campo EF-FORN-FROM
           when 78-ID-EF-FORN-FROM
                perform CONTROLLO
           |78-ID-EF-DEST-FORN-FROM è l'ID del campo EF-DEST-FORN-FROM
           when 78-ID-EF-DEST-FORN-FROM
                perform CONTROLLO
           |78-ID-EF-CLIENTE-FROM è l'ID del campo EF-CLIENTE-FROM
           when 78-ID-EF-CLIENTE-FROM
                perform CONTROLLO
           |78-ID-EF-DEST-CLI-FROM è l'ID del campo EF-DEST-CLI-FROM
      ...
      *    cambio la label legenda
           ...
           evaluate true
           when r-inseriti
                move 78-colore-inseriti        to col-stato-ordine
                move 78-tit-inseriti           to tit-stato-ordine
           when r-accettati
                move 78-colore-accettati       to col-stato-ordine
                move 78-tit-accettati          to tit-stato-ordine
           when r-inviati
                move 78-colore-inviati         to col-stato-ordine
                move 78-tit-inviati            to tit-stato-ordine
           when r-in-lavorazioni
                move 78-colore-in-lavorazioni  to col-stato-ordine
                move 78-tit-in-lavorazioni     to tit-stato-ordine
           when r-chiusi
                move 78-colore-chiusi          to col-stato-ordine
                move 78-tit-chiusi             to tit-stato-ordine
           end-evaluate
      ...
      * <TOTEM:PARA. CARICA-ORDINI>
           ...
           move ordine-from  to tof-numero.
           ...
           when inseriti
                ...
                start tordforn key is >= tof-k-stato
                   invalid 
                      continue
                   not invalid 
                      perform SCORRI-ORDINI
                end-start

      *****     when accettati
      *****          set tof-accettato  to true
      *****          start tordforn key is >= k-stato
      *****             invalid 
      *****                continue
      *****             not invalid 
      *****                perform SCORRI-ORDINI
      ...
      * <TOTEM:PARA. CERCA>
           evaluate control-id
           when 78-ID-ef-forn-from
                inquire ef-forn-from, value in cli-codice
                ...
                cancel "zoom-gt"
                if stato-zoom = 0
                   move cli-codice to forn-from
                   display ef-forn-from
                   move cli-ragsoc-1 to lab-forn-buf
                   display lab-forn
                end-if
           when 78-ID-ef-dest-forn-from
                inquire ef-forn-from, value in desf-codice
                inquire ef-dest-forn-from, value in desf-prog
                ...
                cancel "zoom-gt"
                if stato-zoom = 0
                   move desf-prog to dest-forn-from
                   display ef-dest-forn-from
                   move desf-ragsoc-1 to lab-dest-forn-buf
                   display lab-dest-forn
                end-if
           when 78-ID-ef-cliente-from
           ...
           when 78-ID-ef-dest-cli-from
                inquire ef-cliente-from, value in des-codice
                inquire ef-dest-cli-from, value in des-prog
                ...
                cancel "zoom-gt"
                if stato-zoom = 0
                   move des-prog to dest-cli-from
                   display ef-dest-cli-from
                   move des-ragsoc-1 to lab-dest-cli-buf
                   display lab-dest-cli
                end-if
           end-evaluate 
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. CHIAMA-MANUTENZIONE>
           ...
           move como-anno          to tof-anno.
           move como-numero-ordine to tof-numero.
           move tof-chiave         to LinkChiave.
           move "selordforn"       to LinkPgm.
      ...
      -    "rio!"
           ...
           when 78-ID-ef-forn-from
                if forn-from = 0
                   ...
                   move all "9" to forn-to
                   move zero to mod-dest-forn
                else
                   move forn-from to cli-codice
                   set cli-tipo-F to true
                   read clienti no lock
                      invalid
                         ...
                         move zero to mod-dest-forn
                      not invalid
                         move 1    to mod-dest-forn
                   end-read
                   move forn-from to forn-to
                end-if
                move cli-ragsoc-1 to lab-forn-buf
                display lab-forn
                display ef-dest-forn-from
           ...
           when 78-ID-ef-dest-forn-from
                if mod-dest-forn = 1
                   if dest-forn-from = 0
                      ...
                      move forn-from  to desf-codice
                      move dest-forn-from     to desf-prog
           ...
           when 78-ID-ef-dest-cli-from
                if mod-dest-cli = 1
                   if dest-cli-from = 0
                      ...
                      move cliente-from     to des-codice
                      move dest-cli-from   to des-prog
      ...
      * <TOTEM:PARA. METTI-IN-GRIGLIA>
           move tof-anno     to col-anno.
           move tof-numero   to col-numero.

           move tof-data-ordine(1:4)  to col-data(7:4)
           move tof-data-ordine(5:2)  to col-data(4:2)
           move tof-data-ordine(7:2)  to col-data(1:2)

           move "/"                   to col-data(3:1)
                                         col-data(6:1).

           move tof-cod-forn          to Col-fornitore
                                         cli-codice
                                         desf-codice.
           ...
           read clienti   key cli-chiave
              invalid
                 move "FORNITORE NON TROVATO" to desf-ragsoc-1
           end-read
           
           move cli-ragsoc-1          to  Col-rag-soc-forn.

           move tof-destino           to col-dest
                                         desf-prog
           read destinif
              invalid
                 move "DESTINO NON TROVATO" to desf-ragsoc-1
           end-read
           move desf-ragsoc-1         to  Col-rag-soc-dest.


           evaluate true
           when tof-inserito
                set r-inseriti                 to true
                move 78-colore-inseriti        to col-stato-ordine
      *****     when tof-accettato
      *****          set r-accettati                to true
      *****          move 78-colore-accettati       to col-stato-ordine
           when tof-inviato
                set r-inviati                  to true
                move 78-colore-inviati         to col-stato-ordine
           when tof-in-lavorazione
                set r-in-lavorazioni           to true
                move 78-colore-in-lavorazioni  to col-stato-ordine
           when tof-chiuso
                set r-chiusi                   to true
                move 78-colore-chiusi          to col-stato-ordine
           end-evaluate
           ...
           modify gd-ordini(riga), ROW-COLOR = col-stato-ordine.
      ...
      * <TOTEM:PARA. PARAGRAFO-COPY>
           ...
           copy "riempi-combo-stato-ordforn.cpy" 
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. VALIDA-ORDINE>
           ...
           if tof-numero < ordine-FROM or
              tof-numero > ordine-TO
              set record-ok to false
           end-if.

           if tof-data-ordine < data-from-AAAAMMGG or tof-data-ordine > 
           data-to-AAAAMMGG
              set record-ok to false
           end-if.

           if tof-cod-forn < forn-from or 
              tof-cod-forn > forn-to
              set record-ok to false
           end-if.

           if tof-cliente < cliente-from or 
              tof-cliente > cliente-to
              set record-ok to false
           end-if.

           if forn-from not = zero and dest-forn-from not = zero
              if tof-destino not = dest-forn-from
                 set record-ok to false
              end-if
           end-if.

           if cliente-from not = zero and dest-cli-from not = zero
              if tof-destino-c not = dest-cli-from
                 set record-ok to false
              end-if
           end-if.

           if tof-anno not = anno-to
              set record-ok to false
           end-if 
           .
      * <TOTEM:END>

       EF-DEST-FROM-BeforeProcedure.
      * <TOTEM:PARA. EF-DEST-FROM-BeforeProcedure>
           move 1 to e-cerca.
           modify tool-cerca, enabled = e-cerca 
           .
      * <TOTEM:END>

       EF-DEST-FROM-AfterProcedure.
      * <TOTEM:PARA. EF-DEST-FROM-AfterProcedure>
           perform CONTROLLO.
           move 0 to e-cerca.
           modify tool-cerca, enabled = e-cerca 
           .
      ...
      * <TOTEM:PARA. RB-SINGOLA-LinkTo>
           move 0 to mod-limiti.
           move 0 to mod-dest-forn.
           move 0 to forn-from.
           move 0 to cliente-from.
           move 0 to dest-forn-from.
           move 0 to dest-cli-from.
           move "<< HELP >> 0 = TUTTI I FORNITORI" to lab-forn-buf.
           move "<< HELP >> 0 = TUTTI I DESTINI" to lab-dest-forn-buf.
           move "<< HELP >> 0 = TUTTI I CLIENTI" to lab-cli-buf.
           move "<< HELP >> 0 = TUTTI I DESTINI" to lab-dest-cli-buf.
           display Form1 
           .
      * <TOTEM:END>
       RB-ELENCO-LinkTo.
      * <TOTEM:PARA. RB-ELENCO-LinkTo>
           ...
           inquire EF-forn-FROM, VALUE forn-FROM
           if forn-FROM = zero
              move zero   to mod-dest-forn
           else
              move 1      to mod-dest-forn
           ...
           inquire EF-CLIENTE-FROM, VALUE CLIENTE-FROM
           if cliente-FROM = zero
              move zero   to mod-dest-cli
           else
              move 1      to mod-dest-cli
           end-if.
      ...
      * <TOTEM:PARA. pb-ok-LinkTo>
           ...
           perform  varying CONTROL-ID from 78-id-ef-anno by 1
                      until CONTROL-ID > 78-id-EF-DEST-CLI-FROM
              perform CONTROLLO
              if errori 
                 exit perform 
              end-if
      ...
      * <TOTEM:PARA. pb-ok2-LinkTo>
           ...
           .
      * <TOTEM:END>
       EF-FORN-FROM-BeforeProcedure.
      * <TOTEM:PARA. EF-FORN-FROM-BeforeProcedure>
           MODIFY CONTROL-HANDLE COLOR = COLORE-NU
           move 1 to e-cerca.
           modify tool-cerca, enabled = e-cerca 
           .
      * <TOTEM:END>
       EF-FORN-FROM-AfterProcedure.
      * <TOTEM:PARA. EF-FORN-FROM-AfterProcedure>
           MODIFY CONTROL-HANDLE COLOR = COLORE-OR
           perform CONTROLLO.
           move 0 to e-cerca.
           modify tool-cerca, enabled = e-cerca 
           .
      * <TOTEM:END>
       EF-DEST-FORN-FROM-BeforeProcedure.
      * <TOTEM:PARA. EF-DEST-FORN-FROM-BeforeProcedure>
           MODIFY CONTROL-HANDLE COLOR = COLORE-NU
           move 1 to e-cerca.
           modify tool-cerca, enabled = e-cerca 
           .
      * <TOTEM:END>
       EF-DEST-FORN-FROM-AfterProcedure.
      * <TOTEM:PARA. EF-DEST-FORN-FROM-AfterProcedure>
           MODIFY CONTROL-HANDLE COLOR = COLORE-OR
           perform CONTROLLO.
           move 0 to e-cerca.
           modify tool-cerca, enabled = e-cerca 
           .
      * <TOTEM:END>
       EF-DEST-CLI-FROM-BeforeProcedure.
      * <TOTEM:PARA. EF-DEST-CLI-FROM-BeforeProcedure>
           MODIFY CONTROL-HANDLE COLOR = COLORE-NU
           move 1 to e-cerca.
           modify tool-cerca, enabled = e-cerca 
           .
      * <TOTEM:END>
       EF-DEST-CLI-FROM-AfterProcedure.
      * <TOTEM:PARA. EF-DEST-CLI-FROM-AfterProcedure>
           MODIFY CONTROL-HANDLE COLOR = COLORE-OR
           perform CONTROLLO.
           move 0 to e-cerca.
           modify tool-cerca, enabled = e-cerca 
