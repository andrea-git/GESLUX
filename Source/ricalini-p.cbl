       ...
       PROGRAM-ID.                      ricalini-p.
       REMARKS. Partendo da inizio anno fino alla data di consolidamento
                ricalcolo i valori iniziali utilizzando il segno opposto 
                a quanto inidicato nella causale.
                I valori di iniziali (KG e UDM) coincideranno con quelli
                della giacenza periodo. Manca però il valore delle ini
                dato che il costo mp a quella data non ce l'ho più.
       AUTHOR.                          Andrea.
      ******************************************************************
      ...
      ******************************************************************
       ...
       77  controllo             pic xx.
           ...
           88  errori            value "ER".
       78  titolo                value "Ricalcolo iniziali".
       77  filler                pic 9.
      ...
      ***---
       ELABORAZIONE.
           ...
           if tutto-ok
              ...
              display "                      "
                 upon agmag-handle at column 04
                                        line 03
              ||||||||
              perform until 1 = 2
                 ...
                 if counter2 = 100
                    ...
                    display counter-edit
                       upon agmag-handle at column 12
                                              line 03
                    move 0 to counter2
                 end-if
       ...
       LOOP-RIGHE-RMOVMAG.
           ...
           if tutto-ok
              perform until 1 = 2
                 ...
                 move -1                 to multiplyer(4)
                 move -1                 to multiplyer(5)
                 move -1                 to multiplyer(6)
                 move -1                 to multiplyer(7)
                 move -1                 to multiplyer(8)
                 move -1                 to multiplyer(9)
                 move -1                 to multiplyer(10)
                 move -1                 to multiplyer(11)
                 move -1                 to multiplyer(12)
                 move -1                 to multiplyer(13)
                 move -1                 to multiplyer(14)
