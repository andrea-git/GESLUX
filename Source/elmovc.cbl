      *{TOTEM}PRG-COMMENT
      * elmovc.Cbl
      * elmovc.Cbl is generated by TOTEM
      ...
      *{TOTEM}PRGID
       ...
       DATE-WRITTEN.        martedì 1 aprile 2014 19:14:11.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:elmovc, INIT:elmovc, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       78 titolo VALUE IS "Geslux - Elenco bozze d'evazione correlate". 
       77 Small-Font
      ...
      * GRID
       05
           ...
           ADJUSTABLE-COLUMNS,
           BOXED,
           DATA-COLUMNS (1, 2, 6, 14, 24, 64, 104, 114, 118),
           ALIGNMENT ("C", "C", "R", "C", "L", "L", "L", "C", "C"),
           SEPARATION (5, 5, 5, 5, 5, 5, 5, 5, 5),
           DATA-TYPES ("X", "9(4)", "9(8)", "D(10)", "X(40)", "x(40)", 
           "x(10)", "x(4)", "x(8)"),
           NUM-COL-HEADINGS 1,
           COLUMN-HEADINGS,
      ...
      * LABEL
       05
           ...
           HEIGHT-IN-CELLS,
           WIDTH-IN-CELLS,
           TITLE "Doppio Click: parte bianca = bozza; parte rossa = movi
      -    "mento di magazzino",
           .
      ...
      *{TOTEM}LINKPARA
       PROCEDURE  DIVISION USING link-elmovc, LK-BLOCKPGM, USER-CODI, 
           LIVELLO-ABIL.
      *{TOTEM}END

      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:elmovc, INIT:elmovc, BeforeDeclarative>
      ***---
       teva-ERR SECTION.
      ...
      * <TOTEM:EPT. INIT:elmovc, INIT:elmovc, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-clienti.
      * <TOTEM:EPT. INIT:elmovc, FD:clienti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT clienti
           ...
           END-IF
      * <TOTEM:EPT. INIT:elmovc, FD:clienti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmp-elmovc.
      * <TOTEM:EPT. INIT:elmovc, FD:tmp-elmovc, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O tmp-elmovc
           ...
           IF NOT Valid-STATUS-tmp-elmovc
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:elmovc, FD:tmp-elmovc, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-reva.
      * <TOTEM:EPT. INIT:elmovc, FD:reva, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT reva
           IF NOT Valid-STATUS-reva
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:elmovc, FD:reva, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-teva.
      * <TOTEM:EPT. INIT:elmovc, FD:teva, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT teva
           IF NOT Valid-STATUS-teva
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:elmovc, FD:teva, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmagaz.
      * <TOTEM:EPT. INIT:elmovc, FD:tmagaz, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tmagaz
           IF NOT Valid-STATUS-tmagaz
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:elmovc, FD:tmagaz, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-clienti.
      * <TOTEM:EPT. INIT:elmovc, FD:clienti, BeforeClose>
      * <TOTEM:END>
           CLOSE clienti
           .

       CLOSE-tmp-elmovc.
      * <TOTEM:EPT. INIT:elmovc, FD:tmp-elmovc, BeforeClose>
      * <TOTEM:END>
           CLOSE tmp-elmovc
           .

       CLOSE-reva.
      * <TOTEM:EPT. INIT:elmovc, FD:reva, BeforeClose>
      * <TOTEM:END>
           CLOSE reva
           .

       CLOSE-teva.
      * <TOTEM:EPT. INIT:elmovc, FD:teva, BeforeClose>
      * <TOTEM:END>
           CLOSE teva
           .

       CLOSE-tmagaz.
      * <TOTEM:EPT. INIT:elmovc, FD:tmagaz, BeforeClose>
      * <TOTEM:END>
           CLOSE tmagaz
           .
      ...
      * DISPLAY-COLUMNS settings
              MODIFY gd-mov, DISPLAY-COLUMNS (1, 4, 12, 23, 35, 75, 
           115, 131, 146)
           .
      ...
      * <TOTEM:EPT. FORM:Form2, FORM:Form2, BeforeAccept>
           ...
           if not trovato
      *        display message box "Nessun movimento presente associato all'ordine"
      *                title = tit-err
      *                icon mb-error-icon
              perform FORM2-EXIT
           else                                  
      ...
      * <TOTEM:PARA. CARICA-MOVIMENTI>
           move link-tof-anno   to reva-anno-ordf
           move link-tof-numero to reva-numero-ordf
           move low-value       to reva-riga-ordf
           ...
           start reva key not < reva-chiave-ordf
              ...
              not invalid
                 perform until 1 = 2
                    ...
                    if link-tof-anno not = reva-anno-ordf or 
                       link-tof-numero not = reva-numero-ordf
                       exit perform
                    end-if
                    move reva-anno    to tmp-emc-anno
                    move reva-numero  to tmp-emc-numero

                    move zero         to tmp-emc-prg
                    write tmp-emc-rec
                       invalid
                          continue
                    end-write
      ...
      * <TOTEM:END>
       ...
       CHIAMA-MANUTENZIONE-M.
      * <TOTEM:PARA. CHIAMA-MANUTENZIONE-M>
           modify form2-handle, visible false.
      ...
      *     move teva-causale          to tca-codice.
      ...
      *     move tca-descrizione      to col-descau.
           ...
           move mag-descrizione to Col-magazzino
           evaluate true
           when teva-aperta
                move "APERTA"   to Col-stato
                move space            to col-anno-mov
                                         col-num-mov
           when teva-chiusa
                move "CHIUSA"   to Col-stato
      ...
      * <TOTEM:END>
       ...
       MOVIM-DA-GRIGLIA.
      * <TOTEM:PARA. MOVIM-DA-GRIGLIA>
           inquire gd-mov(riga), record-data = rec-grid.

           move col-anno-mov        to como-anno          
           teva-anno-movim.
           move col-num-mov         to como-numero-ordine 
           teva-num-movim.
           move riga                to como-riga.

           if teva-anno-movim not = 0
              perform CHIAMA-MANUTENZIONE-M
           end-if.
