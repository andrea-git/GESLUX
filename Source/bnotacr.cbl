      *{TOTEM}PRG-COMMENT
      * bnotacr.Cbl
      * bnotacr.Cbl is generated by TOTEM
      ...
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:bnotacr, INIT:bnotacr, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:bnotacr, INIT:bnotacr, BeforeDeclarative>
      ***---
      ...
      * <TOTEM:EPT. INIT:bnotacr, INIT:bnotacr, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-btnotacr.
      * <TOTEM:EPT. INIT:bnotacr, FD:btnotacr, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O btnotacr
           ...
           END-IF
      * <TOTEM:EPT. INIT:bnotacr, FD:btnotacr, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tparamge.
      * <TOTEM:EPT. INIT:bnotacr, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           IF NOT Valid-STATUS-tparamge
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bnotacr, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-brnotacr.
      * <TOTEM:EPT. INIT:bnotacr, FD:brnotacr, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O brnotacr
           ...
           IF NOT Valid-STATUS-brnotacr
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bnotacr, FD:brnotacr, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-destini.
      * <TOTEM:EPT. INIT:bnotacr, FD:destini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT destini
           IF NOT Valid-STATUS-destini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bnotacr, FD:destini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-clienti.
      * <TOTEM:EPT. INIT:bnotacr, FD:clienti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT clienti
           IF NOT Valid-STATUS-clienti
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bnotacr, FD:clienti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-articoli.
      * <TOTEM:EPT. INIT:bnotacr, FD:articoli, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT articoli
           IF NOT Valid-STATUS-articoli
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bnotacr, FD:articoli, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tordini.
      * <TOTEM:EPT. INIT:bnotacr, FD:tordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tordini
           IF NOT Valid-STATUS-tordini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bnotacr, FD:tordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-rordini.
      * <TOTEM:EPT. INIT:bnotacr, FD:rordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT rordini
           IF NOT Valid-STATUS-rordini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bnotacr, FD:rordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-progmag.
      * <TOTEM:EPT. INIT:bnotacr, FD:progmag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT progmag
           IF NOT Valid-STATUS-progmag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bnotacr, FD:progmag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-timballi.
      * <TOTEM:EPT. INIT:bnotacr, FD:timballi, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT timballi
           IF NOT Valid-STATUS-timballi
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bnotacr, FD:timballi, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-timbalqta.
      * <TOTEM:EPT. INIT:bnotacr, FD:timbalqta, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-timbalqta
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bnotacr, FD:timbalqta, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmp-progmag-zoom.
      * <TOTEM:EPT. INIT:bnotacr, FD:tmp-progmag-zoom, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-tmp-progmag-zoom
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bnotacr, FD:tmp-progmag-zoom, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tvettori.
      * <TOTEM:EPT. INIT:bnotacr, FD:tvettori, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tvettori
           IF NOT Valid-STATUS-tvettori
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bnotacr, FD:tvettori, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-ttipocli.
      * <TOTEM:EPT. INIT:bnotacr, FD:ttipocli, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT ttipocli
           IF NOT Valid-STATUS-ttipocli
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bnotacr, FD:ttipocli, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmarche.
      * <TOTEM:EPT. INIT:bnotacr, FD:tmarche, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tmarche
           IF NOT Valid-STATUS-tmarche
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bnotacr, FD:tmarche, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tpiombo.
      * <TOTEM:EPT. INIT:bnotacr, FD:tpiombo, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tpiombo
           IF NOT Valid-STATUS-tpiombo
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bnotacr, FD:tpiombo, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tivaese.
      * <TOTEM:EPT. INIT:bnotacr, FD:tivaese, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tivaese
           IF NOT Valid-STATUS-tivaese
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bnotacr, FD:tivaese, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-timposte.
      * <TOTEM:EPT. INIT:bnotacr, FD:timposte, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT timposte
           IF NOT Valid-STATUS-timposte
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bnotacr, FD:timposte, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmp-fatturati.
      * <TOTEM:EPT. INIT:bnotacr, FD:tmp-fatturati, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-tmp-fatturati
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bnotacr, FD:tmp-fatturati, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tcodpag.
      * <TOTEM:EPT. INIT:bnotacr, FD:tcodpag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcodpag
           IF NOT Valid-status-tcodpag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bnotacr, FD:tcodpag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tcaumag.
      * <TOTEM:EPT. INIT:bnotacr, FD:tcaumag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcaumag
           IF NOT Valid-STATUS-tcaumag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bnotacr, FD:tcaumag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-param.
      * <TOTEM:EPT. INIT:bnotacr, FD:param, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT param
           IF NOT Valid-STATUS-param
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bnotacr, FD:param, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tcontat.
      * <TOTEM:EPT. INIT:bnotacr, FD:tcontat, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcontat
           IF NOT Valid-STATUS-tcontat
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bnotacr, FD:tcontat, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tnazioni.
      * <TOTEM:EPT. INIT:bnotacr, FD:tnazioni, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tnazioni
           IF NOT Valid-STATUS-tnazioni
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bnotacr, FD:tnazioni, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmagaz.
      * <TOTEM:EPT. INIT:bnotacr, FD:tmagaz, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tmagaz
           IF NOT Valid-STATUS-tmagaz
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bnotacr, FD:tmagaz, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-btnotacr.
      * <TOTEM:EPT. INIT:bnotacr, FD:btnotacr, BeforeClose>
      * <TOTEM:END>
           CLOSE btnotacr
           .

       CLOSE-tparamge.
      * <TOTEM:EPT. INIT:bnotacr, FD:tparamge, BeforeClose>
      * <TOTEM:END>
           CLOSE tparamge
           .

       CLOSE-brnotacr.
      * <TOTEM:EPT. INIT:bnotacr, FD:brnotacr, BeforeClose>
      * <TOTEM:END>
           CLOSE brnotacr
           .

       CLOSE-destini.
      * <TOTEM:EPT. INIT:bnotacr, FD:destini, BeforeClose>
      * <TOTEM:END>
           CLOSE destini
           .

       CLOSE-clienti.
      * <TOTEM:EPT. INIT:bnotacr, FD:clienti, BeforeClose>
      * <TOTEM:END>
           CLOSE clienti
           .

       CLOSE-articoli.
      * <TOTEM:EPT. INIT:bnotacr, FD:articoli, BeforeClose>
      * <TOTEM:END>
           CLOSE articoli
           .

       CLOSE-tordini.
      * <TOTEM:EPT. INIT:bnotacr, FD:tordini, BeforeClose>
      * <TOTEM:END>
           CLOSE tordini
           .

       CLOSE-rordini.
      * <TOTEM:EPT. INIT:bnotacr, FD:rordini, BeforeClose>
      * <TOTEM:END>
           CLOSE rordini
           .

       CLOSE-progmag.
      * <TOTEM:EPT. INIT:bnotacr, FD:progmag, BeforeClose>
      * <TOTEM:END>
           CLOSE progmag
           .

       CLOSE-timballi.
      * <TOTEM:EPT. INIT:bnotacr, FD:timballi, BeforeClose>
      * <TOTEM:END>
           CLOSE timballi
           .

       CLOSE-timbalqta.
      * <TOTEM:EPT. INIT:bnotacr, FD:timbalqta, BeforeClose>
      * <TOTEM:END>
           CLOSE timbalqta
           .

       CLOSE-tmp-progmag-zoom.
      * <TOTEM:EPT. INIT:bnotacr, FD:tmp-progmag-zoom, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-tvettori.
      * <TOTEM:EPT. INIT:bnotacr, FD:tvettori, BeforeClose>
      * <TOTEM:END>
           CLOSE tvettori
           .

       CLOSE-ttipocli.
      * <TOTEM:EPT. INIT:bnotacr, FD:ttipocli, BeforeClose>
      * <TOTEM:END>
           CLOSE ttipocli
           .

       CLOSE-tmarche.
      * <TOTEM:EPT. INIT:bnotacr, FD:tmarche, BeforeClose>
      * <TOTEM:END>
           CLOSE tmarche
           .

       CLOSE-tpiombo.
      * <TOTEM:EPT. INIT:bnotacr, FD:tpiombo, BeforeClose>
      * <TOTEM:END>
           CLOSE tpiombo
           .

       CLOSE-tivaese.
      * <TOTEM:EPT. INIT:bnotacr, FD:tivaese, BeforeClose>
      * <TOTEM:END>
           CLOSE tivaese
           .

       CLOSE-timposte.
      * <TOTEM:EPT. INIT:bnotacr, FD:timposte, BeforeClose>
      * <TOTEM:END>
           CLOSE timposte
           .

       CLOSE-tmp-fatturati.
      * <TOTEM:EPT. INIT:bnotacr, FD:tmp-fatturati, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-tcodpag.
      * <TOTEM:EPT. INIT:bnotacr, FD:tcodpag, BeforeClose>
      * <TOTEM:END>
           CLOSE tcodpag
           .

       CLOSE-tcaumag.
      * <TOTEM:EPT. INIT:bnotacr, FD:tcaumag, BeforeClose>
      * <TOTEM:END>
           CLOSE tcaumag
           .

       CLOSE-param.
      * <TOTEM:EPT. INIT:bnotacr, FD:param, BeforeClose>
      * <TOTEM:END>
           CLOSE param
           .

       CLOSE-tcontat.
      * <TOTEM:EPT. INIT:bnotacr, FD:tcontat, BeforeClose>
      * <TOTEM:END>
           CLOSE tcontat
           .

       CLOSE-tnazioni.
      * <TOTEM:EPT. INIT:bnotacr, FD:tnazioni, BeforeClose>
      * <TOTEM:END>
           CLOSE tnazioni
           .

       CLOSE-tmagaz.
      * <TOTEM:EPT. INIT:bnotacr, FD:tmagaz, BeforeClose>
      * <TOTEM:END>
           CLOSE tmagaz
           .
      ...
      * DISPLAY-COLUMNS settings
           ...
           103, 115, 127, 139)
              MODIFY gd-fatt, DISPLAY-COLUMNS (1, 6, 14, 51, 60, 73, 
      ...
      * TAB
           ...
           TAB-TO-ADD = (
                 ...
                 " - Sezione Righe &Nota Credito - ",
                 " - Sezione Righe Nota &Addebito - ",
                 "- Sezione Righe Merce &Rotta -",
                        )
           MOVE 0 TO 
      ...
      * Generazione stringa perform CONTROLLO
      ...
      -    "debito" to TOTEM-HINT-TEXT
           ...
           WHEN 5020 MOVE "Digitare il prezzo unitario" to 
           TOTEM-HINT-TEXT
           WHEN 5021 MOVE "Valore imposta sul consumo" to 
           TOTEM-HINT-TEXT
           WHEN 5022 MOVE "Valore imposta COU/COBAT" to TOTEM-HINT-TEXT
           WHEN 5023 MOVE "Valore addizionale piombo" to TOTEM-HINT-TEXT
           WHEN 5024 MOVE "Valore imponibile della merce" to 
           TOTEM-HINT-TEXT
           WHEN 5025 MOVE "Codice I.V.A." to TOTEM-HINT-TEXT
           ...
           When 5020 PERFORM ef-uni-BeforeProcedure
           When 5021 PERFORM ef-cons-BeforeProcedure
           When 5022 PERFORM ef-cou-BeforeProcedure
           When 5023 PERFORM ef-cou-BeforeProcedure
           When 5024 PERFORM ef-imp-BeforeProcedure
       ...
       Form1-AfterProcedure.
           ...
           When 5018 PERFORM ef-art-AfterProcedure
           When 5019 PERFORM ef-qta-AfterProcedure
           When 5020 PERFORM ef-uni-AfterProcedure
           When 5021 PERFORM ef-cons-AfterProcedure
           When 5022 PERFORM ef-cou-AfterProcedure
           When 5023 PERFORM ef-cou-AfterProcedure
           When 5024 PERFORM ef-imp-AfterProcedure
       ...
       form1-gd-1-Event-Proc.
           ...
           WHEN Msg-Begin-Drag ALSO 54 ALSO
                    Form1-handle 
              PERFORM form1-gd-2-Ev-Msg-Begin-Drag
           WHEN Msg-Begin-Entry ALSO 54 ALSO
                    Form1-handle 
              PERFORM form1-gd-2-Ev-Msg-Begin-Entry
           WHEN Msg-Cancel-Entry ALSO 54 ALSO
                    Form1-handle 
              PERFORM form1-gd-2-Ev-Msg-Cancel-Entry
           WHEN Msg-End-Drag ALSO 54 ALSO
                    Form1-handle 
              PERFORM form1-gd-2-Ev-Msg-End-Drag
           WHEN Msg-Finish-Entry ALSO 54 ALSO
                    Form1-handle 
              PERFORM form1-gd-2-Ev-Msg-Finish-Entry
           WHEN Msg-Goto-Cell ALSO 54 ALSO
                    Form1-handle 
              PERFORM form1-gd-2-Ev-Msg-Goto-Cell
           WHEN Msg-Goto-Cell-Drag ALSO 54 ALSO
                    Form1-handle 
              PERFORM form1-gd-2-Ev-Msg-Goto-Cell-Drag
           WHEN Msg-Goto-Cell-Mouse ALSO 54 ALSO
                    Form1-handle 
              PERFORM form1-gd-2-Ev-Msg-Goto-Cell-Mouse
           WHEN Msg-Begin-Drag ALSO 121 ALSO
                    Form1-handle 
              PERFORM form1-gd-3-Ev-Msg-Begin-Drag
           WHEN Msg-Begin-Entry ALSO 121 ALSO
                    Form1-handle 
              PERFORM form1-gd-3-Ev-Msg-Begin-Entry
           WHEN Msg-Cancel-Entry ALSO 121 ALSO
                    Form1-handle 
              PERFORM form1-gd-3-Ev-Msg-Cancel-Entry
           WHEN Msg-End-Drag ALSO 121 ALSO
                    Form1-handle 
              PERFORM form1-gd-3-Ev-Msg-End-Drag
           WHEN Msg-Finish-Entry ALSO 121 ALSO
                    Form1-handle 
              PERFORM form1-gd-3-Ev-Msg-Finish-Entry
           WHEN Msg-Goto-Cell ALSO 121 ALSO
                    Form1-handle 
              PERFORM form1-gd-3-Ev-Msg-Goto-Cell
           WHEN Msg-Goto-Cell-Drag ALSO 121 ALSO
                    Form1-handle 
              PERFORM form1-gd-3-Ev-Msg-Goto-Cell-Drag
           WHEN Msg-Goto-Cell-Mouse ALSO 121 ALSO
                    Form1-handle 
              PERFORM form1-gd-3-Ev-Msg-Goto-Cell-Mouse
           END-EVALUATE
           .
       ...
       gd-pag2-Event-Proc.
           EVALUATE Event-Type ALSO Event-Control-Id ALSO
                                    Event-Window-Handle
           WHEN Msg-Begin-Drag ALSO 120 ALSO
                    Form1-handle 
              PERFORM gd-pag2-Ev-Msg-Begin-Drag
           WHEN Msg-Begin-Entry ALSO 120 ALSO
                    Form1-handle 
              PERFORM gd-pag2-Ev-Msg-Begin-Entry
           WHEN Msg-End-Drag ALSO 120 ALSO
                    Form1-handle 
              PERFORM gd-pag2-Ev-Msg-End-Drag
           WHEN Msg-Goto-Cell ALSO 120 ALSO
                    Form1-handle 
              PERFORM gd-pag2-Ev-Msg-Goto-Cell
           WHEN Msg-Goto-Cell-Drag ALSO 120 ALSO
                    Form1-handle 
              PERFORM gd-pag2-Ev-Msg-Goto-Cell-Drag
           WHEN Msg-Goto-Cell-Mouse ALSO 120 ALSO
                    Form1-handle 
       ...
       gd-pag3-Event-Proc.
           EVALUATE Event-Type ALSO Event-Control-Id ALSO
                                    Event-Window-Handle
           WHEN Msg-Begin-Drag ALSO 124 ALSO
                    Form1-handle 
              PERFORM gd-pag3-Ev-Msg-Begin-Drag
           WHEN Msg-Begin-Entry ALSO 124 ALSO
                    Form1-handle 
              PERFORM gd-pag3-Ev-Msg-Begin-Entry
           WHEN Msg-End-Drag ALSO 124 ALSO
                    Form1-handle 
              PERFORM gd-pag3-Ev-Msg-End-Drag
           WHEN Msg-Goto-Cell ALSO 124 ALSO
                    Form1-handle 
              PERFORM gd-pag3-Ev-Msg-Goto-Cell
           WHEN Msg-Goto-Cell-Drag ALSO 124 ALSO
                    Form1-handle 
              PERFORM gd-pag3-Ev-Msg-Goto-Cell-Drag
           WHEN Msg-Goto-Cell-Mouse ALSO 124 ALSO
                    Form1-handle 
      ...
      * <TOTEM:PARA. notacr-Ev-Before-Program>
           ...
           move "Creazione Bozza per Nota Credito/Addebito" to titolo 
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. gd-pag3-Ev-Msg-Goto-Cell-Mouse>
           ...
           .
      * <TOTEM:END>
       form1-gd-3-Ev-Msg-Begin-Drag.
      * <TOTEM:PARA. form1-gd-3-Ev-Msg-Begin-Drag>
           perform SPOSTAMENTO3 
           .
      * <TOTEM:END>
       form1-gd-3-Ev-Msg-Begin-Entry.
      * <TOTEM:PARA. form1-gd-3-Ev-Msg-Begin-Entry>
           perform FORM1-GD-2-BEGIN-ENTRY 
           .
      * <TOTEM:END>
       form1-gd-3-Ev-Msg-Cancel-Entry.
      * <TOTEM:PARA. form1-gd-3-Ev-Msg-Cancel-Entry>
           perform RESETTA-VIRGOLA 
           .
      * <TOTEM:END>
       form1-gd-3-Ev-Msg-End-Drag.
      * <TOTEM:PARA. form1-gd-3-Ev-Msg-End-Drag>
           perform SPOSTAMENTO3 
           .
      * <TOTEM:END>
       form1-gd-3-Ev-Msg-Goto-Cell.
      * <TOTEM:PARA. form1-gd-3-Ev-Msg-Goto-Cell>
           perform SPOSTAMENTO3 
           .
      * <TOTEM:END>
       form1-gd-3-Ev-Msg-Goto-Cell-Drag.
      * <TOTEM:PARA. form1-gd-3-Ev-Msg-Goto-Cell-Drag>
           perform SPOSTAMENTO3 
           .
      * <TOTEM:END>
       form1-gd-3-Ev-Msg-Goto-Cell-Mouse.
      * <TOTEM:PARA. form1-gd-3-Ev-Msg-Goto-Cell-Mouse>
           perform SPOSTAMENTO3 
           .
      * <TOTEM:END>
