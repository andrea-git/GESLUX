      ...
      * COSTANTI
       78  titolo  value "Stampa password scadute".
      ...
      ***---
       INIT.
           ...
           string wstampa             delimited low-value
                  "password_scadute"  delimited size
                  "_"                 delimited size
      ...
      ***---
       SCRIVI-UTENTE.
           ...
           move user-name  to r-nome-utente
