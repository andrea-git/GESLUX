      *{TOTEM}PRG-COMMENT
      * timballi.Cbl
      * timballi.Cbl is generated by TOTEM
      ...
      *{TOTEM}PRGID
       ...
       DATE-WRITTEN.        martedì 1 aprile 2014 19:19:54.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:timballi, INIT:timballi, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       77 Form1-Tb-1-Handle
                  USAGE IS HANDLE OF WINDOW.
       78 titolo VALUE IS "Geslux - Tabella Imballi". 
       77 E-ESCI           PIC  9
                  VALUE IS 1.
       77 E-NUOVO          PIC  9
                  VALUE IS 1.
       ...
       01 old-imb-rec.
           03 old-imb-chiave.
               05 old-imb-codice   PIC  x(3).
           03 old-imb-dati.
               05 old-imb-descrizione          PIC  x(50).
               05 old-imb-qta-imb  PIC  9(4).
               05 old-imb-dati-comuni.
                   10 old-imb-data-creazione       PIC  9(8).
                   10 old-imb-ora-creazione        PIC  9(8).
                   10 old-imb-utente-creazione     PIC  x(10).
                   10 old-imb-data-ultima-modifica PIC  9(8).
                   10 old-imb-ora-ultima-modifica  PIC  9(8).
                   10 old-imb-utente-ultima-modifica           PIC  
           x(10).
               05 old-imb-vuoti.
                   10 old-imb-num-vuoto-1          PIC  9(15).
                   10 old-imb-num-vuoto-2          PIC  9(15).
                   10 old-imb-num-vuoto-3          PIC  9(15).
                   10 old-imb-alfa-vuoto-1         PIC  x(20).
                   10 old-imb-alfa-vuoto-2         PIC  x(20).
                   10 old-imb-alfa-vuoto-3         PIC  x(20).
      ...
      ***********************************************************
       ...
       77 TMP-Form1-timballi-RESTOREBUF  PIC X(210).
       77 TMP-Form1-KEYIS  PIC 9(3) VALUE 1.
       77 Form1-MULKEY-TMPBUF   PIC X(210).
      ...
      * FILE'S LOCK MODE FLAG
       ...
       77 DataSet1-timballi-KEY1-ORDER  PIC X VALUE "A".
          88 DataSet1-timballi-KEY1-Asc  VALUE "A".
          88 DataSet1-timballi-KEY1-Desc VALUE "D".
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:timballi, INIT:timballi, BeforeDeclarative>
      ...
      * <TOTEM:EPT. INIT:timballi, INIT:timballi, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-timballi.
      * <TOTEM:EPT. INIT:timballi, FD:timballi, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O timballi
           IF STATUS-timballi = "35"
              OPEN OUTPUT timballi
                IF Valid-STATUS-timballi
                   CLOSE timballi
                   OPEN I-O timballi
                END-IF
           END-IF
           ...
           END-IF
      * <TOTEM:EPT. INIT:timballi, FD:timballi, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-timballi.
      * <TOTEM:EPT. INIT:timballi, FD:timballi, BeforeClose>
      * <TOTEM:END>
           CLOSE timballi
           .
       ...
       DataSet1-Change-CurrentKey-Asc.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              MOVE "A" TO DataSet1-timballi-KEY1-ORDER
           END-EVALUATE
           .
       ...
       DataSet1-Change-CurrentKey-Desc.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              MOVE "D" TO DataSet1-timballi-KEY1-ORDER
           END-EVALUATE
           .
      ...
      * GRID
       ...
       Form1-First.
           ...
           PERFORM DataSet1-timballi-INITSTART
           PERFORM DataSet1-timballi-START
           IF NOT Valid-STATUS-timballi
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
           PERFORM DataSet1-timballi-Read-Next
           IF NOT Valid-STATUS-timballi
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Previous.
              PERFORM Form1-Buf-To-Fld
              PERFORM DataSet1-timballi-START-LESS
           IF NOT Valid-STATUS-timballi
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
           PERFORM DataSet1-timballi-Read-Prev
           IF NOT Valid-STATUS-timballi
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Next.
              PERFORM Form1-Buf-To-Fld
              PERFORM DataSet1-timballi-START-GREATER
           IF NOT Valid-STATUS-timballi
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Last.
           ...
           PERFORM DataSet1-timballi-INITEND
           PERFORM DataSet1-timballi-START-NOTGREATER
           IF NOT Valid-STATUS-timballi
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
      * write
           PERFORM DataSet1-timballi-Rec-Write
           IF Valid-STATUS-timballi
      ...
      * <TOTEM:END>
      * write
           PERFORM DataSet1-timballi-Rec-Rewrite
           IF Valid-STATUS-timballi
      ...
      * delete
           PERFORM Form1-Buf-To-Fld
           PERFORM DataSet1-timballi-Rec-Delete
           IF Valid-STATUS-timballi
              PERFORM Form1-CLEAR
              PERFORM Form1-DUMMY-DELETE-INIT
              MOVE "303" TO TOTEM-MSG-ID
              MOVE "00" to STATUS-timballi
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Save-Status.
           MOVE DataSet1-timballi-KEY1-ORDER TO TMP-Form1-KEY1-ORDER
           MOVE DataSet1-KEYIS TO TMP-Form1-KEYIS
           MOVE imb-rec OF timballi TO 
              TMP-Form1-timballi-RESTOREBUF
           .             

       Form1-Restore-Status.
           MOVE TMP-Form1-KEY1-ORDER TO DataSet1-timballi-KEY1-ORDER
           MOVE TMP-Form1-KEYIS TO DataSet1-KEYIS
           MOVE TMP-Form1-timballi-RESTOREBUF TO
              imb-rec OF timballi
           PERFORM DataSet1-timballi-START
           IF Valid-STATUS-timballi
              PERFORM DataSet1-timballi-Read-Next
           ELSE
              PERFORM DataSet1-timballi-INITREC
           END-IF
           PERFORM UNTIL NOT Valid-STATUS-timballi OR
              (Valid-STATUS-timballi AND
                 imb-rec OF timballi = 
                   TMP-Form1-timballi-RESTOREBUF)
              PERFORM DataSet1-timballi-Read-Next
           END-PERFORM
      ...
      * <TOTEM:PARA. LOAD-RECORD>
           ...
           move low-value to imb-codice.
           start timballi key is >= imb-chiave
                  invalid continue
              not invalid
      ...
      *--->modifica (isacco)
           if nuovo 
              ...
              if mod = 1
                 close timballi
                 open i-o timballi allowing readers
              else
                 set tutto-ok to true
                 if NoSalvato
                    move 1 to mod
      ...
      * <TOTEM:PARA. NUOVO>
           ...
           if tutto-ok
              ...
              initialize old-imb-rec replacing numeric data by zeroes
                                          alphanumeric data by spaces
      ...
      * <TOTEM:PARA. VALORE-RIGA>
           inquire form1-gd-1(riga, 1), cell-data imb-codice.
           inquire form1-gd-1(riga, 2), cell-data imb-descrizione  
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. VALORE-OLD-RIGA>
           if vecchio
              inquire form1-gd-1(riga, 1) cell-data old-imb-codice
              move old-imb-codice         to imb-codice
              read timballi               no lock
              move imb-rec                to old-imb-rec
           else
              initialize old-imb-rec replacing numeric data by zeroes
                                          alphanumeric data by spaces
           end-if 
      ...
      *    se non ho valorizzato i campi di creazione li valorizzo
           if imb-data-creazione = zero
              accept imb-data-creazione from century-date
           end-if.
           if imb-ora-creazione = zero
              accept imb-ora-creazione from time
           end-if.
           if imb-utente-creazione = space
              move user-codi to imb-utente-creazione
           end-if.

           accept imb-data-ultima-modifica from century-date.
           accept imb-ora-ultima-modifica from time.
           move user-codi to imb-utente-ultima-modifica 
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. form1-gd-1-Ev-Msg-Begin-Entry>
           ...
           if colonna = 1
              if imb-codice not = zero and imb-codice not = spaces
                 set event-action to event-action-fail
              end-if
           else 
              if mod = zero
