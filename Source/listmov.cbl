      *{TOTEM}PRG-COMMENT
      * listmov.Cbl
      * listmov.Cbl is generated by TOTEM
      ...
      *{TOTEM}PRGID
       ...
       DATE-WRITTEN.        martedì 1 aprile 2014 19:17:19.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:listmov, INIT:listmov, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       77 uscite-s1-z      PIC  ----.---.---.--9,999.
       77 uscite-s2-z      PIC  ----.---.---.--9,999.
       ...
       01 rec-grid.
           ...
           05 col-uscite-s1    PIC  x(20).
           05 col-uscite-s2    PIC  x(20).
           05 col-giacenza     PIC  x(20).
       77 scr-visua-handle
                  USAGE IS HANDLE OF WINDOW.
       77 tot-entrate      PIC  s9(15)v999.
       77 tot-uscite-s1    PIC  s9(15)v999.
       77 tot-uscite-s2    PIC  s9(15)v999.
       77 tot-giacenza     PIC  s9(15)v999.
       77 como-entrate     PIC  s9(15)v999.
       77 como-uscite-s1   PIC  s9(15)v999.
       77 como-uscite-s2   PIC  s9(15)v999.
      ...
      * GRID
       05
           ...
           BOXED,
           CENTERED-HEADINGS,
           DATA-COLUMNS (1, 9, 29, 49, 69),
           ALIGNMENT ("C", "R", "R", "R", "R"),
           SEPARATION (5, 5, 5, 5, 5),
           DATA-TYPES ("D(8)", "X", "X", "X", "X"),
           NUM-COL-HEADINGS 1,
           COLUMN-HEADINGS,
           CURSOR-FRAME-WIDTH 0,
           DIVIDER-COLOR 1,
      ...
      * GRID
       05
           ...
           BOXED,
           CENTERED-HEADINGS,
           DATA-COLUMNS (1, 9, 28, 47, 66),
           ALIGNMENT ("C", "R", "R", "R", "R"),
           SEPARATION (5, 5, 5, 5, 5),
           DATA-TYPES ("D(10)", "X", "X", "X", "X"),
           CURSOR-FRAME-WIDTH 0,
           DIVIDER-COLOR 1,
           HEADING-COLOR 257,
           HEADING-DIVIDER-COLOR 1,
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:listmov, INIT:listmov, BeforeDeclarative>
      ***---
      ...
      * <TOTEM:EPT. INIT:listmov, INIT:listmov, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-tparamge.
      * <TOTEM:EPT. INIT:listmov, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           ...
           END-IF
      * <TOTEM:EPT. INIT:listmov, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-anautf.
      * <TOTEM:EPT. INIT:listmov, FD:anautf, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT anautf
           IF NOT Valid-STATUS-anautf
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:listmov, FD:anautf, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-lineseq.
      * <TOTEM:EPT. INIT:listmov, FD:lineseq, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT lineseq
           IF NOT Valid-STATUS-lineseq
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:listmov, FD:lineseq, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-tparamge.
      * <TOTEM:EPT. INIT:listmov, FD:tparamge, BeforeClose>
      * <TOTEM:END>
           CLOSE tparamge
           .

       CLOSE-anautf.
      * <TOTEM:EPT. INIT:listmov, FD:anautf, BeforeClose>
      * <TOTEM:END>
           CLOSE anautf
           .

       CLOSE-lineseq.
      * <TOTEM:EPT. INIT:listmov, FD:lineseq, BeforeClose>
      * <TOTEM:END>
           .
      ...
      * CELLS' SETTING
              MODIFY gd1, X = 3, Y = 1,
                CELL-DATA = "Uscite Kg. 1",
      * CELLS' SETTING
              MODIFY gd1, X = 4, Y = 1,
                CELL-DATA = "Uscite Kg. 2",
           .
      ...
      * <TOTEM:EPT. FORM:screen1, FORM:screen1, BeforeAccept>
           move 0 to tot-entrate tot-uscite-s1 tot-uscite-s2.
           ...
           perform until 1 = 2
              ...
              move line-riga(34:20) to col-uscite-s1 
              move line-riga(57:20) to col-uscite-s2
              if listmov-data-from-anautf
                 move line-riga(82:20) to col-giacenza
                 modify gd2,(riga, 1), cell-data = col-data
                 modify gd2,(riga, 2), cell-data = col-entrate
                 modify gd2,(riga, 3), cell-data = col-uscite-s1
                 modify gd2,(riga, 4), cell-data = col-uscite-s2
                 modify gd2,(riga, 5), cell-data = col-giacenza
              else
                 modify gd1,(riga, 1), cell-data = col-data
                 modify gd1,(riga, 2), cell-data = col-entrate
                 modify gd1,(riga, 3), cell-data = col-uscite-s1
                 modify gd1,(riga, 4), cell-data = col-uscite-s2
              end-if
           end-perform.
           close lineseq.
           ...
           if listmov-data-from-anautf
              ...
              perform varying riga from 2 by 1 until riga > tot-righe
                 ...
                 inquire gd2(riga, 3), cell-data in como-uscite-s1
                 inquire gd2(riga, 4), cell-data in como-uscite-s2
                 add como-entrate      to tot-entrate
                 add como-uscite-s1    to tot-uscite-s1
                 add como-uscite-s2    to tot-uscite-s2
              end-perform
              modify gd-tot2, reset-grid = 1
              perform GD-TOT2-CONTENT
              move tot-entrate to entrate-z
              move tot-uscite-s1  to uscite-s1-z
              move tot-uscite-s2  to uscite-s2-z
              move link-finale to giacenza-z
              modify gd-tot2(1, 2), cell-data = entrate-z
              modify gd-tot2(1, 3), cell-data = uscite-s1-z
              modify gd-tot2(1, 4), cell-data = uscite-s2-z
              modify gd-tot2(1, 5), cell-data = giacenza-z
              ...
              perform varying riga from 2 by 1 until riga > tot-righe
                 ...
                 inquire gd1(riga, 3), cell-data in como-uscite-s1
                 inquire gd1(riga, 4), cell-data in como-uscite-s2
                 add como-entrate to tot-entrate
                 add como-uscite-s1  to tot-uscite-s1
                 add como-uscite-s2  to tot-uscite-s2
              end-perform
              ...
              modify gd-tot(1, 3), cell-data = uscite-s1-z
              modify gd-tot(1, 4), cell-data = uscite-s2-z
      ...
      * DISPLAY-COLUMNS settings
              MODIFY gd1, DISPLAY-COLUMNS (1, 16, 34, 52)
              MODIFY gd-tot, DISPLAY-COLUMNS (1, 16, 34, 52)
           .
      ...
      * DISPLAY-COLUMNS settings
              MODIFY gd2, DISPLAY-COLUMNS (1, 16, 34, 52, 70)
              MODIFY gd-tot2, DISPLAY-COLUMNS (1, 16, 34, 52, 70)
           .
      ...
      *
           when 78-ID-ef-num-reg
                inquire ef-num-reg, value in ef-num-reg-buf
                move ef-num-reg-buf    to utf-num-reg
                move como-data-to(1:4) to utf-anno
                read anautf no lock
                     invalid
                 ...
                 not invalid
                     if utf-dettaglio
                        set errori to true
                        display message "Solo registro cumulativo"
                                  title tit-err
                                   icon 2
                     end-if
                     move utf-desc1 to lab-reg-buf
      ...
      * <TOTEM:PARA. pb-ok-LinkTo>
           ...
           if tutto-ok
              ...
              call   "listmov-p" using listmov-linkage
              cancel "listmov-p"
