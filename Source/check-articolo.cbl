      *{TOTEM}PRG-COMMENT
      * check-articolo.Cbl
      * check-articolo.Cbl is generated by TOTEM
      * This is a generated file. DO NOT modify this file directly.
      *{TOTEM}END
       IDENTIFICATION       DIVISION.
      *{TOTEM}PRGID
       PROGRAM-ID.          check-articolo.
       AUTHOR.              ANDREA EVENTI.
       DATE-WRITTEN.        martedì 1 aprile 2014 19:13:48.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:check-articolo, INIT:check-articolo, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       78 titolo VALUE IS "Controllo Articolo". 
      ...
      *{TOTEM}COPY-PROCEDURE
       EXIT-STOP-ROUTINE.
      * <TOTEM:EPT. INIT:check-articolo, INIT:check-articolo, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. pb-sib-LinkTo>
           ...
           if tutto-ok
              ...
              if cbo-tipo-buf = "Ordini" set ordini       to true
              else                       set note-credito to true
              end-if
              move 0 to link-result
              call "W$MOUSE" using set-mouse-shape, wait-pointer
              call   "check-articolo-p" using form1-handle, 
                                              link-result,
                                              anno-to,
                                              num-from,
                                              num-to,
