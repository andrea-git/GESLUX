      *{TOTEM}PRG-COMMENT
      * azzstat.Cbl
      * azzstat.Cbl is generated by TOTEM
      ...
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:azzstat, INIT:azzstat, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * LABEL
       05
           ...
           WIDTH-IN-CELLS,
           TRANSPARENT,
           TITLE "Azzeramento Statistiche con raffronti per mese in cors
      -    "o...",
           .
      ...
      * LABEL
       05
           ...
           WIDTH-IN-CELLS,
           TRANSPARENT,
           TITLE "Azzeramento Statistiche settoriali con raffronti per m
      -    "ese in corso...",
           .
      ...
      * LABEL
       05
           ...
           WIDTH-IN-CELLS,
           TRANSPARENT,
           TITLE "Aggiornamento DEFINITIVO e IRREVERSIBILE!             
      ...
      * LABEL
       05
           ...
           WIDTH-IN-CELLS,
           TRANSPARENT,
           TITLE "- Statistiche settoriali con raffronti per mese (statr
      -    "aff)",
           .
      ...
      * LABEL
       05
           ...
           WIDTH-IN-CELLS,
           TRANSPARENT,
           TITLE "- Statistiche con raffronti per mese (statsett)",
           .
      ...
      *{TOTEM}COPY-PROCEDURE
       EXIT-STOP-ROUTINE.
      * <TOTEM:EPT. INIT:azzstat, INIT:azzstat, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      * <TOTEM:EPT. FORM:Screen1, FORM:Screen1, BeforeAccept>
           ...
           call   "azzstatraff-p" using screen1-handle.
      ...
      * <TOTEM:EPT. FORM:Screen1a, FORM:Screen1a, BeforeAccept>
           call  "W$MOUSE" using set-mouse-shape, wait-pointer.
           call   "azzstatsett-p" using form1a-handle.
