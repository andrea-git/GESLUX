      *{TOTEM}PRG-COMMENT
      * 08utf-daylist.Cbl
      * 08utf-daylist.Cbl is generated by TOTEM
      ...
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:08utf-daylist, INIT:08utf-daylist, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:08utf-daylist, INIT:08utf-daylist, BeforeDeclarative>
      ***---
       ANAUTF-ERR SECTION.
      ...
      * <TOTEM:EPT. INIT:08utf-daylist, INIT:08utf-daylist, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-anautf.
      * <TOTEM:EPT. INIT:08utf-daylist, FD:anautf, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT anautf
           ...
           END-IF
      * <TOTEM:EPT. INIT:08utf-daylist, FD:anautf, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-anautf.
      * <TOTEM:EPT. INIT:08utf-daylist, FD:anautf, BeforeClose>
      * <TOTEM:END>
           CLOSE anautf
           .
...
LUBEXX        end-evaluate
              call   "08utf-daylist-p" using utf-daylist-linkage
              cancel "08utf-daylist-p"
