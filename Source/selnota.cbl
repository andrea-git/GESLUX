      ...
      *{TOTEM}PRGID
       ...
       DATE-WRITTEN.        martedì 1 aprile 2014 19:18:48.
       REMARKS.
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       77 toolbar-bmp      PIC  S9(9)
                  ...
                  VALUE IS 0.
       77 num-edit         PIC  z(8).
       78 titolo VALUE IS "GESLUX - Creazione Nota Credito". 
       77 E-ESCI           PIC  9
                  VALUE IS 1.
       77 E-CERCA          PIC  9
                  VALUE IS 1.
      ...
      * PUSH BUTTON
       05
           ...
           ID IS 300,
           VISIBLE v-generico,
           AFTER PROCEDURE pb-abb-AfterProcedure, 
           BEFORE PROCEDURE pb-abb-BeforeProcedure, 
           .
      ...
      *    After Open
       ...
       OPEN-tordini.
      * <TOTEM:EPT. INIT:selnota, FD:tordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tordini
           ...
           END-IF
      * <TOTEM:EPT. INIT:selnota, FD:tordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-zoom-tordini.
      * <TOTEM:EPT. INIT:selnota, FD:zoom-tordini, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-zoom-tordini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selnota, FD:zoom-tordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tcaumag.
      * <TOTEM:EPT. INIT:selnota, FD:tcaumag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcaumag
           IF NOT Valid-STATUS-tcaumag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selnota, FD:tcaumag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-destini.
      * <TOTEM:EPT. INIT:selnota, FD:destini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT destini
           IF NOT Valid-STATUS-destini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selnota, FD:destini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-btnotacr.
      * <TOTEM:EPT. INIT:selnota, FD:btnotacr, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT btnotacr
           IF NOT Valid-STATUS-btnotacr
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selnota, FD:btnotacr, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-clienti.
      * <TOTEM:EPT. INIT:selnota, FD:clienti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT clienti
           IF NOT Valid-STATUS-clienti
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selnota, FD:clienti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmagaz.
      * <TOTEM:EPT. INIT:selnota, FD:tmagaz, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tmagaz
           IF NOT Valid-STATUS-tmagaz
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selnota, FD:tmagaz, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-tordini.
      * <TOTEM:EPT. INIT:selnota, FD:tordini, BeforeClose>
      * <TOTEM:END>
           CLOSE tordini
           .

       CLOSE-zoom-tordini.
      * <TOTEM:EPT. INIT:selnota, FD:zoom-tordini, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-tcaumag.
      * <TOTEM:EPT. INIT:selnota, FD:tcaumag, BeforeClose>
      * <TOTEM:END>
           CLOSE tcaumag
           .

       CLOSE-destini.
      * <TOTEM:EPT. INIT:selnota, FD:destini, BeforeClose>
      * <TOTEM:END>
           CLOSE destini
           .

       CLOSE-btnotacr.
      * <TOTEM:EPT. INIT:selnota, FD:btnotacr, BeforeClose>
      * <TOTEM:END>
           CLOSE btnotacr
           .

       CLOSE-clienti.
      * <TOTEM:EPT. INIT:selnota, FD:clienti, BeforeClose>
      * <TOTEM:END>
           CLOSE clienti
           .

       CLOSE-tmagaz.
      * <TOTEM:EPT. INIT:selnota, FD:tmagaz, BeforeClose>
      * <TOTEM:END>
           CLOSE tmagaz
           .
      ...
      * <TOTEM:PARA. CERCA>
           ...
           when 1003
                ...
                if stato-zoom = 0
                   ...
                   move btno-anno     to anno
                   modify ef-anno, VALUE anno
                   display ef-num-b
                end-if
           ...
           read btnotacr no lock
                ...
                display message "Bozza non caricata"
                          title tit-err
                           icon 2
            not invalid
                move btno-causale to save-btno-causale
                if tca-tipo-nota-abbuono
                   move Link-TipoNota to btno-causale
                end-if
                if Link-TipoNota not = btno-causale
                   display message 
                   "ATTENZIONE!!!"
            x"0d0a""Bozza non compatibile."
            x"0d0a""Scelta:  " Link-TipoNota
            x"0d0a""Bozza : " btno-causale
                             title tit-err
                              icon 2
                   set errori to true
                else
                   if btno-num-nc  not = 0 or
                      ...
                      btno-anno-nc not = 0
                      move btno-num-nc to num-edit
                      display message 
                      "ATTENZIONE!!!"
               x"0d0a""Già assegnata nota credito n. " num-edit"."
               x"0d0a""Proseguire comunque?"
                ...
                move save-btno-causale to btno-causale
           end-read
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. PB-ESEGUI-LinkTo>
           ...
           move       anno         to tor-anno-fattura btno-anno.
           ...
           if tor-num-fattura not = 0 and
              btno-numero     not = 0
              set errori to true
              display message "Inserire n. fattura o n. bozza"
                        title tit-err
                         icon 2
           end-if.

           if tor-num-fattura not = 0 and tutto-ok
              perform CONTROLLO-FATTURA
           end-if.

           if btno-numero not = 0 and tutto-ok
              perform CONTROLLO-BOZZA
              set LinkBozza    to true
           ...
           if tutto-ok
              ...
              if LinkFatt
                 ...
                 if btno-numero not = 0
                    ...
                    move "selnota"        to LinkPgm
                    move notacr-linkage   to SAVE-notacr-linkage
                    call   "bnotavar"  using lk-blockpgm,
                                             user-codi,
                                             livello-abil,
                                             notacr-linkage
                    cancel "bnotavar"
                    move LinkStatusNota to SAVE-LinkStatusNota
                    move SAVE-notacr-linkage   to notacr-linkage
                    move sav-livello-abil to livello-abil
                    if LinkStatusNota = 1
                       move mb-yes to scelta
                    else
      ...
      * <TOTEM:PARA. pb-diff-AfterProcedure>
           ...
           .
      * <TOTEM:END>
       pb-abb-BeforeProcedure.
      * <TOTEM:PARA. pb-abb-BeforeProcedure>
           modify pb-abb, bitmap-number = 6 
           .
      * <TOTEM:END>
       pb-abb-AfterProcedure.
      * <TOTEM:PARA. pb-abb-AfterProcedure>
           modify pb-abb, bitmap-number = 5 
           .
      * <TOTEM:END>
      ...
      * <TOTEM:END>
       pb-abb-LinkTo.
      * <TOTEM:PARA. pb-abb-LinkTo>
           evaluate mag-codice
           when "LBX" move "NCNC" to Link-TipoNota
           when "EXD" move "NNEX" to Link-TipoNota
           end-evaluate.
      *****     perform CONTROLLA-CAUSALE.
      *****     if tutto-ok
      *****        modify form1-handle, visible = 0
      ...
      *****     perform RESET-BOTTONI
      *****     modify pb-abb,  bitmap-number = 6.
      *****     move 300 to control-id.
      *****     move   4 to accept-control.
      *****     modify form1-handle, visible = 1.
      *****
      *****     move mag-cau-diff to Link-TipoNota.
      ...
      * <TOTEM:PARA. pb-reso-LinkTo>
           move mag-cau-reso to Link-TipoNota.
           perform ELABORA-CREAZIONE
           modify pb-reso, bitmap-number = 2.
      ...
      * <TOTEM:PARA. ef-mag-AfterProcedure>
           ...
           if mag-codice = "LBX" or 
              mag-codice = "EXD"
              move 1 to v-generico
           else
              move 0 to v-generico
           end-if.
