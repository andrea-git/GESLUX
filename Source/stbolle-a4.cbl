      *{TOTEM}PRG-COMMENT
      * stbolle-a4.Cbl
      * stbolle-a4.Cbl is generated by TOTEM
      * This is a generated file. DO NOT modify this file directly.
      *{TOTEM}END
       IDENTIFICATION       DIVISION.
      *{TOTEM}PRGID
       PROGRAM-ID.          stbolle-a4.
       AUTHOR.              andre.
       DATE-WRITTEN.        giovedì 20 giugno 2019 10:15:58.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:stbolle-a4, INIT:stbolle-a4, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       77 data-stampa-2    PIC  99/99/9999.
       77 como-stampante   PIC  x(100).
       77 printerToSet     PIC  x(100).
       78 titolo VALUE IS "Stampa Bolle A4". 
       01 file-info.
       ...
       77 Form1-Tb-1-Handleaa
                  USAGE IS HANDLE OF WINDOW.
       77 data-stampa-1    PIC  99/99/9999.
      ...
      *{TOTEM}ID-LOGICI
      ***** Elenco ID Logici *****
       78  78-ID-ef-data-1 VALUE 5001.
       78  78-ID-ef-data-2 VALUE 5002.
      ***** Fine ID Logici *****
      *{TOTEM}END
      ...
      * ENTRY FIELD
       05
           ...
           BOXED,
           COLOR IS 513,
           ID IS 78-ID-ef-data-2,                
           HEIGHT-IN-CELLS,
           WIDTH-IN-CELLS,
           CENTER,
           VALUE data-stampa-2,
           VISIBLE 0,
           AFTER PROCEDURE ef-data-2-AfterProcedure, 
           BEFORE PROCEDURE ef-data-BeforeProcedure, 
           .
      ...
      * LABEL
       05
           ...
           WIDTH-IN-CELLS,
           TRANSPARENT,
           TITLE "Data di stampa SERIE BOLLE 2",
           VISIBLE 0,
           .
      ...
      * LABEL
      ...
      -    "a data di stampa all'interno della tabella dei contatori.",
           .
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:stbolle-a4, INIT:stbolle-a4, BeforeDeclarative>
      ***---
       TCONTAT-ERR SECTION.
      ...
      * <TOTEM:EPT. INIT:stbolle-a4, INIT:stbolle-a4, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-tcontat.
      * <TOTEM:EPT. INIT:stbolle-a4, FD:tcontat, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcontat
           ...
           END-IF
      * <TOTEM:EPT. INIT:stbolle-a4, FD:tcontat, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tparamge.
      * <TOTEM:EPT. INIT:stbolle-a4, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           IF NOT Valid-STATUS-tparamge
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:stbolle-a4, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-tcontat.
      * <TOTEM:EPT. INIT:stbolle-a4, FD:tcontat, BeforeClose>
      * <TOTEM:END>
           CLOSE tcontat
           .

       CLOSE-tparamge.
      * <TOTEM:EPT. INIT:stbolle-a4, FD:tparamge, BeforeClose>
      * <TOTEM:END>
           CLOSE tparamge
           .
      ...
      * <TOTEM:EPT. FORM:Form1, FORM:Form1, BeforeAccept>
           ...
           move como-data to data-stampa-1 data-stampa-2.
           display ef-data-1 ef-data-2.
      ...
      * <TOTEM:PARA. CONTROLLO>
           set tutto-ok to true.
           inquire ef-data-1, value in data-stampa-1.
           move data-stampa-1 to como-data.

           perform DATE-FORMAT.

           move como-data   to data-stampa-1.
           display ef-data-1.
           ...
           if tge-anno not = como-data(5:4)
              ...
              if como-data < con-ult-stampa-bolle-gdo
                 display message "Data di stampa < data "
                                 ...
                                 con-ult-stampa-bolle-gdo(7:2) "/"
                                 con-ult-stampa-bolle-gdo(5:2) "/"
                                 con-ult-stampa-bolle-gdo(1:4)")"
                         title = tit-err
                         icon 2
                 set errori to true
              else
                 if como-data(5:2) not = con-ult-stampa-bolle-gdo(5:2)
                    ...
                    if como-data <= con-ult-stampa-fatt               
                       display message "La data dev'essere > a quella di
      -    " ultima fatturazione ("
                                       con-ult-stampa-fatt(7:2) "/"
                                       con-ult-stampa-fatt(5:2) "/"
                                       con-ult-stampa-fatt(1:4)")"
                               title = tit-err
                               icon 2
                       set errori to true
                    end-if
           ...
           if errori
              move 78-ID-ef-data-1 to control-id
              move 4               to accept-control
           else
              move data-stampa-1 to data-stampa-2
           end-if.

      *****     if tutto-ok
      *****        inquire ef-data-2, value in data-stampa-2
      *****        move data-stampa-2 to como-data
      *****
      *****        perform DATE-FORMAT
      *****
      *****        move como-data   to data-stampa-2
      *****        display ef-data-2
      *****
      *****        move spaces   to tge-codice
      *****        read tparamge no lock invalid continue end-read
      *****        if tge-anno not = como-data(5:4)
      *****           display message "L'anno di stampa SERIE 2 non coincide"
      *****                           " con quello d'esercizio."
      *****                   x"0d0a""Anno d'esercizio: ", tge-anno
      *****                   title = tit-err
      *****                   icon 2
      ...
      *****           perform DATE-TO-FILE
      *****
      *****           if como-data < con-ult-stampa-bolle-MV
      *****              display message "Data di stampa SERIE 2 < data "
      *****                              "di ultima stampa bolle"
      *****                      title = tit-err
      *****                      icon 2
      *****              set errori to true
      *****           else
      *****              if como-data(5:2) not = con-ult-stampa-bolle-MV(5:2)
      *****                 display message "Il mese di stampa SERIE 2 non coincide "
      *****                                 "con quello di ultima stampa bolle."
      *****                          x"0d0a""Mese di ultima stampa: " 
      *****                                 con-ult-stampa-bolle-MV(5:2)
      *****                         title = tit-err
      *****                         icon 2
      *****                 set errori to true
      *****              end-if
      ...
      *****
      *****        if errori
      *****           move 78-ID-ef-data-2 to control-id
      *****           move 4               to accept-control
      *****        end-if
      *****     end-if 
           .
      ...
      * <TOTEM:PARA. PB-ESEGUI-LinkTo>
           perform varying control-id from 78-ID-ef-data-1 by 1 
                     until control-id > 78-ID-ef-data-2
              perform CONTROLLO
              if errori
                 exit perform
              end-if
           ...
           if tutto-ok
              ...
              if scelta = MB-YES
                 ...
                 if scelta = MB-YES
                    ...
                    perform STAMPA-BOLLA     
  
                    if stbolle-giro not = 9

                       if stbolle-ultima-bolla > 0
                          set stbolle-ristampa to true        
                          move stbolle-prima-bolla  to stb-numero-da
                          move stbolle-ultima-bolla to stb-numero-a
           ...
           stbolle-path-riepilogo, file-info
                        
                          if file-size not = 0            
                             accept printerToSet from environment "STAMP
      -    "ANTE_RIEPILOGO_CORRIERI"
                             move printerToSet to 
      ...
      *****           accept printerToSet from environment "STAMPANTE_STBOLLE_SPLIT"
                 move printerToSet to splcrt2graf-percorso-stampa-u
                 move stbolle-split              
                   to splcrt2graf-percorso-stampa
                 set  splcrt2graf-stampa        to true
           ...
           call "C$DELETE" using stbolle-split
      ...
      * <TOTEM:PARA. pb-si-LinkTo>
           ...
           .
      * <TOTEM:END>
       ef-data-2-AfterProcedure.
      * <TOTEM:PARA. ef-data-2-AfterProcedure>
