      ...
      *****************************************************************
       ...
       77  path-OLD-sto-rordini         pic x(256).
       77  path-OLD-sto-mrordini        pic x(256).
       77  path-OLD-sto-rmovmag         pic x(256).
       77  path-OLD-sto-rnotacr         pic x(256).
       77  path-OLD-sto-rordforn        pic x(256).
       77  path-OLD-sto-provvig         pic x(256).
       77  path-OLD-sto-reva            pic x(256).
       77  path-OLD-sto-brnotacr        pic x(256).
           ...
           start OLD-ordfor2 key >= OLD-ord2-chiave
             ...
             not invalid
                 perform until 1 = 2                              
                    ...
                    move OLD-ord2-art-descrizione 
                      to ord2-art-descrizione          
      ...
      ***---
       CREA-RENAME-STO.                      
           perform NOME-FILE-UPPERCASE-STO.
           inspect nome-file replacing trailing spaces by low-value.                  
           add  interlinea      to line-file.
           ...
           move path-source to path-sto-rordini.
           move path-source to path-sto-mrordini.     
           move path-source to path-sto-rmovmag.      
           move path-source to path-sto-rnotacr.      
           move path-source to path-sto-rordforn.     
           move path-source to path-sto-provvig.      
           move path-source to path-sto-reva.         
           move path-source to path-sto-brnotacr.     
                                 
           move path-dest to path-OLD-sto-rordini.  
           move path-dest to path-OLD-sto-mrordini. 
           move path-dest to path-OLD-sto-rmovmag.  
           move path-dest to path-OLD-sto-rnotacr.  
           move path-dest to path-OLD-sto-rordforn. 
           move path-dest to path-OLD-sto-provvig.
           move path-dest to path-OLD-sto-reva.
           move path-dest to path-OLD-sto-brnotacr.
      ...
      ***---
       NOME-FILE-UPPERCASE-STO.
           initialize nome-file-upper.
           string "STO-"    delimited size
                  nome-file delimited size
             into nome-file-upper
           end-string.
           call "C$TOUPPER" using nome-file-upper, value 15.
