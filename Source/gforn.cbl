      ...
      * <TOTEM:END>
       ...
       OPEN-anacap.
      * <TOTEM:EPT. INIT:gforn, FD:anacap, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT anacap
           IF NOT Valid-STATUS-anacap
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gforn, FD:anacap, AfterOpen>
      * <TOTEM:END>
           .
      ...
      * Generazione stringa perform CONTROLLO
      ...
      -    "nto dell'evasione manuale" to TOTEM-HINT-TEXT
           ...
           TOTEM-HINT-TEXT
           WHEN 38 MOVE "Se attivo chiude l'ordine fornitore EXD al mome
      -    "nto dell'evasione manuale" to TOTEM-HINT-TEXT
      ...
      -    " o no delle imposte" to TOTEM-HINT-TEXT
           ...
           When 38 PERFORM Form1-DaCb-1-BeforeProcedure
       ...
       Form1-AfterProcedure.
           ...
           When 39 PERFORM Form1-DaCb-1-AfterProcedure
