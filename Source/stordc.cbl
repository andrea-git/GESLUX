      *{TOTEM}PRG-COMMENT
      * stordc.Cbl
      * stordc.Cbl is generated by TOTEM
      ...
      *{TOTEM}PRGID
       PROGRAM-ID.          stordc.
       AUTHOR.              andre.
       DATE-WRITTEN.        mercoledì 10 marzo 2021 13:00:42.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:stordc, INIT:stordc, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      *{TOTEM}COPY-PROCEDURE
       EXIT-STOP-ROUTINE.
      * <TOTEM:EPT. INIT:stordc, INIT:stordc, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      * <TOTEM:EPT. FORM:Screen2, FORM:Screen2, BeforeAccept>
           ...
           move 78-evasioni to cbo-stato-ord-buf
      ...
      ***---
       RIEMPI-COMBO-STATO-ORD.
           Modify cbo-stato-ord, item-to-add 78-evasioni.
           Modify cbo-stato-ord, item-to-add 78-gdo.
           Modify cbo-stato-ord, item-to-add 78-tutti.

      ***---
       CARICA-COMBO-STATO-ORD.
           evaluate true
           when evasioni move 78-evasioni to cbo-stato-ord-buf
           when GDO      move 78-gdo      to cbo-stato-ord-buf
      ...
      ***---
       SCARICA-COMBO-STATO-ORD.     
           ...
           when 78-evasioni set evasioni to true
           when 78-gdo      set GDO      to true
      ...
      * <TOTEM:PARA. PB-ESEGUI-LinkTo>
           ...
           if tutto-ok  
              ...
              move anno-to   to stordc-da-anno
              move anno-to   to stordc-a-anno
              move num-from  to stordc-da-num
              move num-to    to stordc-a-num

              move data-from(1:2)     to data-from-AAAAMMGG(7:2)
              move data-from(3:2)     to data-from-AAAAMMGG(5:2)
              move data-from(5:4)     to data-from-AAAAMMGG(1:4)
              move data-from-AAAAMMGG to stordc-da-data
              move data-to(1:2)       to data-to-AAAAMMGG(7:2)
              move data-to(3:2)       to data-to-AAAAMMGG(5:2)
              move data-to(5:4)       to data-to-AAAAMMGG(1:4)
              move data-to-AAAAMMGG   to stordc-a-data
