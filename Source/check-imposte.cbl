      *{TOTEM}PRG-COMMENT
      * check-imposte.Cbl
      * check-imposte.Cbl is generated by TOTEM
      * This is a generated file. DO NOT modify this file directly.
      *{TOTEM}END
       IDENTIFICATION       DIVISION.
      *{TOTEM}PRGID
       PROGRAM-ID.          check-imposte.
       AUTHOR.              ANDREA EVENTI.
       DATE-WRITTEN.        martedì 1 aprile 2014 19:13:50.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:check-imposte, INIT:check-imposte, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       01 tipo-doc         PIC  x.
           88 ordini VALUE IS "O". 
           88 note-credito VALUE IS "N". 
           88 movimenti VALUE IS "M". 
           88 ordini-f VALUE IS "F". 
       77 Small-Font
                  USAGE IS HANDLE OF FONT SMALL-FONT.
       78 titolo VALUE IS "Verifica Imposte". 
      ...
      * COMBO-BOX
       05
           ...
           UNSORTED,
           VALUE cbo-tipo-buf,
           AFTER PROCEDURE scr-elab-Cm-1-AfterProcedure, 
           BEFORE PROCEDURE scr-elab-Cm-1-BeforeProcedure, 
           .
      * PUSH BUTTON
       05
           pb-sib, 
      ...
      *{TOTEM}COPY-PROCEDURE
       EXIT-STOP-ROUTINE.
      * <TOTEM:EPT. INIT:check-imposte, INIT:check-imposte, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      * <TOTEM:EPT. FORM:form1, FORM:form1, BeforeAccept>
           ...
           modify cbo-tipo, item-to-add = "Ordini".
           modify cbo-tipo, item-to-add = "Note Credito".
           modify cbo-tipo, item-to-add = "Mov. Magazzino".
           modify cbo-tipo, item-to-add = "Ordini F.".
           move "Ordini" to cbo-tipo-buf.
      ...
      * <TOTEM:PARA. pb-sib-LinkTo>
           ...
           if tutto-ok
              ...
              when "Ordini"         set ordini       to true
              when "Note Credito"   set note-credito to true
              when "Mov. Magazzino" set movimenti    to true
              when "Ordini F."      set ordini-f     to true
              end-evaluate
              move 0 to link-result
              call "W$MOUSE" using set-mouse-shape, wait-pointer
              call   "check-imposte-p" using form1-handle, 
                                             link-result,
                                             anno-to,
                                             num-from,
                                             num-to,
      ...
      * <TOTEM:END>
       ...
       scr-elab-Cm-1-BeforeProcedure.
      * <TOTEM:PARA. scr-elab-Cm-1-BeforeProcedure>
           MODIFY CONTROL-HANDLE COLOR = COLORE-NU
           .
      * <TOTEM:END>
       scr-elab-Cm-1-AfterProcedure.
      * <TOTEM:PARA. scr-elab-Cm-1-AfterProcedure>
           MODIFY CONTROL-HANDLE COLOR = COLORE-OR
           .
      * <TOTEM:END>
