      *{TOTEM}PRG-COMMENT
      * wprogmagric.Cbl
      * wprogmagric.Cbl is generated by TOTEM
      ...
      *{TOTEM}PRGID
       ...
       AUTHOR.              andre.
       DATE-WRITTEN.        lunedì 9 settembre 2024 19:06:36.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:wprogmagric, INIT:wprogmagric, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       01 FILLER           PIC  9
                  VALUE IS 0.
           88 progmagricAlreadyOpen VALUE IS 1    WHEN SET TO FALSE  0. 
       01 SaveKey.
       ...
       01 OLD-prr-rec.
           ...
           05 OLD-prr-dati.
               ...
               10 OLD-prr-sezione-dinamici.
                   15 OLD-prr-costo-ultimo         PIC  S9(9)V9(2).
                   15 OLD-prr-costo-medio          PIC  S9(9)V9(2).
                   15 OLD-prr-scorta   PIC  S9(8).
                   15 OLD-prr-giacenza PIC  S9(8).
                   15 OLD-prr-impegnato            PIC  S9(8).
                   15 OLD-prr-ordinato PIC  S9(8).
               10 OLD-prr-sezione-consolidati.
                   15 OLD-prr-iniziali.
                       20 OLD-prr-ini-udm  PIC  S9(8).
                       20 OLD-prr-ini-kg   PIC  S9(9)v999.
                       20 OLD-prr-ini-valore           PIC  S9(9)V9(2).
                   15 OLD-prr-acquisti.
                       20 OLD-prr-acq-udm  PIC  S9(8).
                       20 OLD-prr-acq-kg   PIC  S9(9)v999.
                       20 OLD-prr-acq-valore           PIC  S9(9)V9(2).
                   15 OLD-prr-vendite.
                       20 OLD-prr-ven-udm  PIC  S9(8).
                       20 OLD-prr-ven-kg   PIC  S9(9)v999.
                       20 OLD-prr-ven-valore           PIC  S9(9)V9(2).
                   15 OLD-prr--variazioni.
      *((XFD NAME = prr-var-inv-udm))
                       20 OLD-prr-var-inv-udm          PIC  S9(8).
      *(( XFD NAME = pgm-var-inventari- ))
      *((XFD NAME = prr-var-inv-kg))
                       20 OLD-prr-var-inv-kg           PIC  S9(9)v999.
      *(( XFD NAME = pgm-var-inventari- ))
      *((XFD NAME = prr-var-inv-val))
                       20 OLD-prr-var-inv-valore       PIC  S9(9)V9(2).
                   15 OLD-prr-resi-a-fornitori.
      *((XFD NAME = prr-resi-f-udm))
                       20 OLD-prr-resi-fornitori-udm   PIC  S9(8).
      *(( XFD NAME = pmg-resi-fornitori ))
      *((XFD NAME = prr-resi-f-kg))
                       20 OLD-prr-resi-fornitori-kg    PIC  S9(9)v999.
      *(( XFD NAME = pmg-resi-fornitori ))
      *((XFD NAME = prr-resi-f))
           ...
           S9(9)V9(2).
                   15 OLD-prr-resi-da-cliente.
                       ...
                       20 OLD-prr-resi-da-cli-kg       PIC  S9(9)v999.
                       20 OLD-prr-resi-da-cli-valore   PIC  S9(9)V9(2).
                   15 OLD-prr-giacenza-periodo.
                       20 OLD-prr-giacenza-udm         PIC  s9(8).
                       20 OLD-prr-giacenza-kg          PIC  S9(9)v999.
                   15 OLD-prr-entrate.
                       20 OLD-prr-udm-el   PIC  s9(8).
                       20 OLD-prr-kg-el    PIC  S9(9)v999.
                       20 OLD-prr-valore-el            PIC  S9(9)V9(2).
                   15 OLD-prr-uscite.
                       20 OLD-prr-udm-ul   PIC  s9(8).
                       20 OLD-prr-kg-ul    PIC  S9(9)v999.
                       20 OLD-prr-valore-ul            PIC  S9(9)V9(2).
               10 OLD-prr-giac-day PIC  s9(8).
               10 OLD-prr-stato    PIC  X(1).
                   88 OLD-prr-attivo VALUE IS "A". 
                   88 OLD-prr-disattivo VALUE IS "D". 
                   88 OLD-prr-bloccato VALUE IS "B". 
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:wprogmagric, INIT:wprogmagric, BeforeDeclarative>
      * <TOTEM:END>
       INPUT-ERROR SECTION.
      ...
      *{TOTEM}ENTRY-BEFPRG
      *    Before-Program
           PERFORM wprogmagric-Ev-Before-Program
      *{TOTEM}END
      ...
      * <TOTEM:EPT. INIT:wprogmagric, INIT:wprogmagric, BeforeDestroyResource>
      * <TOTEM:END>
           CALL "w$bitmap" USING WBITMAP-DESTROY, toolbar-bmp
      *    After-Program
           PERFORM wprogmagric-Ev-After-Program
      ...
      *    After Open
       ...
       OPEN-progmagric.
      * <TOTEM:EPT. INIT:wprogmagric, FD:progmagric, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O progmagric
           ...
           END-IF
      * <TOTEM:EPT. INIT:wprogmagric, FD:progmagric, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmagaz.
      * <TOTEM:EPT. INIT:wprogmagric, FD:tmagaz, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tmagaz
           IF NOT Valid-STATUS-tmagaz
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:wprogmagric, FD:tmagaz, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tcaumag.
      * <TOTEM:EPT. INIT:wprogmagric, FD:tcaumag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcaumag
           IF NOT Valid-STATUS-tcaumag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:wprogmagric, FD:tcaumag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-timbalqta.
      * <TOTEM:EPT. INIT:wprogmagric, FD:timbalqta, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-timbalqta
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:wprogmagric, FD:timbalqta, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-timballi.
      * <TOTEM:EPT. INIT:wprogmagric, FD:timballi, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT timballi
           IF NOT Valid-STATUS-timballi
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:wprogmagric, FD:timballi, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-articoli.
      * <TOTEM:EPT. INIT:wprogmagric, FD:articoli, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT articoli
           IF NOT Valid-STATUS-articoli
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:wprogmagric, FD:articoli, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tordforn.
      * <TOTEM:EPT. INIT:wprogmagric, FD:tordforn, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tordforn
           IF NOT Valid-STATUS-tordforn
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:wprogmagric, FD:tordforn, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tparamge.
      * <TOTEM:EPT. INIT:wprogmagric, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           IF NOT Valid-STATUS-tparamge
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:wprogmagric, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .

       CLOSE-FILE-RTN.
      *    Before Close
      *    progmagric CLOSE MODE IS FALSE
      ...
      *    After Close
       ...
       CLOSE-progmagric.
      * <TOTEM:EPT. INIT:wprogmagric, FD:progmagric, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-tmagaz.
      * <TOTEM:EPT. INIT:wprogmagric, FD:tmagaz, BeforeClose>
      * <TOTEM:END>
           CLOSE tmagaz
           .

       CLOSE-tcaumag.
      * <TOTEM:EPT. INIT:wprogmagric, FD:tcaumag, BeforeClose>
      * <TOTEM:END>
           CLOSE tcaumag
           .

       CLOSE-timbalqta.
      * <TOTEM:EPT. INIT:wprogmagric, FD:timbalqta, BeforeClose>
      * <TOTEM:END>
           CLOSE timbalqta
           .

       CLOSE-timballi.
      * <TOTEM:EPT. INIT:wprogmagric, FD:timballi, BeforeClose>
      * <TOTEM:END>
           CLOSE timballi
           .

       CLOSE-articoli.
      * <TOTEM:EPT. INIT:wprogmagric, FD:articoli, BeforeClose>
      * <TOTEM:END>
           CLOSE articoli
           .

       CLOSE-tordforn.
      * <TOTEM:EPT. INIT:wprogmagric, FD:tordforn, BeforeClose>
      * <TOTEM:END>
           CLOSE tordforn
           .

       CLOSE-tparamge.
      * <TOTEM:EPT. INIT:wprogmagric, FD:tparamge, BeforeClose>
      * <TOTEM:END>
           CLOSE tparamge
           .
