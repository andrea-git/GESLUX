      *{TOTEM}PRG-COMMENT
      * tcaudisb.Cbl
      * tcaudisb.Cbl is generated by TOTEM
      ...
      *{TOTEM}PRGID
       ...
       DATE-WRITTEN.        martedì 1 aprile 2014 19:19:34.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:tcaudisb, INIT:tcaudisb, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       77 Form1-Tb-1-Handle
                  USAGE IS HANDLE OF WINDOW.
       78 titolo VALUE IS "Geslux - Tabella Causali x Distinta Base". 
       77 E-ESCI           PIC  9
                  VALUE IS 1.
       77 E-NUOVO          PIC  9
                  VALUE IS 1.
       ...
       77 e-des            PIC  9
                  VALUE IS 0.
       01 rec-grid.
           05 col-codice       PIC  x(4).
           05 col-des          PIC  X(40).
           05 col-carico       PIC  x(4).
           05 col-scarico      PIC  x(4).
       77 Screen1-Handle
                  USAGE IS HANDLE OF WINDOW.
       ...
       01 old-tdc-rec.
           05 old-tdc-chiave.
               10 old-tdc-codice   PIC  x(4).
           05 old-tdc-dati.
               10 old-tdc-descrizione          PIC  x(40).
               10 old-tdc-caus-carico          PIC  x(4).
               10 old-tdc-caus-scarico         PIC  x(4).
               10 old-tdc-dati-comuni.
                   15 old-tdc-data-creazione       PIC  9(8).
                   15 old-tdc-ora-creazione        PIC  9(8).
                   15 old-tdc-utente-creazione     PIC  X(10).
                   15 old-tdc-data-ultima-modifica PIC  9(8).
                   15 old-tdc-ora-ultima-modifica  PIC  9(8).
                   15 old-tdc-utente-ultima-modifica           PIC  
           X(10).
               10 old-tdc-vuoti.
                   15 old-tdc-num-vuoto-1          PIC  9(15).
                   15 old-tdc-num-vuoto-2          PIC  9(15).
                   15 old-tdc-num-vuoto-3          PIC  9(15).
                   15 old-tdc-alfa-vuoto-1         PIC  X(20).
                   15 old-tdc-alfa-vuoto-2         PIC  X(20).
                   15 old-tdc-alfa-vuoto-3         PIC  X(20).
      ...
      ***********************************************************
       ...
       77 TMP-Form1-tcaudisb-RESTOREBUF  PIC X(209).
       77 TMP-Form1-KEYIS  PIC 9(3) VALUE 1.
       77 Form1-MULKEY-TMPBUF   PIC X(209).
      ...
      * FILE'S LOCK MODE FLAG
       ...
       77 DataSet1-tcaudisb-KEY1-ORDER  PIC X VALUE "A".
          88 DataSet1-tcaudisb-KEY1-Asc  VALUE "A".
          88 DataSet1-tcaudisb-KEY1-Desc VALUE "D".
      ...
      * GRID
       05
           ...
           3-D,
           CENTERED-HEADINGS,
           DATA-COLUMNS (1, 5, 45, 49),
           SEPARATION (5, 5, 5, 5),
           DATA-TYPES ("U(4)", "X(40)", "U(4)", "U(4)"),
           NUM-COL-HEADINGS 1,
           COLUMN-HEADINGS,
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:tcaudisb, INIT:tcaudisb, BeforeDeclarative>
      ...
      * <TOTEM:EPT. INIT:tcaudisb, INIT:tcaudisb, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-tcaumag.
      * <TOTEM:EPT. INIT:tcaudisb, FD:tcaumag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcaumag
           ...
           END-IF
      * <TOTEM:EPT. INIT:tcaudisb, FD:tcaumag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tcaudisb.
      * <TOTEM:EPT. INIT:tcaudisb, FD:tcaudisb, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O tcaudisb
           IF STATUS-tcaudisb = "35"
              OPEN OUTPUT tcaudisb
                IF Valid-STATUS-tcaudisb
                   CLOSE tcaudisb
                   OPEN I-O tcaudisb
                END-IF
           END-IF
           IF NOT Valid-STATUS-tcaudisb
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:tcaudisb, FD:tcaudisb, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-tcaumag.
      * <TOTEM:EPT. INIT:tcaudisb, FD:tcaumag, BeforeClose>
      * <TOTEM:END>
           CLOSE tcaumag
           .

       CLOSE-tcaudisb.
      * <TOTEM:EPT. INIT:tcaudisb, FD:tcaudisb, BeforeClose>
      * <TOTEM:END>
           CLOSE tcaudisb
           .
      ...
      * <TOTEM:END>
       ...
       DataSet1-Change-CurrentKey-Asc.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              MOVE "A" TO DataSet1-tcaudisb-KEY1-ORDER
           END-EVALUATE
           .
       ...
       DataSet1-Change-CurrentKey-Desc.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              MOVE "D" TO DataSet1-tcaudisb-KEY1-ORDER
           END-EVALUATE
           .
      ...
      * CELLS' SETTING
              MODIFY form1-gd-1, X = 3, Y = 1,
                CELL-DATA = "Causale di Carico",
      * CELLS' SETTING
              MODIFY form1-gd-1, X = 4, Y = 1,
                CELL-DATA = "Causale di Scarico",
      * COLUMNS' SETTING
      ...
      * DISPLAY-COLUMNS settings
              MODIFY form1-gd-1, DISPLAY-COLUMNS (1, 11, 51, 69)
           .
      ...
      * GRID
       ...
       Form1-DataSet1-Update-Key.
           MOVE tdc-rec OF tcaudisb TO
                     Form1-MULKEY-TMPBUF
           PERFORM Form1-CLEAR
           PERFORM Form1-INIT-DATA
           MOVE Form1-MULKEY-TMPBUF TO
                     tdc-rec OF tcaudisb
           PERFORM DataSet1-tcaudisb-Read
       ...
       Form1-First.
           ...
           PERFORM DataSet1-tcaudisb-INITSTART
           PERFORM DataSet1-tcaudisb-START
           IF NOT Valid-STATUS-tcaudisb
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
           PERFORM DataSet1-tcaudisb-Read-Next
           IF NOT Valid-STATUS-tcaudisb
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Previous.
              PERFORM Form1-Buf-To-Fld
              PERFORM DataSet1-tcaudisb-START-LESS
           IF NOT Valid-STATUS-tcaudisb
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
           PERFORM DataSet1-tcaudisb-Read-Prev
           IF NOT Valid-STATUS-tcaudisb
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Next.
              PERFORM Form1-Buf-To-Fld
              PERFORM DataSet1-tcaudisb-START-GREATER
           IF NOT Valid-STATUS-tcaudisb
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Last.
           ...
           PERFORM DataSet1-tcaudisb-INITEND
           PERFORM DataSet1-tcaudisb-START-NOTGREATER
           IF NOT Valid-STATUS-tcaudisb
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
      * write
           PERFORM DataSet1-tcaudisb-Rec-Rewrite
           IF Valid-STATUS-tcaudisb
      ...
      * delete
           PERFORM Form1-Buf-To-Fld
           PERFORM DataSet1-tcaudisb-Rec-Delete
           IF Valid-STATUS-tcaudisb
              PERFORM Form1-CLEAR
              PERFORM Form1-DUMMY-DELETE-INIT
              MOVE "303" TO TOTEM-MSG-ID
              MOVE "00" to STATUS-tcaudisb
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Save-Status.
           MOVE DataSet1-tcaudisb-KEY1-ORDER TO TMP-Form1-KEY1-ORDER
           MOVE DataSet1-KEYIS TO TMP-Form1-KEYIS
           MOVE tdc-rec OF tcaudisb TO 
              TMP-Form1-tcaudisb-RESTOREBUF
           .             

       Form1-Restore-Status.
           MOVE TMP-Form1-KEY1-ORDER TO DataSet1-tcaudisb-KEY1-ORDER
           MOVE TMP-Form1-KEYIS TO DataSet1-KEYIS
           MOVE TMP-Form1-tcaudisb-RESTOREBUF TO
              tdc-rec OF tcaudisb
           PERFORM DataSet1-tcaudisb-START
           IF Valid-STATUS-tcaudisb
              PERFORM DataSet1-tcaudisb-Read-Next
           ELSE
              PERFORM DataSet1-tcaudisb-INITREC
           END-IF
           PERFORM UNTIL NOT Valid-STATUS-tcaudisb OR
              (Valid-STATUS-tcaudisb AND
                 tdc-rec OF tcaudisb = 
                   TMP-Form1-tcaudisb-RESTOREBUF)
              PERFORM DataSet1-tcaudisb-Read-Next
           END-PERFORM
      ...
      *--->fine.                 
           ...
           if scelta = mb-yes
              ...
              delete tcaudisb record invalid continue end-delete
      ...
      * <TOTEM:PARA. CERCA>
           ...
           when 3
                perform VALORE-RIGA
                move tdc-caus-carico to tca-codice
                set  tca-fornitore   to true
                move "tcaumag-forn-mov-qta"  to como-file
                call   "zoom-gt"  using como-file, tca-rec
                                 giving stato-zoom

                if stato-zoom = 0
                   move tca-codice to col-carico tdc-caus-carico
                   modify form1-gd-1(riga, 3),
                                     cell-data = col-carico
                   perform SET-SALVATO
                end-if
           when 4
                perform VALORE-RIGA
                move tdc-caus-scarico to tca-codice
                set  tca-fornitore    to true
                ...
                if stato-zoom = 0
                   move tca-codice to col-scarico tdc-caus-scarico
                   modify form1-gd-1(riga, 4),
                                     cell-data = col-scarico
                   perform SET-SALVATO
                end-if
           end-evaluate  
           .
      ...
      * <TOTEM:PARA. CONTROLLO>
           ...
           when 2
                if tdc-descrizione = spaces
                   set errori to true
                   move 2 to colonna
                   display message box MSG-Descrizione-mancante
                           title = tit-err
                           icon mb-warning-icon
                end-if
           when 3
                ...
                read tcaumag
                 ...
                 not invalid
                     if tca-cliente
                        set errori to true
                        display message
                        "Causale di carico non valida "
                        "in quanto di tipo cliente"
                                  title tit-err
                                   icon mb-warning-icon
                     else
                        if tca-no-movim
                           set errori to true
                           display message
                           "Causale di carico non valida in "
                           "quanto non movimenta il magazzino"
                                     title tit-err
                                      icon mb-warning-icon
                        else
                           if tca-no-movim-giac-periodo
                              ...
                              display message
                              "Causale di carico non valida in "
                              "quanto genera variazione di valore"
                                        title tit-err
                                         icon mb-warning-icon
                           end-if
                        end-if
                 ...
                 not invalid
                     if tca-cliente
                        ...
                        if tca-no-movim
                           set errori to true
                           display message
                           "Causale di scarico non valida in "
                           "quanto non movimenta il magazzino"
                                     title tit-err
                                      icon mb-warning-icon
                        else
      ...
      * <TOTEM:PARA. INTESTAZIONE>
           ...
           modify form1-gd-1(1, 3), cell-data = "Causale di Carico".
           modify form1-gd-1(1, 4), cell-data = "Causale di Scarico" 
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. LOAD-RECORD>
           ...
           move low-value to tdc-codice.
           start tcaudisb key is >= tdc-chiave
                  invalid continue
              not invalid
                  perform varying riga from 2 by 1
                     ...
                     read tcaudisb next
                          at end exit perform
                      not at end
                          move tdc-codice           to col-codice
                          move tdc-descrizione      to col-des
                          move tdc-caus-carico      to col-carico
                          move tdc-caus-scarico     to col-scarico
      ...
      *--->modifica (isacco)
           if nuovo 
              ...
              if mod = 1
                 close tcaudisb
                 open i-o tcaudisb allowing readers
              else
                 set tutto-ok to true
                 if NoSalvato
                    move 1 to mod
      ...
      * <TOTEM:PARA. NUOVO>
           ...
           if tutto-ok
              ...
              initialize old-tdc-rec replacing numeric data by zeroes
                                          alphanumeric data by spaces
              perform COLORE-RIGA
           end-if 
           .
      ...
      * <TOTEM:PARA. SALVA>
           ...
           if tutto-ok
              ...
              write tdc-rec invalid rewrite tdc-rec end-write
              set sisalvato to true
              set vecchio   to true
           else
              perform ABILITAZIONI
      ...
      * <TOTEM:PARA. SET-SALVATO>
           if tdc-codice       not = old-tdc-codice      or
              tdc-descrizione  not = old-tdc-descrizione or
              tdc-caus-carico  not = old-tdc-caus-carico or
              tdc-caus-scarico not = old-tdc-caus-scarico
              set NoSalvato to true
           else
              set SiSalvato to true
           end-if 
      ...
      * <TOTEM:PARA. VALORE-RIGA>
           inquire form1-gd-1(riga, 1), cell-data in tdc-codice.
           inquire form1-gd-1(riga, 2), cell-data in tdc-descrizione. 
           inquire form1-gd-1(riga, 3), cell-data in tdc-caus-carico. 
           inquire form1-gd-1(riga, 4), cell-data in tdc-caus-scarico 
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. VALORE-OLD-RIGA>
           if vecchio
              perform VALORE-RIGA
              move tdc-codice        to old-tdc-codice
              move tdc-descrizione   to old-tdc-descrizione
              move tdc-caus-carico   to old-tdc-caus-carico
              move tdc-caus-scarico  to old-tdc-caus-scarico
           else
              initialize old-tdc-rec replacing numeric data by zeroes
                                          alphanumeric data by spaces
           end-if 
      ...
      *    se non ho valorizzato i campi di creazione li valorizzo
           if tdc-data-creazione = 0
              accept tdc-data-creazione from century-date
           end-if.
           if tdc-ora-creazione = 0
              accept tdc-ora-creazione from time
           end-if.
           if tdc-utente-creazione = space
              move user-codi to tdc-utente-creazione
           end-if.

           accept tdc-data-ultima-modifica from century-date.
           accept tdc-ora-ultima-modifica  from time.
           move user-codi to tdc-utente-ultima-modifica 
           .
      * <TOTEM:END>
