      *{TOTEM}PRG-COMMENT
      * ricstadoc.Cbl
      * ricstadoc.Cbl is generated by TOTEM
      * This is a generated file. DO NOT modify this file directly.
      *{TOTEM}END
       IDENTIFICATION       DIVISION.
      *{TOTEM}PRGID
       PROGRAM-ID.          ricstadoc.
       AUTHOR.              andre.
       DATE-WRITTEN.        martedì 7 settembre 2021 12:02:56.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:ricstadoc, INIT:ricstadoc, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       77 Form1-Handle
                  USAGE IS HANDLE OF WINDOW.
       77 como-x           PIC  x.
       78 titolo VALUE IS "GESLUX - Ricerca e stampa documenti". 
       ...
       01 gd-ordini-record.
           ...
           05 Col-dt-bolla     PIC  99/99/9999.
           05 col-fatt         PIC  z(7)9.
           05 col-dt-fatt      PIC  99/99/9999.
           05 col-num-ord      PIC  X(50).
           05 col-ragsoc       PIC  X(40).
           05 col-localita     PIC  X(35).
           05 col-sito         PIC  x(30).
           05 col-esito        PIC  X(50).
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:ricstadoc, INIT:ricstadoc, BeforeDeclarative>
       TORDINI-ERR SECTION.
      ...
      * <TOTEM:EPT. INIT:ricstadoc, INIT:ricstadoc, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-tordini.
      * <TOTEM:EPT. INIT:ricstadoc, FD:tordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tordini
           ...
           END-IF
      * <TOTEM:EPT. INIT:ricstadoc, FD:tordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tnotacr.
      * <TOTEM:EPT. INIT:ricstadoc, FD:tnotacr, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tnotacr
           IF NOT Valid-STATUS-tnotacr
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ricstadoc, FD:tnotacr, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tparamge.
      * <TOTEM:EPT. INIT:ricstadoc, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           IF NOT Valid-STATUS-tparamge
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ricstadoc, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-zoom-tno-fat.
      * <TOTEM:EPT. INIT:ricstadoc, FD:zoom-tno-fat, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-zoom-tno-fat
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ricstadoc, FD:zoom-tno-fat, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-zoom-tor-fat.
      * <TOTEM:EPT. INIT:ricstadoc, FD:zoom-tor-fat, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-zoom-tor-fat
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ricstadoc, FD:zoom-tor-fat, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-zoom-tor-bolle.
      * <TOTEM:EPT. INIT:ricstadoc, FD:zoom-tor-bolle, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-zoom-tor-bolle
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ricstadoc, FD:zoom-tor-bolle, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-clienti.
      * <TOTEM:EPT. INIT:ricstadoc, FD:clienti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT clienti
           IF NOT Valid-STATUS-clienti
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ricstadoc, FD:clienti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-destini.
      * <TOTEM:EPT. INIT:ricstadoc, FD:destini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT destini
           IF NOT Valid-STATUS-destini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ricstadoc, FD:destini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tcaumag.
      * <TOTEM:EPT. INIT:ricstadoc, FD:tcaumag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcaumag
           IF NOT Valid-STATUS-tcaumag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ricstadoc, FD:tcaumag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tvettori.
      * <TOTEM:EPT. INIT:ricstadoc, FD:tvettori, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tvettori
           IF NOT Valid-STATUS-tvettori
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ricstadoc, FD:tvettori, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmp-solleciti.
      * <TOTEM:EPT. INIT:ricstadoc, FD:tmp-solleciti, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-status-tmp-solleciti
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ricstadoc, FD:tmp-solleciti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tescons.
      * <TOTEM:EPT. INIT:ricstadoc, FD:tescons, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tescons
           IF NOT Valid-STATUS-tescons
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ricstadoc, FD:tescons, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-zoom-bolle.
      * <TOTEM:EPT. INIT:ricstadoc, FD:zoom-bolle, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O zoom-bolle
           ...
           IF NOT Valid-STATUS-zoom-bolle
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:ricstadoc, FD:zoom-bolle, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-tordini.
      * <TOTEM:EPT. INIT:ricstadoc, FD:tordini, BeforeClose>
      * <TOTEM:END>
           CLOSE tordini
           .

       CLOSE-tnotacr.
      * <TOTEM:EPT. INIT:ricstadoc, FD:tnotacr, BeforeClose>
      * <TOTEM:END>
           CLOSE tnotacr
           .

       CLOSE-tparamge.
      * <TOTEM:EPT. INIT:ricstadoc, FD:tparamge, BeforeClose>
      * <TOTEM:END>
           CLOSE tparamge
           .

       CLOSE-zoom-tno-fat.
      * <TOTEM:EPT. INIT:ricstadoc, FD:zoom-tno-fat, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-zoom-tor-fat.
      * <TOTEM:EPT. INIT:ricstadoc, FD:zoom-tor-fat, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-zoom-tor-bolle.
      * <TOTEM:EPT. INIT:ricstadoc, FD:zoom-tor-bolle, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-clienti.
      * <TOTEM:EPT. INIT:ricstadoc, FD:clienti, BeforeClose>
      * <TOTEM:END>
           CLOSE clienti
           .

       CLOSE-destini.
      * <TOTEM:EPT. INIT:ricstadoc, FD:destini, BeforeClose>
      * <TOTEM:END>
           CLOSE destini
           .

       CLOSE-tcaumag.
      * <TOTEM:EPT. INIT:ricstadoc, FD:tcaumag, BeforeClose>
      * <TOTEM:END>
           CLOSE tcaumag
           .

       CLOSE-tvettori.
      * <TOTEM:EPT. INIT:ricstadoc, FD:tvettori, BeforeClose>
      * <TOTEM:END>
           CLOSE tvettori
           .

       CLOSE-tmp-solleciti.
      * <TOTEM:EPT. INIT:ricstadoc, FD:tmp-solleciti, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-tescons.
      * <TOTEM:EPT. INIT:ricstadoc, FD:tescons, BeforeClose>
      * <TOTEM:END>
           CLOSE tescons
           .

       CLOSE-zoom-bolle.
      * <TOTEM:EPT. INIT:ricstadoc, FD:zoom-bolle, BeforeClose>
      * <TOTEM:END>
           .
      ...
      * <TOTEM:EPT. FORM:Form1, FORM:Form1, BeforeAccept>
           ...
           Perform RIEMPI-COMBO-STATO-CONS.
           move 78-tutti-esiti to cbo-stato-cons-buf
           Modify cbo-stato-cons   value cbo-stato-cons-buf.
      ...
      * COMBO-BOX
           PERFORM CBO-STATO-CONS-Content
           .
           ...
           start tordini key is >= k1
             ...
             not invalid
                 ...
                 perform until 1 = 2
                    ...
                    when altri-esiti
                         if tor-esito-consegna not = filtro-stato
                            set record-ok to false
                         end-if
                    end-evaluate
      ...
      * <TOTEM:PARA. ELENCO>
           ...
           when "Inevasi"        
                set inevasi        to true
           when "Bolle"          
                set emessa-bolla   to true
           when "Fatture"        
                set fatturati      to true
           when "Note Credito"   
      ...
      * <TOTEM:PARA. METTI-IN-GRIGLIA>
           ...
           move tmp-sol-esito         to col-esito.
           move tmp-sol-sito-vettore  to col-sito.

           modify gd-ordini(riga, 1), cell-data col-nulla   
           modify gd-ordini(riga, 2), cell-data Col-anno    
           modify gd-ordini(riga, 3), cell-data col-numero  
           modify gd-ordini(riga, 4), cell-data col-bolla   
           modify gd-ordini(riga, 5), cell-data Col-dt-bolla
           modify gd-ordini(riga, 6), cell-data col-fatt    
           modify gd-ordini(riga, 7), cell-data col-dt-fatt 
           modify gd-ordini(riga, 8), cell-data col-num-ord 
           modify gd-ordini(riga, 9), cell-data col-ragsoc  
           modify gd-ordini(riga, 10), cell-data col-localita
           modify gd-ordini(riga, 11), cell-data col-esito   
           modify gd-ordini(riga, 12), cell-data col-sito    
      ...
      * <TOTEM:PARA. SCRIVI-RECORD-FATTURE>
           ...
           move tec-descrizione    to tmp-sol-esito
           write tmp-sol-rec 
              invalid 
                 continue 
           end-write 
      ...
      * <TOTEM:END>
       ...
       RIEMPI-COMBO-STATO-CONS.
      * <TOTEM:PARA. RIEMPI-COMBO-STATO-CONS>
           move 78-tutti-esiti to cbo-stato-cons-buf
           Modify cbo-stato-cons   value cbo-stato-cons-buf.


           Modify cbo-stato-cons, item-to-add 78-tutti-esiti.
           Modify cbo-stato-cons, item-to-add 78-senza-esiti.


           move low-value to tec-codice
           start tescons key not < tec-chiave
              invalid 
                 continue
              not invalid
                 perform until 1 = 2
                    ...
                    modify CBO-STATO-CONS, ITEM-TO-ADD tec-descrizione
                 end-perform
           end-start.

      ***---
       SCARICA-COMBO-STATO-CONS.     
           move space  to filtro-stato
           inquire cbo-stato-cons,      value cbo-stato-cons-buf.
           evaluate cbo-stato-cons-buf
           when 78-tutti-esiti
                set tutti-esiti to true
           when 78-senza-esiti
                set senza-esiti to true
           when other
                set altri-esiti to true
                ...
                start tescons key not < tec-chiave
                   ...
                   not invalid
                      ...
                      if tec-descrizione = cbo-stato-cons-buf
                         move tec-codice to filtro-stato
                         exit perform
                      end-if
                   end-perform
                end-start
      ...
      * <TOTEM:END>
       ...
       SCEGLI-ORDINE-BOLLA.
      * <TOTEM:PARA. SCEGLI-ORDINE-BOLLA>
           ...
           start tordini key not < k-bolla
              ...
              not invalid
                 perform until 1 = 2
                    ...
                    if ef-bolla-buf not = tor-num-bolla or 
                       ef-anno-buf  not = tor-anno-bolla
                       exit perform
                    end-if
                    add 1 to cont
                    if cont > 1
           ...
           when other
                perform SCEGLI-ORDINE-BOLLA-2
           end-evaluate.

      ***---
       SCEGLI-ORDINE-BOLLA-2.
           call "W$MOUSE" using set-mouse-shape, wait-pointer.
      ...
      * <TOTEM:PARA. PB-ESEGUI-LinkTo>
           ...
           if tutto-ok
              perform CANCELLA-COLORE
              if tipo-ricerca = 1 
                 perform SCARICA-COMBO-STATO-CONS
                 perform ELENCO
              else
                 if e-bolla = 1
      ...
      * <TOTEM:PARA. gd-ordini-Ev-Msg-Begin-Entry>
           ...
           when X"00"|doppio click
                if event-data-1 = 12
                   ...
                   inquire gd-ordini(riga, 12), cell-data in col-sito
