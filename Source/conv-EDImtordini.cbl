       ...
       PROGRAM-ID.                      conv-EDImtordini.
       remarks.                         Per aggiunta inversione imposte EDI
      ...
      ******************************************************************
       ...
       SELECT EDI-mtordini-old
           ...
           WITH DUPLICATES 
           ALTERNATE RECORD KEY IS k-old-emto-stato = old-emto-stato, 
           old-emto-chiave
           WITH DUPLICATES 
           ALTERNATE RECORD KEY IS k-old-emto-data = 
                                   old-emto-data-ordine, 
                                   old-emto-chiave
           WITH DUPLICATES 
           ALTERNATE RECORD KEY IS k-old-emto-clides = old-emto-cod-cli, 
      ...
      ***---
       MUOVI-RECORD.
           ...
           move old-emto-dati         to emto-dati.  
           move old-emto-record-01T   to emto-record-01T
           move old-emto-bloc-forzato to emto-bloc-forzato.
           move old-emto-Sum          to emto-sum.
           move old-emto-evadi-dal    to emto-evadi-dal.
