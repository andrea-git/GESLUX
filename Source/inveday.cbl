      *{TOTEM}PRG-COMMENT
      * inveday.Cbl
      * inveday.Cbl is generated by TOTEM
      ...
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:inveday, INIT:inveday, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       78 titolo VALUE IS "Stampa Inventario DAY". 
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:inveday, INIT:inveday, BeforeDeclarative>
      ...
      * <TOTEM:EPT. INIT:inveday, INIT:inveday, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-tmagaz.
      * <TOTEM:EPT. INIT:inveday, FD:tmagaz, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tmagaz
           ...
           END-IF
      * <TOTEM:EPT. INIT:inveday, FD:tmagaz, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmarche.
      * <TOTEM:EPT. INIT:inveday, FD:tmarche, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tmarche
           IF NOT Valid-STATUS-tmarche
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:inveday, FD:tmarche, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tparamge.
      * <TOTEM:EPT. INIT:inveday, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           IF NOT Valid-STATUS-tparamge
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:inveday, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-tmagaz.
      * <TOTEM:EPT. INIT:inveday, FD:tmagaz, BeforeClose>
      * <TOTEM:END>
           CLOSE tmagaz
           .

       CLOSE-tmarche.
      * <TOTEM:EPT. INIT:inveday, FD:tmarche, BeforeClose>
      * <TOTEM:END>
           CLOSE tmarche
           .

       CLOSE-tparamge.
      * <TOTEM:EPT. INIT:inveday, FD:tparamge, BeforeClose>
      * <TOTEM:END>
           CLOSE tparamge
           .
      ...
      * <TOTEM:PARA. PB-ESEGUI-LinkTo>
           ...
           if tutto-ok
              ...
              move ef-data-buf      to como-data
              perform DATE-TO-FILE
              move como-data        to inveday-a-data
              move tge-data-consolid-progmag to inveday-da-data
              move tipo-costo       to inveday-tipo-costo
              evaluate tipo-rec
              ...
              call   "inveday-p" using inveday-linkage
              cancel "inveday-p"
