      *{TOTEM}PRG-COMMENT
      * stbolle-MV.Cbl
      * stbolle-MV.Cbl is generated by TOTEM
      * This is a generated file. DO NOT modify this file directly.
      *{TOTEM}END
       IDENTIFICATION       DIVISION.
      *{TOTEM}PRGID
       PROGRAM-ID.          stbolle-MV.
       AUTHOR.              ANDREA EVENTI.
       DATE-WRITTEN.        martedì 22 dicembre 2015 16:20:32.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:stbolle-MV, INIT:stbolle-MV, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       78 titolo VALUE IS "Stampa Bolle SERIE 2". 
       01 file-info.
      ...
      * LABEL
      ...
      -    "a data di stampa all'interno della tabella dei contatori SER
      -    "IE 2.",
           .
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:stbolle-MV, INIT:stbolle-MV, BeforeDeclarative>
      ***---
       TCONTAT-ERR SECTION.
      ...
      * <TOTEM:EPT. INIT:stbolle-MV, INIT:stbolle-MV, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-tcontat.
      * <TOTEM:EPT. INIT:stbolle-MV, FD:tcontat, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcontat
           ...
           END-IF
      * <TOTEM:EPT. INIT:stbolle-MV, FD:tcontat, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tparamge.
      * <TOTEM:EPT. INIT:stbolle-MV, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           IF NOT Valid-STATUS-tparamge
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:stbolle-MV, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-tcontat.
      * <TOTEM:EPT. INIT:stbolle-MV, FD:tcontat, BeforeClose>
      * <TOTEM:END>
           CLOSE tcontat
           .

       CLOSE-tparamge.
      * <TOTEM:EPT. INIT:stbolle-MV, FD:tparamge, BeforeClose>
      * <TOTEM:END>
           CLOSE tparamge
           .
              ...
              if como-data < con-ult-stampa-bolle-MV
                 ...
                 if como-data(5:2) not = con-ult-stampa-bolle-MV(5:2)
                    display message "Il mese di stampa NON coincide "
                                    "con quello di ultima stampa bolle s
      -    "erie 2."
      ...
      * <TOTEM:PARA. PB-ESEGUI-LinkTo>
                       ...
                       if file-size not = 0 
                          ...
                          when ru-SO-XP
                               accept como-stampante 
                                from environment "STAMPANTE_STBOLLE_MV_X
      -    "P"
                          when ru-SO-VISTA
                               accept como-stampante 
      ...
      -    "E_MV_7"
                          ...
                          evaluate true
                          when ru-SO-XP
                               set environment "STAMPANTE_STBOLLE_MV_XP"
                                            to printerToSet
                          when ru-SO-VISTA
                               set environment "STAMPANTE_STBOLLE_MV_V"
                                            to printerToSet
                          when ru-SO-7
                               set environment "STAMPANTE_STBOLLE_MV_7"
                                            to printerToSet
                          end-evaluate   
