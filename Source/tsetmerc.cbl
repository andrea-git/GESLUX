      *{TOTEM}PRG-COMMENT
      * tsetmerc.Cbl
      * tsetmerc.Cbl is generated by TOTEM
      ...
      *{TOTEM}PRGID
       ...
       DATE-WRITTEN.        martedì 1 aprile 2014 19:20:23.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:tsetmerc, INIT:tsetmerc, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      *
       ...
       77 Form1-Tb-1-Handle
                  USAGE IS HANDLE OF WINDOW.
       78 titolo VALUE IS "Geslux - Tabella Settori Merceologici". 
       77 E-ESCI           PIC  9
                  VALUE IS 1.
       77 E-NUOVO          PIC  9
                  VALUE IS 1.
       ...
       01 old-sme-rec.
           05 old-sme-chiave.
               10 old-sme-codice   PIC  9(4).
           05 old-sme-dati.
               10 old-sme-descrizione          PIC  x(30).
               10 old-sme-dati-comuni.
                   15 old-sme-data-creazione       PIC  9(8).
                   15 old-sme-ora-creazione        PIC  9(8).
                   15 old-sme-utente-creazione     PIC  x(10).
                   15 old-sme-data-ultima-modifica PIC  9(8).
                   15 old-sme-ora-ultima-modifica  PIC  9(8).
                   15 old-tsetmerc-item13          PIC  9(3).
               10 old-sme-vuoti.
                   15 old-sme-num-vuoto-1          PIC  9(15).
                   15 old-sme-num-vuoto-2          PIC  9(15).
                   15 old-sme-num-vuoto-3          PIC  9(15).
                   15 old-sme-alfa-vuoto-1         PIC  x(20).
                   15 old-sme-alfa-vuoto-2         PIC  x(20).
                   15 old-sme-alfa-vuoto-3         PIC  x(20).
      ...
      ***********************************************************
       ...
       77 TMP-Form1-tsetmerc-RESTOREBUF  PIC X(191).
      ...
      * FILE'S LOCK MODE FLAG
       ...
       77 DataSet1-tsetmerc-KEY1-ORDER  PIC X VALUE "A".
          88 DataSet1-tsetmerc-KEY1-Asc  VALUE "A".
          88 DataSet1-tsetmerc-KEY1-Desc VALUE "D".
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:tsetmerc, INIT:tsetmerc, BeforeDeclarative>
      ...
      * <TOTEM:EPT. INIT:tsetmerc, INIT:tsetmerc, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-tsetmerc.
      * <TOTEM:EPT. INIT:tsetmerc, FD:tsetmerc, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O tsetmerc
           IF STATUS-tsetmerc = "35"
              OPEN OUTPUT tsetmerc
                IF Valid-STATUS-tsetmerc
                   CLOSE tsetmerc
                   OPEN I-O tsetmerc
                END-IF
           END-IF
           ...
           END-IF
      * <TOTEM:EPT. INIT:tsetmerc, FD:tsetmerc, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-tsetmerc.
      * <TOTEM:EPT. INIT:tsetmerc, FD:tsetmerc, BeforeClose>
      * <TOTEM:END>
           CLOSE tsetmerc
           .
       ...
       DataSet1-Change-CurrentKey-Asc.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              MOVE "A" TO DataSet1-tsetmerc-KEY1-ORDER
           END-EVALUATE
           .
       ...
       DataSet1-Change-CurrentKey-Desc.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              MOVE "D" TO DataSet1-tsetmerc-KEY1-ORDER
           END-EVALUATE
           .
      ...
      * GRID
       ...
       Form1-DataSet1-Update-Key.
           MOVE sme-rec OF tsetmerc TO
                     Form1-MULKEY-TMPBUF
           PERFORM Form1-CLEAR
           PERFORM Form1-INIT-DATA
           MOVE Form1-MULKEY-TMPBUF TO
                     sme-rec OF tsetmerc
           PERFORM DataSet1-tsetmerc-Read
       ...
       Form1-First.
           ...
           PERFORM DataSet1-tsetmerc-INITSTART
           PERFORM DataSet1-tsetmerc-START
           IF NOT Valid-STATUS-tsetmerc
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
           PERFORM DataSet1-tsetmerc-Read-Next
           IF NOT Valid-STATUS-tsetmerc
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Previous.
              PERFORM Form1-Buf-To-Fld
              PERFORM DataSet1-tsetmerc-START-LESS
           IF NOT Valid-STATUS-tsetmerc
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
           PERFORM DataSet1-tsetmerc-Read-Prev
           IF NOT Valid-STATUS-tsetmerc
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Next.
              PERFORM Form1-Buf-To-Fld
              PERFORM DataSet1-tsetmerc-START-GREATER
           IF NOT Valid-STATUS-tsetmerc
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Last.
           ...
           PERFORM DataSet1-tsetmerc-INITEND
           PERFORM DataSet1-tsetmerc-START-NOTGREATER
           IF NOT Valid-STATUS-tsetmerc
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
      * write
           PERFORM DataSet1-tsetmerc-Rec-Rewrite
           IF Valid-STATUS-tsetmerc
      ...
      * delete
           PERFORM Form1-Buf-To-Fld
           PERFORM DataSet1-tsetmerc-Rec-Delete
           IF Valid-STATUS-tsetmerc
              PERFORM Form1-CLEAR
              PERFORM Form1-DUMMY-DELETE-INIT
              MOVE "303" TO TOTEM-MSG-ID
              MOVE "00" to STATUS-tsetmerc
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Save-Status.
           MOVE DataSet1-tsetmerc-KEY1-ORDER TO TMP-Form1-KEY1-ORDER
           MOVE DataSet1-KEYIS TO TMP-Form1-KEYIS
           MOVE sme-rec OF tsetmerc TO 
              TMP-Form1-tsetmerc-RESTOREBUF
           .             

       Form1-Restore-Status.
           MOVE TMP-Form1-KEY1-ORDER TO DataSet1-tsetmerc-KEY1-ORDER
           MOVE TMP-Form1-KEYIS TO DataSet1-KEYIS
           MOVE TMP-Form1-tsetmerc-RESTOREBUF TO
              sme-rec OF tsetmerc
           PERFORM DataSet1-tsetmerc-START
           IF Valid-STATUS-tsetmerc
              PERFORM DataSet1-tsetmerc-Read-Next
           ELSE
              PERFORM DataSet1-tsetmerc-INITREC
           END-IF
           PERFORM UNTIL NOT Valid-STATUS-tsetmerc OR
              (Valid-STATUS-tsetmerc AND
                 sme-rec OF tsetmerc = 
                   TMP-Form1-tsetmerc-RESTOREBUF)
              PERFORM DataSet1-tsetmerc-Read-Next
           END-PERFORM
      ...
      * <TOTEM:PARA. LOAD-RECORD>
           ...
           move low-value to sme-codice.
           start tsetmerc key is >= sme-chiave
                  invalid continue
              not invalid
                  perform varying riga from 2 by 1
                     ...
                     read tsetmerc next
                          at end exit perform
                      not at end
                          move sme-codice          to col-id
                          move sme-descrizione     to col-des
      ...
      *--->MODIFICA (ISACCO)
           if nuovo 
              ...
              if mod = 1
                 close    tsetmerc
                 open i-o tsetmerc allowing readers
              else
                 set tutto-ok to true
                 if NoSalvato
                    move 1 to mod
      ...
      * <TOTEM:PARA. NUOVO>
           ...
           if tutto-ok
              ...
              initialize old-sme-rec replacing numeric data by zeroes
                                          alphanumeric data by spaces
      ...
      * <TOTEM:PARA. VALORE-RIGA>
           inquire form1-gd-1(riga, 1), cell-data sme-codice.
           inquire form1-gd-1(riga, 2), cell-data sme-descrizione 
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. VALORE-OLD-RIGA>
           if vecchio
              inquire form1-gd-1(riga, 1) cell-data old-sme-codice
              move old-sme-codice         to sme-codice
              read tsetmerc               no lock
              move sme-rec                to old-sme-rec
           else
              initialize old-sme-rec replacing numeric data by zeroes
                                          alphanumeric data by spaces
           end-if 
      ...
      *    se non ho valorizzato i campi di creazione li valorizzo
           if sme-data-creazione   = zero
              accept sme-data-creazione from century-date
           end-if.
           if sme-ora-creazione    = zero
              accept sme-ora-creazione  from time
           end-if.
           if sme-utente-creazione = space
              move user-codi to sme-utente-creazione
           end-if.

           accept sme-data-ultima-modifica from century-date.
           accept sme-ora-ultima-modifica  from time.
           move user-codi    to sme-utente-ultima-modifica 
           .
      * <TOTEM:END>
