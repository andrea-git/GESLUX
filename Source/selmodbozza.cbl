      *{TOTEM}PRG-COMMENT
      * selmodbozza.Cbl
      * selmodbozza.Cbl is generated by TOTEM
      * This is a generated file. DO NOT modify this file directly.
      *{TOTEM}END
       IDENTIFICATION       DIVISION.
      *{TOTEM}PRGID
       PROGRAM-ID.          selmodbozza.
       AUTHOR.              ANDREA EVENTI.
       DATE-WRITTEN.        martedì 1 aprile 2014 19:18:40.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:selmodbozza, INIT:selmodbozza, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       78 titolo VALUE IS "Geslux - Ricerca e variazione Bozze". 
      ...
      ***********************************************************
       ...
       77 TMP-Form2-btnotacr-RESTOREBUF  PIC X(781).
       77 TMP-Form2-KEYIS  PIC 9(3) VALUE 1.
       77 Form2-MULKEY-TMPBUF   PIC X(781).
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:selmodbozza, INIT:selmodbozza, BeforeDeclarative>
      ***---
       CLIENTI-ERR SECTION.
      ...
      * <TOTEM:EPT. INIT:selmodbozza, INIT:selmodbozza, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-clienti.
      * <TOTEM:EPT. INIT:selmodbozza, FD:clienti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT clienti
           ...
           END-IF
      * <TOTEM:EPT. INIT:selmodbozza, FD:clienti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-destini.
      * <TOTEM:EPT. INIT:selmodbozza, FD:destini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT destini
           IF NOT Valid-STATUS-destini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selmodbozza, FD:destini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tparamge.
      * <TOTEM:EPT. INIT:selmodbozza, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           IF NOT Valid-STATUS-tparamge
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selmodbozza, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-btnotacr.
      * <TOTEM:EPT. INIT:selmodbozza, FD:btnotacr, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT btnotacr
           IF NOT Valid-STATUS-btnotacr
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selmodbozza, FD:btnotacr, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tcaumag.
      * <TOTEM:EPT. INIT:selmodbozza, FD:tcaumag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcaumag
           IF NOT Valid-STATUS-tcaumag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selmodbozza, FD:tcaumag, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-clienti.
      * <TOTEM:EPT. INIT:selmodbozza, FD:clienti, BeforeClose>
      * <TOTEM:END>
           CLOSE clienti
           .

       CLOSE-destini.
      * <TOTEM:EPT. INIT:selmodbozza, FD:destini, BeforeClose>
      * <TOTEM:END>
           CLOSE destini
           .

       CLOSE-tparamge.
      * <TOTEM:EPT. INIT:selmodbozza, FD:tparamge, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-btnotacr.
      * <TOTEM:EPT. INIT:selmodbozza, FD:btnotacr, BeforeClose>
      * <TOTEM:END>
           CLOSE btnotacr
           .

       CLOSE-tcaumag.
      * <TOTEM:EPT. INIT:selmodbozza, FD:tcaumag, BeforeClose>
      * <TOTEM:END>
           CLOSE tcaumag
           .
      ...
      * <TOTEM:EPT. FORM:Form2, FORM:Form2, BeforeAccept>
           ...
           if not trovato
              display message box "Nessuna bozza presente per"
                                  " i limiti richiesti"
                      title = tit-err
                      icon mb-error-icon
              perform FORM2-EXIT
      ...
      *    cambio la label legenda
           ...
           inquire gd-nota(riga, 1), HIDDEN-DATA = btno-causale
           move btno-causale to tca-codice.
           read tcaumag no lock invalid continue end-read.
           evaluate true
           when tca-tipo-nota-abbuono move "Abbuono Generico"      to 
           tit-stato-nota
           when tca-tipo-nota-reso    move "Reso di Merce"         to 
           tit-stato-nota
           when tca-tipo-nota-prz     move "Differenza di Prezzo"  to 
           tit-stato-nota
           end-evaluate.
                ...
                if tipo-elab = 1
                   if nota-from = 0
                      if controllo-finale
                         ...
                         display message "Il numero di bozza è obbligato
      -    "rio!"
                                 title tit-err
                                 icon  MB-WARNING-ICON
                      end-if
                   else
                      move anno-to     to btno-anno
                      move nota-from   to btno-numero
                      read btnotacr
                           invalid 
                           set errori to true
                           move 78-ID-ef-nota-from to CONTROL-ID
      ...
      * <TOTEM:PARA. CARICA-NOTE>
           ...
           if tutte
              start btnotacr key not < btno-chiave
                    invalid continue
      ...
      * <TOTEM:PARA. METTI-IN-GRIGLIA>
           move btno-anno  to Col-anno.

           move btno-numero   to Col-numero

           move btno-data(1:4)  to col-data(7:4).
           move btno-data(5:2)  to col-data(4:2).
           move btno-data(7:2)  to col-data(1:2).
           move "/"            to col-data(3:1)
                                  col-data(6:1).

           move btno-cod-cli           to Col-cliente
                                         cli-codice.
           ...
           modify gd-nota(riga, 1) hidden-data = btno-causale.
           set trovato to true 
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. SCORRI-NOTE>
           ...
           perform until 1 = 2
              ...
              if btno-anno > anno-to    exit perform end-if
      ...
      * <TOTEM:PARA. VALIDA-NOTA>
           ...
           if btno-numero < nota-from or 
              btno-numero > nota-to
              set record-ok to false
           end-if.

LUBEXX     if btno-data-creazione < data-from-AAAAMMGG or 
LUBEXX        btno-data-creazione > data-to-AAAAMMGG
LUBEXX        set record-ok to false
LUBEXX     end-if.

LUBEXX*****     if btno-data < data-from-AAAAMMGG or 
LUBEXX*****        btno-data > data-to-AAAAMMGG
LUBEXX*****        set record-ok to false
LUBEXX*****     end-if.

           if btno-cod-cli < cliente-from or 
              btno-cod-cli > cliente-to
              set record-ok to false
           end-if.
