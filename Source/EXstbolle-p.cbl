...
OMAGGI   03 st-qta-oma             pic zz.zzz.zzz.
      ...
      * COSTANTI
       ...
       78  NumRigheConNote         value 16.
       78  NumRigheSenzaNote       value 18.

       78  NumRigheConNote-graf    value 38.
       78  NumRigheSenzaNote-graf  value 40.
      ...
      ***---
       STAMPA-SEGUE.
           ...
           if LinkPgm = "gordcvar"
              ...
              perform STAMPA-RIGA
              if esiste-note move 24 to n-vuote
              else           move 22 to n-vuote
              end-if
