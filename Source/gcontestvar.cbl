      *{TOTEM}PRG-COMMENT
      * gcontestvar.Cbl
      * gcontestvar.Cbl is generated by TOTEM
      * This is a generated file. DO NOT modify this file directly.
      *{TOTEM}END
       IDENTIFICATION       DIVISION.
      *{TOTEM}PRGID
       PROGRAM-ID.          gcontestvar.
       AUTHOR.              ANDREA EVENTI.
       DATE-WRITTEN.        lunedì 2 dicembre 2013 18:08:20.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:gcontestvar, INIT:gcontestvar, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:gcontestvar, INIT:gcontestvar, BeforeDeclarative>
      ***---
      ...
      * <TOTEM:EPT. INIT:gcontestvar, INIT:gcontestvar, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-tvettori.
      * <TOTEM:EPT. INIT:gcontestvar, FD:tvettori, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O tvettori
           ...
           END-IF
      * <TOTEM:EPT. INIT:gcontestvar, FD:tvettori, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tparamge.
      * <TOTEM:EPT. INIT:gcontestvar, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O tparamge
           ...
           IF NOT Valid-STATUS-tparamge
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gcontestvar, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tordini.
      * <TOTEM:EPT. INIT:gcontestvar, FD:tordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O tordini
           ...
           IF NOT Valid-STATUS-tordini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gcontestvar, FD:tordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tnotacr.
      * <TOTEM:EPT. INIT:gcontestvar, FD:tnotacr, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O tnotacr
           ...
           IF NOT Valid-STATUS-tnotacr
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gcontestvar, FD:tnotacr, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-destini.
      * <TOTEM:EPT. INIT:gcontestvar, FD:destini, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O destini
           ...
           IF NOT Valid-STATUS-destini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gcontestvar, FD:destini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-clienti.
      * <TOTEM:EPT. INIT:gcontestvar, FD:clienti, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O clienti
           ...
           IF NOT Valid-STATUS-clienti
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gcontestvar, FD:clienti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-contestazioni.
      * <TOTEM:EPT. INIT:gcontestvar, FD:contestazioni, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-contestazioni
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gcontestvar, FD:contestazioni, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-zoom-tordini.
      * <TOTEM:EPT. INIT:gcontestvar, FD:zoom-tordini, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-zoom-tordini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gcontestvar, FD:zoom-tordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tcaumag.
      * <TOTEM:EPT. INIT:gcontestvar, FD:tcaumag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcaumag
           IF NOT valid-status-tcaumag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gcontestvar, FD:tcaumag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-note-cont.
      * <TOTEM:EPT. INIT:gcontestvar, FD:note-cont, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT valid-status-note-cont
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gcontestvar, FD:note-cont, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-tvettori.
      * <TOTEM:EPT. INIT:gcontestvar, FD:tvettori, BeforeClose>
      * <TOTEM:END>
           CLOSE tvettori
           .

       CLOSE-tparamge.
      * <TOTEM:EPT. INIT:gcontestvar, FD:tparamge, BeforeClose>
      * <TOTEM:END>
           CLOSE tparamge
           .

       CLOSE-tordini.
      * <TOTEM:EPT. INIT:gcontestvar, FD:tordini, BeforeClose>
      * <TOTEM:END>
           CLOSE tordini
           .

       CLOSE-tnotacr.
      * <TOTEM:EPT. INIT:gcontestvar, FD:tnotacr, BeforeClose>
      * <TOTEM:END>
           CLOSE tnotacr
           .

       CLOSE-destini.
      * <TOTEM:EPT. INIT:gcontestvar, FD:destini, BeforeClose>
      * <TOTEM:END>
           CLOSE destini
           .

       CLOSE-clienti.
      * <TOTEM:EPT. INIT:gcontestvar, FD:clienti, BeforeClose>
      * <TOTEM:END>
           CLOSE clienti
           .

       CLOSE-contestazioni.
      * <TOTEM:EPT. INIT:gcontestvar, FD:contestazioni, BeforeClose>
      * <TOTEM:END>
           CLOSE contestazioni
           .

       CLOSE-zoom-tordini.
      * <TOTEM:EPT. INIT:gcontestvar, FD:zoom-tordini, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-tcaumag.
      * <TOTEM:EPT. INIT:gcontestvar, FD:tcaumag, BeforeClose>
      * <TOTEM:END>
           CLOSE tcaumag
           .

       CLOSE-note-cont.
      * <TOTEM:EPT. INIT:gcontestvar, FD:note-cont, BeforeClose>
      * <TOTEM:END>
           CLOSE note-cont
           .
      ...
      * <TOTEM:END>
       ...
       Form1-CONTROLLO-OLD.
           ...
           if cnt-cod-cli not = old-cnt-cod-cli
              and SiSalvato
              set NoSalvato to true
           ...
           if cnt-prg-destino not = old-cnt-prg-destino
              and SiSalvato
              set NoSalvato to true
           ...
           if cnt-importo not = old-cnt-importo
              and SiSalvato
              set NoSalvato to true
              |78-ID-ef-importo è l'ID del campo ef-importo
              move 78-ID-ef-importo to store-id 
           end-if

           if cnt-bolla not = old-cnt-bolla
              and SiSalvato
              set NoSalvato to true
              |78-ID-ef-bolla è l'ID del campo ef-bolla
              move 78-ID-ef-bolla to store-id 
           end-if

           if cnt-data-bolla-cli not = old-cnt-data-bolla-cli
              and SiSalvato
              set NoSalvato to true
              |78-ID-ef-data-b è l'ID del campo ef-data-b
              move 78-ID-ef-data-b to store-id 
           end-if

           if cnt-richiesta not = old-cnt-richiesta
              and SiSalvato
              set NoSalvato to true
              |78-ID-chk-rich è l'ID del campo chk-rich
              move 78-ID-chk-rich to store-id 
           end-if

           if cnt-data-rich not = old-cnt-data-rich
              and SiSalvato
              set NoSalvato to true
              |78-ID-ef-data-rich è l'ID del campo ef-data-rich
              move 78-ID-ef-data-rich to store-id 
           end-if

           if cnt-corriere not = old-cnt-corriere
              and SiSalvato
              set NoSalvato to true
           ...
           if cnt-data-ricev not = old-cnt-data-ricev
              and SiSalvato
              set NoSalvato to true
              |78-ID-ef-data-ric è l'ID del campo ef-data-ric
              move 78-ID-ef-data-ric to store-id 
           end-if

           if cnt-nota not = old-cnt-nota
              and SiSalvato
              set NoSalvato to true
           ...
           if cnt-numero-nota-debito not = old-cnt-numero-nota-debito
              and SiSalvato
              set NoSalvato to true
              |78-ID-ef-numero è l'ID del campo ef-numero
              move 78-ID-ef-numero to store-id 
           end-if

           if cnt-data-nota-deb not = old-cnt-data-nota-deb
              and SiSalvato
              set NoSalvato to true
              |78-ID-ef-data-nota è l'ID del campo ef-data-nota
              move 78-ID-ef-data-nota to store-id 
           end-if

           if cnt-importo-nota not = old-cnt-importo-nota
              and SiSalvato
              set NoSalvato to true
              |78-ID-ef-imp-nota è l'ID del campo ef-imp-nota
              move 78-ID-ef-imp-nota to store-id 
           end-if

           if cnt-num-reg-contab not = old-cnt-num-reg-contab
              and SiSalvato
              set NoSalvato to true
           ...
           if cnt-appunti not = old-cnt-appunti
              and SiSalvato
              set NoSalvato to true
              |78-ID-ef-appunti è l'ID del campo ef-appunti
              move 78-ID-ef-appunti to store-id 
           end-if

           if cnt-nota-anno-1 not = old-cnt-nota-anno-1
              and SiSalvato
              set NoSalvato to true
              |78-ID-ef-anno1 è l'ID del campo ef-anno1
              move 78-ID-ef-anno1 to store-id 
           end-if

           if cnt-nota-1 not = old-cnt-nota-1
              and SiSalvato
              set NoSalvato to true
              |78-ID-ef-nota1 è l'ID del campo ef-nota1
              move 78-ID-ef-nota1 to store-id 
           end-if

           if cnt-nota-anno-2 not = old-cnt-nota-anno-2
              and SiSalvato
              set NoSalvato to true
              |78-ID-ef-anno2 è l'ID del campo ef-anno2
              move 78-ID-ef-anno2 to store-id 
           end-if

           if cnt-nota-2 not = old-cnt-nota-2
              and SiSalvato
              set NoSalvato to true
              |78-ID-ef-nota2 è l'ID del campo ef-nota2
              move 78-ID-ef-nota2 to store-id 
           end-if

           if cnt-nota-anno-3 not = old-cnt-nota-anno-3
              and SiSalvato
              set NoSalvato to true
              |78-ID-ef-anno3 è l'ID del campo ef-anno3
              move 78-ID-ef-anno3 to store-id 
           end-if

           if cnt-nota-3 not = old-cnt-nota-3
              and SiSalvato
              set NoSalvato to true
              |78-ID-ef-nota3 è l'ID del campo ef-nota3
              move 78-ID-ef-nota3 to store-id 
           end-if

           if cnt-nota-anno-4 not = old-cnt-nota-anno-4
              and SiSalvato
              set NoSalvato to true
              |78-ID-ef-anno4 è l'ID del campo ef-anno4
              move 78-ID-ef-anno4 to store-id 
           end-if

           if cnt-nota-4 not = old-cnt-nota-4
              and SiSalvato
              set NoSalvato to true
              |78-ID-ef-nota4 è l'ID del campo ef-nota4
              move 78-ID-ef-nota4 to store-id 
           end-if

           if cnt-nota-anno-5 not = old-cnt-nota-anno-5
              and SiSalvato
              set NoSalvato to true
              |78-ID-ef-anno5 è l'ID del campo ef-anno5
              move 78-ID-ef-anno5 to store-id 
           end-if

           if cnt-nota-5 not = old-cnt-nota-5
              and SiSalvato
              set NoSalvato to true
              |78-ID-ef-nota5 è l'ID del campo ef-nota5
              move 78-ID-ef-nota5 to store-id 
           end-if
      ...
      * <TOTEM:PARA. PARAGRAFO-COPY>
           ...
           copy "gcontestvar-procedure.cpy".
