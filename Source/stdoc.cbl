      *{TOTEM}PRG-COMMENT
      * stdoc.Cbl
      * stdoc.Cbl is generated by TOTEM
      ...
      *{TOTEM}PRGID
       ...
       DATE-WRITTEN.        lunedì 2 dicembre 2013 19:32:01.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:stdoc, INIT:stdoc, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:stdoc, INIT:stdoc, BeforeDeclarative>
       TORDINI-ERR SECTION.
      ...
      * <TOTEM:EPT. INIT:stdoc, INIT:stdoc, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-tordini.
      * <TOTEM:EPT. INIT:stdoc, FD:tordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tordini
           ...
           END-IF
      * <TOTEM:EPT. INIT:stdoc, FD:tordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tnotacr.
      * <TOTEM:EPT. INIT:stdoc, FD:tnotacr, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tnotacr
           IF NOT Valid-STATUS-tnotacr
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:stdoc, FD:tnotacr, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tparamge.
      * <TOTEM:EPT. INIT:stdoc, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           IF NOT Valid-STATUS-tparamge
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:stdoc, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-zoom-tno-fat.
      * <TOTEM:EPT. INIT:stdoc, FD:zoom-tno-fat, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-zoom-tno-fat
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:stdoc, FD:zoom-tno-fat, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-zoom-tor-fat.
      * <TOTEM:EPT. INIT:stdoc, FD:zoom-tor-fat, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-zoom-tor-fat
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:stdoc, FD:zoom-tor-fat, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-zoom-tor-bolle.
      * <TOTEM:EPT. INIT:stdoc, FD:zoom-tor-bolle, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-zoom-tor-bolle
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:stdoc, FD:zoom-tor-bolle, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-clienti.
      * <TOTEM:EPT. INIT:stdoc, FD:clienti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT clienti
           IF NOT Valid-STATUS-clienti
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:stdoc, FD:clienti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tcaumag.
      * <TOTEM:EPT. INIT:stdoc, FD:tcaumag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcaumag
           IF NOT Valid-STATUS-tcaumag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:stdoc, FD:tcaumag, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-tordini.
      * <TOTEM:EPT. INIT:stdoc, FD:tordini, BeforeClose>
      * <TOTEM:END>
           CLOSE tordini
           .

       CLOSE-tnotacr.
      * <TOTEM:EPT. INIT:stdoc, FD:tnotacr, BeforeClose>
      * <TOTEM:END>
           CLOSE tnotacr
           .

       CLOSE-tparamge.
      * <TOTEM:EPT. INIT:stdoc, FD:tparamge, BeforeClose>
      * <TOTEM:END>
           CLOSE tparamge
           .

       CLOSE-zoom-tno-fat.
      * <TOTEM:EPT. INIT:stdoc, FD:zoom-tno-fat, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-zoom-tor-fat.
      * <TOTEM:EPT. INIT:stdoc, FD:zoom-tor-fat, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-zoom-tor-bolle.
      * <TOTEM:EPT. INIT:stdoc, FD:zoom-tor-bolle, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-clienti.
      * <TOTEM:EPT. INIT:stdoc, FD:clienti, BeforeClose>
      * <TOTEM:END>
           CLOSE clienti
           .

       CLOSE-tcaumag.
      * <TOTEM:EPT. INIT:stdoc, FD:tcaumag, BeforeClose>
      * <TOTEM:END>
           CLOSE tcaumag
           .
      ...
      * <TOTEM:PARA. CHIAMA-MANUTENZIONE>
           evaluate tipo-doc
           when 1   move "stdocB" to LinkPgm
                    perform CALL-GORDCVAR
           when 2   if tor-ordine
                       move "stdocF" to LinkPgm
                       perform CALL-GORDCVAR
                    else          
                       perform CALL-FATMANVAR
                    end-if
           when 3   perform CALL-NOTAVAR
           end-evaluate.
