      *{TOTEM}PRG-COMMENT
      * evaart-GDO.Cbl
      * evaart-GDO.Cbl is generated by TOTEM
      * This is a generated file. DO NOT modify this file directly.
      *{TOTEM}END
       IDENTIFICATION       DIVISION.
      *{TOTEM}PRGID
       PROGRAM-ID.          evaart-GDO.
       AUTHOR.              Andrea.
       DATE-WRITTEN.        martedì 23 novembre 2010 13.02.01.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:evaart-GDO, INIT:evaart-GDO, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       77 EVADI_TUTTO-OLD-BMP          PIC  S9(9)
                  USAGE IS COMP-4
                  VALUE IS 0.
      ...
      ***********************************************************
       ...
       77 STATUS-SCR-EVASIONI-FLAG-REFRESH PIC  9.
          88 SCR-EVASIONI-FLAG-REFRESH  VALUE 1 FALSE 0. 
      ...
      * CHECK BOX
       05
           ...
           LINES 30,00 ,
           SIZE 73,00 ,
           BITMAP-HANDLE EVADI_TUTTO-OLD-BMP,
           BITMAP-NUMBER 1,
           UNFRAMED,
           SQUARE,
           ...
           FONT IS Small-Font,
           ID IS 1,
           TITLE "Indica il tipo di evasione NORMALE o TUTTO",
           VALUE evadi-tutto,
           AFTER PROCEDURE chk-evadi-AfterProcedure,
           BEFORE PROCEDURE chk-evadi-BeforeProcedure, 
           .
      * GRID
       05
           gd3, 
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:evaart-GDO, INIT:evaart-GDO, BeforeDeclarative>
      ...
      * <TOTEM:EPT. INIT:evaart-GDO, INIT:evaart-GDO, BeforeDestroyResource>
      * <TOTEM:END>
           ...
           CALL "w$bitmap" USING WBITMAP-DESTROY, EVADI_TUTTO-OLD-BMP
      ...
      * pb-applica
           ...
           CALL "w$bitmap" USING WBITMAP-LOAD "APPLICA.BMP", 
                   GIVING APPLICA-BMP.
      * chk-evadi
           COPY RESOURCE "EVADI_TUTTO-OLD.BMP".
           CALL "w$bitmap" USING WBITMAP-LOAD "EVADI_TUTTO-OLD.BMP", 
                   GIVING EVADI_TUTTO-OLD-BMP.
      * pb-genera
      ...
      *    After Open
       ...
       OPEN-progmag.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:progmag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT progmag
           ...
           END-IF
      * <TOTEM:EPT. INIT:evaart-GDO, FD:progmag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-articoli.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:articoli, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT articoli
           IF NOT Valid-STATUS-articoli
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:evaart-GDO, FD:articoli, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-clienti.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:clienti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT clienti
           IF NOT Valid-STATUS-clienti
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:evaart-GDO, FD:clienti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-mrordini.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:mrordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT mrordini
           IF NOT Valid-STATUS-mrordini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:evaart-GDO, FD:mrordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-mtordini.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:mtordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT mtordini
           IF NOT Valid-STATUS-mtordini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:evaart-GDO, FD:mtordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmp-mrordini.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tmp-mrordini, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-tmp-mrordini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tmp-mrordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmp-evaart.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tmp-evaart, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-tmp-evaart
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tmp-evaart, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tparamge.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           IF NOT Valid-STATUS-tparamge
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tordini.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O tordini
           ...
           IF NOT Valid-STATUS-tordini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-rordini.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:rordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O rordini
           ...
           IF NOT Valid-STATUS-rordini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:evaart-GDO, FD:rordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-destini.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:destini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT destini
           IF NOT Valid-STATUS-destini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:evaart-GDO, FD:destini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-recapiti.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:recapiti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT recapiti
           IF NOT Valid-STATUS-recapiti
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:evaart-GDO, FD:recapiti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tcaumag.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tcaumag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcaumag
           IF NOT Valid-STATUS-tcaumag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tcaumag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-blister.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:blister, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT blister
           IF NOT Valid-STATUS-blister
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:evaart-GDO, FD:blister, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tgrupgdo.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tgrupgdo, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tgrupgdo
           IF NOT Valid-STATUS-tgrupgdo
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tgrupgdo, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-lockfile.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:lockfile, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O lockfile
           ...
           IF NOT Valid-STATUS-lockfile
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:evaart-GDO, FD:lockfile, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tscorte.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tscorte, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tscorte
           IF NOT Valid-STATUS-tscorte
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tscorte, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tpromo.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tpromo, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tpromo
           IF NOT Valid-STATUS-tpromo
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tpromo, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-ttipocli.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:ttipocli, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT ttipocli
           IF NOT Valid-STATUS-ttipocli
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:evaart-GDO, FD:ttipocli, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-lineseq.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:lineseq, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT lineseq
           IF NOT Valid-STATUS-lineseq
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:evaart-GDO, FD:lineseq, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tagli.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tagli, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O tagli
           IF STATUS-tagli = "35"
              OPEN OUTPUT tagli
           ...
           IF NOT Valid-STATUS-tagli
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tagli, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmp-blis-eva.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tmp-blis-eva, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-tmp-blis-eva
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tmp-blis-eva, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-evaclides.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:evaclides, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-evaclides
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:evaart-GDO, FD:evaclides, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-timposte.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:timposte, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT timposte
           IF NOT Valid-STATUS-timposte
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:evaart-GDO, FD:timposte, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmarche.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tmarche, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tmarche
           IF NOT Valid-STATUS-tmarche
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tmarche, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-progmag.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:progmag, BeforeClose>
      * <TOTEM:END>
           CLOSE progmag
           .

       CLOSE-articoli.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:articoli, BeforeClose>
      * <TOTEM:END>
           CLOSE articoli
           .

       CLOSE-clienti.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:clienti, BeforeClose>
      * <TOTEM:END>
           CLOSE clienti
           .

       CLOSE-mrordini.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:mrordini, BeforeClose>
      * <TOTEM:END>
           CLOSE mrordini
           .

       CLOSE-mtordini.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:mtordini, BeforeClose>
      * <TOTEM:END>
           CLOSE mtordini
           .

       CLOSE-tmp-mrordini.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tmp-mrordini, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-tmp-evaart.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tmp-evaart, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-tparamge.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tparamge, BeforeClose>
      * <TOTEM:END>
           CLOSE tparamge
           .

       CLOSE-tordini.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tordini, BeforeClose>
      * <TOTEM:END>
           CLOSE tordini
           .

       CLOSE-rordini.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:rordini, BeforeClose>
      * <TOTEM:END>
           CLOSE rordini
           .

       CLOSE-destini.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:destini, BeforeClose>
      * <TOTEM:END>
           CLOSE destini
           .

       CLOSE-recapiti.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:recapiti, BeforeClose>
      * <TOTEM:END>
           CLOSE recapiti
           .

       CLOSE-tcaumag.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tcaumag, BeforeClose>
      * <TOTEM:END>
           CLOSE tcaumag
           .

       CLOSE-blister.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:blister, BeforeClose>
      * <TOTEM:END>
           CLOSE blister
           .

       CLOSE-tgrupgdo.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tgrupgdo, BeforeClose>
      * <TOTEM:END>
           CLOSE tgrupgdo
           .

       CLOSE-lockfile.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:lockfile, BeforeClose>
      * <TOTEM:END>
           CLOSE lockfile
           .

       CLOSE-tscorte.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tscorte, BeforeClose>
      * <TOTEM:END>
           CLOSE tscorte
           .

       CLOSE-tpromo.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tpromo, BeforeClose>
      * <TOTEM:END>
           CLOSE tpromo
           .

       CLOSE-ttipocli.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:ttipocli, BeforeClose>
      * <TOTEM:END>
           CLOSE ttipocli
           .

       CLOSE-lineseq.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:lineseq, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-tagli.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tagli, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-tmp-blis-eva.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tmp-blis-eva, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-evaclides.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:evaclides, BeforeClose>
      * <TOTEM:END>
           CLOSE evaclides
           .

       CLOSE-timposte.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:timposte, BeforeClose>
      * <TOTEM:END>
           CLOSE timposte
           .

       CLOSE-tmarche.
      * <TOTEM:EPT. INIT:evaart-GDO, FD:tmarche, BeforeClose>
      * <TOTEM:END>
           CLOSE tmarche
           .
      ...
      * <TOTEM:END>
       ...
       SCR-EVASIONI-Open-Routine.
           PERFORM SCR-EVASIONI-Scrn
           PERFORM SCR-EVASIONI-Proc
           .

       SCR-EVASIONI-Scrn.
           PERFORM SCR-EVASIONI-Create-Win
           PERFORM SCR-EVASIONI-Init-Value
           PERFORM SCR-EVASIONI-Init-Data
      * Tab keystrok settings
      * Tool Bar
           PERFORM SCR-EVASIONI-DISPLAY
           .

       SCR-EVASIONI-Create-Win.
           Display Floating GRAPHICAL WINDOW
              LINES 5,70,
              SIZE 64,00,
              CELL HEIGHT 10,
              ...
              USER-WHITE,
              No WRAP,
              HANDLE IS SCR-EVASIO-SF-HANDLE,
      * <TOTEM:EPT. FORM:SCR-EVASIONI, FORM:SCR-EVASIONI, AfterCreateWin>
      * <TOTEM:END>


      * Tool Bar    
      * Status-bar
           DISPLAY SCR-EVASIONI UPON SCR-EVASIO-SF-HANDLE
      * DISPLAY-COLUMNS settings
           .

       SCR-EVASIONI-PROC.
      * <TOTEM:EPT. FORM:SCR-EVASIONI, FORM:SCR-EVASIONI, BeforeAccept>
           ...
           start tmp-evaart key >= tmeva-k-ord-GDO
                 invalid continue
             not invalid
                 perform until 1 = 2
                    ...
                    if counter2 = 10
                       ...
                       display counter-edit
                          upon SCR-EVASIO-SF-HANDLE at column 19
                                                         line 01
                       move 0 to counter2
                    end-if
                    ...
                    if record-ok
                       ...
                       if tmeva-chiave-testa not = save-chiave-testa
                          move tmeva-cod-cli     to mto-cod-cli
                                                    cli-codice 
                                                    des-codice
                          move tmeva-prg-destino to des-prog
                                                    mto-prg-destino
                          move tmeva-chiave-testa to save-chiave-testa
      ...
      * <TOTEM:END>
           PERFORM UNTIL Exit-Pushed
              ACCEPT OMITTED LINE 1 COL 1
                 ON EXCEPTION
                    PERFORM SCR-EVASIONI-Evaluate-Func
                 MOVE 4 TO TOTEM-Form-Index
              END-ACCEPT
      * <TOTEM:EPT. FORM:SCR-EVASIONI, FORM:SCR-EVASIONI, AfterEndAccept>
      * <TOTEM:END>
           END-PERFORM
      * <TOTEM:EPT. FORM:SCR-EVASIONI, FORM:SCR-EVASIONI, BeforeDestroyWindow>
      * <TOTEM:END>
           DESTROY SCR-EVASIO-SF-HANDLE
           INITIALIZE Key-Status
           .

       SCR-EVASIONI-Evaluate-Func.
      * <TOTEM:EPT. FORM:SCR-EVASIONI, FORM:SCR-EVASIONI, AfterAccept>
      * <TOTEM:END>
           EVALUATE TRUE
              WHEN Exit-Pushed
                 PERFORM SCR-EVASIONI-Exit
              WHEN Event-Occurred
                 IF Event-Type = Cmd-Close
                    PERFORM SCR-EVASIONI-Exit
                 END-IF
      ...
      * avoid changing focus
       ...
       SCR-EVASIONI-DISPLAY.
      * <TOTEM:EPT. FORM:SCR-EVASIONI, FORM:SCR-EVASIONI, BeforeDisplay>
      * <TOTEM:END>
           DISPLAY SCR-EVASIONI UPON SCR-EVASIO-SF-HANDLE
      * <TOTEM:EPT. FORM:SCR-EVASIONI, FORM:SCR-EVASIONI, AfterDisplay>
           SET LK-BL-SCRITTURA     TO TRUE.
           MOVE COMO-PROG-ID       TO LK-BL-PROG-ID.
           MOVE FORM1-HANDLE       TO LK-HND-WIN.
           CALL "BLOCKPGM"  USING LK-BLOCKPGM.
      ...
      * <TOTEM:END>
       ...
       SCR-EVASIONI-Exit.
      * for main screen
      * <TOTEM:EPT. FORM:SCR-EVASIONI, FORM:SCR-EVASIONI, BeforeExit>
      * <TOTEM:END>
           MOVE 27 TO Key-Status
           .

       SCR-EVASIONI-Init-Data.
           MOVE 4 TO TOTEM-Form-Index
           MOVE 0 TO TOTEM-Frame-Index
           .

       SCR-EVASIONI-Init-Value.
      * <TOTEM:EPT. FORM:SCR-EVASIONI, FORM:SCR-EVASIONI, SetDefault>
      * <TOTEM:END>
           PERFORM SCR-EVASIONI-FLD-TO-BUF
           .


       SCR-EVASIONI-ALLGRID-RESET.
           .

      * for Form's Validation
       SCR-EVASIONI-VALIDATION-ROUTINE.
           SET TOTEM-CHECK-OK TO TRUE
           .


       SCR-EVASIONI-Buf-To-Fld.
      * <TOTEM:EPT. FORM:SCR-EVASIONI, FORM:SCR-EVASIONI, BeforeBufToFld>
      * <TOTEM:END>
      * <TOTEM:EPT. FORM:SCR-EVASIONI, FORM:SCR-EVASIONI, AfterBufToFld>
      * <TOTEM:END>
           .

       SCR-EVASIONI-Fld-To-Buf.
      * <TOTEM:EPT. FORM:SCR-EVASIONI, FORM:SCR-EVASIONI, BeforeFldToBuf>
      * <TOTEM:END>
      * <TOTEM:EPT. FORM:SCR-EVASIONI, FORM:SCR-EVASIONI, AfterFldToBuf>
      * <TOTEM:END>
           .

       SCR-EVASIONI-CONTROLLO-OLD.
           set SiSalvato to true.
           if mod = 0 exit paragraph end-if.
           perform SCR-EVASIONI-BUF-TO-FLD.
           move 0 to scelta.
           .
       SCR-EVASIONI-EXTENDED-FILE-STATUS.
           CALL "C$RERRNAME" USING TOTEM-MSG-ERR-FILE
           CALL "C$RERR" USING EXTEND-STAT, TEXT-MESSAGE
           MOVE PRIMARY-ERROR TO TOTEM-MSG-ID
           PERFORM SCR-EVASIONI-SHOW-MSG-ROUTINE
           .

       SCR-EVASIONI-SHOW-MSG-ROUTINE.
           PERFORM SHOW-MSG-ROUTINE
           PERFORM SCR-EVASIONI-DISPLAY-MESSAGE
           .

       SCR-EVASIONI-DISPLAY-MESSAGE.
           PERFORM MESSAGE-BOX-ROUTINE
           DISPLAY MESSAGE BOX TOTEM-MSG-TEXT
               TITLE IS TOTEM-MSG-TITLE
               TYPE  IS TOTEM-MSG-BUTTON-TYPE
       ...
       SCR-EVASIONI-Save-Status.
           .             

       SCR-EVASIONI-Restore-Status.
           .
      ...
      * <TOTEM:PARA. CICLO-EVADIBILITA-PROMO>
           perform CICLO-EVADIBILITA-PROMO-CICLO-1.
           perform EVADIBLITA-MASTER-PROMO.
           if tot-idx-eva > 0
              perform CICLO-EVADIBILITA-PROMO-CICLO-2
           end-if.
      ...
      * <TOTEM:END>
       ...
       CICLO-EVADIBILITA-PROMO-CICLO-2.
      * <TOTEM:PARA. CICLO-EVADIBILITA-PROMO-CICLO-2>
           ...
           start tmp-mrordini key >= k-promo
             ...
             not invalid
                 perform until 1 = 2
                    ...
                    if tmro-promo-no              exit perform end-if
                    ...
                    set record-ok to true
                    |Se sono OLTRE ai giorni di evasione parziale
                    |devo evadere TUTTE le righe
                    if tmro-data-cons > data-consegna
                       set idx-eva to 1
                       search el-master-eva
                         at end set record-ok to false
                       when el-master-eva(idx-eva) = tmro-chiave-testa
                            set record-ok to true
                       end-search
                    end-if
                    if record-ok and tmro-qta > 0
                       ...
                       write tmeva-rec invalid rewrite tmeva-rec 
           end-write
      *****              else
      *****                 compute da-evadere = tmro-qta-evadibile - tmro-qta-e
      *****                 if da-evadere > 0
      *****                    set idx-giac to 1
      *****                    search el-riga
      *****                    at end continue
      *****                    |Rimetto la giacenza a disposizione degli altri
      *****                    when tmro-prg-chiave = el-prg-chiave(idx-giac)
      *****                         add da-evadere to el-giacenza(idx-giac)
      *****                    end-search
      *****                 end-if
      *****                 if tmro-qta not = 0
      *****                    move 0 to tmro-qta tmro-bli-evasi
      *****                    rewrite tmro-rec
      *****                    start tmp-mrordini key >= k-promo
      ...
      * <TOTEM:END>
       ...
       EVADIBLITA-MASTER-PROMO.
      * <TOTEM:PARA. EVADIBLITA-MASTER-PROMO>
           initialize tab-master-eva tab-master-eva-ko.
           initialize save-chiave-testa.
           move 0 to righe-tot righe-eva tot-idx-eva tot-idx-eva-ko.
           move low-value to tmro-rec.
           set tmro-promo-si to true.
           start tmp-mrordini key >= k-promo
                 invalid continue
             not invalid
                 perform until 1 = 2
                    read tmp-mrordini next 
                      at end 
                         perform VALUTA-EVADIBILITA
                         exit perform 
                    end-read

                    if save-anno = 0
                       move tmro-chiave-testa to save-chiave-testa
                    end-if
                    ...
                    if save-chiave-testa not = tmro-chiave-testa
                       perform VALUTA-EVADIBILITA
                    end-if
                    ...
                    if evadi-tutto = 1
                       ...
                       ||EVASO COMPLETO
                       if tmro-qta-evadibile = tmro-qta-o - tmro-qta-e
                          set record-ok to true
                       else
      ...
      *****                       read mrordini no lock invalid continue end-read
      *****                       if mro-tenere-saldo or mro-tagliare-merce
      *****                          set record-ok to true
      *****                       end-if
                          end-if
                       end-if
      ...
      ***---
       VALUTA-EVADIBILITA.
           if righe-tot = righe-eva
              add 1 to tot-idx-eva
              move save-chiave-testa to el-master-eva(tot-idx-eva)
           else
              add 1 to tot-idx-eva-ko
              move save-chiave-testa to el-master-eva-ko(tot-idx-eva-ko)
           end-if.
           move 0 to righe-tot.
           move 0 to righe-eva.
           move tmro-chiave-testa to save-chiave-testa 
      ...
      * <TOTEM:PARA. LOOP-MTORDINI>
           ...
           initialize save-chiave-testa. |tab-giacenza.
      ...
      *****                 mto-fatt-tot or
                       ...
                       read clienti no lock
                       |Richiesta di Walter 11/06: evadere i 
                       |clienti bloccati per fuori fido
                       if cli-attivo or
      ...
      ***---
       METTI-IN-GRIGLIA-1.
           ...
           if mto-prg-destino = 0
              move cli-localita    to col1-destino
           else
              move mto-cod-cli     to des-codice
              move mto-prg-destino to des-prog
              read destini no lock invalid continue end-read
              move des-localita to col1-destino
           end-if.
           ...
           read tgrupgdo no lock
                invalid move spaces           to col1-gdo
            not invalid move gdo-intestazione to col1-gdo
           end-read.
           ...
           modify gd1(riga, 7), cell-data col1-gdo 
           .
      * <TOTEM:END>
      ...
      ***--- DUMMY: NON TOCCARE
       ...
       CHIUDI-MASTER. |SOLO PER TRADIZIONALE, SU GDO CI PENSA L'AGGIORNAMENTO
       TROVA-PARAMETRO.
       TRATTA-BLISTER 
           .
      * <TOTEM:END>
      ...
      * Verdana10-Occidentale
           ...
           MOVE 0 TO WFONT-CHAR-SET
           CALL "W$FONT" USING WFONT-GET-FONT, 
                     Verdana10I-Occidentale, WFONT-DATA
      ...
      * <TOTEM:PARA. pb-genera-LinkTo>
           ...
           if tutto-ok
              perform SCR-EVASIONI-OPEN-ROUTINE
      ...
      * <TOTEM:PARA. pb-si-LinkTo>
           .
      * <TOTEM:END>
       chk-evadi-BeforeProcedure.
      * <TOTEM:PARA. chk-evadi-BeforeProcedure>
           if evadi-tutto = 1
              modify chk-evadi, bitmap-number = 4
           else
              modify chk-evadi, bitmap-number = 2
           end-if.
           MODIFY CONTROL-HANDLE COLOR = COLORE-NU
           .
      * <TOTEM:END>
       chk-evadi-AfterProcedure.
      * <TOTEM:PARA. chk-evadi-AfterProcedure>
           if evadi-tutto = 1
              modify chk-evadi, bitmap-number = 1
           else
              modify chk-evadi, bitmap-number = 3
           end-if.
           MODIFY CONTROL-HANDLE COLOR = COLORE-OR
           .
      * <TOTEM:END>
       chk-evadi-LinkTo.
      * <TOTEM:PARA. chk-evadi-LinkTo>
           close       tmp-evaart.
           open output tmp-evaart.
           close       tmp-evaart.
           open i-o    tmp-evaart.
