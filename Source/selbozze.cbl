      *{TOTEM}PRG-COMMENT
      * selbozze.Cbl
      * selbozze.Cbl is generated by TOTEM
      ...
      *{TOTEM}PRGID
       ...
       DATE-WRITTEN.        mercoledì 8 aprile 2015 16:10:29.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:selbozze, INIT:selbozze, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       78 titolo VALUE IS "Geslux - Ricerca e variazione Bozze d'evasion
      -    "e". 
       ...
       01 Gd-ordini-Record.
           ...
           05 col-anno-mov     PIC  x(4).
           05 col-num-mov      PIC  x(8).
      ...
      * FILE'S LOCK MODE FLAG
       ...
       78  78-colore-aperte  value 513. 
       78  78-colore-chiuse  value 112. 

       78  78-tit-aperte     value "Aperta". 
       78  78-tit-chiuse     value "Chiusa". 
      ...
      * GRID
       05
           ...
           SIZE 161,67 ,
           BOXED,
           DATA-COLUMNS (1, 2, 6, 14, 24, 29, 69, 79, 83),
           ALIGNMENT ("C", "C", "R", "C", "R", "U", "U", "C", "C"),
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:selbozze, INIT:selbozze, BeforeDeclarative>
      ***---
       teva-ERR SECTION.
      ...
      * <TOTEM:EPT. INIT:selbozze, INIT:selbozze, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-teva.
      * <TOTEM:EPT. INIT:selbozze, FD:teva, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT teva
           ...
           END-IF
      * <TOTEM:EPT. INIT:selbozze, FD:teva, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-clienti.
      * <TOTEM:EPT. INIT:selbozze, FD:clienti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT clienti
           IF NOT Valid-STATUS-clienti
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selbozze, FD:clienti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-destini.
      * <TOTEM:EPT. INIT:selbozze, FD:destini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT destini
           IF NOT Valid-STATUS-destini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selbozze, FD:destini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tparamge.
      * <TOTEM:EPT. INIT:selbozze, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           IF NOT Valid-STATUS-tparamge
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selbozze, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-teva.
      * <TOTEM:EPT. INIT:selbozze, FD:teva, BeforeClose>
      * <TOTEM:END>
           CLOSE teva
           .

       CLOSE-clienti.
      * <TOTEM:EPT. INIT:selbozze, FD:clienti, BeforeClose>
      * <TOTEM:END>
           CLOSE clienti
           .

       CLOSE-destini.
      * <TOTEM:EPT. INIT:selbozze, FD:destini, BeforeClose>
      * <TOTEM:END>
           CLOSE destini
           .

       CLOSE-tparamge.
      * <TOTEM:EPT. INIT:selbozze, FD:tparamge, BeforeClose>
      * <TOTEM:END>
           CLOSE tparamge
           .
      ...
      * SPECIFICO PER PROGRAMMI CON SCREEN DI ACCETTAZIONE LIMITI
           ...
           Perform RIEMPI-COMBO-STATO-BOZZE.
      ...
      *    cambio la label legenda
           ...
           evaluate true
           when r-aperte
                move 78-colore-aperte to col-stato-ordine
                move 78-tit-aperte    to tit-stato-ordine
           when r-chiuse
                move 78-colore-chiuse to col-stato-ordine
                move 78-tit-chiuse    to tit-stato-ordine
           end-evaluate
      ...
      * <TOTEM:PARA. CARICA-BOZZE>
           move anno-to      to teva-anno.
           move ordine-from  to teva-numero.
      ...
      * <TOTEM:PARA. CHIAMA-MANUTENZIONE>
           ...
           move como-anno          to teva-anno.
           move como-numero-ordine to teva-numero.
           move teva-chiave         to LinkChiave.
      ...
      * <TOTEM:PARA. METTI-IN-GRIGLIA>
           ...
           move teva-data(1:4)  to col-data(7:4)
           move teva-data(5:2)  to col-data(4:2)
           move teva-data(7:2)  to col-data(1:2)

           move "/"                   to col-data(3:1)
                                         col-data(6:1).

           move teva-cod-forn          to Col-fornitore
                                         cli-codice.
           ...
           evaluate true
           when teva-aperta
                set r-aperte          to true
                move 78-colore-aperte to col-stato-ordine
                move 78-tit-aperte    to col-stato
                move space            to col-anno-mov
                                         col-num-mov
           when teva-chiusa
                set r-chiuse          to true
                move 78-colore-chiuse to col-stato-ordine
                move 78-tit-chiuse    to col-stato

                move teva-num-movim   to num-ed
                move num-ed           to col-num-mov
                move teva-anno-movim  to col-anno-mov
           end-evaluate
      ...
      * <TOTEM:PARA. PARAGRAFO-COPY>
           ...
           copy "riempi-combo-stato-teva.cpy" 
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. SCORRI-BOZZE>
           ...
           perform until 1 = 2
              ...
              if teva-anno > anno-to    
                 exit perform 
              end-if

              if teva-numero > ordine-TO
                 exit perform 
              end-if

              perform VALIDA-BOZZE
      ...
      * <TOTEM:END>
       ...
       VALIDA-BOZZE.
      * <TOTEM:PARA. VALIDA-BOZZE>
           set record-ok to true.

           if teva-data < data-from-AAAAMMGG or teva-data > 
           data-to-AAAAMMGG
              set record-ok to false
           end-if.

           if teva-cod-forn < cliente-from or 
              teva-cod-forn > cliente-to
              set record-ok to false
           end-if 
