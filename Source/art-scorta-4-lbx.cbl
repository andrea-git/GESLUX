       ...
       PROGRAM-ID.                      art-scorta-4-lbx.
       AUTHOR.                          Andrea.
       REMARKS. Passa gli articoli e li mette in scorta 4 e mag standard LBX
      ******************************************************************
      ...
      * COSTANTI
       78  titolo value "Batch articoli scorta 4 LBX".
      ...
      ***---
       INIT.
           ...
           move "art-scorta-4-lbx.csv" to wstampa.
