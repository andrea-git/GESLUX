      ...
      * COSTANTI
       78  titolo value "Importazione prodotti energetici".
      ...
      ***---
       INIT.
           set tutto-ok to true.
           move "imp-prodener.csv" to wstampa.
      ...
      ***---
       ELABORAZIONE.
           ...
           perform until 1 = 2
              initialize line-riga r-prodener
              ...
              read articoli
               ...
               not invalid 
                   add 1 to num-rec-ok
                   move r-prodener to art-cod-prodener
