      *{TOTEM}PRG-COMMENT
      * contr-bozze.Cbl
      * contr-bozze.Cbl is generated by TOTEM
      * This is a generated file. DO NOT modify this file directly.
      *{TOTEM}END
       IDENTIFICATION       DIVISION.
      *{TOTEM}PRGID
       PROGRAM-ID.          contr-bozze.
       AUTHOR.              ANDREA EVENTI.
       DATE-WRITTEN.        martedì 1 aprile 2014 19:14:02.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:contr-bozze, INIT:contr-bozze, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       78 titolo VALUE IS "Geslux - Controllo Bozze". 
       77 form1-Handle
      ...
      * LABEL
       05
           ...
           CENTER,
           TRANSPARENT,
           TITLE "Confermi il controllo dell'esistenza delle righe dell'
      -    "ordine collegate alle bozze?",
           .
      ...
      *{TOTEM}COPY-PROCEDURE
       EXIT-STOP-ROUTINE.
      * <TOTEM:EPT. INIT:contr-bozze, INIT:contr-bozze, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. STAMPA>
           ...
           move spaces to cbo-path
           accept como-data   from century-date
           accept como-ora    from time
           accept  cbo-path   from environment "PATH-ST"
           inspect cbo-path   replacing trailing spaces by low-value
           string  cbo-path   delimited by low-value
                   "contr_bozze"   delimited by size
                   "_"             delimited by size
           ...
           move form3-Handle to cbo-Handle

           call "contr-bozze-p" using contr-bozze-p-linkage
           cancel "contr-bozze-p".
      ...
      * <TOTEM:PARA. pb-ok-LinkTo>
           ...
           call "C$FILEINFO" using cbo-path, file-info
      
           if file-size not = 0
              set  splcrt2graf-stampa    to true
              set  splcrt2graf-windows   to true
              move cbo-path              to splcrt2graf-percorso-stampa
              ...
              display message box "Nessun Errore riscontrato"
                    title titolo
           end-if
