      *{TOTEM}PRG-COMMENT
      * bprepb.Cbl
      * bprepb.Cbl is generated by TOTEM
      ...
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:bprepb, INIT:bprepb, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:bprepb, INIT:bprepb, BeforeDeclarative>
       TORDINI-ERR SECTION.
      ...
      * <TOTEM:EPT. INIT:bprepb, INIT:bprepb, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-tordini.
      * <TOTEM:EPT. INIT:bprepb, FD:tordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O tordini
           ...
           END-IF
      * <TOTEM:EPT. INIT:bprepb, FD:tordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-destini.
      * <TOTEM:EPT. INIT:bprepb, FD:destini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT destini
           IF NOT Valid-STATUS-destini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bprepb, FD:destini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-rordini.
      * <TOTEM:EPT. INIT:bprepb, FD:rordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT rordini
           IF NOT Valid-STATUS-rordini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bprepb, FD:rordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tvettori.
      * <TOTEM:EPT. INIT:bprepb, FD:tvettori, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tvettori
           IF NOT Valid-STATUS-tvettori
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bprepb, FD:tvettori, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-clienti.
      * <TOTEM:EPT. INIT:bprepb, FD:clienti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT clienti
           IF NOT Valid-STATUS-clienti
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bprepb, FD:clienti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-articoli.
      * <TOTEM:EPT. INIT:bprepb, FD:articoli, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT articoli
           IF NOT Valid-STATUS-articoli
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bprepb, FD:articoli, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tparamge.
      * <TOTEM:EPT. INIT:bprepb, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           IF NOT Valid-STATUS-tparamge
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bprepb, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-zoom-tordini.
      * <TOTEM:EPT. INIT:bprepb, FD:zoom-tordini, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-zoom-tordini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bprepb, FD:zoom-tordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tcaumag.
      * <TOTEM:EPT. INIT:bprepb, FD:tcaumag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcaumag
           IF NOT Valid-STATUS-tcaumag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bprepb, FD:tcaumag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tnomen.
      * <TOTEM:EPT. INIT:bprepb, FD:tnomen, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tnomen
           IF NOT Valid-STATUS-tnomen
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:bprepb, FD:tnomen, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-tordini.
      * <TOTEM:EPT. INIT:bprepb, FD:tordini, BeforeClose>
      * <TOTEM:END>
           CLOSE tordini
           .

       CLOSE-destini.
      * <TOTEM:EPT. INIT:bprepb, FD:destini, BeforeClose>
      * <TOTEM:END>
           CLOSE destini
           .

       CLOSE-rordini.
      * <TOTEM:EPT. INIT:bprepb, FD:rordini, BeforeClose>
      * <TOTEM:END>
           CLOSE rordini
           .

       CLOSE-tvettori.
      * <TOTEM:EPT. INIT:bprepb, FD:tvettori, BeforeClose>
      * <TOTEM:END>
           CLOSE tvettori
           .

       CLOSE-clienti.
      * <TOTEM:EPT. INIT:bprepb, FD:clienti, BeforeClose>
      * <TOTEM:END>
           CLOSE clienti
           .

       CLOSE-articoli.
      * <TOTEM:EPT. INIT:bprepb, FD:articoli, BeforeClose>
      * <TOTEM:END>
           CLOSE articoli
           .

       CLOSE-tparamge.
      * <TOTEM:EPT. INIT:bprepb, FD:tparamge, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-zoom-tordini.
      * <TOTEM:EPT. INIT:bprepb, FD:zoom-tordini, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-tcaumag.
      * <TOTEM:EPT. INIT:bprepb, FD:tcaumag, BeforeClose>
      * <TOTEM:END>
           CLOSE tcaumag
           .

       CLOSE-tnomen.
      * <TOTEM:EPT. INIT:bprepb, FD:tnomen, BeforeClose>
      * <TOTEM:END>
           CLOSE tnomen
           .
      ...
      * <TOTEM:END>
       ...
       Form1-Init-Value.
           MOVE "Prenotazione Bolla" TO TOTEM-MSG-TITLE
      ...
      * <TOTEM:EPT. FORM:Screen2, FORM:Screen2, BeforeAccept>
           ...
           start rordini key is >= ror-chiave invalid continue 
           end-start.
           perform until 1 = 2
...
LUBEXX*       Blocco la prenotazione 
LUBEXX        move art-cod-doganale to nom-codice
LUBEXX        read tnomen no lock invalid continue end-read
LUBEXX        evaluate true
LUBEXX        when nom-si-utf
LUBEXX             if ror-peso-utf = 0 or ror-peso-non-utf not = 0
LUBEXX                move 0 to v-ok
LUBEXX                display message "Impossibile prenotare bolla."
LUBEXX                         X"0d0a""UTF incongruente su articolo "
           art-codice
LUBEXX                         X"0d0a""Contattare amministrazione per re
      -    "ttifica"
LUBEXX                          title tit-err
LUBEXX                           icon 3
LUBEXX             end-if
LUBEXX        when nom-no-utf
LUBEXX             if ror-peso-utf not = 0 or ror-peso-non-utf = 0
LUBEXX                move 0 to v-ok
LUBEXX                display message "Impossibile prenotare bolla."
LUBEXX                         X"0d0a""UTF incongruente su articolo "
           art-codice
             ...
             not invalid
                 perform until 1 = 2
                    ...
                    if tor-anno-bolla not = 0 or
                       ...
                       tor-bolla-si-prenotata
                       exit perform
                    end-if

                    if tor-anno not = save-anno |-> TGE-ANNO
...
LABLAB              end-if
      ...
      * <TOTEM:PARA. PB-ESEGUIa-LinkTo>
           ...
           if scelta = mb-yes  
              ...
              move 0      to lprenf-riga
              call   "bprenf"  using link-bprenf
              cancel "bprenf"

              if lprenf-errore = spaces
                 move tor-data-ordine to como-data
                 ...
                 modify screen2-gd-1(lprenf-riga) row-color 431
           ...
           read tordini no lock
            ...
            not invalid
                if tor-fattura-manuale
                   set errori to true
                   display message "Documento non bollettabile"
                             title tit-err   
                              icon 2
                end-if
                ...
                if tor-bolla-si-prenotata
                   set errori to true
                   display message "Ordine già precedentemente prenotato
      -    ""
                             title tit-err   
                              icon 2
                end-if
...
LABLAB             display message "Ordine bloccato!"
...
LABLAB          end-if
      ...
      *****                  else
      *****                     set errori to true
      *****                     display message "Ordine non LBX/ROT"
      *****                               title tit-err   
      *****                                icon 2
      *****                  end-if
      *****             end-read
