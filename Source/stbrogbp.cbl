       program-id.     stbrogbp.
       author.         Andrea.
       remarks. Stampa brogliaccio bloccati
      ...
      *   88 errori            value "ER".
       ...
       01  testata-1-ord.
      *     05 filler             pic x(10).
           05 t1-cau-descrizione pic x(40).
           05 filler             pic x.
      ...
      *****     05 filler             pic x(2).
       ...
       01  riga1-fm.
           ...
           05 filler             pic x(5).
           05 r-netto-fm         pic zzz.zzz.zz9,99.
           05 filler             pic x(6).
           05 r-imposta-fm       pic z.zz9,99.
           05 filler             pic x(4).
           05 r-cou-fm           pic z.zz9,99.
           05 filler             pic x(2).
           05 r-valore-fm        pic zzz.zzz.zz9,99.
           05 filler             pic x(6).
...
LUBEXX        if tor-num-fattura = 0 or tor-data-fattura = 0
LUBEXX           if tutto-ok
...
LABLAB           if tor-attivo or tor-disattivo
...
LUBEXX              if tor-causale = tmo-causale
                       if tmo-anno-fattura  not = 0 and
                          ...
                          if trovato-ultimo-prezzo exit perform end-if
                       end-if
LUBEXX              end-if
                 end-perform
           end-start.
...
LUBEXX          end-if
      ...
      ***---
       CICLO-STAMPA.
           ...
           move stbrogc-da-anno to ror-anno.
      ...
      *     move ror-des-imballo  to r-imballo-ord.
      *    Adriano - Descrizione imballo
...
OMAGGI     move como-valore      to r-qta-ord.
      ...
      *****       ( ror-imponib-merce + ror-imp-consumo + ror-imp-cou-cobat )
      *****     end-if.
           if ror-si-omaggio
      ...
      *    Adriano - Fine
           if trovato-ultimo-prezzo
              string tmo-data-movim(7:2) delimited by size
                     "/"                 delimited by size
                     tmo-data-movim(5:2) delimited by size
                     "/"                 delimited by size
                     tmo-data-movim(3:2) delimited by size
                     into r-data-ord
              end-string
              if ttipocli-gdo
