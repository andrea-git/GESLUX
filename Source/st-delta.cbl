      *{TOTEM}PRG-COMMENT
      * st-delta.Cbl
      * st-delta.Cbl is generated by TOTEM
      ...
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:st-delta, INIT:st-delta, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:st-delta, INIT:st-delta, BeforeDeclarative>
      ***---
      ...
      * <TOTEM:EPT. INIT:st-delta, INIT:st-delta, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-tparamge.
      * <TOTEM:EPT. INIT:st-delta, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           ...
           END-IF
      * <TOTEM:EPT. INIT:st-delta, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .
      ...
      * <TOTEM:PARA. CONTROLLO>
           ...
           when 78-ID-ef-mese
                ...
                if mese = 0 or mese > 12
                   ...
                   if mese <= tge-data-consolid-progmag(5:2)
                      set errori to true
                      display message "Possibile solamente per mese dopo
      -    " consolidamento"
                               title tit-err
                                icon 2
                   end-if
