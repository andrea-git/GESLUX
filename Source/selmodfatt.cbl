      *{TOTEM}PRG-COMMENT
      * selmodfatt.Cbl
      * selmodfatt.Cbl is generated by TOTEM
      * This is a generated file. DO NOT modify this file directly.
      *{TOTEM}END
       IDENTIFICATION       DIVISION.
      *{TOTEM}PRGID
       PROGRAM-ID.          selmodfatt.
       AUTHOR.              ANDREA EVENTI.
       DATE-WRITTEN.        lunedì 2 dicembre 2013 18:29:58.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:selmodfatt, INIT:selmodfatt, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       78 titolo VALUE IS "Geslux - Ricerca e variazione Fatture Manuali
      -    "". 
       ...
       01 tipo-record      PIC  x.
           88 r-FTND VALUE IS "M". 
           88 r-FTMA VALUE IS "N". 
           88 r-FTTR VALUE IS "T". 
       78 78-colore-FTND VALUE IS 400. 
       78 78-colore-FTMA VALUE IS 513. 
       78 78-colore-FTTR VALUE IS 464. 
       77 como-colore      PIC  9(5).
       77 Verdana10B-Occidentale
                  USAGE IS HANDLE OF FONT DEFAULT-FONT.
       77 como-x           PIC  x.
       01 como-chiave-fatman.
           05 como-anno        PIC  9(4).
           05 como-numero-fatman           PIC  9(8).
       77 Form3-Handle
                  USAGE IS HANDLE OF WINDOW.
       ...
       77 Screen1-St-1-Handle
                  USAGE IS HANDLE OF STATUS-BAR.
       77 tit-stato-fatman PIC  X(30).
       77 col-stato-fatman PIC  9(6)
                  VALUE IS 0.
       ...
       77 CBO-stato-fatman-BUF         PIC  X(50).
       77 fatman-FROM      PIC  9(08).
       77 fatman-TO        PIC  9(08).
      ...
      ***** Elenco ID Logici *****
       ...
       78  78-ID-EF-fatman-FROM VALUE 5002.
       78  78-ID-EF-fatman-TO VALUE 5003.
       ...
       78  78-ID-CBO-STATO-FATMAN VALUE 5008.
      ***** Fine ID Logici *****
      *{TOTEM}END
      ...
      * COMBO-BOX
       05
           ...
           COLOR IS 513,
           ENABLED MOD-LIMITI,
           ID IS 78-ID-CBO-STATO-FATMAN,                
           HEIGHT-IN-CELLS,
           WIDTH-IN-CELLS,
           MASS-UPDATE 0,
           DROP-LIST,
           UNSORTED,
           VALUE CBO-stato-fatman-BUF,
      ...
      * LABEL
       05
           ...
           CENTER,
           TRANSPARENT,
           TITLE "Caricamento Fatture Manuali in corso...",
           .
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:selmodfatt, INIT:selmodfatt, BeforeDeclarative>
      ***---
       CLIENTI-ERR SECTION.
      ...
      * <TOTEM:EPT. INIT:selmodfatt, INIT:selmodfatt, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-clienti.
      * <TOTEM:EPT. INIT:selmodfatt, FD:clienti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT clienti
           ...
           END-IF
      * <TOTEM:EPT. INIT:selmodfatt, FD:clienti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-destini.
      * <TOTEM:EPT. INIT:selmodfatt, FD:destini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT destini
           IF NOT Valid-STATUS-destini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selmodfatt, FD:destini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tparamge.
      * <TOTEM:EPT. INIT:selmodfatt, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           IF NOT Valid-STATUS-tparamge
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selmodfatt, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tordini.
      * <TOTEM:EPT. INIT:selmodfatt, FD:tordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tordini
           IF NOT Valid-STATUS-tordini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:selmodfatt, FD:tordini, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-clienti.
      * <TOTEM:EPT. INIT:selmodfatt, FD:clienti, BeforeClose>
      * <TOTEM:END>
           CLOSE clienti
           .

       CLOSE-destini.
      * <TOTEM:EPT. INIT:selmodfatt, FD:destini, BeforeClose>
      * <TOTEM:END>
           CLOSE destini
           .

       CLOSE-tparamge.
      * <TOTEM:EPT. INIT:selmodfatt, FD:tparamge, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-tordini.
      * <TOTEM:EPT. INIT:selmodfatt, FD:tordini, BeforeClose>
      * <TOTEM:END>
           CLOSE tordini
           .
      ...
      * DISPLAY-COLUMNS settings
              MODIFY gd-fatt, DISPLAY-COLUMNS (1, 4, 12, 24, 36, 46, 
           76, 106, 136)
           .
      ...
      * <TOTEM:EPT. FORM:Form2, FORM:Form2, BeforeAccept>
           ...
           if not trovato
              display message box "Nessuna Fattura manuale presente"
                                  " per i limiti richiesti"
                      title = tit-err
                      icon mb-error-icon
              perform FORM2-EXIT
           else             
      ...
      * SPECIFICO PER PROGRAMMI CON SCREEN DI ACCETTAZIONE LIMITI
           ...
           move 1        to tipo-elab.
           Move all "9"  to fatman-to,
                            data-to,
                            cliente-to.

           Move 0        to fatman-from,
                            data-from,
                            cliente-from.

           Perform RIEMPI-COMBO-STATO-FATMAN.

          
           move 78-FTMA to cbo-stato-fatman-buf
      ...
      * <TOTEM:END>
       ...
       Form1-Init-Data.
           ...
           MOVE 0 TO TOTEM-Frame-Index
      * COMBO-BOX
           PERFORM CBO-STATO-FATMAN-Content
           .
      ...
      * Generazione stringa perform CONTROLLO
           ...
           when 78-ID-EF-ANNO
                perform CONTROLLO
           |78-ID-EF-fatman-FROM è l'ID del campo EF-fatman-FROM
           when 78-ID-EF-fatman-FROM
                perform CONTROLLO
           |78-ID-EF-fatman-TO è l'ID del campo EF-fatman-TO
      ...
      * <TOTEM:PARA. CAMBIA-FONT-RIGA>
           modify gd-fatt(riga), ROW-FONT = small-font.

           modify gd-fatt(riga, 1),
                  bitmap        = elemento-bmp,
                  bitmap-number = 1,
                  bitmap-width  = 16.
           ...
           modify gd-fatt(riga), ROW-FONT = font-evidenzia-griglia..

      *    cambio la label legenda

           inquire gd-fatt(riga, 1), HIDDEN-DATA = tipo-record
           evaluate true
           when r-FTND
                move 78-colore-FTND     to col-stato-fatman
                move "Di Merce"         to tit-stato-fatman
           when r-FTMA
                move 78-colore-FTMA     to col-stato-fatman
                move "Non di Merce"     to tit-stato-fatman
           when r-FTTR
                move 78-colore-FTTR     to col-stato-fatman
                move "Trasporto"        to tit-stato-fatman
           end-evaluate.
      ...
      * <TOTEM:PARA. CONTROLLO>
                ...
                if tipo-elab = 1
                   if fatman-from = 0
                      if controllo-finale
                         ...
                         move 78-ID-ef-fatman-from to CONTROL-ID
                         display message "Il numero del documento "
                                         "è obbligatorio!"
                                 title tit-err
                                 icon  MB-WARNING-ICON
                      end-if
                      ...
                      move fatman-from to tor-numero
                      read tordini
                           invalid 
                           set errori to true
                           move 78-ID-ef-fatman-from to CONTROL-ID
                           display message "Documento inesistente!"
                                   title tit-err
                                   icon  MB-WARNING-ICON
                       not invalid
                           if tor-ordine
      ...
      -    ""
           ...
           when 78-ID-ef-fatman-to
                if fatman-to = 0
                   move all "9" to fatman-to
                   modify EF-fatman-TO, VALUE fatman-to
                end-if
                if fatman-to < fatman-from
                   set errori to true
                   move 78-ID-ef-fatman-to to CONTROL-ID
      ...
      * <TOTEM:PARA. CHIAMA-MANUTENZIONE>
           move como-anno          to FatAnno.
           move como-numero-fatman to FatNumero.
      ...
      * <TOTEM:END>
       ...
       CARICA-FATMAN.
      * <TOTEM:PARA. CARICA-FATMAN>
           move anno-to     to tor-anno.
           move fatman-from to tor-numero.

           if tutte
              start tordini key not < tor-chiave
                    invalid continue
                not invalid perform SCORRI-FATMAN
              end-start
           else
              evaluate true
              when FTND move "FTND" to tor-causale
              when FTMA move "FTMA" to tor-causale
              when FTTR move "FTTR" to tor-causale
              end-evaluate
              start tordini key not < k-causale
                    invalid continue
                not invalid perform SCORRI-FATMAN
              end-start
           end-if 
      ...
      * <TOTEM:PARA. METTI-IN-GRIGLIA>
           ...
           move tor-data-ordine(1:4)  to col-data(7:4).
           move tor-data-ordine(5:2)  to col-data(4:2).
           move tor-data-ordine(7:2)  to col-data(1:2).
           ...
           modify gd-fatt, record-to-add Gd-fatman-Record.

           inquire gd-fatt, last-row = riga.

           evaluate tor-causale
           when "FTND" set r-FTND to true
                       move 78-colore-FTND to como-colore
           when "FTMA" set r-FTMA to true
                       move 78-colore-FTMA to como-colore
           when "FTTR" set r-FTTR to true
                       move 78-colore-FTTR to como-colore
           end-evaluate.

           modify gd-fatt(riga), row-color = como-colore.

           modify gd-fatt(riga, 1) hidden-data = tipo-record.
           set trovato to true 
           .
      * <TOTEM:END>

       FATTURA-DA-GRIGLIA.
      * <TOTEM:PARA. FATTURA-DA-GRIGLIA>
           inquire gd-fatt(riga), RECORD-DATA = Gd-fatman-Record.

           move col-anno            to como-anno.
           move Col-numero          to como-numero-fatman.
      ...
      * <TOTEM:PARA. PARAGRAFO-COPY>
           ...
           copy "riempi-combo-stato-fatman.cpy" 
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. SCORRI-FATMAN>
           ...
           perform until 1 = 2
              ...
              if tor-anno > anno-to    exit perform end-if

              if not tutte
                 evaluate tor-causale
                 when "FTND" if not FTND exit perform end-if
                 when "FTMA" if not FTMA exit perform end-if
                 when "FTTR" if not FTTR exit perform end-if
                 end-evaluate
              end-if

              perform VALIDA-FATMAN
      ...
      * <TOTEM:END>
       ...
       VALIDA-FATMAN.
      * <TOTEM:PARA. VALIDA-FATMAN>
           set record-ok to true.

           if tor-numero < fatman-from or 
              tor-numero > fatman-to
...
LUBEXX*****     if tor-data-ordine < data-from-AAAAMMGG or 
LUBEXX*****        tor-data-ordine > data-to-AAAAMMGG
LUBEXX*****        set record-ok to false
LUBEXX*****     end-if.
      ...
      *****     end-if.
           ...
           when FTTR
                if tor-causale not = "FTTR"
                   set record-ok   to false
                end-if
           when tutte
                if  tor-causale not = "FTTR"
                and tor-causale not = "FTMA"   
                and tor-causale not = "FTND"
                   set record-ok   to false
                end-if
           end-evaluate 
           .
      ...
      * <TOTEM:PARA. RB-ELENCO-LinkTo>
           ...
           set tutte to true.
           perform CARICA-COMBO-STATO-FATMAN.
           display Form1 
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. pb-ok-LinkTo>
           ...
           if tutto-ok                        
              ...
              if tipo-elab = 1
                 ...
                 move fatman-from to como-numero-fatman
                 perform CHIAMA-MANUTENZIONE
              else
                 perform SCARICA-COMBO-STATO-FATMAN
