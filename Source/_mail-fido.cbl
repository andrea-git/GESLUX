      ...
      ******************************************************************
       PROCEDURE DIVISION using Form-Handle.
      ...
      ***---
       OPEN-FILES.
           ...
           open input tparamge tgrupgdo ttipocli.
      ...
      ***---
       ELABORAZIONE.
           ...
           start sitfin key >= sf-chiave
             ...
             not invalid
                 perform until 1 = 2
                    read sitfin next at end exit perform end-read
      *    Luciano
                    set cli-tipo-C    to true
      ...
      ***---
       TRATTA-CLIENTE.
           ...
           string "INTERROGAZIONE CLIENTE: "   delimited by size
                  cli-codice                   delimited by size
                  " - "                        delimited by size
                  cli-ragsoc-1                 delimited by size
                  into como-riga
           perform SETTA-RIGA-STAMPA.
           ...
           initialize como-riga
           string "FINE INTERROGAZIONE CLIENTE: " delimited by size
                  cli-codice                      delimited by size
                  " - "                           delimited by size
                  cli-ragsoc-1                    delimited by size
                  into como-riga
