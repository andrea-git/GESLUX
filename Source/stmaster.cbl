      *{TOTEM}PRG-COMMENT
      * stmaster.Cbl
      * stmaster.Cbl is generated by TOTEM
      ...
      *{TOTEM}PRGID
       ...
       DATE-WRITTEN.        martedì 1 aprile 2014 19:19:21.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:stmaster, INIT:stmaster, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       01 stato-ord        PIC  x.
           ...
           88 tutti VALUE IS "T". 
       78 78-bloccati VALUE IS "Solo Bloccati". 
      ...
      *{TOTEM}COPY-PROCEDURE
       EXIT-STOP-ROUTINE.
      * <TOTEM:EPT. INIT:stmaster, INIT:stmaster, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      ***---
       RIEMPI-COMBO-STATO-ORD.
           ...
           Modify cbo-stato-ord, item-to-add 78-Bloccati.
      ...
      ***---
       RIEMPI-COMBO-TIPO.
           Modify cbo-tipo, item-to-add 78-tutti.
           Modify cbo-tipo, item-to-add 78-trad.
           Modify cbo-tipo, item-to-add 78-gdo.

      ***---
       CARICA-COMBO-TIPO.
           evaluate true
           when tipo-gdo 
                move 78-gdo        to cbo-tipo-buf
           when tipo-trad
                move 78-trad       to cbo-tipo-buf
           when tipo-tutti
                move 78-tutti      to cbo-tipo-buf
           end-evaluate.
           modify cbo-tipo,      value cbo-tipo-buf.
      ...
      ***---
       SCARICA-COMBO-TIPO.
           ...
           when 78-gdo
                set tipo-gdo   to true
           when 78-trad
                set tipo-trad  to true
           when 78-tutti    
                set tipo-tutti to true
           end-evaluate 
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. STAMPA-EFFETTIVA>
           initialize stmasterp-limiti
           move anno-to   to stmasterp-da-anno
           move anno-to   to stmasterp-a-anno
           move num-from  to stmasterp-da-num
           move num-to    to stmasterp-a-num

           move data-from(1:2)     to data-from-AAAAMMGG(7:2)
           move data-from(3:2)     to data-from-AAAAMMGG(5:2)
           move data-from(5:4)     to data-from-AAAAMMGG(1:4)
           move data-from-AAAAMMGG to stmasterp-da-data
           move data-to(1:2)       to data-to-AAAAMMGG(7:2)
           move data-to(3:2)       to data-to-AAAAMMGG(5:2)
           move data-to(5:4)       to data-to-AAAAMMGG(1:4)
           move data-to-AAAAMMGG   to stmasterp-a-data

           perform SCARICA-COMBO-STATO-ORD
           evaluate true 
           when bloccati
                set stmasterp-bloccati   to true
           when tutti
                set stmasterp-tutti      to true
           end-evaluate.

           perform SCARICA-COMBO-TIPO.
           move tipo-ord to stmasterp-tipo.

           call   "stmaster-p" using stmasterp-limiti
           cancel "stmaster-p"
           .
      * <TOTEM:END>
