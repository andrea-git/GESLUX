      ...
      ***---
       OPEN-FILES.
           ...
           if tutto-ok
              open input movutf clienti anautf
              if errori
                 close       lineseq
                 delete file lineseq
              end-if
...
LUBEXX ELENCO-USCITE.
           ...
           move utf-daylist-data(1:4)  to utf-anno.
           move utf-daylist-num-reg    to utf-num-reg.
           ...
           start movutf  key is >= k-data-movim
                 invalid continue
             not invalid
                 perform until 1 = 2
...
LUBEXX ELENCO-ENTRATE.
      ...
      ***---
       MOVE-DATI.            
           ...
           move mov-num-movim    to tutf-movim.
      ...
      ***---
       INTESTA1.
           ...
           move utf-daylist-num-reg to st-nreg.
      ...
      ***---
       CLOSE-FILES.
           close movutf, clienti, tmp-utf-day anautf.
