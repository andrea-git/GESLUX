      *{TOTEM}PRG-COMMENT
      * modposte-nc.Cbl
      * modposte-nc.Cbl is generated by TOTEM
      * This is a generated file. DO NOT modify this file directly.
      *{TOTEM}END
       IDENTIFICATION       DIVISION.
      *{TOTEM}PRGID
       PROGRAM-ID.          modposte-nc.
       AUTHOR.              ANDREA EVENTI.
       DATE-WRITTEN.        martedì 1 aprile 2014 19:17:26.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:modposte-nc, INIT:modposte-nc, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:modposte-nc, INIT:modposte-nc, BeforeDeclarative>
      ***---
       TNOTACR-ERR SECTION.
      ...
      * <TOTEM:EPT. INIT:modposte-nc, INIT:modposte-nc, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-destini.
      * <TOTEM:EPT. INIT:modposte-nc, FD:destini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT destini
           ...
           END-IF
      * <TOTEM:EPT. INIT:modposte-nc, FD:destini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-clienti.
      * <TOTEM:EPT. INIT:modposte-nc, FD:clienti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT clienti
           IF NOT Valid-STATUS-clienti
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:modposte-nc, FD:clienti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-articoli.
      * <TOTEM:EPT. INIT:modposte-nc, FD:articoli, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT articoli
           IF NOT Valid-STATUS-articoli
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:modposte-nc, FD:articoli, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tnotacr.
      * <TOTEM:EPT. INIT:modposte-nc, FD:tnotacr, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O tnotacr
           ...
           IF NOT Valid-STATUS-tnotacr
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:modposte-nc, FD:tnotacr, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-rnotacr.
      * <TOTEM:EPT. INIT:modposte-nc, FD:rnotacr, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT rnotacr
           IF NOT Valid-STATUS-rnotacr
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:modposte-nc, FD:rnotacr, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tivaese.
      * <TOTEM:EPT. INIT:modposte-nc, FD:tivaese, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tivaese
           IF NOT Valid-STATUS-tivaese
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:modposte-nc, FD:tivaese, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-zoom-tor-postel.
      * <TOTEM:EPT. INIT:modposte-nc, FD:zoom-tor-postel, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-zoom-tor-postel
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:modposte-nc, FD:zoom-tor-postel, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tcaumag.
      * <TOTEM:EPT. INIT:modposte-nc, FD:tcaumag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcaumag
           IF NOT Valid-STATUS-tcaumag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:modposte-nc, FD:tcaumag, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-destini.
      * <TOTEM:EPT. INIT:modposte-nc, FD:destini, BeforeClose>
      * <TOTEM:END>
           CLOSE destini
           .

       CLOSE-clienti.
      * <TOTEM:EPT. INIT:modposte-nc, FD:clienti, BeforeClose>
      * <TOTEM:END>
           CLOSE clienti
           .

       CLOSE-articoli.
      * <TOTEM:EPT. INIT:modposte-nc, FD:articoli, BeforeClose>
      * <TOTEM:END>
           CLOSE articoli
           .

       CLOSE-tnotacr.
      * <TOTEM:EPT. INIT:modposte-nc, FD:tnotacr, BeforeClose>
      * <TOTEM:END>
           CLOSE tnotacr
           .

       CLOSE-rnotacr.
      * <TOTEM:EPT. INIT:modposte-nc, FD:rnotacr, BeforeClose>
      * <TOTEM:END>
           CLOSE rnotacr
           .

       CLOSE-tivaese.
      * <TOTEM:EPT. INIT:modposte-nc, FD:tivaese, BeforeClose>
      * <TOTEM:END>
           CLOSE tivaese
           .

       CLOSE-zoom-tor-postel.
      * <TOTEM:EPT. INIT:modposte-nc, FD:zoom-tor-postel, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-tcaumag.
      * <TOTEM:EPT. INIT:modposte-nc, FD:tcaumag, BeforeClose>
      * <TOTEM:END>
           CLOSE tcaumag
           .
      ...
      * <TOTEM:EPT. FORM:Screen2, FORM:Screen2, BeforeAccept>
           ...
           move numero to tno-num-fattura.

           read tnotacr no lock key is k-fattura
                invalid continue
           end-read.

           move "Nota Credito n."    to tipo-doc.
           display lab-tipo-doc.
...
LUBEXX        move rno-cod-iva to tbliv-codice2
...
LUBEXX        end-if
      ...
      * DB_LABEL
              MOVE "tno-data-fattura" TO tno-data-fattura
      * DB_LABEL
              MOVE "tno-num-fattura" TO tno-num-fattura
      ...
      * DB_LABEL : Screen2-DaLa-13a
              MOVE tno-data-fattura  TO Screen2-DaLa-13a-BUF
      * DB_LABEL : Screen2-DaLa-14a
              MOVE tno-num-fattura  TO Screen2-DaLa-14a-BUF
      ...
      * <TOTEM:PARA. CERCA>
           ...
           move "zoom-tno-postel"   to como-file.
      ...
      * <TOTEM:PARA. RIEMPI-TMP>
           ...
           string path-zoom-tor-postel    delimited by low-value
                  "zoom-tno-postel"       delimited by size
                  "_"                     delimited by size
           ...
           start tnotacr key  is >= k4
             ...
             not invalid
                 perform until 1 = 2
                    ...
                    if record-ok
                       move tno-anno-fattura   to zoom-top-anno
                       move tno-num-fattura    to zoom-top-numero
                       move tno-data-fattura   to zoom-top-data-ordine
                       move tno-causale        to tca-codice
                       read tcaumag no lock invalid continue end-read
                       move tca-caus-trasporto to zoom-top-causale
                       move tno-cod-cli        to zoom-top-cod-cli
                                                  cli-codice
                                                  des-codice
                       set cli-tipo-C          to true
                       move tno-prg-destino    to zoom-top-prg-destino
                                                  des-prog
                       ...
                       move tno-invio          to zoom-top-invio
      ...
      * <TOTEM:PARA. PB-ESEGUIa-LinkTo>
      ...
      -           "per la nota credito selezionata?"
                   title = titolo
                   type MB-YES-NO
                   default MB-NO
                   giving scelta
           ...
           if scelta = mb-yes
              ...
              evaluate tipo-invio                 
              when 1 set tno-invio-manuale to true
              when 2 set tno-invio-postel  to true
...
LUBEXX                  set record-ok to false
              ...
              when 3 set tno-invio-edi     to true
              end-evaluate         
...
LUBEXX        end-if
      ...
      * <TOTEM:PARA. PB-ESEGUI-LinkTo>
           ...
           read tnotacr no lock key is k-fattura
                invalid 
                 set errori to true
                 display message "Nota Credito non caricata"
                         title = tit-err
            ...
            not invalid
                if tno-fatt-no-prenotata
                   ...
                   if tno-data-fattura  = 0
                   or tno-num-fattura   = 0
                   or tno-anno-fattura  = 0
                   or tno-num-prenot    = 0
                      set errori to true
                      display message"Nota Credito non ancora fatturata"
                          title tit-err
                          icon MB-WARNING-ICON
                   end-if
                end-if
