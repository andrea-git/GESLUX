      *{TOTEM}PRG-COMMENT
      * tescons.Cbl
      * tescons.Cbl is generated by TOTEM
      ...
      *{TOTEM}PRGID
       ...
       DATE-WRITTEN.        martedì 1 aprile 2014 19:19:45.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:tescons, INIT:tescons, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       77 Form1-Tb-1-Handle
                  USAGE IS HANDLE OF WINDOW.
       78 titolo VALUE IS "Geslux - Tabella Esiti Consegna". 
       77 E-ESCI           PIC  9
                  VALUE IS 1.
       77 E-NUOVO          PIC  9
                  VALUE IS 1.
      ...
      ***********************************************************
       ...
       77 TMP-Form1-tescons-RESTOREBUF  PIC X(226).
       77 TMP-Form1-KEYIS  PIC 9(3) VALUE 1.
       77 Form1-MULKEY-TMPBUF   PIC X(226).
      ...
      * FILE'S LOCK MODE FLAG
       ...
       77 DataSet1-tescons-KEY1-ORDER  PIC X VALUE "A".
          88 DataSet1-tescons-KEY1-Asc  VALUE "A".
          88 DataSet1-tescons-KEY1-Desc VALUE "D".


       01  old-tec-rec.
           05 old-tec-chiave.
              10 old-tec-codice                      PIC  x(10).
           05 old-tec-dati.
              10 old-tec-descrizione                 PIC  x(50).
              10 old-tec-dati-comuni.
                 15 old-tec-data-creazione           PIC  9(8).
                 15 old-tec-ora-creazione            PIC  9(8).
                 15 old-tec-utente-creazione         PIC  x(10).
                 15 old-tec-data-ultima-modifica     PIC  9(8).
                 15 old-tec-ora-ultima-modifica      PIC  9(8).
                 15 old-tec-utente-ultima-modifica   PIC  x(10).
              10 old-tec-vuoti.                                  
                 15 old-tec-num-vuoto-1              PIC  9(18).
                 15 old-tec-num-vuoto-2              PIC  9(18).
                 15 old-tec-num-vuoto-3              PIC  9(18).
                 15 old-tec-forza-pod                pic  x.
                 15 old-tec-alfa-vuoto-1             PIC  x(19).
                 15 old-tec-alfa-vuoto-2             PIC  x(20).
                 15 old-tec-alfa-vuoto-3             PIC  x(20).
      *{TOTEM}END
      ...
      * GRID
       05
           ...
           ADJUSTABLE-COLUMNS,
           BOXED,
           DATA-COLUMNS (1, 11, 61),
           ALIGNMENT ("L", "U", "C"),
           SEPARATION (5, 5, 5),
           DATA-TYPES ("U(10)", "X(50)", "U(1)"),
           NUM-COL-HEADINGS 1,
           COLUMN-HEADINGS,
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:tescons, INIT:tescons, BeforeDeclarative>
       tescons-ERR SECTION.
           use after error procedure on tescons.
           evaluate status-tescons
           when "35"
                display message "File [TESCONS] not found!"
                           title titolo
                            icon 3
                set errori to true
           when "39"
      ...
      * <TOTEM:EPT. INIT:tescons, INIT:tescons, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-tescons.
      * <TOTEM:EPT. INIT:tescons, FD:tescons, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O tescons
           IF STATUS-tescons = "35"
              OPEN OUTPUT tescons
                IF Valid-STATUS-tescons
                   CLOSE tescons
                   OPEN I-O tescons
                END-IF
           END-IF
           ...
           END-IF
      * <TOTEM:EPT. INIT:tescons, FD:tescons, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-tescons.
      * <TOTEM:EPT. INIT:tescons, FD:tescons, BeforeClose>
      * <TOTEM:END>
           CLOSE tescons
           .
       ...
       DataSet1-Change-CurrentKey-Asc.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              MOVE "A" TO DataSet1-tescons-KEY1-ORDER
           END-EVALUATE
           .
       ...
       DataSet1-Change-CurrentKey-Desc.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              MOVE "D" TO DataSet1-tescons-KEY1-ORDER
           END-EVALUATE
           .
      ...
      * DISPLAY-COLUMNS settings
              MODIFY form1-gd-1, DISPLAY-COLUMNS (1, 16, 66)
           .
      ...
      * GRID
       ...
       Form1-DataSet1-Update-Key.
           MOVE tec-rec OF tescons TO
                     Form1-MULKEY-TMPBUF
           PERFORM Form1-CLEAR
           PERFORM Form1-INIT-DATA
           MOVE Form1-MULKEY-TMPBUF TO
                     tec-rec OF tescons
           PERFORM DataSet1-tescons-Read
       ...
       Form1-First.
           ...
           PERFORM DataSet1-tescons-INITSTART
           PERFORM DataSet1-tescons-START
           IF NOT Valid-STATUS-tescons
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
           PERFORM DataSet1-tescons-Read-Next
           IF NOT Valid-STATUS-tescons
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Previous.
              PERFORM Form1-Buf-To-Fld
              PERFORM DataSet1-tescons-START-LESS
           IF NOT Valid-STATUS-tescons
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
           PERFORM DataSet1-tescons-Read-Prev
           IF NOT Valid-STATUS-tescons
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Next.
              PERFORM Form1-Buf-To-Fld
              PERFORM DataSet1-tescons-START-GREATER
           IF NOT Valid-STATUS-tescons
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Last.
           ...
           PERFORM DataSet1-tescons-INITEND
           PERFORM DataSet1-tescons-START-NOTGREATER
           IF NOT Valid-STATUS-tescons
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
      * write
           PERFORM DataSet1-tescons-Rec-Rewrite
           IF Valid-STATUS-tescons
      ...
      * delete
           PERFORM Form1-Buf-To-Fld
           PERFORM DataSet1-tescons-Rec-Delete
           IF Valid-STATUS-tescons
              PERFORM Form1-CLEAR
              PERFORM Form1-DUMMY-DELETE-INIT
              MOVE "303" TO TOTEM-MSG-ID
              MOVE "00" to STATUS-tescons
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Save-Status.
           MOVE DataSet1-tescons-KEY1-ORDER TO TMP-Form1-KEY1-ORDER
           MOVE DataSet1-KEYIS TO TMP-Form1-KEYIS
           MOVE tec-rec OF tescons TO 
              TMP-Form1-tescons-RESTOREBUF
           .             

       Form1-Restore-Status.
           MOVE TMP-Form1-KEY1-ORDER TO DataSet1-tescons-KEY1-ORDER
           MOVE TMP-Form1-KEYIS TO DataSet1-KEYIS
           MOVE TMP-Form1-tescons-RESTOREBUF TO
              tec-rec OF tescons
           PERFORM DataSet1-tescons-START
           IF Valid-STATUS-tescons
              PERFORM DataSet1-tescons-Read-Next
           ELSE
              PERFORM DataSet1-tescons-INITREC
           END-IF
           PERFORM UNTIL NOT Valid-STATUS-tescons OR
              (Valid-STATUS-tescons AND
                 tec-rec OF tescons = 
                   TMP-Form1-tescons-RESTOREBUF)
              PERFORM DataSet1-tescons-Read-Next
           END-PERFORM
      ...
      * <TOTEM:PARA. INTESTAZIONE>
           ...
           modify form1-gd-1(1, 3), cell-data = "Forz POD" 
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. LOAD-RECORD>
           ...
           start tescons key is >= tec-chiave
                  invalid continue
              not invalid
                  perform varying riga from 2 by 1
                     ...
                     read tescons next
                          at end exit perform
                      not at end
                          move tec-codice      to col-id 
                          move tec-descrizione to col-des
                          move tec-forza-pod   to col-forza
      ...
      *--->modifica (isacco)
           if nuovo 
              ...
              if mod = 1
                 close tescons
                 open i-o tescons allowing readers
              else
                 set tutto-ok to true
                 if NoSalvato
                    move 1 to mod
      ...
      * <TOTEM:PARA. NUOVO>
           ...
           if tutto-ok
              ...
              initialize old-tec-rec replacing numeric data by zeroes
                                          alphanumeric data by spaces
      ...
      * <TOTEM:PARA. VALORE-RIGA>
           inquire form1-gd-1(riga, 1), cell-data tec-codice.         
           inquire form1-gd-1(riga, 2), cell-data tec-descrizione. 
           inquire form1-gd-1(riga, 3), cell-data tec-forza-pod  
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. VALORE-OLD-RIGA>
           if vecchio
              inquire form1-gd-1(riga, 1) cell-data old-tec-codice
              move old-tec-codice         to tec-codice
              read tescons               no lock
              move tec-rec                to old-tec-rec
           else
              initialize old-tec-rec replacing numeric data by zeroes
                                          alphanumeric data by spaces
           end-if 
      ...
      *    se non ho valorizzato i campi di creazione li valorizzo
           if tec-data-creazione = zero
              accept tec-data-creazione from century-date
           end-if.
           if tec-ora-creazione = zero
              accept tec-ora-creazione from time
           end-if.
           if tec-utente-creazione = space
              move user-codi to tec-utente-creazione
           end-if.

           accept tec-data-ultima-modifica from century-date.
           accept tec-ora-ultima-modifica from time.
           move user-codi to tec-utente-ultima-modifica 
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. form1-gd-1-Ev-Msg-Begin-Entry>
           ...
           if colonna = 1
              if tec-codice not = zero and tec-codice not = spaces
                 set event-action to event-action-fail
              end-if
           else 
              if mod = zero
