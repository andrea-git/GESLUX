      *{TOTEM}PRG-COMMENT
      * timbalqta.Cbl
      * timbalqta.Cbl is generated by TOTEM
      * This is a generated file. DO NOT modify this file directly.
      *{TOTEM}END
       IDENTIFICATION       DIVISION.
      *{TOTEM}PRGID
       PROGRAM-ID.          timbalqta.
       AUTHOR.              ANDREA EVENTI.
       DATE-WRITTEN.        martedì 1 aprile 2014 19:19:55.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:timbalqta, INIT:timbalqta, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       01 old-imq-rec.
           05 old-imq-chiave.
               10 old-imq-codice   PIC  x(3).
               10 old-imq-tipo     PIC  x(3).
           05 old-imq-dati.
               10 old-imq-descrizione          PIC  x(50).
               10 old-imq-qta-imb  PIC  9(4).
               10 old-imq-dati-comuni.
                   15 old-imq-data-creazione       PIC  9(8).
                   15 old-imq-ora-creazione        PIC  9(8).
                   15 old-imq-utente-creazione     PIC  x(10).
                   15 old-imq-data-ultima-modifica PIC  9(8).
                   15 old-imq-ora-ultima-modifica  PIC  9(8).
                   15 old-imq-utente-ultima-modifica           PIC  
           x(10).
               10 old-imq-vuoti.
                   15 old-imq-num-vuoto-1          PIC  9(15).
                   15 old-imq-num-vuoto-2          PIC  9(15).
                   15 old-imq-num-vuoto-3          PIC  9(15).
                   15 old-imq-alfa-vuoto-1         PIC  x(20).
                   15 old-imq-alfa-vuoto-2         PIC  x(20).
                   15 old-imq-alfa-vuoto-3         PIC  x(20).
       77 Form1-Handle
       ...
       77 Form1-Tb-1-Handle
                  USAGE IS HANDLE OF WINDOW.
       78 titolo VALUE IS "Geslux - Tabella Imballi Qta". 
       77 E-ESCI           PIC  9
                  VALUE IS 1.
       77 E-NUOVO          PIC  9
                  VALUE IS 1.
      ...
      ***********************************************************
       ...
       77 TMP-Form1-timbalqta-RESTOREBUF  PIC X(167).
       77 TMP-Form1-KEYIS  PIC 9(3) VALUE 1.
       77 Form1-MULKEY-TMPBUF   PIC X(167).
      ...
      * FILE'S LOCK MODE FLAG
       ...
       77 DataSet1-timbalqta-KEY1-ORDER  PIC X VALUE "A".
          88 DataSet1-timbalqta-KEY1-Asc  VALUE "A".
          88 DataSet1-timbalqta-KEY1-Desc VALUE "D".
      ...
      * GRID
       05
           ...
           ADJUSTABLE-COLUMNS,
           3-D,
           DATA-COLUMNS (1, 4, 7, 57),
           ALIGNMENT ("L", "L", "U", "R"),
           SEPARATION (5, 5, 5, 5),
           DATA-TYPES ("U(3)", "X(3)", "X(50)", "9(4)"),
           NUM-COL-HEADINGS 1,
           COLUMN-HEADINGS,
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:timbalqta, INIT:timbalqta, BeforeDeclarative>
      ...
      * <TOTEM:EPT. INIT:timbalqta, INIT:timbalqta, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-timbalqta.
      * <TOTEM:EPT. INIT:timbalqta, FD:timbalqta, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O timbalqta
           ...
           END-IF
      * <TOTEM:EPT. INIT:timbalqta, FD:timbalqta, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-timballi.
      * <TOTEM:EPT. INIT:timbalqta, FD:timballi, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT timballi
           IF NOT Valid-STATUS-timballi
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:timbalqta, FD:timballi, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-timbalqta.
      * <TOTEM:EPT. INIT:timbalqta, FD:timbalqta, BeforeClose>
      * <TOTEM:END>
           CLOSE timbalqta
           .

       CLOSE-timballi.
      * <TOTEM:EPT. INIT:timbalqta, FD:timballi, BeforeClose>
      * <TOTEM:END>
           CLOSE timballi
           .
       ...
       DataSet1-timbalqta-INITSTART.
           ...
           WHEN 1
              IF DataSet1-timbalqta-KEY1-Asc
       ...
       DataSet1-Change-CurrentKey-Asc.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              MOVE "A" TO DataSet1-timbalqta-KEY1-ORDER
           END-EVALUATE
           .
       ...
       DataSet1-Change-CurrentKey-Desc.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              MOVE "D" TO DataSet1-timbalqta-KEY1-ORDER
           END-EVALUATE
           .
      ...
      * DISPLAY-COLUMNS settings
              MODIFY form1-gd-1, DISPLAY-COLUMNS (1, 11, 21, 71)
           .
      ...
      * GRID
       ...
       Form1-DataSet1-Update-Key.
           MOVE imq-rec OF timbalqta TO
                     Form1-MULKEY-TMPBUF
           PERFORM Form1-CLEAR
           PERFORM Form1-INIT-DATA
           MOVE Form1-MULKEY-TMPBUF TO
                     imq-rec OF timbalqta
       ...
       Form1-First.
           ...
           PERFORM DataSet1-timbalqta-INITSTART
           PERFORM DataSet1-timbalqta-START
           IF NOT Valid-STATUS-timbalqta
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
           PERFORM DataSet1-timbalqta-Read-Next
           IF NOT Valid-STATUS-timbalqta
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Previous.
              PERFORM Form1-Buf-To-Fld
              PERFORM DataSet1-timbalqta-START-LESS
           IF NOT Valid-STATUS-timbalqta
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
           PERFORM DataSet1-timbalqta-Read-Prev
           IF NOT Valid-STATUS-timbalqta
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Next.
              PERFORM Form1-Buf-To-Fld
              PERFORM DataSet1-timbalqta-START-GREATER
           IF NOT Valid-STATUS-timbalqta
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Last.
           ...
           PERFORM DataSet1-timbalqta-INITEND
           PERFORM DataSet1-timbalqta-START-NOTGREATER
           IF NOT Valid-STATUS-timbalqta
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
      * write
           PERFORM DataSet1-timbalqta-Rec-Write
           IF Valid-STATUS-timbalqta
      ...
      * <TOTEM:END>
      * write
           PERFORM DataSet1-timbalqta-Rec-Rewrite
           IF Valid-STATUS-timbalqta
      ...
      * delete
           PERFORM Form1-Buf-To-Fld
           PERFORM DataSet1-timbalqta-Rec-Delete
           IF Valid-STATUS-timbalqta
              PERFORM Form1-CLEAR
              PERFORM Form1-DUMMY-DELETE-INIT
              MOVE "303" TO TOTEM-MSG-ID
              MOVE "00" to STATUS-timbalqta
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Save-Status.
           MOVE DataSet1-timbalqta-KEY1-ORDER TO TMP-Form1-KEY1-ORDER
           MOVE DataSet1-KEYIS TO TMP-Form1-KEYIS
           MOVE imq-rec OF timbalqta TO 
              TMP-Form1-timbalqta-RESTOREBUF
           .             

       Form1-Restore-Status.
           MOVE TMP-Form1-KEY1-ORDER TO DataSet1-timbalqta-KEY1-ORDER
           MOVE TMP-Form1-KEYIS TO DataSet1-KEYIS
           MOVE TMP-Form1-timbalqta-RESTOREBUF TO
              imq-rec OF timbalqta
           PERFORM DataSet1-timbalqta-START
           IF Valid-STATUS-timbalqta
              PERFORM DataSet1-timbalqta-Read-Next
           ELSE
              PERFORM DataSet1-timbalqta-INITREC
           END-IF
           PERFORM UNTIL NOT Valid-STATUS-timbalqta OR
              (Valid-STATUS-timbalqta AND
                 imq-rec OF timbalqta = 
                   TMP-Form1-timbalqta-RESTOREBUF)
              PERFORM DataSet1-timbalqta-Read-Next
           END-PERFORM
      ...
      * <TOTEM:PARA. CERCA>
           ...
           when 1
                if colonna = 2
                   ...
                   move "timballi" to  como-file
                   call "zoom-gt" using  como-file, imb-rec
                                 giving stato-zoom
                   end-call
                   cancel "zoom-gt"
                   if stato-zoom = 0  
                      move imb-codice to col-tipo
                      modify form1-gd-1(riga, 2), 
                                        cell-data = col-tipo
                      move col-tipo to imq-tipo
                      move imb-descrizione to col-des
                      modify form1-gd-1(riga, 3) 
                                cell-data = col-des
                      if imq-rec not = old-imq-rec
      ...
      * <TOTEM:PARA. CONTROLLO>
           ...
           when 2
                if imq-tipo = zero or spaces 
                   ...
                   read timballi
                      invalid
                         set errori to true
                         display message "Tipo Imballo non valido!"
                                    title = tit-err
                                    icon mb-warning-icon                
           ...
           when 4
                if imq-qta-imb = zero
                   set errori to true
                   move 4 to colonna
                   display message box "Quantità mancante"
                           title = tit-err
                           icon mb-warning-icon
                else
                   move imq-qta-imb to col-qta
      ...
      * <TOTEM:PARA. INTESTAZIONE>
           ...
           modify form1-gd-1(1, 2), cell-data = "Tipo".           
           modify form1-gd-1(1, 3), cell-data = "Descrizione".
           modify form1-gd-1(1, 4), cell-data = "Quantità" 
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. LOAD-RECORD>
           ...
           move low-value to imq-codice
                             imq-tipo.
           start timbalqta key is >= imq-chiave
                  invalid continue
              not invalid
                  perform varying riga from 2 by 1
                     ...
                     read timbalqta next
                          at end exit perform
                      not at end
                          move imq-codice      to col-id
                          move imq-tipo        to col-tipo
                          move imq-tipo        to imb-codice
                          read timballi              
                             invalid 
                                move MSG-Descrizione-mancante 
                                      to imb-descrizione
                          end-read                                      
                          move imb-descrizione to col-des
                          move imq-qta-imb     to col-qta
      ...
      *--->modifica (isacco)
           if nuovo 
              ...
              if mod = 1
                 close timbalqta
                 open i-o timbalqta allowing readers
              else
                 set tutto-ok to true
                 if NoSalvato
                    move 1 to mod
      ...
      * <TOTEM:PARA. NUOVO>
           ...
           if tutto-ok
              ...
              initialize old-imq-rec replacing numeric data by zeroes
                                          alphanumeric data by spaces
      ...
      * <TOTEM:PARA. VALORE-RIGA>
           inquire form1-gd-1(riga, 1), cell-data imq-codice.
           inquire form1-gd-1(riga, 2), cell-data imq-tipo.
           inquire form1-gd-1(riga, 4), cell-data imq-qta-imb  
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. VALORE-OLD-RIGA>
           if vecchio
              inquire form1-gd-1(riga, 1) cell-data old-imq-codice
              inquire form1-gd-1(riga, 2) cell-data old-imq-tipo
              move old-imq-codice         to imq-codice
              move old-imq-tipo           to imq-tipo
              read timbalqta              no lock
              move imq-rec                to old-imq-rec
           else
              initialize old-imq-rec replacing numeric data by zeroes
                                          alphanumeric data by spaces
           end-if 
      ...
      *    se non ho valorizzato i campi di creazione li valorizzo
           if imq-data-creazione = zero
              accept imq-data-creazione from century-date
           end-if.
           if imq-ora-creazione = zero
              accept imq-ora-creazione from time
           end-if.
           if imq-utente-creazione = space
              move user-codi to imq-utente-creazione
           end-if.

           accept imq-data-ultima-modifica from century-date.
           accept imq-ora-ultima-modifica from time.
           move user-codi to imq-utente-ultima-modifica 
           .
      * <TOTEM:END>
