       ...
       PROGRAM-ID.                      stfornitori.
       AUTHOR.                          Andrea.
       REMARKS. Stampa CODICE RAGSOC-INDIRIZZO
                              TEL-EMAIL        dei fornitori
      ******************************************************************
      ...
      *****************************************************************
       ...
       78  titolo                value "Stampa fornitori".
      ...
      * RIGHE PER LA STAMPA TXT
       ...
       01  intestazione.
         ...
         05 filler               pic x(11).
         05 filler               pic x(16) value "Elenco Fornitori".
         05 filler               pic x(29).
      ...
      ***---
       GENERA-FILE-EXCEL.
           if prima-volta
              ...
              string " "              delimited size
                     separatore       delimited size
                     "ELENCO FORNITORI" delimited size
                     into line-riga
              end-string
              write line-riga
