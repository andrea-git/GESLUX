      *{TOTEM}PRG-COMMENT
      * stp-omag.Cbl
      * stp-omag.Cbl is generated by TOTEM
      ...
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:stp-omag, INIT:stp-omag, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       78 titolo VALUE IS "Liquidazione provvigioni: stampa lista omaggi
      -    "". 
       01 file-info.
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:stp-omag, INIT:stp-omag, BeforeDeclarative>
      ***---
      ...
      * <TOTEM:EPT. INIT:stp-omag, INIT:stp-omag, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-tparamge.
      * <TOTEM:EPT. INIT:stp-omag, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           ...
           END-IF
      * <TOTEM:EPT. INIT:stp-omag, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-agenti.
      * <TOTEM:EPT. INIT:stp-omag, FD:agenti, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O agenti
           IF STATUS-agenti = "35"
              OPEN OUTPUT agenti
           ...
           IF NOT Valid-STATUS-agenti
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:stp-omag, FD:agenti, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-tparamge.
      * <TOTEM:EPT. INIT:stp-omag, FD:tparamge, BeforeClose>
      * <TOTEM:END>
           CLOSE tparamge
           .

       CLOSE-agenti.
      * <TOTEM:EPT. INIT:stp-omag, FD:agenti, BeforeClose>
      * <TOTEM:END>
           CLOSE agenti
           .
      ...
      * <TOTEM:PARA. pb-ok-LinkTo>
           ...
           if tutto-ok
              ...
              call   "stp-omag-p" using stp-omag-linkage
              cancel "stp-omag-p"
