      *{TOTEM}PRG-COMMENT
      * stbolle.Cbl
      * stbolle.Cbl is generated by TOTEM
      ...
      *{TOTEM}PRGID
       ...
       DATE-WRITTEN.        giovedì 21 marzo 2019 12:16:35.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:stbolle, INIT:stbolle, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:stbolle, INIT:stbolle, BeforeDeclarative>
      ***---
       TCONTAT-ERR SECTION.
      ...
      * <TOTEM:EPT. INIT:stbolle, INIT:stbolle, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-tcontat.
      * <TOTEM:EPT. INIT:stbolle, FD:tcontat, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcontat
           ...
           END-IF
      * <TOTEM:EPT. INIT:stbolle, FD:tcontat, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tparamge.
      * <TOTEM:EPT. INIT:stbolle, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           IF NOT Valid-STATUS-tparamge
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:stbolle, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-tcontat.
      * <TOTEM:EPT. INIT:stbolle, FD:tcontat, BeforeClose>
      * <TOTEM:END>
           CLOSE tcontat
           .

       CLOSE-tparamge.
      * <TOTEM:EPT. INIT:stbolle, FD:tparamge, BeforeClose>
      * <TOTEM:END>
           CLOSE tparamge
           .
      ...
      *                    set environment "STAMPANTE_STBOLLE"
      *                                 to printerToSet
