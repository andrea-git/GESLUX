      *{TOTEM}PRG-COMMENT
      * gordc.Cbl
      * gordc.Cbl is generated by TOTEM
      ...
      *{TOTEM}PRGID
       PROGRAM-ID.          gordc.
       AUTHOR.              andre.
       DATE-WRITTEN.        mercoledì 5 giugno 2019 11:34:50.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:gordc, INIT:gordc, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       77 FILLER           PIC  9.
           88 trovato-lock VALUE IS 1    WHEN SET TO FALSE  0. 
       77 Screen1-Handle
                  USAGE IS HANDLE OF WINDOW.
       77 Default-Font
       ...
       78 TITOLO VALUE IS "Geslux - Caricamento Ordini". 
       77 AUTO-ID          PIC  9(6)
                  VALUE IS 0.
      ...
      * Data.Entry-Field
              10 ef-data-bolla-BUF PIC 99/99/9999.
              10 ef-data-bolla-VALUEBUF PIC 9(8).
      * Data.Entry-Field
              10 ef-num-bolla-BUF PIC z(8).
              10 ef-num-bolla-VALUEBUF PIC 9(8).
      * Data.Label
      ...
      * FILE'S LOCK MODE FLAG
       ...
       77 DataSet1-int-tordini-LOCK-FLAG   PIC X VALUE SPACE.
           88 DataSet1-int-tordini-LOCK  VALUE "Y".
       77 DataSet1-int-tordini-KEY-ORDER  PIC X VALUE "A".
          88 DataSet1-int-tordini-KEY-Asc  VALUE "A".
          88 DataSet1-int-tordini-KEY-Desc VALUE "D".
       77 DataSet1-int-rordini-LOCK-FLAG   PIC X VALUE SPACE.
           88 DataSet1-int-rordini-LOCK  VALUE "Y".
       77 DataSet1-int-rordini-KEY-ORDER  PIC X VALUE "A".
          88 DataSet1-int-rordini-KEY-Asc  VALUE "A".
          88 DataSet1-int-rordini-KEY-Desc VALUE "D".
       ...
       77 int-tordini-int-k-causale-SPLITBUF  PIC X(17).
       77 int-tordini-int-k1-SPLITBUF  PIC X(23).
       77 int-tordini-int-k2-SPLITBUF  PIC X(21).
       77 int-tordini-int-k-bolla-SPLITBUF  PIC X(13).
       77 int-tordini-int-k3-SPLITBUF  PIC X(22).
       77 int-tordini-int-k-fattura-SPLITBUF  PIC X(13).
       77 int-tordini-int-k4-SPLITBUF  PIC X(30).
       77 int-tordini-int-k-contab-SPLITBUF  PIC X(14).
       77 int-tordini-int-k-tipo-SPLITBUF  PIC X(14).
       77 int-tordini-int-k-data-SPLITBUF  PIC X(17).
       77 int-tordini-int-k-agfatt-SPLITBUF  PIC X(42).
       77 int-tordini-int-k-stbolle-SPLITBUF  PIC X(34).
       77 int-tordini-int-k-andamento-data-SPLITBUF  PIC X(10).
       77 int-tordini-int-k-andamento-cliente-SPLITBUF  PIC X(15).
       77 int-tordini-int-k-andamento-clides-SPLITBUF  PIC X(20).
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:gordc, INIT:gordc, BeforeDeclarative>
       PROGMAG-ERR SECTION.
      ...
      * <TOTEM:EPT. INIT:gordc, INIT:gordc, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      * TOOL-ESCI
       ...
       OPEN-FILE-RTN.
           PERFORM gordc-Ev-Before-DSD-Open
      ...
      *    PERFORM OPEN-zoom-tcaumag
           PERFORM OPEN-int-tordini
           PERFORM OPEN-int-rordini
      ...
      *    After Open
       ...
       OPEN-tordini.
      * <TOTEM:EPT. INIT:gordc, FD:tordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O tordini
           ...
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:tordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-agenti.
      * <TOTEM:EPT. INIT:gordc, FD:agenti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT agenti
           IF NOT Valid-STATUS-agenti
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:agenti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tvettori.
      * <TOTEM:EPT. INIT:gordc, FD:tvettori, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tvettori
           IF NOT Valid-STATUS-tvettori
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:tvettori, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tivaese.
      * <TOTEM:EPT. INIT:gordc, FD:tivaese, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tivaese
           IF NOT Valid-STATUS-tivaese
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:tivaese, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-clienti.
      * <TOTEM:EPT. INIT:gordc, FD:clienti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT clienti
           IF NOT Valid-STATUS-clienti
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:clienti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-destini.
      * <TOTEM:EPT. INIT:gordc, FD:destini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT destini
           IF NOT Valid-STATUS-destini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:destini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-articoli.
      * <TOTEM:EPT. INIT:gordc, FD:articoli, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT articoli
           IF NOT Valid-STATUS-articoli
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:articoli, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-note.
      * <TOTEM:EPT. INIT:gordc, FD:note, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT note
           IF NOT Valid-STATUS-note
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:note, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tcodpag.
      * <TOTEM:EPT. INIT:gordc, FD:tcodpag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcodpag
           IF NOT Valid-STATUS-tcodpag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:tcodpag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-assorcli.
      * <TOTEM:EPT. INIT:gordc, FD:assorcli, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT assorcli
           IF NOT Valid-STATUS-assorcli
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:assorcli, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-progmag.
      * <TOTEM:EPT. INIT:gordc, FD:progmag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT progmag
           IF NOT Valid-STATUS-progmag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:progmag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-timposte.
      * <TOTEM:EPT. INIT:gordc, FD:timposte, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT timposte
           IF NOT Valid-STATUS-timposte
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:timposte, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmarche.
      * <TOTEM:EPT. INIT:gordc, FD:tmarche, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tmarche
           IF NOT Valid-STATUS-tmarche
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:tmarche, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmp-assorcli.
      * <TOTEM:EPT. INIT:gordc, FD:tmp-assorcli, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-tmp-assorcli
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:tmp-assorcli, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tparamge.
      * <TOTEM:EPT. INIT:gordc, FD:tparamge, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tparamge
           IF NOT Valid-STATUS-tparamge
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:tparamge, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmagaz.
      * <TOTEM:EPT. INIT:gordc, FD:tmagaz, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tmagaz
           IF NOT Valid-STATUS-tmagaz
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:tmagaz, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tcaumag.
      * <TOTEM:EPT. INIT:gordc, FD:tcaumag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcaumag
           IF NOT Valid-STATUS-tcaumag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:tcaumag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-timbalqta.
      * <TOTEM:EPT. INIT:gordc, FD:timbalqta, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-timbalqta
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:timbalqta, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-timballi.
      * <TOTEM:EPT. INIT:gordc, FD:timballi, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT timballi
           IF NOT Valid-STATUS-timballi
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:timballi, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-recapiti.
      * <TOTEM:EPT. INIT:gordc, FD:recapiti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT recapiti
           IF NOT Valid-STATUS-recapiti
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:recapiti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-rmovmag.
      * <TOTEM:EPT. INIT:gordc, FD:rmovmag, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT rmovmag
           IF NOT Valid-STATUS-rmovmag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:rmovmag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-ttipocli.
      * <TOTEM:EPT. INIT:gordc, FD:ttipocli, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT ttipocli
           IF NOT Valid-STATUS-ttipocli
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:ttipocli, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-rordini.
      * <TOTEM:EPT. INIT:gordc, FD:rordini, BeforeOpen>
      ...
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-rordini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:rordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmp-progmag-zoom.
      * <TOTEM:EPT. INIT:gordc, FD:tmp-progmag-zoom, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-tmp-progmag-zoom
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:tmp-progmag-zoom, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-zoom-tcaumag.
      * <TOTEM:EPT. INIT:gordc, FD:zoom-tcaumag, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-zoom-tcaumag
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:zoom-tcaumag, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-int-tordini.
      * <TOTEM:EPT. INIT:gordc, FD:int-tordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O int-tordini
           IF STATUS-int-tordini = "35"
              OPEN OUTPUT int-tordini
                IF Valid-STATUS-int-tordini
                   CLOSE int-tordini
                   OPEN I-O int-tordini
                END-IF
           END-IF
           IF NOT Valid-STATUS-int-tordini
              PERFORM  Form1-EXTENDED-FILE-STATUS
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:int-tordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-int-rordini.
      * <TOTEM:EPT. INIT:gordc, FD:int-rordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O int-rordini
           IF STATUS-int-rordini = "35"
              OPEN OUTPUT int-rordini
                IF Valid-STATUS-int-rordini
                   CLOSE int-rordini
                   OPEN I-O int-rordini
                END-IF
           END-IF
           IF NOT Valid-STATUS-int-rordini
              PERFORM  Form1-EXTENDED-FILE-STATUS
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:int-rordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-listini.
      * <TOTEM:EPT. INIT:gordc, FD:listini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT listini
           IF NOT Valid-STATUS-listini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:listini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tpromo.
      * <TOTEM:EPT. INIT:gordc, FD:tpromo, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tpromo
           IF NOT Valid-STATUS-tpromo
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:tpromo, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-rpromo.
      * <TOTEM:EPT. INIT:gordc, FD:rpromo, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT rpromo
           IF NOT Valid-STATUS-rpromo
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:rpromo, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tmp-promo-prz.
      * <TOTEM:EPT. INIT:gordc, FD:tmp-promo-prz, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-tmp-promo-prz
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:tmp-promo-prz, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-locali.
      * <TOTEM:EPT. INIT:gordc, FD:locali, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT locali
           IF NOT Valid-STATUS-locali
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:locali, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-blister.
      * <TOTEM:EPT. INIT:gordc, FD:blister, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT blister
           IF NOT Valid-STATUS-blister
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:blister, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tpiombo.
      * <TOTEM:EPT. INIT:gordc, FD:tpiombo, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tpiombo
           IF NOT Valid-STATUS-tpiombo
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:tpiombo, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-lisagente.
      * <TOTEM:EPT. INIT:gordc, FD:lisagente, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-lisagente
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:lisagente, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-lockfile.
      * <TOTEM:EPT. INIT:gordc, FD:lockfile, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O lockfile
           ...
           IF NOT Valid-STATUS-lockfile
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:lockfile, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-sitfin.
      * <TOTEM:EPT. INIT:gordc, FD:sitfin, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT sitfin
           IF NOT Valid-STATUS-sitfin
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:sitfin, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tscorte.
      * <TOTEM:EPT. INIT:gordc, FD:tscorte, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tscorte
           IF NOT Valid-STATUS-tscorte
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:tscorte, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-pagbloc.
      * <TOTEM:EPT. INIT:gordc, FD:pagbloc, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT pagbloc
           IF NOT Valid-STATUS-pagbloc
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:pagbloc, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-param.
      * <TOTEM:EPT. INIT:gordc, FD:param, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT param
           IF NOT Valid-STATUS-param
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:param, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-mtordini.
      * <TOTEM:EPT. INIT:gordc, FD:mtordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT mtordini
           IF NOT Valid-STATUS-mtordini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:mtordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-cli-prg.
      * <TOTEM:EPT. INIT:gordc, FD:cli-prg, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT cli-prg
           IF NOT Valid-STATUS-cli-prg
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:cli-prg, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tcontat.
      * <TOTEM:EPT. INIT:gordc, FD:tcontat, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tcontat
           IF NOT Valid-STATUS-tcontat
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:tcontat, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tnazioni.
      * <TOTEM:EPT. INIT:gordc, FD:tnazioni, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tnazioni
           IF NOT Valid-STATUS-tnazioni
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:tnazioni, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-paramSHI.
      * <TOTEM:EPT. INIT:gordc, FD:paramSHI, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT paramSHI
           IF NOT Valid-STATUS-paramshi
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:paramSHI, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-grade.
      * <TOTEM:EPT. INIT:gordc, FD:grade, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT grade
           IF NOT Valid-STATUS-grade
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:gordc, FD:grade, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    PERFORM CLOSE-zoom-tcaumag
           PERFORM CLOSE-int-tordini
           PERFORM CLOSE-int-rordini
      ...
      *    After Close
       ...
       CLOSE-tordini.
      * <TOTEM:EPT. INIT:gordc, FD:tordini, BeforeClose>
      * <TOTEM:END>
           CLOSE tordini
           .

       CLOSE-agenti.
      * <TOTEM:EPT. INIT:gordc, FD:agenti, BeforeClose>
      * <TOTEM:END>
           CLOSE agenti
           .

       CLOSE-tvettori.
      * <TOTEM:EPT. INIT:gordc, FD:tvettori, BeforeClose>
      * <TOTEM:END>
           CLOSE tvettori
           .

       CLOSE-tivaese.
      * <TOTEM:EPT. INIT:gordc, FD:tivaese, BeforeClose>
      * <TOTEM:END>
           CLOSE tivaese
           .

       CLOSE-clienti.
      * <TOTEM:EPT. INIT:gordc, FD:clienti, BeforeClose>
      * <TOTEM:END>
           CLOSE clienti
           .

       CLOSE-destini.
      * <TOTEM:EPT. INIT:gordc, FD:destini, BeforeClose>
      * <TOTEM:END>
           CLOSE destini
           .

       CLOSE-articoli.
      * <TOTEM:EPT. INIT:gordc, FD:articoli, BeforeClose>
      * <TOTEM:END>
           CLOSE articoli
           .

       CLOSE-note.
      * <TOTEM:EPT. INIT:gordc, FD:note, BeforeClose>
      * <TOTEM:END>
           CLOSE note
           .

       CLOSE-tcodpag.
      * <TOTEM:EPT. INIT:gordc, FD:tcodpag, BeforeClose>
      * <TOTEM:END>
           CLOSE tcodpag
           .

       CLOSE-assorcli.
      * <TOTEM:EPT. INIT:gordc, FD:assorcli, BeforeClose>
      * <TOTEM:END>
           CLOSE assorcli
           .

       CLOSE-progmag.
      * <TOTEM:EPT. INIT:gordc, FD:progmag, BeforeClose>
      * <TOTEM:END>
           CLOSE progmag
           .

       CLOSE-timposte.
      * <TOTEM:EPT. INIT:gordc, FD:timposte, BeforeClose>
      * <TOTEM:END>
           CLOSE timposte
           .

       CLOSE-tmarche.
      * <TOTEM:EPT. INIT:gordc, FD:tmarche, BeforeClose>
      * <TOTEM:END>
           CLOSE tmarche
           .

       CLOSE-tmp-assorcli.
      * <TOTEM:EPT. INIT:gordc, FD:tmp-assorcli, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-tparamge.
      * <TOTEM:EPT. INIT:gordc, FD:tparamge, BeforeClose>
      * <TOTEM:END>
           CLOSE tparamge
           .

       CLOSE-tmagaz.
      * <TOTEM:EPT. INIT:gordc, FD:tmagaz, BeforeClose>
      * <TOTEM:END>
           CLOSE tmagaz
           .

       CLOSE-tcaumag.
      * <TOTEM:EPT. INIT:gordc, FD:tcaumag, BeforeClose>
      * <TOTEM:END>
           CLOSE tcaumag
           .

       CLOSE-timbalqta.
      * <TOTEM:EPT. INIT:gordc, FD:timbalqta, BeforeClose>
      * <TOTEM:END>
           CLOSE timbalqta
           .

       CLOSE-timballi.
      * <TOTEM:EPT. INIT:gordc, FD:timballi, BeforeClose>
      * <TOTEM:END>
           CLOSE timballi
           .

       CLOSE-recapiti.
      * <TOTEM:EPT. INIT:gordc, FD:recapiti, BeforeClose>
      * <TOTEM:END>
           CLOSE recapiti
           .

       CLOSE-rmovmag.
      * <TOTEM:EPT. INIT:gordc, FD:rmovmag, BeforeClose>
      * <TOTEM:END>
           CLOSE rmovmag
           .

       CLOSE-ttipocli.
      * <TOTEM:EPT. INIT:gordc, FD:ttipocli, BeforeClose>
      * <TOTEM:END>
           CLOSE ttipocli
           .

       CLOSE-rordini.
      * <TOTEM:EPT. INIT:gordc, FD:rordini, BeforeClose>
           if status-rordini = "9E"
              exit paragraph 
           end-if
      ...
      * <TOTEM:EPT. INIT:gordc, FD:tmp-progmag-zoom, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-zoom-tcaumag.
      * <TOTEM:EPT. INIT:gordc, FD:zoom-tcaumag, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-int-tordini.
      * <TOTEM:EPT. INIT:gordc, FD:int-tordini, BeforeClose>
      * <TOTEM:END>
           CLOSE int-tordini
           .

       CLOSE-int-rordini.
      * <TOTEM:EPT. INIT:gordc, FD:int-rordini, BeforeClose>
      * <TOTEM:END>
           CLOSE int-rordini
           .

       CLOSE-listini.
      * <TOTEM:EPT. INIT:gordc, FD:listini, BeforeClose>
      * <TOTEM:END>
           CLOSE listini
           .

       CLOSE-tpromo.
      * <TOTEM:EPT. INIT:gordc, FD:tpromo, BeforeClose>
      * <TOTEM:END>
           CLOSE tpromo
           .

       CLOSE-rpromo.
      * <TOTEM:EPT. INIT:gordc, FD:rpromo, BeforeClose>
      * <TOTEM:END>
           CLOSE rpromo
           .

       CLOSE-tmp-promo-prz.
      * <TOTEM:EPT. INIT:gordc, FD:tmp-promo-prz, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-locali.
      * <TOTEM:EPT. INIT:gordc, FD:locali, BeforeClose>
      * <TOTEM:END>
           CLOSE locali
           .

       CLOSE-blister.
      * <TOTEM:EPT. INIT:gordc, FD:blister, BeforeClose>
      * <TOTEM:END>
           CLOSE blister
           .

       CLOSE-tpiombo.
      * <TOTEM:EPT. INIT:gordc, FD:tpiombo, BeforeClose>
      * <TOTEM:END>
           CLOSE tpiombo
           .

       CLOSE-lisagente.
      * <TOTEM:EPT. INIT:gordc, FD:lisagente, BeforeClose>
      * <TOTEM:END>
           CLOSE lisagente
           .

       CLOSE-lockfile.
      * <TOTEM:EPT. INIT:gordc, FD:lockfile, BeforeClose>
      * <TOTEM:END>
           CLOSE lockfile
           .

       CLOSE-sitfin.
      * <TOTEM:EPT. INIT:gordc, FD:sitfin, BeforeClose>
      * <TOTEM:END>
           CLOSE sitfin
           .

       CLOSE-tscorte.
      * <TOTEM:EPT. INIT:gordc, FD:tscorte, BeforeClose>
      * <TOTEM:END>
           CLOSE tscorte
           .

       CLOSE-pagbloc.
      * <TOTEM:EPT. INIT:gordc, FD:pagbloc, BeforeClose>
      * <TOTEM:END>
           CLOSE pagbloc
           .

       CLOSE-param.
      * <TOTEM:EPT. INIT:gordc, FD:param, BeforeClose>
      * <TOTEM:END>
           CLOSE param
           .

       CLOSE-mtordini.
      * <TOTEM:EPT. INIT:gordc, FD:mtordini, BeforeClose>
      * <TOTEM:END>
           CLOSE mtordini
           .

       CLOSE-cli-prg.
      * <TOTEM:EPT. INIT:gordc, FD:cli-prg, BeforeClose>
      * <TOTEM:END>
           CLOSE cli-prg
           .

       CLOSE-tcontat.
      * <TOTEM:EPT. INIT:gordc, FD:tcontat, BeforeClose>
      * <TOTEM:END>
           .

       CLOSE-tnazioni.
      * <TOTEM:EPT. INIT:gordc, FD:tnazioni, BeforeClose>
      * <TOTEM:END>
           CLOSE tnazioni
           .

       CLOSE-paramSHI.
      * <TOTEM:EPT. INIT:gordc, FD:paramSHI, BeforeClose>
      * <TOTEM:END>
           CLOSE paramSHI
           .

       CLOSE-grade.
      * <TOTEM:EPT. INIT:gordc, FD:grade, BeforeClose>
      * <TOTEM:END>
           CLOSE grade
           .
      ...
      * <TOTEM:END>
       ...
       int-tordini-int-k-causale-MERGE-SPLITBUF.
           INITIALIZE int-tordini-int-k-causale-SPLITBUF
           MOVE int-tor-causale(1:4) TO 
           int-tordini-int-k-causale-SPLITBUF(1:4)
           MOVE int-tor-anno(1:4) TO 
           int-tordini-int-k-causale-SPLITBUF(5:4)
           MOVE int-tor-numero(1:8) TO 
           int-tordini-int-k-causale-SPLITBUF(9:8)
           .

       int-tordini-int-k1-MERGE-SPLITBUF.
           INITIALIZE int-tordini-int-k1-SPLITBUF
           MOVE int-tor-cod-cli(1:5) TO int-tordini-int-k1-SPLITBUF(1:5)
           MOVE int-tor-prg-destino(1:5) TO 
           int-tordini-int-k1-SPLITBUF(6:5)
           MOVE int-tor-anno(1:4) TO int-tordini-int-k1-SPLITBUF(11:4)
           MOVE int-tor-numero(1:8) TO int-tordini-int-k1-SPLITBUF(15:8)
           .

       int-tordini-int-k2-MERGE-SPLITBUF.
           INITIALIZE int-tordini-int-k2-SPLITBUF
           MOVE int-tor-data-passaggio-ordine(1:8) TO 
           int-tordini-int-k2-SPLITBUF(1:8)
           MOVE int-tor-anno(1:4) TO int-tordini-int-k2-SPLITBUF(9:4)
           MOVE int-tor-numero(1:8) TO int-tordini-int-k2-SPLITBUF(13:8)
           .

       int-tordini-int-k-bolla-MERGE-SPLITBUF.
           INITIALIZE int-tordini-int-k-bolla-SPLITBUF
           MOVE int-tor-anno-bolla(1:4) TO 
           int-tordini-int-k-bolla-SPLITBUF(1:4)
           MOVE int-tor-num-bolla(1:8) TO 
           int-tordini-int-k-bolla-SPLITBUF(5:8)
           .

       int-tordini-int-k3-MERGE-SPLITBUF.
           INITIALIZE int-tordini-int-k3-SPLITBUF
           MOVE int-tor-anno-bolla(1:4) TO 
           int-tordini-int-k3-SPLITBUF(1:4)
           MOVE int-tor-data-bolla(1:8) TO 
           int-tordini-int-k3-SPLITBUF(5:8)
           MOVE int-tor-num-bolla(1:8) TO 
           int-tordini-int-k3-SPLITBUF(13:8)
           MOVE int-tor-bolla-prenotata(1:1) TO 
           int-tordini-int-k3-SPLITBUF(21:1)
           .

       int-tordini-int-k-fattura-MERGE-SPLITBUF.
           INITIALIZE int-tordini-int-k-fattura-SPLITBUF
           MOVE int-tor-anno-fattura(1:4) TO 
           int-tordini-int-k-fattura-SPLITBUF(1:4)
           MOVE int-tor-num-fattura(1:8) TO 
           int-tordini-int-k-fattura-SPLITBUF(5:8)
           .

       int-tordini-int-k4-MERGE-SPLITBUF.
           INITIALIZE int-tordini-int-k4-SPLITBUF
           MOVE int-tor-anno-fattura(1:4) TO 
           int-tordini-int-k4-SPLITBUF(1:4)
           MOVE int-tor-data-fattura(1:8) TO 
           int-tordini-int-k4-SPLITBUF(5:8)
           MOVE int-tor-num-fattura(1:8) TO 
           int-tordini-int-k4-SPLITBUF(13:8)
           MOVE int-tor-num-prenot(1:8) TO 
           int-tordini-int-k4-SPLITBUF(21:8)
           MOVE int-tor-fatt-prenotata(1:1) TO 
           int-tordini-int-k4-SPLITBUF(29:1)
           .

       int-tordini-int-k-contab-MERGE-SPLITBUF.
           INITIALIZE int-tordini-int-k-contab-SPLITBUF
           MOVE int-tor-agg-contab(1:1) TO 
           int-tordini-int-k-contab-SPLITBUF(1:1)
           MOVE int-tor-anno-fattura(1:4) TO 
           int-tordini-int-k-contab-SPLITBUF(2:4)
           MOVE int-tor-num-fattura(1:8) TO 
           int-tordini-int-k-contab-SPLITBUF(6:8)
           .

       int-tordini-int-k-tipo-MERGE-SPLITBUF.
           INITIALIZE int-tordini-int-k-tipo-SPLITBUF
           MOVE int-tor-tipo(1:1) TO 
           int-tordini-int-k-tipo-SPLITBUF(1:1)
           MOVE int-tor-chiave(1:12) TO 
           int-tordini-int-k-tipo-SPLITBUF(2:12)
           .

       int-tordini-int-k-data-MERGE-SPLITBUF.
           INITIALIZE int-tordini-int-k-data-SPLITBUF
           MOVE int-tor-data-creazione(1:8) TO 
           int-tordini-int-k-data-SPLITBUF(1:8)
           MOVE int-tor-numero(1:8) TO 
           int-tordini-int-k-data-SPLITBUF(9:8)
           .

       int-tordini-int-k-agfatt-MERGE-SPLITBUF.
           INITIALIZE int-tordini-int-k-agfatt-SPLITBUF
           MOVE int-tor-anno-fattura(1:4) TO 
           int-tordini-int-k-agfatt-SPLITBUF(1:4)
           MOVE int-tor-data-fattura(1:8) TO 
           int-tordini-int-k-agfatt-SPLITBUF(5:8)
           MOVE int-tor-num-fattura(1:8) TO 
           int-tordini-int-k-agfatt-SPLITBUF(13:8)
           MOVE int-tor-num-prenot(1:8) TO 
           int-tordini-int-k-agfatt-SPLITBUF(21:8)
           MOVE int-tor-fatt-prenotata(1:1) TO 
           int-tordini-int-k-agfatt-SPLITBUF(29:1)
           MOVE int-tor-chiave(1:12) TO 
           int-tordini-int-k-agfatt-SPLITBUF(30:12)
           .

       int-tordini-int-k-stbolle-MERGE-SPLITBUF.
           INITIALIZE int-tordini-int-k-stbolle-SPLITBUF
           MOVE int-tor-anno-bolla(1:4) TO 
           int-tordini-int-k-stbolle-SPLITBUF(1:4)
           MOVE int-tor-data-bolla(1:8) TO 
           int-tordini-int-k-stbolle-SPLITBUF(5:8)
           MOVE int-tor-num-bolla(1:8) TO 
           int-tordini-int-k-stbolle-SPLITBUF(13:8)
           MOVE int-tor-bolla-prenotata(1:1) TO 
           int-tordini-int-k-stbolle-SPLITBUF(21:1)
           MOVE int-tor-chiave(1:12) TO 
           int-tordini-int-k-stbolle-SPLITBUF(22:12)
           .

       int-tordini-int-k-andamento-data-MERGE-SPLITBUF.
           INITIALIZE int-tordini-int-k-andamento-data-SPLITBUF
           MOVE int-tor-agg-contab(1:1) TO 
           int-tordini-int-k-andamento-data-SPLITBUF(1:1)
           MOVE int-tor-data-fattura(1:8) TO 
           int-tordini-int-k-andamento-data-SPLITBUF(2:8)
           .

       int-tordini-int-k-andamento-cliente-MERGE-SPLITBUF.
           INITIALIZE int-tordini-int-k-andamento-cliente-SPLITBUF
           MOVE int-tor-cod-cli(1:5) TO 
           int-tordini-int-k-andamento-cliente-SPLITBUF(1:5)
           MOVE int-tor-agg-contab(1:1) TO 
           int-tordini-int-k-andamento-cliente-SPLITBUF(6:1)
           MOVE int-tor-data-fattura(1:8) TO 
           int-tordini-int-k-andamento-cliente-SPLITBUF(7:8)
           .

       int-tordini-int-k-andamento-clides-MERGE-SPLITBUF.
           INITIALIZE int-tordini-int-k-andamento-clides-SPLITBUF
           MOVE int-tor-cod-cli(1:5) TO 
           int-tordini-int-k-andamento-clides-SPLITBUF(1:5)
           MOVE int-tor-prg-destino(1:5) TO 
           int-tordini-int-k-andamento-clides-SPLITBUF(6:5)
           MOVE int-tor-agg-contab(1:1) TO 
           int-tordini-int-k-andamento-clides-SPLITBUF(11:1)
           MOVE int-tor-data-fattura(1:8) TO 
           int-tordini-int-k-andamento-clides-SPLITBUF(12:8)
           .

       int-tordini-int-k-promo-MERGE-SPLITBUF.
           INITIALIZE int-tordini-int-k-promo-SPLITBUF
           MOVE int-tor-stato(1:1) TO 
           int-tordini-int-k-promo-SPLITBUF(1:1)
           MOVE int-tor-promo(1:1) TO 
           int-tordini-int-k-promo-SPLITBUF(2:1)
           MOVE int-tor-data-ordine(1:8) TO 
           int-tordini-int-k-promo-SPLITBUF(3:8)
           MOVE int-tor-numero(1:8) TO 
           int-tordini-int-k-promo-SPLITBUF(11:8)
           MOVE int-tor-cod-cli(1:5) TO 
           int-tordini-int-k-promo-SPLITBUF(19:5)
           MOVE int-tor-prg-destino(1:5) TO 
           int-tordini-int-k-promo-SPLITBUF(24:5)
           .

       DataSet1-int-tordini-INITSTART.
           IF DataSet1-int-tordini-KEY-Asc
              MOVE Low-Value TO int-tor-chiave
           ELSE
              MOVE High-Value TO int-tor-chiave
           END-IF
           .

       DataSet1-int-tordini-INITEND.
           IF DataSet1-int-tordini-KEY-Asc
              MOVE High-Value TO int-tor-chiave
           ELSE
              MOVE Low-Value TO int-tor-chiave
      ...
      * int-tordini
       DataSet1-int-tordini-START.
           IF DataSet1-int-tordini-KEY-Asc
              START int-tordini KEY >= int-tor-chiave
           ELSE
              START int-tordini KEY <= int-tor-chiave
           END-IF
           .

       DataSet1-int-tordini-START-NOTGREATER.
           IF DataSet1-int-tordini-KEY-Asc
              START int-tordini KEY <= int-tor-chiave
           ELSE
              START int-tordini KEY >= int-tor-chiave
       ...
       DataSet1-int-tordini-START-GREATER.
           IF DataSet1-int-tordini-KEY-Asc
              START int-tordini KEY > int-tor-chiave
           ELSE
              START int-tordini KEY < int-tor-chiave
       ...
       DataSet1-int-tordini-START-LESS.
           IF DataSet1-int-tordini-KEY-Asc
              START int-tordini KEY < int-tor-chiave
           ELSE
              START int-tordini KEY > int-tor-chiave
       ...
       DataSet1-int-tordini-Read.
      * <TOTEM:EPT. FD:DataSet1, FD:int-tordini, BeforeRead>
      * <TOTEM:END>
      * <TOTEM:EPT. FD:DataSet1, FD:int-tordini, BeforeReadRecord>
      * <TOTEM:END>
           IF DataSet1-int-tordini-LOCK
              READ int-tordini WITH LOCK 
              KEY int-tor-chiave
           ELSE
              READ int-tordini WITH NO LOCK 
              KEY int-tor-chiave
           END-IF
           PERFORM int-tordini-int-k-causale-MERGE-SPLITBUF
           PERFORM int-tordini-int-k1-MERGE-SPLITBUF
           PERFORM int-tordini-int-k2-MERGE-SPLITBUF
           PERFORM int-tordini-int-k-bolla-MERGE-SPLITBUF
           PERFORM int-tordini-int-k3-MERGE-SPLITBUF
           PERFORM int-tordini-int-k-fattura-MERGE-SPLITBUF
           PERFORM int-tordini-int-k4-MERGE-SPLITBUF
           PERFORM int-tordini-int-k-contab-MERGE-SPLITBUF
           PERFORM int-tordini-int-k-tipo-MERGE-SPLITBUF
           PERFORM int-tordini-int-k-data-MERGE-SPLITBUF
           PERFORM int-tordini-int-k-agfatt-MERGE-SPLITBUF
           PERFORM int-tordini-int-k-stbolle-MERGE-SPLITBUF
           PERFORM int-tordini-int-k-andamento-data-MERGE-SPLITBUF
           PERFORM int-tordini-int-k-andamento-cliente-MERGE-SPLITBUF
           PERFORM int-tordini-int-k-andamento-clides-MERGE-SPLITBUF
           PERFORM int-tordini-int-k-promo-MERGE-SPLITBUF
           MOVE STATUS-int-tordini TO TOTEM-ERR-STAT 
           MOVE "int-tordini" TO TOTEM-ERR-FILE
           MOVE "READ" TO TOTEM-ERR-MODE
      * <TOTEM:EPT. FD:DataSet1, FD:int-tordini, AfterRead>
      * <TOTEM:END>
      * <TOTEM:EPT. FD:DataSet1, FD:int-tordini, AfterReadRecord>
      * <TOTEM:END>
           .

       DataSet1-int-tordini-Read-Next.
      * <TOTEM:EPT. FD:DataSet1, FD:int-tordini, BeforeRead>
      * <TOTEM:END>
      * <TOTEM:EPT. FD:DataSet1, FD:int-tordini, BeforeReadNext>
      * <TOTEM:END>
           IF DataSet1-int-tordini-KEY-Asc
              IF DataSet1-int-tordini-LOCK
                 READ int-tordini NEXT WITH LOCK
              ELSE
                 READ int-tordini NEXT WITH NO LOCK
              END-IF
           ELSE
              IF DataSet1-int-tordini-LOCK
                 READ int-tordini PREVIOUS WITH LOCK
              ELSE
                 READ int-tordini PREVIOUS WITH NO LOCK
              END-IF
           END-IF
           PERFORM int-tordini-int-k-causale-MERGE-SPLITBUF
           PERFORM int-tordini-int-k1-MERGE-SPLITBUF
      ...
      * <TOTEM:EPT. FD:DataSet1, FD:int-tordini, AfterRead>
      * <TOTEM:END>
      * <TOTEM:EPT. FD:DataSet1, FD:int-tordini, AfterReadNext>
      * <TOTEM:END>
           .

       DataSet1-int-tordini-Read-Prev.
      * <TOTEM:EPT. FD:DataSet1, FD:int-tordini, BeforeRead>
      * <TOTEM:END>
      * <TOTEM:EPT. FD:DataSet1, FD:int-tordini, BeforeReadPrev>
      * <TOTEM:END>
           IF DataSet1-int-tordini-KEY-Asc
              IF DataSet1-int-tordini-LOCK
                 READ int-tordini PREVIOUS WITH LOCK
      ...
      * <TOTEM:EPT. FD:DataSet1, FD:int-tordini, AfterRead>
      * <TOTEM:END>
      * <TOTEM:EPT. FD:DataSet1, FD:int-tordini, AfterReadPrev>
      * <TOTEM:END>
           .

       DataSet1-int-tordini-Rec-Write.
      * <TOTEM:EPT. FD:DataSet1, FD:int-tordini, BeforeWrite>
      * <TOTEM:END>
           WRITE int-tor-rec OF int-tordini.
           MOVE STATUS-int-tordini TO TOTEM-ERR-STAT
           MOVE "int-tordini" TO TOTEM-ERR-FILE
           MOVE "WRITE" TO TOTEM-ERR-MODE
      * <TOTEM:EPT. FD:DataSet1, FD:int-tordini, AfterWrite>
      * <TOTEM:END>
           .

       DataSet1-int-tordini-Rec-Rewrite.
      * <TOTEM:EPT. FD:DataSet1, FD:int-tordini, BeforeRewrite>
      * <TOTEM:END>
           REWRITE int-tor-rec OF int-tordini.
           MOVE STATUS-int-tordini TO TOTEM-ERR-STAT
           MOVE "int-tordini" TO TOTEM-ERR-FILE
           MOVE "REWRITE" TO TOTEM-ERR-MODE
      * <TOTEM:EPT. FD:DataSet1, FD:int-tordini, AfterRewrite>
      * <TOTEM:END>
           .

       DataSet1-int-tordini-Rec-Delete.
      * <TOTEM:EPT. FD:DataSet1, FD:int-tordini, BeforeDelete>
      * <TOTEM:END>
           DELETE int-tordini.
           MOVE STATUS-int-tordini TO TOTEM-ERR-STAT
           MOVE "int-tordini" TO TOTEM-ERR-FILE
           MOVE "DELETE" TO TOTEM-ERR-MODE
      * <TOTEM:EPT. FD:DataSet1, FD:int-tordini, AfterDelete>
      * <TOTEM:END>
           .

       int-rordini-int-ror-k-promo-MERGE-SPLITBUF.
           INITIALIZE int-rordini-int-ror-k-promo-SPLITBUF
           MOVE int-ror-promo(1:15) TO 
           int-rordini-int-ror-k-promo-SPLITBUF(1:15)
           .

       int-rordini-int-ror-k-articolo-MERGE-SPLITBUF.
           INITIALIZE int-rordini-int-ror-k-articolo-SPLITBUF
           MOVE int-ror-cod-articolo(1:6) TO 
           int-rordini-int-ror-k-articolo-SPLITBUF(1:6)
           MOVE int-ror-chiave(1:17) TO 
           int-rordini-int-ror-k-articolo-SPLITBUF(7:17)
           .

       DataSet1-int-rordini-INITSTART.
           IF DataSet1-int-rordini-KEY-Asc
              MOVE Low-Value TO int-ror-chiave
           ELSE
              MOVE High-Value TO int-ror-chiave
           END-IF
           .

       DataSet1-int-rordini-INITEND.
           IF DataSet1-int-rordini-KEY-Asc
              MOVE High-Value TO int-ror-chiave
           ELSE
              MOVE Low-Value TO int-ror-chiave
      ...
      * int-rordini
       ...
       DataSet1-int-rordini-START-NOTGREATER.
           IF DataSet1-int-rordini-KEY-Asc
              START int-rordini KEY <= int-ror-chiave
           ELSE
              START int-rordini KEY >= int-ror-chiave
       ...
       DataSet1-int-rordini-START-GREATER.
           IF DataSet1-int-rordini-KEY-Asc
              START int-rordini KEY > int-ror-chiave
           ELSE
              START int-rordini KEY < int-ror-chiave
       ...
       DataSet1-int-rordini-START-LESS.
           IF DataSet1-int-rordini-KEY-Asc
              START int-rordini KEY < int-ror-chiave
           ELSE
              START int-rordini KEY > int-ror-chiave
       ...
       DataSet1-int-rordini-Read.
      * <TOTEM:EPT. FD:DataSet1, FD:int-rordini, BeforeRead>
      * <TOTEM:END>
      * <TOTEM:EPT. FD:DataSet1, FD:int-rordini, BeforeReadRecord>
      * <TOTEM:END>
           IF DataSet1-int-rordini-LOCK
              READ int-rordini WITH LOCK 
              KEY int-ror-chiave
           ELSE
              READ int-rordini WITH NO LOCK 
              KEY int-ror-chiave
           END-IF
           PERFORM int-rordini-int-ror-k-promo-MERGE-SPLITBUF
           PERFORM int-rordini-int-ror-k-articolo-MERGE-SPLITBUF
           MOVE STATUS-int-rordini TO TOTEM-ERR-STAT 
           MOVE "int-rordini" TO TOTEM-ERR-FILE
           MOVE "READ" TO TOTEM-ERR-MODE
      * <TOTEM:EPT. FD:DataSet1, FD:int-rordini, AfterRead>
      * <TOTEM:END>
      * <TOTEM:EPT. FD:DataSet1, FD:int-rordini, AfterReadRecord>
      * <TOTEM:END>
           .

       DataSet1-int-rordini-Read-Next.
      * <TOTEM:EPT. FD:DataSet1, FD:int-rordini, BeforeRead>
      * <TOTEM:END>
      * <TOTEM:EPT. FD:DataSet1, FD:int-rordini, BeforeReadNext>
      * <TOTEM:END>
           IF DataSet1-int-rordini-KEY-Asc
              IF DataSet1-int-rordini-LOCK
                 READ int-rordini NEXT WITH LOCK
              ELSE
                 READ int-rordini NEXT WITH NO LOCK
              END-IF
           ELSE
              IF DataSet1-int-rordini-LOCK
                 READ int-rordini PREVIOUS WITH LOCK
              ELSE
                 READ int-rordini PREVIOUS WITH NO LOCK
              END-IF
           END-IF
           PERFORM int-rordini-int-ror-k-promo-MERGE-SPLITBUF
           PERFORM int-rordini-int-ror-k-articolo-MERGE-SPLITBUF
      ...
      * <TOTEM:EPT. FD:DataSet1, FD:int-rordini, AfterRead>
      * <TOTEM:END>
      * <TOTEM:EPT. FD:DataSet1, FD:int-rordini, AfterReadNext>
      * <TOTEM:END>
           .

       DataSet1-int-rordini-Read-Prev.
      * <TOTEM:EPT. FD:DataSet1, FD:int-rordini, BeforeRead>
      * <TOTEM:END>
      * <TOTEM:EPT. FD:DataSet1, FD:int-rordini, BeforeReadPrev>
      * <TOTEM:END>
           IF DataSet1-int-rordini-KEY-Asc
              IF DataSet1-int-rordini-LOCK
                 READ int-rordini PREVIOUS WITH LOCK
      ...
      * <TOTEM:EPT. FD:DataSet1, FD:int-rordini, AfterRead>
      * <TOTEM:END>
      * <TOTEM:EPT. FD:DataSet1, FD:int-rordini, AfterReadPrev>
      * <TOTEM:END>
           .

       DataSet1-int-rordini-Rec-Write.
      * <TOTEM:EPT. FD:DataSet1, FD:int-rordini, BeforeWrite>
      * <TOTEM:END>
           WRITE int-ror-rec OF int-rordini.
           MOVE STATUS-int-rordini TO TOTEM-ERR-STAT
           MOVE "int-rordini" TO TOTEM-ERR-FILE
           MOVE "WRITE" TO TOTEM-ERR-MODE
      * <TOTEM:EPT. FD:DataSet1, FD:int-rordini, AfterWrite>
      * <TOTEM:END>
           .

       DataSet1-int-rordini-Rec-Rewrite.
      * <TOTEM:EPT. FD:DataSet1, FD:int-rordini, BeforeRewrite>
      * <TOTEM:END>
           REWRITE int-ror-rec OF int-rordini.
           MOVE STATUS-int-rordini TO TOTEM-ERR-STAT
           MOVE "int-rordini" TO TOTEM-ERR-FILE
           MOVE "REWRITE" TO TOTEM-ERR-MODE
      * <TOTEM:EPT. FD:DataSet1, FD:int-rordini, AfterRewrite>
      * <TOTEM:END>
           .

       DataSet1-int-rordini-Rec-Delete.
      * <TOTEM:EPT. FD:DataSet1, FD:int-rordini, BeforeDelete>
      * <TOTEM:END>
           DELETE int-rordini.
           MOVE STATUS-int-rordini TO TOTEM-ERR-STAT
           MOVE "int-rordini" TO TOTEM-ERR-FILE
           MOVE "DELETE" TO TOTEM-ERR-MODE
      * <TOTEM:EPT. FD:DataSet1, FD:int-rordini, AfterDelete>
      * <TOTEM:END>
           .
      ...
      * <TOTEM:END>
       ...
       DataSet1-INIT-RECORD.
           ...
           INITIALIZE int-tor-rec OF int-tordini
           INITIALIZE int-ror-rec OF int-rordini
      ...
      * DB_Entry-Field : ef-data-bolla
           MOVE ef-data-bolla-BUF TO tor-data-bolla
      ...
      *
           ...
           if DatiBollaManuale
              ...
              initialize tor-bolla replacing numeric data by zeroes
                                        alphanumeric data by spaces
      ...
      *
           ...
           move data-oggi             to tor-data-creazione.            
                 
           move como-ora              to tor-ora-creazione.
           move user-codi             to tor-utente-creazione.
                                    
           initialize tor-fattura replacing numeric data by zeroes
                                       alphanumeric data by spaces.
...
LUBEXX     move ef-gest-buf to tor-gest-plus.
      ...
      * DB_RADIOBOX : rb-man, rb-gui, 
           ...
           END-EVALUATE
      * DB_Entry-Field : ef-data-bolla
           MOVE tor-data-bolla TO ef-data-bolla-BUF
      * DB_Entry-Field : ef-num-bolla
           MOVE tor-num-bolla TO ef-num-bolla-BUF
      * DB_LABEL : lab-age
      ...
      * <TOTEM:END>
       ...
       Form1-CONTROLLO-OLD.
           ...
           if tor-data-bolla not = old-tor-data-bolla
              and SiSalvato
              set NoSalvato to true
           ...
           if tor-num-bolla not = old-tor-num-bolla
              and SiSalvato
              set NoSalvato to true
      ...
      * Generazione stringa perform CONTROLLO
           ...
           when 78-ID-cbo-stato
                perform CONTROLLO
           |78-ID-rb-man è l'ID del campo rb-man
           when 78-ID-rb-man
                perform CONTROLLO
           |78-ID-rb-gui è l'ID del campo rb-gui
           when 78-ID-rb-gui
                perform CONTROLLO
           |78-ID-ef-data-bolla è l'ID del campo ef-data-bolla
      ...
      *****     modify form1-gd-1(riga, 78-NumColMan + 1),  
      *****            hidden-data = hid-cod-articolo.
      *****     modify form1-gd-1(riga, 78-NumColMan + 2),  
      *****            hidden-data = hid-cod-magazzino.
      *****     modify form1-gd-1(riga, 78-NumColMan + 3),  
      *****            hidden-data = hid-tipo-imballo.
      *****     modify form1-gd-1(riga, 78-NumColMan + 4),  
      *****            hidden-data = hid-peso.
      *****     modify form1-gd-1(riga, 78-NumColMan + 5),  
      *****            hidden-data = hid-imballi.
      *****     modify form1-gd-1(riga, 78-NumColMan + 7),  
      *****            hidden-data = hid-des-imballo.
      *****     modify form1-gd-1(riga, 78-NumColMan + 8),  
      *****            hidden-data = hid-cod-art-cli.
      *****     modify form1-gd-1(riga, 78-NumColMan + 9),  
      *****            hidden-data = hid-var-piu.
      *****     modify form1-gd-1(riga, 78-NumColMan + 10), 
      *****            hidden-data = hid-var-meno.
      *****     modify form1-gd-1(riga, 78-NumColMan + 11), 
      *****            hidden-data = hid-prezzo.  
      *****     modify form1-gd-1(riga, 78-NumColMan + 12), 
      *****            hidden-data = hid-utf.
      *****     modify form1-gd-1(riga, 78-NumColMan + 13), 
      *****            hidden-data = hid-non-utf.                   
      *****     modify form1-gd-1(riga, 78-NumColMan + 14), 
      *****            hidden-data = hid-giacenza.
      *****     modify form1-gd-1(riga, 78-NumColMan + 15), 
      *****            hidden-data = hid-impegnato.
      *****     modify form1-gd-1(riga, 78-NumColMan + 16), 
      *****            hidden-data = hid-ordinato. 
      *****     modify form1-gd-1(riga, 78-NumColMan + 17),
      *****            hidden-data = hid-perce-iva.
      *****     modify form1-gd-1(riga, 78-NumColMan + 18),
      *****            hidden-data = hid-qta-omaggi.
      *****     modify form1-gd-1(riga, 78-NumColMan + 19),
      *****            hidden-data = hid-blister.   
LABLAB*****     modify form1-gd-1(riga, 78-NumColMan + 20),
      *****            hidden-data = hid-flag-bloccato.   
LABLAB*****     modify form1-gd-1(riga, 78-NumColMan + 21),
      *****            hidden-data = hid-promo.
...
LUBEXX        end-if
      ...
      *    Luciano
           if hid-no-prz-manuale
              if newRow
                 move ef-uni-buf      to ror-prz-unitario
                 move ef-sconto-buf   to ror-perce-sconto
                 if ror-prz-unitario  not = como-prezzo-proposto or
                    ror-perce-sconto  not = como-sconto-proposto
                    set hid-si-prz-manuale  to true
                 end-if
              else
                 move col-uni    to ror-prz-unitario
                 if old-prezzo       not = ror-prz-unitario or 
                    old-perce-sconto not = ror-perce-sconto
                    set hid-si-prz-manuale  to true
                 end-if
              end-if
           end-if
      ...
      * <TOTEM:PARA. INIT>
           ...
           move 0 to v-guidata form1-radio-1-buf 
                     old-art-codice.
      ...
      *****     inquire form1-gd-1(riga, 78-NumColMan + 9), 
      *****             hidden-data in  hid-var-piu.
      *****     inquire form1-gd-1(riga, 78-NumColMan + 10),
      *****             hidden-data in  hid-var-meno.
      *****     inquire form1-gd-1(riga, 78-NumColMan + 11), 
      *****             hidden-data in  hid-prezzo.  
      ...
      *****     inquire form1-gd-1(riga, 78-NumColMan + 14), 
      *****             hidden-data in  hid-giacenza.
      *****     inquire form1-gd-1(riga, 78-NumColMan + 15), 
      *****             hidden-data in  hid-impegnato.
      *****     inquire form1-gd-1(riga, 78-NumColMan + 16), 
      *****             hidden-data in  hid-ordinato. 
...
LUBEXX     read timbalqta no lock invalid continue end-read.
           ...
           move col-qta    to ef-qta-buf ror-qta.
OMAGGI     move hid-qta-omaggi to ef-qta-oma-buf ror-qta-omaggi.
BLISTR     move hid-blister to chk-blister-buf.
           move col-uni    to ef-uni-buf old-prezzo ror-prz-unitario.
           move col-sconto to ef-sconto-buf ror-perce-sconto 
                                            old-perce-sconto.
           move col-cons   to ef-cons-buf   ror-imp-consumo.
           move col-cou    to ef-cou-buf    ror-imp-cou-cobat.
           move col-add    to ef-add-buf    ror-add-piombo.
           move col-imp    to ef-imp-buf    ror-imponib-merce.
           move col-iva    to ef-cod-iva-buf tbliv-codice2 ror-cod-iva.
      ...
      * <TOTEM:PARA. SALVA>
           ...
           if errori
              ...
              if tutto-ok and tcl-si-gestione-fido or 
           cli-gestione-fido-si
...
LABLAB                 if si-promo set tor-si-promo to true
LABLAB                 else        set tor-no-promo to true
LABLAB                 end-if
...
PATCH                  end-if
                       ...
                       set tor-no-agg-contab     to true
                       set tor-ordine            to true
                       set tor-rec-prezzi        to false
                       set tor-ev-singola        to true
      ...
      *****                 end-if                     
                       ...
                       if tor-causale = tge-causale-omag   
                          ...
                          move "RICORDARSI D'INSERIRE DETTAGLI PROMOZION
      -    "E!!!"
      ...
      *****                 |Scrittura del tmp ad uso interno
      *****                 move  tor-rec to int-tor-rec
      *****                 write int-tor-rec 
      *****                       invalid rewrite int-tor-rec 
      *****                 end-write
...
PATCH       bitmap-number = BitmapNumSave.
      ...
      ********--- DEVE RIMANERE IDENTICO A QUELLO DI GORDCVAR
...
LUBEXX*****     set EsisteIVA to false.
      ...
      *****                                alphanumeric data by spaces
      *****        inquire form1-gd-2(riga, 4), cell-data in col-qta
      ...
      *****
      *****           inquire form1-gd-2(riga, 2), cell-data in col-art-2
      *****           move col-art-2 to ror-cod-articolo
      *****
      *****           move como-qta  to ror-qta
      *****
      *****           inquire form1-gd-2(riga, 78-NumCol + 3),  hidden-data 
      *****           in hid-tipo-imballo
      *****           move hid-tipo-imballo to ror-cod-imballo
      *****
      *****           inquire form1-gd-2(riga, 5), cell-data in col-uni-2
      *****           move col-uni-2 to ror-prz-unitario                 
      *****
      *****           inquire form1-gd-2(riga, 78-NumCol + 5),  hidden-data 
      *****           in hid-imballi
...
BLISTR*****           end-if
      *****
      *****           inquire form1-gd-2(riga, 78-NumCol + 6),  hidden-data 
      *****           in hid-utf
      *****           move hid-utf     to ror-peso-utf
      *****
      *****           inquire form1-gd-2(riga, 78-NumCol + 7),  hidden-data 
      *****           in hid-non-utf
      *****           move hid-non-utf to ror-peso-non-utf
      *****
      *****           inquire form1-gd-2(riga, 78-NumCol + 9),  hidden-data 
      *****           in hid-sconto
      *****           move hid-sconto to ror-perce-sconto
      *****
      *****           inquire form1-gd-2(riga, 78-NumCol + 10), hidden-data 
      *****           in hid-cons
      *****           move hid-cons to ror-imp-consumo
      *****
      *****           inquire form1-gd-2(riga, 78-NumCol + 11), hidden-data 
      *****           in hid-cobat
      *****           move hid-cobat to ror-imp-cou-cobat
      *****
...
LUBEXX*****              end-if
      ...
      *****                 ror-prz-unitario - ror-imp-consumo - ror-imp-cou-cobat
      *****           end-if
      *****
      *****           inquire form1-gd-2(riga, 78-NumCol + 13), hidden-data
      *****                in hid-des-imballo
      *****           move hid-des-imballo to ror-des-imballo
      *****
      *****           inquire form1-gd-2(riga, 78-NumCol + 14), hidden-data 
      *****           in hid-cod-art-cli
      *****           move hid-cod-art-cli to ror-cod-art-cli
      *****
      *****           if tor-cod-ese-iva not = spaces
      *****              move tor-cod-ese-iva to ror-cod-iva
      *****           else
      *****              inquire form1-gd-2(riga, 78-NumCol + 15), 
      *****              hidden-data in hid-cod-iva
      *****              move hid-cod-iva to ror-cod-iva
      *****           end-if
      *****
LUBEXX*****           if not EsisteIVA
...
LUBEXX*****           end-if
      ...
      *****          
      *****           inquire form1-gd-2(riga, 78-NumCol + 1),  hidden-data 
      *****                in hid-cod-articolo
      *****           inquire form1-gd-2(riga, 78-NumCol + 2),  hidden-data 
      *****                in hid-cod-magazzino
      *****           inquire form1-gd-2(riga, 78-NumCol + 3),  hidden-data 
      *****                in hid-tipo-imballo
      *****           inquire form1-gd-2(riga, 78-NumCol + 4),  hidden-data 
      *****                in hid-peso
      *****
      *****           if CallWProgmag
      ...
      *****           end-if
      *****
      *****           move HiddenKey to ror-prg-chiave
      *****
      *****           accept como-ora from time
      *****           move data-oggi to ror-data-creazione
      *****           move como-ora  to ror-ora-creazione
      *****           move user-codi to ror-utente-creazione
      *****           write ror-rec invalid rewrite ror-rec end-write
      *****
      *****           |Scrittura del tmp ad uso interno
      *****           move  ror-rec to int-ror-rec
      *****           write int-ror-rec 
      *****                 invalid rewrite int-ror-rec 
      *****           end-write
      *****
      *****        end-if
      *****     end-perform  
...
PATCH**              move col-num to ror-num-riga

PATCH         subtract 1 from riga giving ror-num-riga
...
LABLAB     end-if 
      ...
      * <TOTEM:PARA. VALORIZZA-NUMERO>
           ...
           |Controllo che sia in gestione altrimenti
           |se sessione si è inchiodata lo cancello
           if trovato-lock
              read lockfile lock
              if RecLocked
                 if lck-nome-pgm = 78-evaart
                    display message "Tabella contatori in uso da: " 
           lck-utente-creazione
                             x"0d0a""per evasione automatica ordini mast
      -    "er tradizionali"
                             x"0d0a""Operazione impossibile! Attendere t
      -    "ermine operazione!"
                              title titolo
                               icon 2
                 else
      ...
      * <TOTEM:PARA. ef-num-bolla-AfterProcedure>
              INQUIRE ef-num-bolla, VALUE IN tor-num-bolla
              SET TOTEM-CHECK-OK TO FALSE
              PERFORM ef-num-bolla-VALIDATION
              IF NOT TOTEM-CHECK-OK
                 MOVE 1 TO ACCEPT-CONTROL
      ...
      * <TOTEM:PARA. ef-data-bolla-AfterProcedure>
              INQUIRE ef-data-bolla, VALUE IN tor-data-bolla
              SET TOTEM-CHECK-OK TO FALSE
              PERFORM ef-data-bolla-VALIDATION
              IF NOT TOTEM-CHECK-OK
                 MOVE 1 TO ACCEPT-CONTROL
      ...
      * <TOTEM:END>
       ...
       gordc-Ev-Before-DSD-Open.
      * <TOTEM:PARA. gordc-Ev-Before-DSD-Open>
