      *{TOTEM}PRG-COMMENT
      * ordf-elab.Cbl
      * ordf-elab.Cbl is generated by TOTEM
      * This is a generated file. DO NOT modify this file directly.
      *{TOTEM}END
       IDENTIFICATION       DIVISION.
      *{TOTEM}PRGID
       PROGRAM-ID.          ordf-elab.
       AUTHOR.              ANDREA EVENTI.
       DATE-WRITTEN.        venerdì 31 luglio 2015 12:42:05.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:ordf-elab, INIT:ordf-elab, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       78 titolo VALUE IS "GESLUX - Sistemazione ordini F". 
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:ordf-elab, INIT:ordf-elab, BeforeDeclarative>
      * <TOTEM:END>
       INPUT-ERROR SECTION.
      ...
      * <TOTEM:EPT. INIT:ordf-elab, INIT:ordf-elab, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-tordforn.
      * <TOTEM:EPT. INIT:ordf-elab, FD:tordforn, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O tordforn
           ...
           END-IF
      * <TOTEM:EPT. INIT:ordf-elab, FD:tordforn, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-tordforn.
      * <TOTEM:EPT. INIT:ordf-elab, FD:tordforn, BeforeClose>
      * <TOTEM:END>
           CLOSE tordforn
           .
      ...
      * <TOTEM:PARA. pb-sib-LinkTo>
           ...
           if tutto-ok
              display message "Verranno aggiornati gli ordini fornitore 
      -    "" num-from " al " num-to 
                       x"0d0a""Data di consegna = data odierna"
                       x"0d0a""Creazione solleciti con data consegna"
                       x"0d0a""Confermi?"
                        title titolo
                         icon 2
                         type mb-yes-no
           ...
           if tutto-ok
              ...
              perform varying num-from from num-from by 1
                 ...
                 read tordforn no lock
                  ...
                  not invalid
                      add 1 to deleted
                      accept tof-data-ordine from century-date
                      rewrite tof-rec
              ...
              display message "OPERAZIONE TERMINATA!!!"
                       x"0d0a""ELABORATI " deleted " ORDINI F"
                        title titolo
                         icon 2
              modify pb-sib, bitmap-number = 1
