      *{TOTEM}PRG-COMMENT
      * utf-daylist.Cbl
      * utf-daylist.Cbl is generated by TOTEM
      * This is a generated file. DO NOT modify this file directly.
      *{TOTEM}END
       IDENTIFICATION       DIVISION.
      *{TOTEM}PRGID
       PROGRAM-ID.          utf-daylist.
       AUTHOR.              ANDREA EVENTI.
       DATE-WRITTEN.        martedì 1 aprile 2014 19:20:29.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:utf-daylist, INIT:utf-daylist, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       78 titolo VALUE IS "Stampa della lista del giorno". 
       01 file-info.
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:utf-daylist, INIT:utf-daylist, BeforeDeclarative>
      ***---
       ANAUTF-ERR SECTION.
      ...
      * <TOTEM:EPT. INIT:utf-daylist, INIT:utf-daylist, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-anautf.
      * <TOTEM:EPT. INIT:utf-daylist, FD:anautf, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT anautf
           ...
           END-IF
      * <TOTEM:EPT. INIT:utf-daylist, FD:anautf, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-anautf.
      * <TOTEM:EPT. INIT:utf-daylist, FD:anautf, BeforeClose>
      * <TOTEM:END>
           CLOSE anautf
           .
      ...
      * <TOTEM:PARA. CERCA>
           ...
           when 78-ID-ef-num-reg
                move como-data-from(1:4) to utf-anno
      ...
      * <TOTEM:PARA. pb-ok-LinkTo>
           ...
           if tutto-ok
              ...
              initialize utf-daylist-linkage
              move como-data-from   to utf-daylist-data
              move ef-num-reg-buf   to utf-daylist-num-reg
LUBEXX        evaluate tipo-mov
LUBEXX        when 1 set utf-daylist-entrate to true
LUBEXX        when 2 set utf-daylist-uscite  to true
LUBEXX        when 3 set utf-daylist-tutte   to true
LUBEXX        end-evaluate
              call   "utf-daylist-p" using utf-daylist-linkage
              cancel "utf-daylist-p"
              
              initialize file-info

              call "C$FILEINFO" using utf-daylist-path, file-info

              if file-size not = 0           
                 move    utf-daylist-path        to 
           splcrt2graf-percorso-stampa
              ...
              call "C$DELETE"        using utf-daylist-path, "S"
