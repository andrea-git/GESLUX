      *{TOTEM}PRG-COMMENT
      * vescons.Cbl
      * vescons.Cbl is generated by TOTEM
      ...
      *{TOTEM}PRGID
       ...
       DATE-WRITTEN.        lunedì 2 dicembre 2013 19:39:31.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:vescons, INIT:vescons, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       01 rec-grid.
           05 col-nulla        PIC  X.
           05 Col-esito        PIC  x(10).
           05 Col-descr-esito  PIC  x(50).
           05 Col-data-es      PIC  99/99/9999.
           05 Col-ora-es       PIC  x(5).
           05 Col-vettore      PIC  X(40).
           05 col-dt-ap-giac   PIC  99/99/9999.
           05 col-dt-avviso    PIC  99/99/9999.
           05 col-dt-import    PIC  99/99/9999.
      ...
      *{TOTEM}LINKAGE
       01 como-tor-chiave.
           05 como-tor-anno    PIC  9(4).
           05 como-tor-numero  PIC  9(8).
      ...
      * GRID
       05
           ...
           SIZE 161,67 ,
           BOXED,
           DATA-COLUMNS (1, 2, 12, 62, 72, 77, 117, 127, 137),
           ALIGNMENT ("C", "L", "L", "C", "C", "U", "C", "C", "C"),
           SEPARATION (5, 5, 5, 5, 5, 5, 5, 5, 5),
           DATA-TYPES ("X", "x(10)", "x(50)", "99/99/9999", "x(5)", "x(4
      -    "0)", "99/99/9999", "99/99/9999", "99/99/9999"),
           NUM-COL-HEADINGS 1,
           COLUMN-HEADINGS,
      ...
      * LABEL
       05
           ...
           CENTER,
           TRANSPARENT,
           TITLE "Caricamento Esiti in corso...",
           .

      *{TOTEM}END

      *{TOTEM}LINKPARA
       PROCEDURE  DIVISION USING como-tor-chiave.
      *{TOTEM}END

      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:vescons, INIT:vescons, BeforeDeclarative>
      ***---
       TORDINI-ERR SECTION.
      ...
      * <TOTEM:EPT. INIT:vescons, INIT:vescons, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-clienti.
      * <TOTEM:EPT. INIT:vescons, FD:clienti, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT clienti
           ...
           END-IF
      * <TOTEM:EPT. INIT:vescons, FD:clienti, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-destini.
      * <TOTEM:EPT. INIT:vescons, FD:destini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT destini
           IF NOT Valid-STATUS-destini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vescons, FD:destini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tordini.
      * <TOTEM:EPT. INIT:vescons, FD:tordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tordini
           IF NOT Valid-STATUS-tordini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vescons, FD:tordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-eordini.
      * <TOTEM:EPT. INIT:vescons, FD:eordini, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT eordini
           IF NOT Valid-STATUS-eordini
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vescons, FD:eordini, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tescons.
      * <TOTEM:EPT. INIT:vescons, FD:tescons, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tescons
           IF NOT Valid-STATUS-tescons
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vescons, FD:tescons, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-tvettori.
      * <TOTEM:EPT. INIT:vescons, FD:tvettori, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT tvettori
           IF NOT Valid-STATUS-tvettori
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:vescons, FD:tvettori, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-clienti.
      * <TOTEM:EPT. INIT:vescons, FD:clienti, BeforeClose>
      * <TOTEM:END>
           CLOSE clienti
           .

       CLOSE-destini.
      * <TOTEM:EPT. INIT:vescons, FD:destini, BeforeClose>
      * <TOTEM:END>
           CLOSE destini
           .

       CLOSE-tordini.
      * <TOTEM:EPT. INIT:vescons, FD:tordini, BeforeClose>
      * <TOTEM:END>
           CLOSE tordini
           .

       CLOSE-eordini.
      * <TOTEM:EPT. INIT:vescons, FD:eordini, BeforeClose>
      * <TOTEM:END>
           CLOSE eordini
           .

       CLOSE-tescons.
      * <TOTEM:EPT. INIT:vescons, FD:tescons, BeforeClose>
      * <TOTEM:END>
           CLOSE tescons
           .

       CLOSE-tvettori.
      * <TOTEM:EPT. INIT:vescons, FD:tvettori, BeforeClose>
      * <TOTEM:END>
           CLOSE tvettori
           .
      ...
      * DISPLAY-COLUMNS settings
              MODIFY gd-ordini, DISPLAY-COLUMNS (1, 4, 12, 62, 78, 85, 
           115, 131, 145)
           .
      ...
      * <TOTEM:EPT. FORM:Form2, FORM:Form2, BeforeAccept>
           ...
           if not trovato
      ***        display message box "Nessun ordine presente per i limiti richiesti"
      ***                title = tit-err
      ***                icon mb-error-icon
              perform FORM2-EXIT
           else             
      ...
      * <TOTEM:END>
       ...
       CARICA-ESITI.
      * <TOTEM:PARA. CARICA-ESITI>
           move como-tor-chiave to eor-tor-chiave
           move low-value       to eor-num-riga
           start eordini key not < eor-chiave
              invalid
                 continue
              not invalid
                 perform SCORRI-ESITI
           end-start
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. METTI-IN-GRIGLIA>
           move eor-esito to Col-esito
                             tec-codice
           read tescons
              invalid
                 initialize tec-descrizione
           end-read
           move tec-descrizione to Col-descr-esito

           if eor-dt-consegna = zero
              move space  to Col-data-es
           else
              move eor-dt-consegna(7:2)  to como-data(1:2)
              move eor-dt-consegna(5:2)  to como-data(3:2)
              move eor-dt-consegna(1:4)  to como-data(5:4)
              move como-data             to Col-data-es
           end-if

           if eor-ora-consegna = zero
              move space  to Col-ora-es
           else
              move eor-ora-consegna(1:2) to Col-ora-es(1:2)
              move ":"                   to Col-ora-es(3:1)
              move eor-ora-consegna(3:2) to Col-ora-es(4:2)
           end-if


           move eor-vettore  to vet-codice
           read tvettori
              invalid
                 initialize vet-descrizione
           end-read
           move vet-descrizione to Col-vettore


           if eor-dt-avviso = zero
              move space  to col-dt-avviso
           else
              move eor-dt-avviso(7:2) to como-data(1:2)
              move eor-dt-avviso(5:2) to como-data(3:2)
              move eor-dt-avviso(1:4) to como-data(5:4)
              move como-data          to col-dt-avviso
           end-if

           if eor-dt-ap-giacenza = zero
              move space  to col-dt-ap-giac
           else
              move eor-dt-ap-giacenza(7:2)  to como-data(1:2)
              move eor-dt-ap-giacenza(5:2)  to como-data(3:2)
              move eor-dt-ap-giacenza(1:4)  to como-data(5:4)
              move como-data                to col-dt-ap-giac
           end-if

           move eor-data-ultima-modifica(7:2)  to como-data(1:2)
           move eor-data-ultima-modifica(5:2)  to como-data(3:2)
           move eor-data-ultima-modifica(1:4)  to como-data(5:4)
           move como-data                      to col-dt-import

           modify gd-ordini, RECORD-TO-ADD rec-grid.
      ...
      * <TOTEM:PARA. RIEMPI-GRID>
           ...
           perform GD-ORDINI-CONTENT.
           perform CARICA-ESITI.
           modify gd-ordini, mass-update = 0 
           .
      * <TOTEM:END>

       SCORRI-ESITI.
      * <TOTEM:PARA. SCORRI-ESITI>
           ...
           perform until 1 = 2
              ...
              if como-tor-chiave not = eor-tor-chiave
                 exit perform
              end-if
