      * Paragrafo per la struttura dei controlli sulla screen Form1
           ...
           |78-ID-ef-pag-d è l'ID del control ef-pag-d
           when 78-ID-ef-pag-d
                inquire ef-pag-d, value in ef-pag-d-buf

           |78-ID-ef-perce-premi-d è l'ID del control ef-perce-premi-d
           when 78-ID-ef-perce-premi-d
                inquire ef-perce-premi-d, value in ef-perce-premi-d-buf
      ...
      * Paragrafo per la struttura dei controlli sulla screen form-note
           evaluate control-id
           end-evaluate.
