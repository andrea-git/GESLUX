      * Paragrafo per la struttura dei controlli sulla screen Form1
           ...
           |78-ID-ef-num-ord è l'ID del control ef-num-ord
           when 78-ID-ef-num-ord
                inquire ef-num-ord, value in ef-num-ord-buf
           ...
           |78-ID-rb-man è l'ID del control rb-man
           when 78-ID-rb-man
                inquire rb-man, value in rb-man-buf

           |78-ID-rb-gui è l'ID del control rb-gui
           when 78-ID-rb-gui
                inquire rb-gui, value in rb-gui-buf
           ...
           |78-ID-ef-qta-oma è l'ID del control ef-qta-oma
           when 78-ID-ef-qta-oma
                inquire ef-qta-oma, value in ef-qta-oma-buf
      ...
      * Paragrafo per la struttura dei controlli sulla screen scr-conf
           evaluate control-id
           end-evaluate.
