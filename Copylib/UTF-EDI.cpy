      ...
      *    In questo caso splamo la differenza su tutte le righe
...
LUBEXX           end-if
      ...
      ***---
       CONTROLLO-TRASFERISCI.
           ...
           if pen-si-sdoppia-riga 
      *    se 3403 trasferisco la riga solo per i carichi e se fornitore
      *    estero
              if fornitore-estero
       ...
       VAL-ARTICOLI.
           ...
           if art-cod-prodener = space
              ...
              string "Cod. "          delimited by size
                     art-cod-prodener delimited by size
                     " non presente in anagrafica"   delimited by size
      ...
      ***---
       CREA-REPORT.
           ...
           string wstampa             delimited by low-value
                  "art_no_prodener"   delimited by size
