      *{TOTEM}PRG-COMMENT
      * GET-exp.Cbl
      * GET-exp.Cbl is generated by TOTEM
      ...
      *{TOTEM}PRGID
       ...
       DATE-WRITTEN.        martedì 1 aprile 2014 17:29:59.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:GET-exp, INIT:GET-exp, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       78 titolo VALUE IS "Geslux - Esportazione dati GET". 
       77 form1-Handle
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:GET-exp, INIT:GET-exp, BeforeDeclarative>
      ...
      * <TOTEM:EPT. INIT:GET-exp, INIT:GET-exp, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-paramget.
      * <TOTEM:EPT. INIT:GET-exp, FD:paramget, BeforeOpen>
      * <TOTEM:END>
           OPEN  INPUT paramget
           ...
           END-IF
      * <TOTEM:EPT. INIT:GET-exp, FD:paramget, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-lineseq.
      * <TOTEM:EPT. INIT:GET-exp, FD:lineseq, BeforeOpen>
      * <TOTEM:END>
           OPEN  OUTPUT lineseq
           IF NOT Valid-STATUS-lineseq
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:GET-exp, FD:lineseq, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-paramget.
      * <TOTEM:EPT. INIT:GET-exp, FD:paramget, BeforeClose>
      * <TOTEM:END>
           CLOSE paramget
           .

       CLOSE-lineseq.
      * <TOTEM:EPT. INIT:GET-exp, FD:lineseq, BeforeClose>
      * <TOTEM:END>
           .
      ...
      * <TOTEM:PARA. EXP-ARTICOLI>
      ...
      -              "valorizzato"  to como-messaggio
              ...
              call   "get-exparticoli" using exp-linkage
              cancel "get-exparticoli" 
      ...
      * <TOTEM:PARA. EXP-VETTORI>
           if get-file-vettori = space 
              move     "Esportazione Vettori impossibile! Nome file non 
      -              "valorizzato"  to como-messaggio
              perform SCRIVI-MESSAGGIO
           else
              call   "get-expvettori" using exp-linkage
              cancel "get-expvettori" 
              if exp-err-bloccante
                 set errori  to true
              end-if
           end-if 
      ...
      * <TOTEM:END>
       ...
       EXP-CLIENTI.
      * <TOTEM:PARA. EXP-CLIENTI>
           if get-file-clienti = space 
              move   "Esportazione Clienti impossibile! Nome file non va
      -    "lorizzato"  
                to como-messaggio
              perform SCRIVI-MESSAGGIO
           else
              call   "get-expclienti" using exp-linkage
              cancel "get-expclienti" 
              if exp-err-bloccante
                 set errori  to true
              end-if
           end-if 
      ...
      * <TOTEM:PARA. EXP-FORNITORI>
           if get-file-fornitori = space 
              move   "Esportazione Fornitori impossibile! Nome file non 
      -              "valorizzato"  to como-messaggio
              perform SCRIVI-MESSAGGIO
           else
              call   "get-expfornitori" using exp-linkage
              cancel "get-expfornitori" 
              if exp-err-bloccante
                 set errori  to true
              end-if
           end-if 
