      ...
      *-----------------------------------------------------------------*
       ...
       paramget-ERR SECTION.
           use error  procedure on paramget.
           set errori to true.
      ...
      ***---
       PREPARA-PERCORSI.
           ...
           string get-path-imp           delimited by low-value
                  ...
                  get-file-tordini-imp   delimited by size
                  into wstampa.
           initialize wstampa2.
           string get-path-imp           delimited by low-value
                  barra                  delimited by size
                  get-file-rordini-imp   delimited by size
                  into wstampa2.
      ...
      ***---
       ELABORAZIONE.
           ...
           move get-file-tordini-imp to nome-file.
           perform until 1 = 2
              initialize line-riga
      ...
      ***---
       PREELABORA-RIGHE.
           move get-file-rordini-imp to nome-file.
      ...
      ***---
       VALORIZZA-RECORD-R.
           ...
           move "GET"                    to tmp-iror-MAG-CODICE.
      ...
      ***--- 
       DIREZIONA-IMPEGNATO.
           |DUMMY: non intervengo ullì'impegnato
